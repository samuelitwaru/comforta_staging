...
namespace GeneXus.Programs {
   public class trn_managerww : GXDataArea
   {
      ...
      {
         /* GeneXus formulas. */
         AV96Pgmname = "Trn_ManagerWW";
         edtavManagerisactive_Enabled = 0;
      }

      protected int subGridclient_rec_count_fnc( )
      {
         AV97Trn_managerwwds_1_filterfulltext = AV15FilterFullText;
         AV98Trn_managerwwds_2_tfmanagergivenname = AV20TFManagerGivenName;
         AV99Trn_managerwwds_3_tfmanagergivenname_sel = AV21TFManagerGivenName_Sel;
         AV100Trn_managerwwds_4_tfmanagerlastname = AV22TFManagerLastName;
         AV101Trn_managerwwds_5_tfmanagerlastname_sel = AV23TFManagerLastName_Sel;
         AV102Trn_managerwwds_6_tfmanageremail = AV26TFManagerEmail;
         AV103Trn_managerwwds_7_tfmanageremail_sel = AV27TFManagerEmail_Sel;
         AV104Trn_managerwwds_8_tfmanagerphone = AV28TFManagerPhone;
         AV105Trn_managerwwds_9_tfmanagerphone_sel = AV29TFManagerPhone_Sel;
         AV106Trn_managerwwds_10_tfmanagergender_sels = AV31TFManagerGender_Sels;
         GRID_nRecordCount = 0;
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A27ManagerGender ,
                                              AV106Trn_managerwwds_10_tfmanagergender_sels ,
                                              AV99Trn_managerwwds_3_tfmanagergivenname_sel ,
                                              AV98Trn_managerwwds_2_tfmanagergivenname ,
                                              AV101Trn_managerwwds_5_tfmanagerlastname_sel ,
                                              AV100Trn_managerwwds_4_tfmanagerlastname ,
                                              AV103Trn_managerwwds_7_tfmanageremail_sel ,
                                              AV102Trn_managerwwds_6_tfmanageremail ,
                                              AV105Trn_managerwwds_9_tfmanagerphone_sel ,
                                              AV104Trn_managerwwds_8_tfmanagerphone ,
                                              AV106Trn_managerwwds_10_tfmanagergender_sels.Count ,
                                              A22ManagerGivenName ,
                                              A23ManagerLastName ,
                                              A25ManagerEmail ,
                                              A26ManagerPhone ,
                                              AV13OrderedBy ,
                                              AV14OrderedDsc ,
                                              AV97Trn_managerwwds_1_filterfulltext ,
                                              A11OrganisationId ,
                                              AV61OrganisationId } ,
                                              new int[]{
         ...
         lV98Trn_managerwwds_2_tfmanagergivenname = StringUtil.Concat( StringUtil.RTrim( AV98Trn_managerwwds_2_tfmanagergivenname), "%", "");
         lV100Trn_managerwwds_4_tfmanagerlastname = StringUtil.Concat( StringUtil.RTrim( AV100Trn_managerwwds_4_tfmanagerlastname), "%", "");
         lV102Trn_managerwwds_6_tfmanageremail = StringUtil.Concat( StringUtil.RTrim( AV102Trn_managerwwds_6_tfmanageremail), "%", "");
         lV104Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV104Trn_managerwwds_8_tfmanagerphone), 20, "%");
         /* Using cursor H003E2 */
         pr_default.execute(0, new Object[] {AV61OrganisationId, lV98Trn_managerwwds_2_tfmanagergivenname, AV99Trn_managerwwds_3_tfmanagergivenname_sel, lV100Trn_managerwwds_4_tfmanagerlastname, AV101Trn_managerwwds_5_tfmanagerlastname_sel, lV102Trn_managerwwds_6_tfmanageremail, AV103Trn_managerwwds_7_tfmanageremail_sel, lV104Trn_managerwwds_8_tfmanagerphone, AV105Trn_managerwwds_9_tfmanagerphone_sel});
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV104Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV104Trn_managerwwds_8_tfmanagerphone), 20, "%");
            /* Using cursor H003E3 */
            pr_default.execute(1, new Object[] {AV61OrganisationId, lV98Trn_managerwwds_2_tfmanagergivenname, AV99Trn_managerwwds_3_tfmanagergivenname_sel, lV100Trn_managerwwds_4_tfmanagerlastname, AV101Trn_managerwwds_5_tfmanagerlastname_sel, lV102Trn_managerwwds_6_tfmanageremail, AV103Trn_managerwwds_7_tfmanageremail_sel, lV104Trn_managerwwds_8_tfmanagerphone, AV105Trn_managerwwds_9_tfmanagerphone_sel});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            GRID_nEOF = 0;
      ...
      protected void E193E2( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  AV94successmsg,  "success",  "",  "true",  ""));
      ...
      protected void E203E2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV96Pgmname, out  GXt_char4) ;
      ...
      protected void E113E2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_ManagerWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV96Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV96Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV96Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV96Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV96Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV107GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251241056335", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerww.js", "?20251241056338", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV104Trn_managerwwds_8_tfmanagerphone = "";
         AV105Trn_managerwwds_9_tfmanagerphone_sel = "";
         AV106Trn_managerwwds_10_tfmanagergender_sels = new GxSimpleCollection<string>();
         lV98Trn_managerwwds_2_tfmanagergivenname = "";
         lV100Trn_managerwwds_4_tfmanagerlastname = "";
         lV102Trn_managerwwds_6_tfmanageremail = "";
         lV104Trn_managerwwds_8_tfmanagerphone = "";
      ...
      private int AV106Trn_managerwwds_10_tfmanagergender_sels_Count ;
      ...
      private string AV104Trn_managerwwds_8_tfmanagerphone ;
      private string AV105Trn_managerwwds_9_tfmanagerphone_sel ;
      private string lV104Trn_managerwwds_8_tfmanagerphone ;
      ...
      private string AV97Trn_managerwwds_1_filterfulltext ;
      private string AV98Trn_managerwwds_2_tfmanagergivenname ;
      private string AV99Trn_managerwwds_3_tfmanagergivenname_sel ;
      private string AV100Trn_managerwwds_4_tfmanagerlastname ;
      private string AV101Trn_managerwwds_5_tfmanagerlastname_sel ;
      private string AV102Trn_managerwwds_6_tfmanageremail ;
      private string AV103Trn_managerwwds_7_tfmanageremail_sel ;
      private string lV98Trn_managerwwds_2_tfmanagergivenname ;
      private string lV100Trn_managerwwds_4_tfmanagerlastname ;
      private string lV102Trn_managerwwds_6_tfmanageremail ;
      ...
      private GxSimpleCollection<string> AV106Trn_managerwwds_10_tfmanagergender_sels ;
...
public class trn_managerww__default : DataStoreHelperBase, IDataStoreHelper
{
   protected Object[] conditional_H003E2( IGxContext context ,
                                          ...
                                          GxSimpleCollection<string> AV106Trn_managerwwds_10_tfmanagergender_sels ,
                                          string AV99Trn_managerwwds_3_tfmanagergivenname_sel ,
                                          string AV98Trn_managerwwds_2_tfmanagergivenname ,
                                          string AV101Trn_managerwwds_5_tfmanagerlastname_sel ,
                                          string AV100Trn_managerwwds_4_tfmanagerlastname ,
                                          string AV103Trn_managerwwds_7_tfmanageremail_sel ,
                                          string AV102Trn_managerwwds_6_tfmanageremail ,
                                          string AV105Trn_managerwwds_9_tfmanagerphone_sel ,
                                          string AV104Trn_managerwwds_8_tfmanagerphone ,
                                          int AV106Trn_managerwwds_10_tfmanagergender_sels_Count ,
                                          string A22ManagerGivenName ,
                                          ...
                                          short AV13OrderedBy ,
                                          bool AV14OrderedDsc ,
                                          string AV97Trn_managerwwds_1_filterfulltext ,
                                          ...
                                          Guid AV61OrganisationId )
   {
      ...
      if ( String.IsNullOrEmpty(StringUtil.RTrim( AV99Trn_managerwwds_3_tfmanagergivenname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV98Trn_managerwwds_2_tfmanagergivenname)) ) )
      {
         AddWhere(sWhereString, "(ManagerGivenName like :lV98Trn_managerwwds_2_tfmanagergivenname)");
      }
      else
      {
         GXv_int11[1] = 1;
      }
      if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV99Trn_managerwwds_3_tfmanagergivenname_sel)) && ! ( StringUtil.StrCmp(AV99Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 ) )
      {
         AddWhere(sWhereString, "(ManagerGivenName = ( :AV99Trn_managerwwds_3_tfmanagergivenname_sel))");
      }
      else
      {
         GXv_int11[2] = 1;
      }
      if ( StringUtil.StrCmp(AV99Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 )
      {
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerGivenName))=0))");
      }
      if ( String.IsNullOrEmpty(StringUtil.RTrim( AV101Trn_managerwwds_5_tfmanagerlastname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV100Trn_managerwwds_4_tfmanagerlastname)) ) )
      {
         AddWhere(sWhereString, "(ManagerLastName like :lV100Trn_managerwwds_4_tfmanagerlastname)");
      }
      else
      {
         GXv_int11[3] = 1;
      }
      if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV101Trn_managerwwds_5_tfmanagerlastname_sel)) && ! ( StringUtil.StrCmp(AV101Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 ) )
      {
         AddWhere(sWhereString, "(ManagerLastName = ( :AV101Trn_managerwwds_5_tfmanagerlastname_sel))");
      }
      else
      {
         GXv_int11[4] = 1;
      }
      if ( StringUtil.StrCmp(AV101Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 )
      {
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerLastName))=0))");
      }
      if ( String.IsNullOrEmpty(StringUtil.RTrim( AV103Trn_managerwwds_7_tfmanageremail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV102Trn_managerwwds_6_tfmanageremail)) ) )
      {
         AddWhere(sWhereString, "(ManagerEmail like :lV102Trn_managerwwds_6_tfmanageremail)");
      }
      else
      {
         GXv_int11[5] = 1;
      }
      if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV103Trn_managerwwds_7_tfmanageremail_sel)) && ! ( StringUtil.StrCmp(AV103Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 ) )
      {
         AddWhere(sWhereString, "(ManagerEmail = ( :AV103Trn_managerwwds_7_tfmanageremail_sel))");
      }
      else
      {
         GXv_int11[6] = 1;
      }
      if ( StringUtil.StrCmp(AV103Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 )
      {
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerEmail))=0))");
      }
      if ( String.IsNullOrEmpty(StringUtil.RTrim( AV105Trn_managerwwds_9_tfmanagerphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV104Trn_managerwwds_8_tfmanagerphone)) ) )
      {
         AddWhere(sWhereString, "(ManagerPhone like :lV104Trn_managerwwds_8_tfmanagerphone)");
      }
      else
      {
         GXv_int11[7] = 1;
      }
      if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV105Trn_managerwwds_9_tfmanagerphone_sel)) && ! ( StringUtil.StrCmp(AV105Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 ) )
      {
         AddWhere(sWhereString, "(ManagerPhone = ( :AV105Trn_managerwwds_9_tfmanagerphone_sel))");
      }
      else
      {
         GXv_int11[8] = 1;
      }
      if ( StringUtil.StrCmp(AV105Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 )
      {
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerPhone))=0))");
      }
      if ( AV106Trn_managerwwds_10_tfmanagergender_sels_Count > 0 )
      {
         AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV106Trn_managerwwds_10_tfmanagergender_sels, "ManagerGender IN (", ")")+")");
      }
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       new ParDef("lV98Trn_managerwwds_2_tfmanagergivenname",GXType.VarChar,100,0) ,
       new ParDef("AV99Trn_managerwwds_3_tfmanagergivenname_sel",GXType.VarChar,100,0) ,
       new ParDef("lV100Trn_managerwwds_4_tfmanagerlastname",GXType.VarChar,100,0) ,
       new ParDef("AV101Trn_managerwwds_5_tfmanagerlastname_sel",GXType.VarChar,100,0) ,
       new ParDef("lV102Trn_managerwwds_6_tfmanageremail",GXType.VarChar,100,0) ,
       new ParDef("AV103Trn_managerwwds_7_tfmanageremail_sel",GXType.VarChar,100,0) ,
       new ParDef("lV104Trn_managerwwds_8_tfmanagerphone",GXType.Char,20,0) ,
       new ParDef("AV105Trn_managerwwds_9_tfmanagerphone_sel",GXType.Char,20,0)
       };
       Object[] prmH003E3;
