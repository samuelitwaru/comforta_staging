...
namespace GeneXus.Programs {
   public class prc_uniquelocationservicename : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A58ProductServiceId = P00B92_A58ProductServiceId[0];
            A29LocationId = P00B92_A29LocationId[0];
            A59ProductServiceName = P00B92_A59ProductServiceName[0];
            A11OrganisationId = P00B92_A11OrganisationId[0];
            AV12GXLvl2 = 1;
      ...
      {
         P00B92_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P00B92_A29LocationId = new Guid[] {Guid.Empty} ;
         P00B92_A59ProductServiceName = new string[] {""} ;
         P00B92_A11OrganisationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_uniquelocationservicename__default(),
            new Object[][] {
                new Object[] {
               P00B92_A58ProductServiceId, P00B92_A29LocationId, P00B92_A59ProductServiceName, P00B92_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00B92_A58ProductServiceId ;
      private Guid[] P00B92_A29LocationId ;
      private string[] P00B92_A59ProductServiceName ;
      private Guid[] P00B92_A11OrganisationId ;
