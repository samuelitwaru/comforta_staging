	...
	this.Scripts = [];
		...
		this.Start = function() {
			...
			//	  new Clock();
				  ...
				  const editorManager = new ChildEditorManager(dataManager)
				...
				toolBox.childEditorManager = childEditorManager
				alert()
