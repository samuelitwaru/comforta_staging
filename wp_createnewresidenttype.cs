   ...
   public class wp_createnewresidenttype : GXDataArea
   {
      ...
      protected void WB860( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavTrn_residenttype_residenttypename_Internalname, "Resident Type", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412191574063", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createnewresidenttype.js", "?202412191574064", false, true);
