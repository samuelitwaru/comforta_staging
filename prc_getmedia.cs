   ...
   public class prc_getmedia : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getmedia__default(),
            new Object[][] {
                new Object[] {
               P009Y2_A40000MediaImage_GXI, P009Y2_n40000MediaImage_GXI, P009Y2_A409MediaId, P009Y2_A410MediaName, P009Y2_A413MediaSize, P009Y2_A414MediaType, P009Y2_A412MediaUrl, P009Y2_A411MediaImage, P009Y2_n411MediaImage
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class prc_getmedia__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P009Y2", "SELECT MediaImage_GXI, MediaId, MediaName, MediaSize, MediaType, MediaUrl, MediaImage FROM Trn_Media ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009Y2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[7])[0] = rslt.getMultimediaFile(7, rslt.getVarchar(1));
