...
namespace GeneXus.Programs {
   public class prc_inithomepage : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV15BC_HomePage.gxTpr_Ispredefined = true;
      ...
      protected void S111( )
      {
         ...
         new prc_createpagetile(context ).execute(  context.GetMessage( "Reception", ""),  "#333333",  context.GetMessage( "left", ""),  context.GetMessage( "Reception", ""),  0,  "",  AV20baseUrl+context.GetMessage( "/media/receptie-197@3x.png", ""),  AV10ReceptionPageId.ToString(),  "Content",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
      ...
      protected void S131( )
      {
         ...
         AV18RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV17TilesItem;
         new prc_createpagetile(context ).execute(  context.GetMessage( "Location", ""),  "#333333",  context.GetMessage( "left", ""),  "",  0,  "",  AV20baseUrl+context.GetMessage( "/media/LocationInfo.png", ""),  AV11LocationPageId.ToString(),  "Content",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV17TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV17TilesItem = new SdtSDT_MenuPage_RowsItem_TilesItem(context);
         AV17TilesItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
      ...
      protected void S141( )
      {
         ...
         AV18RowsItem.gxTpr_Id = new SdtRandomStringGenerator(context).generate(15);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV17TilesItem;
         new prc_createpagetile(context ).execute(  context.GetMessage( "My Care", ""),  "#333333",  context.GetMessage( "center", ""),  "",  0,  "",  "",  AV12CarePageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV17TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV18RowsItem.gxTpr_Tiles.Add(AV17TilesItem, 0);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV17TilesItem;
         new prc_createpagetile(context ).execute(  context.GetMessage( "My Living", ""),  "#333333",  context.GetMessage( "center", ""),  "",  0,  "",  "",  AV13LivingPageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV17TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV18RowsItem.gxTpr_Tiles.Add(AV17TilesItem, 0);
         GXt_SdtSDT_MenuPage_RowsItem_TilesItem1 = AV17TilesItem;
         new prc_createpagetile(context ).execute(  context.GetMessage( "My Services", ""),  "#333333",  context.GetMessage( "center", ""),  "",  0,  "",  "",  AV14ServicesPageId.ToString(),  "Menu",  "", out  GXt_SdtSDT_MenuPage_RowsItem_TilesItem1) ;
         AV17TilesItem = GXt_SdtSDT_MenuPage_RowsItem_TilesItem1;
         AV18RowsItem.gxTpr_Tiles.Add(AV17TilesItem, 0);
         AV16SDT_MenuPage.gxTpr_Rows.Add(AV18RowsItem, 0);
      }
