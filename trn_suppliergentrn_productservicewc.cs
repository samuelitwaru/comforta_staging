...
namespace GeneXus.Programs {
   public class trn_suppliergentrn_productservicewc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Supplier Gen Trn_Product Service WC") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26OrderedBy), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11GridCurrentPage), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12GridPageCount), 10, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMANAGEFILTERSEXECUTIONSTEP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24ManageFiltersExecutionStep), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV39Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV39Pgmname, "")), context));
      ...
      {
         return "Trn_Supplier Gen Trn_Product Service WC" ;
      }
      ...
      protected void WB9U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV9FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV9FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Search", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_Trn_SupplierGenTrn_ProductServiceWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START9U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Supplier Gen Trn_Product Service WC", 0) ;
            context.wjLoc = "";
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( ( context.localUtil.CToN( cgiGet( sPrefix+"GXH_vORDEREDBY"), ".", ",") != Convert.ToDecimal( AV26OrderedBy )) )
                                             {
                                                Rfr0gs = true;
                                             }
      ...
      protected void RF9U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
            /* Using cursor H009U2 */
            pr_default.execute(0, new Object[] {AV32SupplierGenId, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV9FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV9FilterFullText), "%", "");
         /* Using cursor H009U3 */
         pr_default.execute(1, new Object[] {AV32SupplierGenId, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText, lV9FilterFullText});
         GRID_nRecordCount = H009U3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP9U0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV11GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ".", ","), 18, MidpointRounding.ToEven));
            AV12GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "FILTERFULLTEXT",  "Main filter",  !String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterFullText)),  0,  AV9FilterFullText,  AV9FilterFullText,  false,  "",  "") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121110555531", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_suppliergentrn_productservicewc.js", "?2024121110555532", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Service Group") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
      ...
      public override void initialize( )
      {
         ...
         H009U3_AGRID_nRecordCount = new long[1] ;
      ...
      private string lV9FilterFullText ;
      ...
      private long[] H009U3_AGRID_nRecordCount ;
   ...
   public class trn_suppliergentrn_productservicewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV32SupplierGenId )
      {
         ...
         sFromString = " FROM ((Trn_ProductService T1 LEFT JOIN Trn_SupplierAGB T2 ON T2.SupplierAgbId = T1.SupplierAgbId) INNER JOIN Trn_Location T3 ON T3.LocationId = T1.LocationId AND T3.OrganisationId = T1.OrganisationId)";
         sOrderString = "";
         ...
         {
            sOrderString += " ORDER BY T1.SupplierGenId, T1.ProductServiceName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 1 ) && ( AV27OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 2 ) && ! AV27OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SupplierGenId, T1.ProductServiceTileName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 2 ) && ( AV27OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceTileName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 3 ) && ! AV27OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SupplierGenId, T1.ProductServiceClass, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 3 ) && ( AV27OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceClass DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( true )
         {
                                             ...
                                             Guid AV32SupplierGenId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((Trn_ProductService T1 LEFT JOIN Trn_SupplierAGB T3 ON T3.SupplierAgbId = T1.SupplierAgbId) INNER JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId)";
         AddWhere(sWhereString, "(T1.SupplierGenId = :AV32SupplierGenId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.ProductServiceName like '%' || :lV9FilterFullText) or ( T1.ProductServiceTileName like '%' || :lV9FilterFullText) or ( 'select category' like '%' || LOWER(:lV9FilterFullText) and (char_length(trim(trailing ' ' from T1.ProductServiceClass))=0)) or ( 'my living' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Living')) or ( 'my care' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Care')) or ( 'my services' like '%' || LOWER(:lV9FilterFullText) and T1.ProductServiceClass = ( 'My Services')))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H009U2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H009U3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV9FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV9FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV9FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV9FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV9FilterFullText",GXType.VarChar,100,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H009U3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009U3,1, GxCacheFrequency.OFF ,true,false )
