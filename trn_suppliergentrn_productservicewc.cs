...
namespace GeneXus.Programs {
   public class trn_suppliergentrn_productservicewc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV26OrderedBy, AV27OrderedDsc, AV9FilterFullText, AV32SupplierGenId, AV24ManageFiltersExecutionStep, AV39Pgmname, AV18IsAuthorized_Display, AV22IsAuthorized_Update, AV17IsAuthorized_Delete, AV20IsAuthorized_ProductServiceName, AV19IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV39Pgmname = "Trn_SupplierGenTrn_ProductServiceWC";
      ...
      protected void RenderHtmlCloseForm9U2( )
      {
      ...
      protected void WB9U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV9FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV9FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_Trn_SupplierGenTrn_ProductServiceWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A11OrganisationId = H009U2_A11OrganisationId[0];
            A31LocationName = H009U2_A31LocationName[0];
            A42SupplierGenId = H009U2_A42SupplierGenId[0];
            n42SupplierGenId = H009U2_n42SupplierGenId[0];
            AssignAttri(sPrefix, false, "A42SupplierGenId", A42SupplierGenId.ToString());
            A51SupplierAgbName = H009U2_A51SupplierAgbName[0];
            A49SupplierAgbId = H009U2_A49SupplierAgbId[0];
            n49SupplierAgbId = H009U2_n49SupplierAgbId[0];
            A366ProductServiceGroup = H009U2_A366ProductServiceGroup[0];
            A40000ProductServiceImage_GXI = H009U2_A40000ProductServiceImage_GXI[0];
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
            A408ProductServiceClass = H009U2_A408ProductServiceClass[0];
            A60ProductServiceDescription = H009U2_A60ProductServiceDescription[0];
            A301ProductServiceTileName = H009U2_A301ProductServiceTileName[0];
            A59ProductServiceName = H009U2_A59ProductServiceName[0];
            A29LocationId = H009U2_A29LocationId[0];
            A58ProductServiceId = H009U2_A58ProductServiceId[0];
            A61ProductServiceImage = H009U2_A61ProductServiceImage[0];
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
            A51SupplierAgbName = H009U2_A51SupplierAgbName[0];
            A31LocationName = H009U2_A31LocationName[0];
      ...
      protected void RF9U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11OrganisationId = H009U3_A11OrganisationId[0];
               A31LocationName = H009U3_A31LocationName[0];
               A42SupplierGenId = H009U3_A42SupplierGenId[0];
               n42SupplierGenId = H009U3_n42SupplierGenId[0];
               AssignAttri(sPrefix, false, "A42SupplierGenId", A42SupplierGenId.ToString());
               A51SupplierAgbName = H009U3_A51SupplierAgbName[0];
               A49SupplierAgbId = H009U3_A49SupplierAgbId[0];
               n49SupplierAgbId = H009U3_n49SupplierAgbId[0];
               A366ProductServiceGroup = H009U3_A366ProductServiceGroup[0];
               A40000ProductServiceImage_GXI = H009U3_A40000ProductServiceImage_GXI[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A408ProductServiceClass = H009U3_A408ProductServiceClass[0];
               A60ProductServiceDescription = H009U3_A60ProductServiceDescription[0];
               A301ProductServiceTileName = H009U3_A301ProductServiceTileName[0];
               A59ProductServiceName = H009U3_A59ProductServiceName[0];
               A29LocationId = H009U3_A29LocationId[0];
               A58ProductServiceId = H009U3_A58ProductServiceId[0];
               A61ProductServiceImage = H009U3_A61ProductServiceImage[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A51SupplierAgbName = H009U3_A51SupplierAgbName[0];
               A31LocationName = H009U3_A31LocationName[0];
      ...
      private void E189U2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            {
               A29LocationId = H009U4_A29LocationId[0];
      ...
      protected void E119U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_SupplierGenTrn_ProductServiceWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_SupplierGenTrn_ProductServiceWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV39Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_SupplierGenTrn_ProductServiceWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S142( )
      {
         ...
         {
            AV13GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV39Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         {
            AV14GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV41GXV1));
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "FILTERFULLTEXT",  context.GetMessage( "WWP_FullTextFilterDescription", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterFullText)),  0,  AV9FilterFullText,  AV9FilterFullText,  false,  "",  "") ;
         AV13GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV39Pgmname+"GridState",  AV13GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV33TrnContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext(context);
         ...
         AV34TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202512410543846", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_suppliergentrn_productservicewc.js", "?202512410543846", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E159U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV27OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV9FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV32SupplierGenId","fld":"vSUPPLIERGENID"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV18IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV22IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV17IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV19IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A58ProductServiceId","fld":"PRODUCTSERVICEID","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV6DDO_TitleSettingsIcons = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         A31LocationName = "";
         ...
         A51SupplierAgbName = "";
         GXDecQS = "";
         H009U2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009U2_A31LocationName = new string[] {""} ;
         H009U2_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H009U2_n42SupplierGenId = new bool[] {false} ;
         H009U2_A51SupplierAgbName = new string[] {""} ;
         H009U2_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H009U2_n49SupplierAgbId = new bool[] {false} ;
         H009U2_A366ProductServiceGroup = new string[] {""} ;
         H009U2_A40000ProductServiceImage_GXI = new string[] {""} ;
         H009U2_A408ProductServiceClass = new string[] {""} ;
         H009U2_A60ProductServiceDescription = new string[] {""} ;
         H009U2_A301ProductServiceTileName = new string[] {""} ;
         H009U2_A59ProductServiceName = new string[] {""} ;
         H009U2_A29LocationId = new Guid[] {Guid.Empty} ;
         H009U2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H009U2_A61ProductServiceImage = new string[] {""} ;
         H009U3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009U3_A31LocationName = new string[] {""} ;
         H009U3_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H009U3_n42SupplierGenId = new bool[] {false} ;
         H009U3_A51SupplierAgbName = new string[] {""} ;
         H009U3_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H009U3_n49SupplierAgbId = new bool[] {false} ;
         H009U3_A366ProductServiceGroup = new string[] {""} ;
         H009U3_A40000ProductServiceImage_GXI = new string[] {""} ;
         H009U3_A408ProductServiceClass = new string[] {""} ;
         H009U3_A60ProductServiceDescription = new string[] {""} ;
         H009U3_A301ProductServiceTileName = new string[] {""} ;
         H009U3_A59ProductServiceName = new string[] {""} ;
         H009U3_A29LocationId = new Guid[] {Guid.Empty} ;
         H009U3_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H009U3_A61ProductServiceImage = new string[] {""} ;
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons2 = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         AV36WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H009U4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009U4_A29LocationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergentrn_productservicewc__default(),
            new Object[][] {
                new Object[] {
               H009U2_A11OrganisationId, H009U2_A31LocationName, H009U2_A42SupplierGenId, H009U2_n42SupplierGenId, H009U2_A51SupplierAgbName, H009U2_A49SupplierAgbId, H009U2_n49SupplierAgbId, H009U2_A366ProductServiceGroup, H009U2_A40000ProductServiceImage_GXI, H009U2_A408ProductServiceClass,
               H009U2_A60ProductServiceDescription, H009U2_A301ProductServiceTileName, H009U2_A59ProductServiceName, H009U2_A29LocationId, H009U2_A58ProductServiceId, H009U2_A61ProductServiceImage
               }
               , new Object[] {
               H009U3_A11OrganisationId, H009U3_A31LocationName, H009U3_A42SupplierGenId, H009U3_n42SupplierGenId, H009U3_A51SupplierAgbName, H009U3_A49SupplierAgbId, H009U3_n49SupplierAgbId, H009U3_A366ProductServiceGroup, H009U3_A40000ProductServiceImage_GXI, H009U3_A408ProductServiceClass,
               H009U3_A60ProductServiceDescription, H009U3_A301ProductServiceTileName, H009U3_A59ProductServiceName, H009U3_A29LocationId, H009U3_A58ProductServiceId, H009U3_A61ProductServiceImage
               }
               , new Object[] {
               H009U4_A11OrganisationId, H009U4_A29LocationId
               }
            }
         );
         AV39Pgmname = "Trn_SupplierGenTrn_ProductServiceWC";
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV6DDO_TitleSettingsIcons ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPGridState AV13GridState ;
      private IDataStoreProvider pr_default ;
      private Guid[] H009U2_A11OrganisationId ;
      private string[] H009U2_A31LocationName ;
      private Guid[] H009U2_A42SupplierGenId ;
      private bool[] H009U2_n42SupplierGenId ;
      private string[] H009U2_A51SupplierAgbName ;
      private Guid[] H009U2_A49SupplierAgbId ;
      private bool[] H009U2_n49SupplierAgbId ;
      private string[] H009U2_A366ProductServiceGroup ;
      private string[] H009U2_A40000ProductServiceImage_GXI ;
      private string[] H009U2_A408ProductServiceClass ;
      private string[] H009U2_A60ProductServiceDescription ;
      private string[] H009U2_A301ProductServiceTileName ;
      private string[] H009U2_A59ProductServiceName ;
      private Guid[] H009U2_A29LocationId ;
      private Guid[] H009U2_A58ProductServiceId ;
      private string[] H009U2_A61ProductServiceImage ;
      private Guid[] H009U3_A11OrganisationId ;
      private string[] H009U3_A31LocationName ;
      private Guid[] H009U3_A42SupplierGenId ;
      private bool[] H009U3_n42SupplierGenId ;
      private string[] H009U3_A51SupplierAgbName ;
      private Guid[] H009U3_A49SupplierAgbId ;
      private bool[] H009U3_n49SupplierAgbId ;
      private string[] H009U3_A366ProductServiceGroup ;
      private string[] H009U3_A40000ProductServiceImage_GXI ;
      private string[] H009U3_A408ProductServiceClass ;
      private string[] H009U3_A60ProductServiceDescription ;
      private string[] H009U3_A301ProductServiceTileName ;
      private string[] H009U3_A59ProductServiceName ;
      private Guid[] H009U3_A29LocationId ;
      private Guid[] H009U3_A58ProductServiceId ;
      private string[] H009U3_A61ProductServiceImage ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons2 ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV36WWPContext ;
      private Guid[] H009U4_A11OrganisationId ;
      private Guid[] H009U4_A29LocationId ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4 ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue AV14GridStateFilterValue ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext AV33TrnContext ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute AV34TrnContextAtt ;
   ...
   {
      protected Object[] conditional_H009U2( IGxContext context ,
                                             short AV26OrderedBy ,
                                             bool AV27OrderedDsc ,
                                             ...
                                             string A408ProductServiceClass )
      {
         ...
         scmdbuf = "SELECT T1.OrganisationId, T3.LocationName, T1.SupplierGenId, T2.SupplierAgbName, T1.SupplierAgbId, T1.ProductServiceGroup, T1.ProductServiceImage_GXI, T1.ProductServiceClass, T1.ProductServiceDescription, T1.ProductServiceTileName, T1.ProductServiceName, T1.LocationId, T1.ProductServiceId, T1.ProductServiceImage FROM ((Trn_ProductService T1 LEFT JOIN Trn_SupplierAGB T2 ON T2.SupplierAgbId = T1.SupplierAgbId) INNER JOIN Trn_Location T3 ON T3.LocationId = T1.LocationId AND T3.OrganisationId = T1.OrganisationId)";
      ...
      protected Object[] conditional_H009U3( IGxContext context ,
                                             short AV26OrderedBy ,
                                             bool AV27OrderedDsc ,
                                             Guid A42SupplierGenId ,
                                             Guid AV32SupplierGenId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H009U2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] );
               case 1 :
                     return conditional_H009U3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H009U2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009U2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H009U3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009U3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H009U4", "SELECT OrganisationId, LocationId FROM Trn_Location WHERE (OrganisationId = :OrganisationId) AND (LocationId = :LocationId) ORDER BY OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009U4,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
