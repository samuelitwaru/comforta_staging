...
namespace GeneXus.Programs {
   public class wc_childnotifications : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV22SDT_NotificationGroupCollection);
         AV15ParentId = GetPar( "ParentId");
         ajax_req_read_hidden_sdt(GetNextPar( ), AV20WWP_SDTNotificationsData);
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV35Pgmname, AV22SDT_NotificationGroupCollection, AV15ParentId, AV20WWP_SDTNotificationsData, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV35Pgmname = "WC_ChildNotifications";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WC_Child Notifications") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWWP_SDTNOTIFICATIONSDATA", AV20WWP_SDTNotificationsData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWWP_SDTNOTIFICATIONSDATA", AV20WWP_SDTNotificationsData);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWP_SDTNOTIFICATIONSDATA", GetSecureSignedToken( sPrefix, AV20WWP_SDTNotificationsData, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"Wwp_sdtnotificationsdata", AV20WWP_SDTNotificationsData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"Wwp_sdtnotificationsdata", AV20WWP_SDTNotificationsData);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_Wwp_sdtnotificationsdata", GetSecureSignedToken( sPrefix, AV20WWP_SDTNotificationsData, context));
      ...
      protected void RenderHtmlCloseForm9Z2( )
      {
      ...
      protected void START9Z2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WC_Child Notifications", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "LSCR") == 0 )
                           {
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    GX_FocusControl = edtavWwp_sdtnotificationsdata__notificationid_Internalname;
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "GRID.ONLINEACTIVATE") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV27GXV1 = (int)(nGXsfl_12_idx+GRID_nFirstRecordOnPage);
                              if ( ( AV20WWP_SDTNotificationsData.Count >= AV27GXV1 ) && ( AV27GXV1 > 0 ) )
                              {
                                 AV20WWP_SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV20WWP_SDTNotificationsData.Item(AV27GXV1));
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV15ParentId ,
                                       GXBaseCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem> AV20WWP_SDTNotificationsData ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         return AV20WWP_SDTNotificationsData.Count ;
      }
      ...
      protected void STRUP9Z0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"Wwp_sdtnotificationsdata"), AV20WWP_SDTNotificationsData);
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vWWP_SDTNOTIFICATIONSDATA"), AV20WWP_SDTNotificationsData);
            /* Read saved values. */
            ...
            while ( nGXsfl_12_fel_idx < nRC_GXsfl_12 )
            {
               ...
               AV27GXV1 = (int)(nGXsfl_12_fel_idx+GRID_nFirstRecordOnPage);
               if ( ( AV20WWP_SDTNotificationsData.Count >= AV27GXV1 ) && ( AV27GXV1 > 0 ) )
               {
                  AV20WWP_SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV20WWP_SDTNotificationsData.Item(AV27GXV1));
                  AV13NotificationIcon = cgiGet( edtavNotificationicon_Internalname);
            ...
            if ( nGXsfl_12_idx > 0 )
            {
               ...
               if ( ( AV27GXV1 > 0 ) && ( AV20WWP_SDTNotificationsData.Count >= AV27GXV1 ) )
               {
                  AV20WWP_SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV20WWP_SDTNotificationsData.Item(AV27GXV1));
               }
            }
      ...
      protected void E129Z2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV20WWP_SDTNotificationsData", AV20WWP_SDTNotificationsData);
      }
      ...
      private void E139Z2( )
      {
         ...
         returnInSub = false;
         AV27GXV1 = 1;
         while ( AV27GXV1 <= AV20WWP_SDTNotificationsData.Count )
         {
            AV20WWP_SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV20WWP_SDTNotificationsData.Item(AV27GXV1));
            cmbavActiongroup.removeAllItems();
            cmbavActiongroup.addItem("0", ";fas fa-bars", 0);
            cmbavActiongroup.addItem("1", StringUtil.Format( "%1;%2", "Mark as Read", "fas fa-envelope-open", "", "", "", "", "", "", ""), 0);
            cmbavActiongroup.addItem("2", StringUtil.Format( "%1;%2", "Open Link", "fas fa-link", "", "", "", "", "", "", ""), 0);
            edtavNotificationicon_Format = 2;
            AV13NotificationIcon = StringUtil.Format( "<i class=\"%1 %2\"></i>", ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)(AV20WWP_SDTNotificationsData.CurrentItem)).gxTpr_Notificationiconclass, "NotificationFontIconGrid", "", "", "", "", "", "", "");
            AssignAttri(sPrefix, false, edtavNotificationicon_Internalname, AV13NotificationIcon);
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void S132( )
      {
         ...
         while ( AV34GXV8 <= AV22SDT_NotificationGroupCollection.Count )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Trim( AV24SDT_NotificationGroupItem.gxTpr_Parentlinkid), StringUtil.Trim( AV15ParentId)) == 0 )
            {
               ...
               AV25WWP_SDTNotificationsDataItem.gxTpr_Notificationtitle = AV24SDT_NotificationGroupItem.gxTpr_Notificationtitle;
               AV25WWP_SDTNotificationsDataItem.gxTpr_Notificationdescription = AV24SDT_NotificationGroupItem.gxTpr_Notificationdescription;
               AV25WWP_SDTNotificationsDataItem.gxTpr_Notificationdatetime = AV24SDT_NotificationGroupItem.gxTpr_Notificationdatetime;
               AV25WWP_SDTNotificationsDataItem.gxTpr_Notificationiconclass = AV24SDT_NotificationGroupItem.gxTpr_Notificationiconclass;
               AV25WWP_SDTNotificationsDataItem.gxTpr_Notificationlink = AV24SDT_NotificationGroupItem.gxTpr_Notificationlink;
               AV20WWP_SDTNotificationsData.Add(AV25WWP_SDTNotificationsDataItem, 0);
               gx_BV12 = true;
            }
      ...
      protected void S112( )
      {
         ...
         {
            AV9GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV35Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV9GridState.FromXml(AV17Session.Get(AV35Pgmname+"GridState"), null, "", "");
         }
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV35Pgmname+"GridState",  AV9GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E149Z2( )
      {
         ...
         returnInSub = false;
         AV26LinkUrl = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)(AV20WWP_SDTNotificationsData.CurrentItem)).gxTpr_Notificationlink;
         CallWebObject(formatLink(AV26LinkUrl) );
         context.wjLocDisableFrm = 0;
         GXt_int1 = ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)(AV20WWP_SDTNotificationsData.CurrentItem)).gxTpr_Notificationid;
         ...
         ((GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)(AV20WWP_SDTNotificationsData.CurrentItem)).gxTpr_Notificationid = (int)(GXt_int1);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121713215218", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wc_childnotifications.js", "?2024121713215219", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( ( cmbavActiongroup.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV27GXV1 > 0 ) && ( AV20WWP_SDTNotificationsData.Count >= AV27GXV1 ) && (0==AV5ActionGroup) )
                  {
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavActiongroup,(string)cmbavActiongroup_Internalname,StringUtil.Trim( StringUtil.Str( (decimal)(AV5ActionGroup), 4, 0)),(short)1,(string)cmbavActiongroup_Jsonclick,(short)7,(string)"'"+sPrefix+"'"+",false,"+"'"+"e159z2_client"+"'",(string)"int",(string)"",(short)-1,(short)1,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"ConvertToDDO",(string)"WWActionGroupColumn hidden-xs hidden-sm hidden-md hidden-lg",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"",(string)"",(bool)true,(short)0});
            cmbavActiongroup.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV5ActionGroup), 4, 0));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22SDT_NotificationGroupCollection","fld":"vSDT_NOTIFICATIONGROUPCOLLECTION"},{"av":"AV15ParentId","fld":"vPARENTID"},{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E139Z2","iparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E159Z2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV5ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV5ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID.ONLINEACTIVATE","""{"handler":"E149Z2","iparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22SDT_NotificationGroupCollection","fld":"vSDT_NOTIFICATIONGROUPCOLLECTION"},{"av":"AV15ParentId","fld":"vPARENTID"},{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         setEventMetadata("GRID_FIRSTPAGE",""","oparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22SDT_NotificationGroupCollection","fld":"vSDT_NOTIFICATIONGROUPCOLLECTION"},{"av":"AV15ParentId","fld":"vPARENTID"},{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         setEventMetadata("GRID_PREVPAGE",""","oparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22SDT_NotificationGroupCollection","fld":"vSDT_NOTIFICATIONGROUPCOLLECTION"},{"av":"AV15ParentId","fld":"vPARENTID"},{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         setEventMetadata("GRID_NEXTPAGE",""","oparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22SDT_NotificationGroupCollection","fld":"vSDT_NOTIFICATIONGROUPCOLLECTION"},{"av":"AV15ParentId","fld":"vPARENTID"},{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]""");
         setEventMetadata("GRID_LASTPAGE",""","oparms":[{"av":"AV20WWP_SDTNotificationsData","fld":"vWWP_SDTNOTIFICATIONSDATA","grid":12,"hsh":true},{"av":"nGXsfl_12_idx","ctrl":"GRID","prop":"GridCurrRow","grid":12},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_12","ctrl":"GRID","prop":"GridRC","grid":12}]}""");
      ...
      public override void initialize( )
      {
         ...
         sPrefix = "";
         AV35Pgmname = "";
         AV20WWP_SDTNotificationsData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem>( context, "WWP_SDTNotificationsDataItem", "Comforta_version2");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem> AV20WWP_SDTNotificationsData ;
      ...
      private GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem AV25WWP_SDTNotificationsDataItem ;
