...
namespace GeneXus.Programs {
   public class trn_suppliergentypetrn_suppliergenwc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251115202527", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_suppliergentypetrn_suppliergenwc.js", "?20251115202527", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class trn_suppliergentypetrn_suppliergenwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV8SupplierGenTypeId )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(SupplierGenKvkNumber) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(SupplierGenCompanyName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(SupplierGenContactName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(SupplierGenContactPhone) like '%' || LOWER(:lV16FilterFullText)))");
         }
         else
         {
            GXv_int5[1] = 1;
