   ...
   public class aprc_createdynamicformpage : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         else
         {
            ...
            {
               A395LocationDynamicFormId = P00B22_A395LocationDynamicFormId[0];
               A11OrganisationId = P00B22_A11OrganisationId[0];
               A29LocationId = P00B22_A29LocationId[0];
      ...
      public override void initialize( )
      {
         ...
         P00B22_A395LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         P00B22_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00B22_A29LocationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprc_createdynamicformpage__default(),
            new Object[][] {
                new Object[] {
               P00B22_A395LocationDynamicFormId, P00B22_A11OrganisationId, P00B22_A29LocationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00B22_A395LocationDynamicFormId ;
      private Guid[] P00B22_A11OrganisationId ;
      private Guid[] P00B22_A29LocationId ;
...
public class aprc_createdynamicformpage__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00B22", "SELECT LocationDynamicFormId, OrganisationId, LocationId FROM Trn_LocationDynamicForm WHERE LocationDynamicFormId = :AV23FormId ORDER BY LocationDynamicFormId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00B22,100, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
