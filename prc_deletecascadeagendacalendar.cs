...
namespace GeneXus.Programs {
   public class prc_deletecascadeagendacalendar : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A11OrganisationId = P00C92_A11OrganisationId[0];
            A29LocationId = P00C92_A29LocationId[0];
            A303AgendaCalendarId = P00C92_A303AgendaCalendarId[0];
            new prc_deletecascadeagendaeventgroup(context ).execute(  A303AgendaCalendarId,  Guid.Empty) ;
            /* Using cursor P00C93 */
      ...
      public override void initialize( )
      {
         ...
         P00C92_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00C92_A29LocationId = new Guid[] {Guid.Empty} ;
         P00C92_A303AgendaCalendarId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadeagendacalendar__default(),
            new Object[][] {
                new Object[] {
               P00C92_A11OrganisationId, P00C92_A29LocationId, P00C92_A303AgendaCalendarId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C92_A11OrganisationId ;
      private Guid[] P00C92_A29LocationId ;
      private Guid[] P00C92_A303AgendaCalendarId ;
   }
   ...
   public class prc_deletecascadeagendacalendar__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C92(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C92", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C92,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C93", "SAVEPOINT gxupdate;DELETE FROM Trn_AgendaCalendar  WHERE AgendaCalendarId = :AgendaCalendarId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C93)
          };
       }
    }
