...
namespace GeneXus.Programs {
   public class trn_networkindividual : GXDataArea
   {
      ...
      protected void CheckExtendedTable0A17( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A388NetworkIndividualPhoneNumber)) && ! GxRegex.IsMatch(A388NetworkIndividualPhoneNumber,context.GetMessage( "^\\d{9}$", "")) )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A449NetworkIndividualHomePhoneNumb)) && ! GxRegex.IsMatch(A449NetworkIndividualHomePhoneNumb,context.GetMessage( "^\\d{9}$", "")) )
         {
         ...
         if ( ! GxRegex.IsMatch(A346NetworkIndividualZipCode,context.GetMessage( "^\\d{4}\\s?[A-Z]{2}$", "")) && ! String.IsNullOrEmpty(StringUtil.RTrim( A346NetworkIndividualZipCode)) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251222059611", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_networkindividual.js", "?20251222059612", false, true);
