   ...
   public class trn_pageww : GXDataArea
   {
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext)) || ( ( StringUtil.Like( StringUtil.Lower( A318Trn_PageName) , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A431PageJsonContent) , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A432PageGJSHtml) , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A433PageGJSJson) , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "true", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( A439PageIsContentPage ) ) || ( StringUtil.Like( context.GetMessage( "false", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ! A439PageIsContentPage ) || ( StringUtil.Like( StringUtil.Lower( A437PageChildren) , StringUtil.PadR( "%" + StringUtil.Lower( AV60Trn_pagewwds_1_filterfulltext) , 255 , "%"),  ' ' ) ) ) )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202521815543782", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_pageww.js", "?202521815543785", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
