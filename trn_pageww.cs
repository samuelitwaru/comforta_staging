...
namespace GeneXus.Programs {
   public class trn_pageww : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTFPAGEISPUBLISHED_SEL", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV55TFPageIsPublished_Sel), 1, 0, ".", "")));
      ...
      protected void WB5M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_PageWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_PageWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_PageWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF5M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV60Trn_pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext), "%", "");
            lV60Trn_pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext), "%", "");
            lV60Trn_pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext), "%", "");
            lV60Trn_pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext), "%", "");
            lV60Trn_pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV60Trn_pagewwds_1_filterfulltext), "%", "");
            ...
            /* Using cursor H005M2 */
            pr_default.execute(0, new Object[] {lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV61Trn_pagewwds_2_tftrn_pagename, AV62Trn_pagewwds_3_tftrn_pagename_sel, lV63Trn_pagewwds_4_tfpagejsoncontent, AV64Trn_pagewwds_5_tfpagejsoncontent_sel, lV65Trn_pagewwds_6_tfpagegjshtml, AV66Trn_pagewwds_7_tfpagegjshtml_sel, lV67Trn_pagewwds_8_tfpagegjsjson, AV68Trn_pagewwds_9_tfpagegjsjson_sel, lV71Trn_pagewwds_12_tfpagechildren, AV72Trn_pagewwds_13_tfpagechildren_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV71Trn_pagewwds_12_tfpagechildren = StringUtil.Concat( StringUtil.RTrim( AV71Trn_pagewwds_12_tfpagechildren), "%", "");
         /* Using cursor H005M3 */
         pr_default.execute(1, new Object[] {lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV60Trn_pagewwds_1_filterfulltext, lV61Trn_pagewwds_2_tftrn_pagename, AV62Trn_pagewwds_3_tftrn_pagename_sel, lV63Trn_pagewwds_4_tfpagejsoncontent, AV64Trn_pagewwds_5_tfpagejsoncontent_sel, lV65Trn_pagewwds_6_tfpagegjshtml, AV66Trn_pagewwds_7_tfpagegjshtml_sel, lV67Trn_pagewwds_8_tfpagegjsjson, AV68Trn_pagewwds_9_tfpagegjsjson_sel, lV71Trn_pagewwds_12_tfpagechildren, AV72Trn_pagewwds_13_tfpagechildren_sel});
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFPAGEJSONCONTENT",  "Json Content",  !String.IsNullOrEmpty(StringUtil.RTrim( AV42TFPageJsonContent)),  0,  AV42TFPageJsonContent,  AV42TFPageJsonContent,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV43TFPageJsonContent_Sel)),  AV43TFPageJsonContent_Sel,  AV43TFPageJsonContent_Sel) ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFPAGEGJSHTML",  "GJSHtml",  !String.IsNullOrEmpty(StringUtil.RTrim( AV44TFPageGJSHtml)),  0,  AV44TFPageGJSHtml,  AV44TFPageGJSHtml,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV45TFPageGJSHtml_Sel)),  AV45TFPageGJSHtml_Sel,  AV45TFPageGJSHtml_Sel) ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFPAGEGJSJSON",  "GJSJson",  !String.IsNullOrEmpty(StringUtil.RTrim( AV46TFPageGJSJson)),  0,  AV46TFPageGJSJson,  AV46TFPageGJSJson,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV47TFPageGJSJson_Sel)),  AV47TFPageGJSJson_Sel,  AV47TFPageGJSJson_Sel) ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFPAGEISPUBLISHED_SEL",  "Is Published",  !(0==AV55TFPageIsPublished_Sel),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV55TFPageIsPublished_Sel), 1, 0)),  ((AV55TFPageIsPublished_Sel==1) ? "Checked" : "Unchecked"),  false,  "",  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFPAGEISCONTENTPAGE_SEL",  "Content Page",  !(0==AV49TFPageIsContentPage_Sel),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV49TFPageIsContentPage_Sel), 1, 0)),  ((AV49TFPageIsContentPage_Sel==1) ? "Checked" : "Unchecked"),  false,  "",  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFPAGECHILDREN",  "Children",  !String.IsNullOrEmpty(StringUtil.RTrim( AV56TFPageChildren)),  0,  AV56TFPageChildren,  AV56TFPageChildren,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV57TFPageChildren_Sel)),  AV57TFPageChildren_Sel,  AV57TFPageChildren_Sel) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121118184667", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_pageww.js", "?2024121118184672", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Is Published") ;
            context.WriteHtmlTextNl( "</th>") ;
   ...
   public class trn_pageww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " OrganisationId, ProductServiceId, PageChildren, PageIsContentPage, PageIsPublished, PageGJSJson, PageGJSHtml, PageJsonContent, LocationId, Trn_PageName, Trn_PageId";
         ...
         {
            sOrderString += " ORDER BY PageIsPublished, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 1 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageIsPublished DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 2 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 2 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY Trn_PageId DESC, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 3 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY Trn_PageName, Trn_PageId, LocationId";
         }
         else if ( ( AV41OrderedBy == 3 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY Trn_PageName DESC, Trn_PageId, LocationId";
         }
         else if ( ( AV41OrderedBy == 4 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY LocationId, Trn_PageId, Trn_PageName";
         }
         else if ( ( AV41OrderedBy == 4 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY LocationId DESC, Trn_PageId, Trn_PageName";
         }
         else if ( ( AV41OrderedBy == 5 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY PageJsonContent, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 5 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageJsonContent DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 6 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY PageGJSHtml, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 6 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageGJSHtml DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 7 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY PageGJSJson, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 7 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageGJSJson DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 8 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY PageIsContentPage, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 8 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageIsContentPage DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 9 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY PageChildren, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 9 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY PageChildren DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 10 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 10 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 11 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY OrganisationId, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( ( AV41OrderedBy == 11 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY OrganisationId DESC, Trn_PageId, Trn_PageName, LocationId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY Trn_PageId, Trn_PageName, LocationId";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005M2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (bool)dynConstraints[17] , (string)dynConstraints[18] , (bool)dynConstraints[19] , (short)dynConstraints[20] , (bool)dynConstraints[21] );
               case 1 :
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV60Trn_pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Trn_pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Trn_pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Trn_pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Trn_pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
