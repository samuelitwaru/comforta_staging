...
namespace GeneXus.Programs {
   public class trn_residentpackagewwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV29GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "Trn_ResidentPackageWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRKBO2 = false;
            A555SG_LocationId = P00BO2_A555SG_LocationId[0];
            A557ResidentPackageName = P00BO2_A557ResidentPackageName[0];
            A559ResidentPackageDefault = P00BO2_A559ResidentPackageDefault[0];
            A558ResidentPackageModules = P00BO2_A558ResidentPackageModules[0];
            A554ResidentPackageId = P00BO2_A554ResidentPackageId[0];
            AV26count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00BO2_A557ResidentPackageName[0], A557ResidentPackageName) == 0 ) )
            {
               BRKBO2 = false;
               A554ResidentPackageId = P00BO2_A554ResidentPackageId[0];
            ...
            if ( (0==AV17SkipItems) )
            {
               AV21Option = (String.IsNullOrEmpty(StringUtil.RTrim( A557ResidentPackageName)) ? "<#Empty#>" : A557ResidentPackageName);
      ...
      protected void S131( )
      {
         ...
         {
            BRKBO4 = false;
            A555SG_LocationId = P00BO3_A555SG_LocationId[0];
            A558ResidentPackageModules = P00BO3_A558ResidentPackageModules[0];
            A559ResidentPackageDefault = P00BO3_A559ResidentPackageDefault[0];
            A557ResidentPackageName = P00BO3_A557ResidentPackageName[0];
            A554ResidentPackageId = P00BO3_A554ResidentPackageId[0];
            AV26count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00BO3_A558ResidentPackageModules[0], A558ResidentPackageModules) == 0 ) )
            {
               BRKBO4 = false;
               A554ResidentPackageId = P00BO3_A554ResidentPackageId[0];
               AV26count = (long)(AV26count+1);
            ...
            if ( (0==AV17SkipItems) )
            {
               AV21Option = (String.IsNullOrEmpty(StringUtil.RTrim( A558ResidentPackageModules)) ? "<#Empty#>" : A558ResidentPackageModules);
               AV22Options.Add(AV21Option, 0);
               AV25OptionIndexes.Add(StringUtil.Trim( context.localUtil.Format( (decimal)(AV26count), "Z,ZZZ,ZZZ,ZZ9")), 0);
               if ( AV22Options.Count == 10 )
               {
      ...
      public override void initialize( )
      {
         ...
         P00BO2_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         P00BO2_A557ResidentPackageName = new string[] {""} ;
         P00BO2_A559ResidentPackageDefault = new bool[] {false} ;
         P00BO2_A558ResidentPackageModules = new string[] {""} ;
         P00BO2_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         A554ResidentPackageId = Guid.Empty;
         AV21Option = "";
         P00BO3_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         P00BO3_A558ResidentPackageModules = new string[] {""} ;
         P00BO3_A559ResidentPackageDefault = new bool[] {false} ;
         P00BO3_A557ResidentPackageName = new string[] {""} ;
         P00BO3_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentpackagewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00BO2_A555SG_LocationId, P00BO2_A557ResidentPackageName, P00BO2_A559ResidentPackageDefault, P00BO2_A558ResidentPackageModules, P00BO2_A554ResidentPackageId
               }
               , new Object[] {
               P00BO3_A555SG_LocationId, P00BO3_A558ResidentPackageModules, P00BO3_A559ResidentPackageDefault, P00BO3_A557ResidentPackageName, P00BO3_A554ResidentPackageId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00BO2_A555SG_LocationId ;
      private string[] P00BO2_A557ResidentPackageName ;
      private bool[] P00BO2_A559ResidentPackageDefault ;
      private string[] P00BO2_A558ResidentPackageModules ;
      private Guid[] P00BO2_A554ResidentPackageId ;
      private Guid[] P00BO3_A555SG_LocationId ;
      private string[] P00BO3_A558ResidentPackageModules ;
      private bool[] P00BO3_A559ResidentPackageDefault ;
      private string[] P00BO3_A557ResidentPackageName ;
      private Guid[] P00BO3_A554ResidentPackageId ;
   ...
   public class trn_residentpackagewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00BO2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (bool)dynConstraints[8] , (Guid)dynConstraints[9] , (Guid)dynConstraints[10] );
               case 1 :
                     return conditional_P00BO3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (bool)dynConstraints[8] , (Guid)dynConstraints[9] , (Guid)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00BO3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BO3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
