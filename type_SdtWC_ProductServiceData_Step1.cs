/*
				   File: type_SdtWC_ProductServiceData_Step1
			Description: Step1
...
{
	[XmlRoot(ElementName="WC_ProductServiceData.Step1")]
	[XmlType(TypeName="WC_ProductServiceData.Step1" , Namespace="Comforta_version2" )]
	[Serializable]
	public class SdtWC_ProductServiceData_Step1 : GxUserType
	{
		public SdtWC_ProductServiceData_Step1( )
		{
			/* Constructor for serialization */
			gxTv_SdtWC_ProductServiceData_Step1_Productserviceclass = "";

			gxTv_SdtWC_ProductServiceData_Step1_Productservicegroup = "";

			gxTv_SdtWC_ProductServiceData_Step1_Productservicedescription = "";

			gxTv_SdtWC_ProductServiceData_Step1_Productservicename = "";

			gxTv_SdtWC_ProductServiceData_Step1_Productservicetilename = "";

			gxTv_SdtWC_ProductServiceData_Step1_Productserviceimagevar = "";

			gxTv_SdtWC_ProductServiceData_Step1_Filename = "";

		}

		public SdtWC_ProductServiceData_Step1(IGxContext context)
		{
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productserviceclass; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productserviceclass = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productservicegroup; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productservicegroup = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productservicedescription; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productservicedescription = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Suppliergenid; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Suppliergenid = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Nofiltergen; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Nofiltergen = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Supplieragbid; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Supplieragbid = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Nofilteragb; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Nofilteragb = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Locationid; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Locationid = value;
				SetDirty("Locationid");
			}
		}
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productserviceid; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productserviceid = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productservicename; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productservicename = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productservicetilename; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productservicetilename = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Productserviceimagevar; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Productserviceimagevar = value;
		...
		{
			get {
				return gxTv_SdtWC_ProductServiceData_Step1_Filename; 
			}
			set {
				gxTv_SdtWC_ProductServiceData_Step1_Filename = value;
				SetDirty("Filename");
			}
		}
		...
		protected string gxTv_SdtWC_ProductServiceData_Step1_Productserviceclass;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Productservicegroup;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Productservicedescription;
		 

		protected Guid gxTv_SdtWC_ProductServiceData_Step1_Suppliergenid;
		 

		protected bool gxTv_SdtWC_ProductServiceData_Step1_Nofiltergen;
		 

		protected Guid gxTv_SdtWC_ProductServiceData_Step1_Supplieragbid;
		 

		protected bool gxTv_SdtWC_ProductServiceData_Step1_Nofilteragb;
		 

		protected Guid gxTv_SdtWC_ProductServiceData_Step1_Locationid;
		 

		protected Guid gxTv_SdtWC_ProductServiceData_Step1_Productserviceid;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Productservicename;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Productservicetilename;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Productserviceimagevar;
		 

		protected string gxTv_SdtWC_ProductServiceData_Step1_Filename;
	...
	[DataContract(Name=@"WC_ProductServiceData.Step1", Namespace="Comforta_version2")]
	public class SdtWC_ProductServiceData_Step1_RESTInterface : GxGenericCollectionItem<SdtWC_ProductServiceData_Step1>, System.Web.SessionState.IRequiresSessionState
	{
		public SdtWC_ProductServiceData_Step1_RESTInterface( ) : base()
		{	
		}

		public SdtWC_ProductServiceData_Step1_RESTInterface( SdtWC_ProductServiceData_Step1 psdt ) : base(psdt)
		{	
		}
		...
		public SdtWC_ProductServiceData_Step1 sdt
		{
			get { 
				return (SdtWC_ProductServiceData_Step1)Sdt;
			}
			set { 
				Sdt = value;
			}
		...
		void checkSdt( StreamingContext ctx )
		{
			if ( sdt == null )
			{
				sdt = new SdtWC_ProductServiceData_Step1() ;
			}
		}
	}
	#endregion
