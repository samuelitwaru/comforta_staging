...
namespace GeneXus.Programs {
   public class prc_authenticatereceptionist : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A93ReceptionistEmail = P00AD2_A93ReceptionistEmail[0];
            A29LocationId = P00AD2_A29LocationId[0];
            A11OrganisationId = P00AD2_A11OrganisationId[0];
            A89ReceptionistId = P00AD2_A89ReceptionistId[0];
      ...
      public override void initialize( )
      {
         AV10UserName = "";
         GXt_char1 = "";
         P00AD2_A93ReceptionistEmail = new string[] {""} ;
         P00AD2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00AD2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00AD2_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_authenticatereceptionist__default(),
            new Object[][] {
                new Object[] {
               P00AD2_A93ReceptionistEmail, P00AD2_A29LocationId, P00AD2_A11OrganisationId, P00AD2_A89ReceptionistId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00AD2_A93ReceptionistEmail ;
      private Guid[] P00AD2_A29LocationId ;
      private Guid[] P00AD2_A11OrganisationId ;
      private Guid[] P00AD2_A89ReceptionistId ;
