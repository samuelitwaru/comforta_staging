   ...
   public class ucreatedynamicform : GXDataArea
   {
      ...
      protected void WBA30( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsettings_Internalname, "", context.GetMessage( "UASettings", ""), bttBtnsettings_Jsonclick, 7, context.GetMessage( "UASettings", ""), "", StyleString, ClassString, bttBtnsettings_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11a31_client"+"'", TempTags, "", 2, "HLP_UCreateDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E14A32( )
      {
         ...
         if ( StringUtil.StrCmp(AV9HttpRequest.Method, "GET") == 0 )
         {
            ...
            else
            {
               ...
               {
                  A206WWPFormId = H00A32_A206WWPFormId[0];
                  A207WWPFormVersionNumber = H00A32_A207WWPFormVersionNumber[0];
               ...
               {
                  GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_RecordNotFound", ""),  "success",  "",  "true",  ""));
            ...
            {
               AV53GXV1 = 1;
               while ( AV53GXV1 <= AV27WWPForm.gxTpr_Element.Count )
               {
                  AV44WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV27WWPForm.gxTpr_Element.Item(AV53GXV1));
      ...
      protected void E17A32( )
      {
            ...
            if ( StringUtil.StrCmp(AV26WWPDynamicFormMode, "INS") == 0 )
            {
               ...
               if ( AV27WWPForm.Success() )
               {
                  ...
                  if ( ! (Guid.Empty==AV48LocationId) )
                  {
                     ...
                     {
                        AV56GXV3 = 1;
                        AV55GXV2 = AV50Trn_LocationDynamicForm.GetMessages();
                        while ( AV56GXV3 <= AV55GXV2.Count )
                        {
                           AV10Message = ((GeneXus.Utils.SdtMessages_Message)AV55GXV2.Item(AV56GXV3));
                           GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV10Message.gxTpr_Description,  "error",  "",  "false",  ""));
            ...
            else
            {
               if ( ( StringUtil.StrCmp(AV26WWPDynamicFormMode, "DSP") != 0 ) && ! (0==AV33WWPFormVersionNumber) )
               {
                  ...
                  while ( (pr_default.getStatus(2) != 101) )
                  {
                     ...
                     A234WWPFormInstantiated = H00A34_A234WWPFormInstantiated[0];
                  ...
                  else
                  {
                     if ( AV29FormWasInstantiated )
                     {
                        ...
                        AV58GXV4 = 1;
                        while ( AV58GXV4 <= AV27WWPForm.gxTpr_Element.Count )
                        {
                           AV7Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV27WWPForm.gxTpr_Element.Item(AV58GXV4));
         ...
         {
            AV59GXV5 = 1;
            while ( AV59GXV5 <= AV11Messages.Count )
            {
               AV10Message = ((GeneXus.Utils.SdtMessages_Message)AV11Messages.Item(AV59GXV5));
      ...
      protected void S122( )
      {
         ...
         AV60GXV6 = 1;
         while ( AV60GXV6 <= AV27WWPForm.gxTpr_Element.Count )
         {
            AV7Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV27WWPForm.gxTpr_Element.Item(AV60GXV6));
            if ( ! AV8HasDeletedElements || ! StringUtil.Contains( AV7Element.ToJSonString(true, true), "\"Mode\":\"DLT\"") )
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( StringUtil.Trim( AV15VisibleCondition.gxTpr_Expression))) || ( AV14Validations.Count > 0 ) )
               {
                  ...
                  {
                     AV61GXV7 = 1;
                     while ( AV61GXV7 <= AV14Validations.Count )
                     {
                        AV40Validation = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV14Validations.Item(AV61GXV7));
      ...
      protected void wb_table1_42_A32( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_42_A32e( true) ;
         }
         else
         {
            wb_table1_42_A32e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251222111117", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ucreatedynamicform.js", "?20251222111118", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOSETTINGS'","""{"handler":"E11A31","iparms":[]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13A32","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E15A32","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("VDYNAMICSECTIONTOUPDATE.CLICK","""{"handler":"E18A32","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV26WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true},{"av":"cmbavDynamicsectiontoupdate"},{"av":"AV28DynamicSectionToUpdate","fld":"vDYNAMICSECTIONTOUPDATE","pic":"ZZZ9"}]""");
         setEventMetadata("VDYNAMICSECTIONTOUPDATE.CLICK",""","oparms":[{"av":"AV27WWPForm","fld":"vWWPFORM"},{"ctrl":"WCWWP_DYNAMICFORMFS_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12A32","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         H00A32_A206WWPFormId = new short[1] ;
         H00A32_A207WWPFormVersionNumber = new short[1] ;
         ...
         AV50Trn_LocationDynamicForm = new SdtTrn_LocationDynamicForm(context);
         AV55GXV2 = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         H00A34_A206WWPFormId = new short[1] ;
         H00A34_A234WWPFormInstantiated = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ucreatedynamicform__default(),
            new Object[][] {
                new Object[] {
               H00A32_A206WWPFormId, H00A32_A207WWPFormVersionNumber
               }
               , new Object[] {
               H00A33_A207WWPFormVersionNumber, H00A33_A206WWPFormId
               }
               , new Object[] {
               H00A34_A206WWPFormId, H00A34_A234WWPFormInstantiated, H00A34_A231WWPFormDate, H00A34_A207WWPFormVersionNumber
               }
            }
         );
      ...
      private short[] H00A32_A206WWPFormId ;
      private short[] H00A32_A207WWPFormVersionNumber ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV55GXV2 ;
      private short[] H00A34_A206WWPFormId ;
      private bool[] H00A34_A234WWPFormInstantiated ;
...
public class ucreatedynamicform__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("H00A32", "SELECT WWPFormId, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = :AV32WWPFormId ORDER BY WWPFormId, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A32,1, GxCacheFrequency.OFF ,false,true )
          ,new CursorDef("H00A33", "SELECT WWPFormVersionNumber, WWPFormId FROM WWP_Form ORDER BY WWPFormId DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A33,1, GxCacheFrequency.OFF ,false,true )
          ,new CursorDef("H00A34", "SELECT WWPFormId, WWPFormInstantiated, WWPFormDate, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = :AV32WWPFormId ORDER BY WWPFormId, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A34,1, GxCacheFrequency.OFF ,false,true )
       };
    }
 }
