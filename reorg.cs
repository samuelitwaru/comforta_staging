...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_Memo( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE INDEX ITRN_MEMO1 ON Trn_Memo (MemoCategoryId ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX ITRN_MEMO1 "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_AppVersionPage( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_AppVersionPage (AppVersionId CHAR(36) NOT NULL , PageId CHAR(36) NOT NULL , PageName VARCHAR(100) NOT NULL , PageStructure TEXT NOT NULL , PageType VARCHAR(40) NOT NULL , PagePublishedStructure TEXT NOT NULL , IsPredefined BOOLEAN NOT NULL , PRIMARY KEY(AppVersionId, PageId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_AppVersion( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_AppVersion (AppVersionId CHAR(36) NOT NULL , AppVersionName VARCHAR(100) NOT NULL , LocationId CHAR(36) , IsActive BOOLEAN NOT NULL , OrganisationId CHAR(36) , PRIMARY KEY(AppVersionId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE UNIQUE INDEX UTRN_APPVERSION ON Trn_AppVersion (AppVersionName ,LocationId ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX UTRN_APPVERSION "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Media( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Media (MediaId CHAR(36) NOT NULL , MediaName VARCHAR(100) NOT NULL , MediaImage BYTEA , MediaImage_GXI VARCHAR(2048) , MediaUrl VARCHAR(1000) NOT NULL , MediaSize integer NOT NULL , MediaType CHAR(20) NOT NULL , LocationId CHAR(36) NOT NULL , PRIMARY KEY(MediaId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Theme( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Theme (Trn_ThemeId CHAR(36) NOT NULL , Trn_ThemeName VARCHAR(100) NOT NULL , Trn_ThemeFontFamily VARCHAR(40) NOT NULL , Trn_ThemeFontSize smallint NOT NULL , OrganisationId CHAR(36) , PRIMARY KEY(Trn_ThemeId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE INDEX ITRN_THEME1 ON Trn_Theme (OrganisationId ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX ITRN_THEME1 "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITrn_ThemeTrn_Organisation( )
      {
         string cmdBuffer;
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Theme ADD CONSTRAINT ITRN_THEME1 FOREIGN KEY (OrganisationId) REFERENCES Trn_Organisation (OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_Theme DROP CONSTRAINT ITRN_THEME1 "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      public void RITrn_AppVersionTrn_Organisation( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_AppVersion ADD CONSTRAINT GX_0031000B FOREIGN KEY (OrganisationId) REFERENCES Trn_Organisation (OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_AppVersion DROP CONSTRAINT GX_0031000B "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTrn_Memo" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateTrn_MemoCategory" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateTrn_ThemeCtaColor" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "CreateTrn_ResidentPackage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 5 ,  "CreateTrn_AppVersionPage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 6 ,  "CreateTrn_AppVersion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "CreateTrn_OrganisationSetting" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "CreateTrn_OrganisationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "CreateTrn_Page" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 10 ,  "CreateTrn_ResidentNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 11 ,  "CreateTrn_AppNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 12 ,  "CreateTrn_AgendaEventGroup" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 13 ,  "CreateTrn_ThemeIcon" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 14 ,  "CreateTrn_PreferredGenSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 15 ,  "CreateTrn_PreferredAgbSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 16 ,  "CreateTrn_Audit" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 17 ,  "CreateTrn_Media" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 18 ,  "CreateTrn_CallToAction" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 19 ,  "CreateTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 20 ,  "CreateTrn_Device" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 21 ,  "CreateTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 22 ,  "CreateTrn_Receptionist" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 23 ,  "CreateTrn_AgendaCalendar" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 24 ,  "CreateTrn_SupplierGenType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 25 ,  "CreateTrn_SupplierAgbType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 26 ,  "CreateTrn_Template" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 27 ,  "CreateTrn_ThemeColor" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 28 ,  "CreateTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 29 ,  "CreateUserCustomizations" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 30 ,  "CreateWWP_FormInstanceElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 31 ,  "CreateWWP_FormInstance" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 32 ,  "CreateWWP_FormElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 33 ,  "CreateWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 34 ,  "CreateWWP_DiscussionMessageMention" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 35 ,  "CreateWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 36 ,  "CreateWWP_MailAttachments" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 37 ,  "CreateWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 38 ,  "CreateWWP_MailTemplate" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 39 ,  "CreateWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 40 ,  "CreateWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 41 ,  "CreateWWP_WebClient" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 42 ,  "CreateWWP_WebNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 43 ,  "CreateWWP_SMS" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 44 ,  "CreateWWP_Subscription" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 45 ,  "CreateWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 46 ,  "CreateWWP_Parameter" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 47 ,  "CreateWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 48 ,  "CreateTrn_MedicalIndication" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 49 ,  "CreateTrn_ResidentType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 50 ,  "CreateTrn_NetworkCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 51 ,  "CreateTrn_NetworkIndividual" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 52 ,  "CreateTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 53 ,  "CreateTrn_SupplierAGB" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 54 ,  "CreateTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 55 ,  "CreateTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 56 ,  "CreateTrn_Manager" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 57 ,  "CreateTrn_OrganisationType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 58 ,  "CreateTrn_Organisation" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 59 ,  "RITrn_OrganisationTrn_OrganisationType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 60 ,  "RITrn_ManagerTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 61 ,  "RITrn_LocationTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 62 ,  "RITrn_LocationTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 63 ,  "RITrn_SupplierGenTrn_SupplierGenType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 64 ,  "RITrn_SupplierGenTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 65 ,  "RITrn_SupplierAGBTrn_SupplierAgbType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 66 ,  "RITrn_ResidentTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 67 ,  "RITrn_ResidentTrn_ResidentType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 68 ,  "RITrn_ResidentTrn_MedicalIndication" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 69 ,  "RITrn_ResidentTrn_ResidentPackage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 70 ,  "RIWWP_SubscriptionWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 71 ,  "RIWWP_SubscriptionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 72 ,  "RIWWP_SMSWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 73 ,  "RIWWP_WebNotificationWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 74 ,  "RIWWP_WebClientWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 75 ,  "RIWWP_NotificationDefinitionWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 76 ,  "RIWWP_NotificationWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 77 ,  "RIWWP_NotificationWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 78 ,  "RIWWP_MailWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 79 ,  "RIWWP_MailAttachmentsWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 80 ,  "RIWWP_DiscussionMessageWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 81 ,  "RIWWP_DiscussionMessageWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 82 ,  "RIWWP_DiscussionMessageWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 83 ,  "RIWWP_DiscussionMessageMentionWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 84 ,  "RIWWP_DiscussionMessageMentionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 85 ,  "RIWWP_FormElementWWP_FormElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 86 ,  "RIWWP_FormInstanceWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 87 ,  "RIWWP_FormInstanceWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 88 ,  "RIWWP_FormInstanceElementWWP_FormInstance" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 89 ,  "RITrn_ThemeTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 90 ,  "RITrn_ThemeColorTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 91 ,  "RITrn_AgendaCalendarTrn_Location" , new Object[]{ });
         ...
         ReorgExecute.RegisterBlockForSubmit( 100 ,  "RITrn_AuditTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 101 ,  "RITrn_ThemeIconTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 102 ,  "RITrn_AgendaEventGroupTrn_AgendaCalendar" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 103 ,  "RITrn_ResidentNotificationTrn_AppNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 104 ,  "RITrn_PageTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 105 ,  "RITrn_PageTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 106 ,  "RITrn_OrganisationDynamicFormTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 107 ,  "RITrn_OrganisationDynamicFormWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 108 ,  "RITrn_OrganisationSettingTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 109 ,  "RITrn_AppVersionTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 110 ,  "RITrn_AppVersionTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 111 ,  "RITrn_AppVersionPageTrn_AppVersion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 112 ,  "RITrn_ResidentPackageTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 113 ,  "RITrn_ThemeCtaColorTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 114 ,  "RITrn_MemoTrn_MemoCategory" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 115 ,  "RITrn_MemoTrn_Resident" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Memo", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Memo" ,  "CreateTrn_MemoCategory" );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Memo" ,  "CreateTrn_Resident" );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_MemoCategory", ""}) );
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeCtaColor", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeCtaColor" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentPackage", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ResidentPackage" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 5 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppVersionPage", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AppVersionPage" ,  "CreateTrn_AppVersion" );
         GXReorganization.SetMsg( 6 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppVersion", ""}) );
         ...
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationSetting", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_OrganisationSetting" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Page", ""}) );
         ...
         GXReorganization.SetMsg( 10 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentNotification", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ResidentNotification" ,  "CreateTrn_AppNotification" );
         GXReorganization.SetMsg( 11 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppNotification", ""}) );
         GXReorganization.SetMsg( 12 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AgendaEventGroup", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AgendaEventGroup" ,  "CreateTrn_AgendaCalendar" );
         GXReorganization.SetMsg( 13 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeIcon", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeIcon" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 14 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredGenSupplier", ""}) );
         GXReorganization.SetMsg( 15 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredAgbSupplier", ""}) );
         GXReorganization.SetMsg( 16 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Audit", ""}) );
         ...
         GXReorganization.SetMsg( 18 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_CallToAction", ""}) );
         ...
         GXReorganization.SetMsg( 19 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_LocationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 20 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Device", ""}) );
         GXReorganization.SetMsg( 21 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ProductService", ""}) );
         ...
         GXReorganization.SetMsg( 22 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Receptionist", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Receptionist" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 23 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AgendaCalendar", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AgendaCalendar" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 24 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierGenType", ""}) );
         GXReorganization.SetMsg( 25 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierAgbType", ""}) );
         GXReorganization.SetMsg( 26 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Template", ""}) );
         GXReorganization.SetMsg( 27 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeColor", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeColor" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 28 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Theme", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Theme" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 29 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"UserCustomizations", ""}) );
         GXReorganization.SetMsg( 30 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormInstanceElement", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_FormInstanceElement" ,  "CreateWWP_FormInstance" );
         GXReorganization.SetMsg( 31 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormInstance", ""}) );
         ...
         GXReorganization.SetMsg( 32 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormElement", ""}) );
         GXReorganization.SetMsg( 33 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Form", ""}) );
         GXReorganization.SetMsg( 34 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_DiscussionMessageMention", ""}) );
         ...
         GXReorganization.SetMsg( 35 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_DiscussionMessage", ""}) );
         ...
         GXReorganization.SetMsg( 36 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailAttachments", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_MailAttachments" ,  "CreateWWP_Mail" );
         GXReorganization.SetMsg( 37 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Mail", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_Mail" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 38 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailTemplate", ""}) );
         GXReorganization.SetMsg( 39 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Notification", ""}) );
         ...
         GXReorganization.SetMsg( 40 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_NotificationDefinition", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_NotificationDefinition" ,  "CreateWWP_Entity" );
         GXReorganization.SetMsg( 41 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebClient", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebClient" ,  "CreateWWP_UserExtended" );
         GXReorganization.SetMsg( 42 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebNotification", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebNotification" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 43 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_SMS", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_SMS" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 44 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Subscription", ""}) );
         ...
         GXReorganization.SetMsg( 45 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Entity", ""}) );
         GXReorganization.SetMsg( 46 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Parameter", ""}) );
         GXReorganization.SetMsg( 47 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_UserExtended", ""}) );
         GXReorganization.SetMsg( 48 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_MedicalIndication", ""}) );
         GXReorganization.SetMsg( 49 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentType", ""}) );
         GXReorganization.SetMsg( 50 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_NetworkCompany", ""}) );
         GXReorganization.SetMsg( 51 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_NetworkIndividual", ""}) );
         GXReorganization.SetMsg( 52 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Resident", ""}) );
         ...
         GXReorganization.SetMsg( 53 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierAGB", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_SupplierAGB" ,  "CreateTrn_SupplierAgbType" );
         GXReorganization.SetMsg( 54 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierGen", ""}) );
         ...
         GXReorganization.SetMsg( 55 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Location", ""}) );
         ...
         GXReorganization.SetMsg( 56 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Manager", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Manager" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 57 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationType", ""}) );
         GXReorganization.SetMsg( 58 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Organisation", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Organisation" ,  "CreateTrn_OrganisationType" );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 59 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATION1"}) );
         ...
         GXReorganization.SetMsg( 60 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MANAGER1"}) );
         ...
         GXReorganization.SetMsg( 61 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION1"}) );
         ...
         GXReorganization.SetMsg( 62 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION2"}) );
         ...
         GXReorganization.SetMsg( 63 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN1"}) );
         ...
         GXReorganization.SetMsg( 64 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN2"}) );
         ...
         GXReorganization.SetMsg( 65 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERAGB1"}) );
         ...
         GXReorganization.SetMsg( 66 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT4"}) );
         ...
         GXReorganization.SetMsg( 67 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT3"}) );
         ...
         GXReorganization.SetMsg( 68 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT2"}) );
         ...
         GXReorganization.SetMsg( 69 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT1"}) );
         ...
         GXReorganization.SetMsg( 70 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION2"}) );
         ...
         GXReorganization.SetMsg( 71 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION1"}) );
         ...
         GXReorganization.SetMsg( 72 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SMS1"}) );
         ...
         GXReorganization.SetMsg( 73 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 74 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBCLIENT1"}) );
         ...
         GXReorganization.SetMsg( 75 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATIONDEFINITION1"}) );
         ...
         GXReorganization.SetMsg( 76 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION2"}) );
         ...
         GXReorganization.SetMsg( 77 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 78 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAIL1"}) );
         ...
         GXReorganization.SetMsg( 79 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAILATTACHMENTS1"}) );
         ...
         GXReorganization.SetMsg( 80 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE3"}) );
         ...
         GXReorganization.SetMsg( 81 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE2"}) );
         ...
         GXReorganization.SetMsg( 82 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         GXReorganization.SetMsg( 83 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION2"}) );
         ...
         GXReorganization.SetMsg( 84 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION1"}) );
         ...
         GXReorganization.SetMsg( 85 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMELEMENT1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         GXReorganization.SetMsg( 86 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCE1"}) );
         ...
         GXReorganization.SetMsg( 87 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_FORMINSTANCE"}) );
         ...
         GXReorganization.SetMsg( 88 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCEELEMENT1"}) );
         ...
         GXReorganization.SetMsg( 89 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEME1"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_ThemeTrn_Organisation" ,  "CreateTrn_Theme" );
         ReorgExecute.RegisterPrecedence( "RITrn_ThemeTrn_Organisation" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 90 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMECOLOR1"}) );
         ...
         GXReorganization.SetMsg( 91 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AGENDACALENDAR1"}) );
         ...
         GXReorganization.SetMsg( 100 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AUDIT"}) );
         ...
         GXReorganization.SetMsg( 101 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMEICON1"}) );
         ...
         GXReorganization.SetMsg( 102 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AGENDAEVENTGROUP1"}) );
         ...
         GXReorganization.SetMsg( 103 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 104 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_002S000B000T"}) );
         ...
         GXReorganization.SetMsg( 105 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PAGE1"}) );
         ...
         GXReorganization.SetMsg( 106 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 107 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONDYNAMICFORM1"}) );
         ...
         GXReorganization.SetMsg( 108 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONSETTING1"}) );
         ...
         GXReorganization.SetMsg( 109 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_0031000B"}) );
         ...
         GXReorganization.SetMsg( 110 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_APPVERSION1"}) );
         ...
         GXReorganization.SetMsg( 111 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_APPVERSIONPAGE2"}) );
         ...
         GXReorganization.SetMsg( 112 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTPACKAGE1"}) );
         ...
         GXReorganization.SetMsg( 113 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMECTACOLOR1"}) );
         ...
         GXReorganization.SetMsg( 114 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MEMO1"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_MemoTrn_MemoCategory" ,  "CreateTrn_Memo" );
         ReorgExecute.RegisterPrecedence( "RITrn_MemoTrn_MemoCategory" ,  "CreateTrn_MemoCategory" );
         GXReorganization.SetMsg( 115 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MEMO2"}) );
