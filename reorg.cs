...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_Location( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Location (LocationId CHAR(36) NOT NULL , OrganisationId CHAR(36) NOT NULL , LocationName VARCHAR(100) NOT NULL , LocationEmail VARCHAR(100) NOT NULL , LocationPhone CHAR(20) NOT NULL , LocationDescription TEXT NOT NULL , LocationCity VARCHAR(100) NOT NULL , LocationZipCode VARCHAR(100) NOT NULL , LocationAddressLine1 VARCHAR(100) NOT NULL , LocationAddressLine2 VARCHAR(100) NOT NULL , LocationCountry VARCHAR(100) NOT NULL , LocationPhoneCode VARCHAR(40) NOT NULL , LocationPhoneNumber VARCHAR(9) NOT NULL , Trn_ThemeId CHAR(36) , LocationImage BYTEA NOT NULL , LocationImage_GXI VARCHAR(2048) , PRIMARY KEY(LocationId, OrganisationId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
