...
namespace GeneXus.Programs {
   public class trn_memoww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV25TFMemoCategoryName = GetPar( "TFMemoCategoryName");
         AV26TFMemoCategoryName_Sel = GetPar( "TFMemoCategoryName_Sel");
         ...
         AV53IsAuthorized_MemoCategoryName = StringUtil.StrToBool( GetPar( "IsAuthorized_MemoCategoryName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV16FilterFullText, AV24ManageFiltersExecutionStep, AV19ColumnsSelector, AV60Pgmname, AV25TFMemoCategoryName, AV26TFMemoCategoryName_Sel, AV27TFMemoTitle, AV28TFMemoTitle_Sel, AV29TFMemoStartDateTime, AV30TFMemoStartDateTime_To, AV34TFMemoEndDateTime, AV35TFMemoEndDateTime_To, AV39TFMemoDuration, AV40TFMemoDuration_To, AV41TFMemoRemoveDate, AV42TFMemoRemoveDate_To, AV56IsAuthorized_Display, AV57IsAuthorized_Update, AV58IsAuthorized_Delete, AV53IsAuthorized_MemoCategoryName, AV54IsAuthorized_MemoTitle, AV59IsAuthorized_Insert) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_MEMOCATEGORYNAME", AV53IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( "", AV53IsAuthorized_MemoCategoryName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTFMEMOCATEGORYNAME_SEL", AV26TFMemoCategoryName_Sel);
      ...
      protected void WBBA0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV16FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV16FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_Trn_MemoWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_memostartdatetimeauxdatetext_Internalname, AV33DDO_MemoStartDateTimeAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV33DDO_MemoStartDateTimeAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,70);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_memostartdatetimeauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_MemoWW.htm");
            /* User Defined Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_memoremovedateauxdatetext_Internalname, AV45DDO_MemoRemoveDateAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV45DDO_MemoRemoveDateAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_memoremovedateauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_MemoWW.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              A575MemoId = StringUtil.StrToGuid( cgiGet( edtMemoId_Internalname));
                              A568MemoCategoryId = StringUtil.StrToGuid( cgiGet( edtMemoCategoryId_Internalname));
                              A569MemoCategoryName = cgiGet( edtMemoCategoryName_Internalname);
                              A576MemoTitle = cgiGet( edtMemoTitle_Internalname);
                              A577MemoDescription = cgiGet( edtMemoDescription_Internalname);
                              A578MemoImage = cgiGet( edtMemoImage_Internalname);
                              n578MemoImage = false;
                              A579MemoDocument = cgiGet( edtMemoDocument_Internalname);
                              n579MemoDocument = false;
                              A587MemoStartDateTime = context.localUtil.CToT( cgiGet( edtMemoStartDateTime_Internalname), 0);
                              n587MemoStartDateTime = false;
                              A588MemoEndDateTime = context.localUtil.CToT( cgiGet( edtMemoEndDateTime_Internalname), 0);
                              n588MemoEndDateTime = false;
                              A589MemoDuration = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtMemoDuration_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
                              n589MemoDuration = false;
                              A590MemoRemoveDate = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtMemoRemoveDate_Internalname), 0));
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV60Pgmname ,
                                       string AV25TFMemoCategoryName ,
                                       string AV26TFMemoCategoryName_Sel ,
                                       ...
                                       bool AV53IsAuthorized_MemoCategoryName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MEMOID", GetSecureSignedToken( "", A575MemoId, context));
         GxWebStd.gx_hidden_field( context, "MEMOID", A575MemoId.ToString());
      }
      ...
      protected void RFBA2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV63Trn_memowwds_3_tfmemocategoryname_sel ,
                                                 AV62Trn_memowwds_2_tfmemocategoryname ,
                                                 AV65Trn_memowwds_5_tfmemotitle_sel ,
                                                 AV64Trn_memowwds_4_tfmemotitle ,
                                                 AV66Trn_memowwds_6_tfmemostartdatetime ,
                                                 AV67Trn_memowwds_7_tfmemostartdatetime_to ,
                                                 AV68Trn_memowwds_8_tfmemoenddatetime ,
                                                 AV69Trn_memowwds_9_tfmemoenddatetime_to ,
                                                 AV70Trn_memowwds_10_tfmemoduration ,
                                                 AV71Trn_memowwds_11_tfmemoduration_to ,
                                                 AV72Trn_memowwds_12_tfmemoremovedate ,
                                                 AV73Trn_memowwds_13_tfmemoremovedate_to ,
                                                 A569MemoCategoryName ,
                                                 A576MemoTitle ,
                                                 A589MemoDuration ,
                                                 A587MemoStartDateTime ,
                                                 A588MemoEndDateTime ,
                                                 A590MemoRemoveDate ,
                                                 AV13OrderedBy ,
                                                 AV14OrderedDsc } ,
                                                 ...
                                                 TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            });
            lV61Trn_memowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Trn_memowwds_1_filterfulltext), "%", "");
            lV61Trn_memowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Trn_memowwds_1_filterfulltext), "%", "");
            lV61Trn_memowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV61Trn_memowwds_1_filterfulltext), "%", "");
            lV62Trn_memowwds_2_tfmemocategoryname = StringUtil.Concat( StringUtil.RTrim( AV62Trn_memowwds_2_tfmemocategoryname), "%", "");
            lV64Trn_memowwds_4_tfmemotitle = StringUtil.Concat( StringUtil.RTrim( AV64Trn_memowwds_4_tfmemotitle), "%", "");
            /* Using cursor H00BA2 */
            pr_default.execute(0, new Object[] {lV61Trn_memowwds_1_filterfulltext, lV61Trn_memowwds_1_filterfulltext, lV61Trn_memowwds_1_filterfulltext, lV62Trn_memowwds_2_tfmemocategoryname, AV63Trn_memowwds_3_tfmemocategoryname_sel, lV64Trn_memowwds_4_tfmemotitle, AV65Trn_memowwds_5_tfmemotitle_sel, AV66Trn_memowwds_6_tfmemostartdatetime, AV67Trn_memowwds_7_tfmemostartdatetime_to, AV68Trn_memowwds_8_tfmemoenddatetime, AV69Trn_memowwds_9_tfmemoenddatetime_to, AV70Trn_memowwds_10_tfmemoduration, AV71Trn_memowwds_11_tfmemoduration_to, AV72Trn_memowwds_12_tfmemoremovedate, AV73Trn_memowwds_13_tfmemoremovedate_to, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A555SG_LocationId = H00BA2_A555SG_LocationId[0];
               A29LocationId = H00BA2_A29LocationId[0];
               A556SG_OrganisationId = H00BA2_A556SG_OrganisationId[0];
               A11OrganisationId = H00BA2_A11OrganisationId[0];
               A71ResidentGUID = H00BA2_A71ResidentGUID[0];
               A65ResidentLastName = H00BA2_A65ResidentLastName[0];
               A64ResidentGivenName = H00BA2_A64ResidentGivenName[0];
               A72ResidentSalutation = H00BA2_A72ResidentSalutation[0];
               A62ResidentId = H00BA2_A62ResidentId[0];
               A590MemoRemoveDate = H00BA2_A590MemoRemoveDate[0];
               A589MemoDuration = H00BA2_A589MemoDuration[0];
               n589MemoDuration = H00BA2_n589MemoDuration[0];
               A588MemoEndDateTime = H00BA2_A588MemoEndDateTime[0];
               n588MemoEndDateTime = H00BA2_n588MemoEndDateTime[0];
               A587MemoStartDateTime = H00BA2_A587MemoStartDateTime[0];
               n587MemoStartDateTime = H00BA2_n587MemoStartDateTime[0];
               A579MemoDocument = H00BA2_A579MemoDocument[0];
               n579MemoDocument = H00BA2_n579MemoDocument[0];
               A578MemoImage = H00BA2_A578MemoImage[0];
               n578MemoImage = H00BA2_n578MemoImage[0];
               A577MemoDescription = H00BA2_A577MemoDescription[0];
               A576MemoTitle = H00BA2_A576MemoTitle[0];
               A569MemoCategoryName = H00BA2_A569MemoCategoryName[0];
               A568MemoCategoryId = H00BA2_A568MemoCategoryId[0];
               A575MemoId = H00BA2_A575MemoId[0];
               A71ResidentGUID = H00BA2_A71ResidentGUID[0];
               A65ResidentLastName = H00BA2_A65ResidentLastName[0];
               A64ResidentGivenName = H00BA2_A64ResidentGivenName[0];
               A72ResidentSalutation = H00BA2_A72ResidentSalutation[0];
      ...
      protected void send_integrity_lvl_hashesBA2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_MEMOTITLE", AV54IsAuthorized_MemoTitle);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOTITLE", GetSecureSignedToken( "", AV54IsAuthorized_MemoTitle, context));
         GxWebStd.gx_hidden_field( context, "gxhash_MEMOID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, A575MemoId, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV59IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV59IsAuthorized_Insert, context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         AV62Trn_memowwds_2_tfmemocategoryname = AV25TFMemoCategoryName;
         AV63Trn_memowwds_3_tfmemocategoryname_sel = AV26TFMemoCategoryName_Sel;
         AV64Trn_memowwds_4_tfmemotitle = AV27TFMemoTitle;
         AV65Trn_memowwds_5_tfmemotitle_sel = AV28TFMemoTitle_Sel;
         AV66Trn_memowwds_6_tfmemostartdatetime = AV29TFMemoStartDateTime;
         AV67Trn_memowwds_7_tfmemostartdatetime_to = AV30TFMemoStartDateTime_To;
         AV68Trn_memowwds_8_tfmemoenddatetime = AV34TFMemoEndDateTime;
         AV69Trn_memowwds_9_tfmemoenddatetime_to = AV35TFMemoEndDateTime_To;
         AV70Trn_memowwds_10_tfmemoduration = AV39TFMemoDuration;
         AV71Trn_memowwds_11_tfmemoduration_to = AV40TFMemoDuration_To;
         AV72Trn_memowwds_12_tfmemoremovedate = AV41TFMemoRemoveDate;
         AV73Trn_memowwds_13_tfmemoremovedate_to = AV42TFMemoRemoveDate_To;
         ...
         lV64Trn_memowwds_4_tfmemotitle = StringUtil.Concat( StringUtil.RTrim( AV64Trn_memowwds_4_tfmemotitle), "%", "");
         /* Using cursor H00BA3 */
         pr_default.execute(1, new Object[] {lV61Trn_memowwds_1_filterfulltext, lV61Trn_memowwds_1_filterfulltext, lV61Trn_memowwds_1_filterfulltext, lV62Trn_memowwds_2_tfmemocategoryname, AV63Trn_memowwds_3_tfmemocategoryname_sel, lV64Trn_memowwds_4_tfmemotitle, AV65Trn_memowwds_5_tfmemotitle_sel, AV66Trn_memowwds_6_tfmemostartdatetime, AV67Trn_memowwds_7_tfmemostartdatetime_to, AV68Trn_memowwds_8_tfmemoenddatetime, AV69Trn_memowwds_9_tfmemoenddatetime_to, AV70Trn_memowwds_10_tfmemoduration, AV71Trn_memowwds_11_tfmemoduration_to, AV72Trn_memowwds_12_tfmemoremovedate, AV73Trn_memowwds_13_tfmemoremovedate_to});
         GRID_nRecordCount = H00BA3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUPBA0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( nGXsfl_39_idx > 0 )
            {
               ...
               A579MemoDocument = cgiGet( edtMemoDocument_Internalname);
               n579MemoDocument = false;
               A587MemoStartDateTime = context.localUtil.CToT( cgiGet( edtMemoStartDateTime_Internalname));
               n587MemoStartDateTime = false;
               A588MemoEndDateTime = context.localUtil.CToT( cgiGet( edtMemoEndDateTime_Internalname));
               n588MemoEndDateTime = false;
               A589MemoDuration = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtMemoDuration_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               n589MemoDuration = false;
               A590MemoRemoveDate = context.localUtil.CToD( cgiGet( edtMemoRemoveDate_Internalname), DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt")));
               A62ResidentId = StringUtil.StrToGuid( cgiGet( edtResidentId_Internalname));
               cmbResidentSalutation.Name = cmbResidentSalutation_Internalname;
               cmbResidentSalutation.CurrentValue = cgiGet( cmbResidentSalutation_Internalname);
               A72ResidentSalutation = cgiGet( cmbResidentSalutation_Internalname);
      ...
      protected void E18BA2( )
      {
         ...
         GXt_boolean1 = AV53IsAuthorized_MemoCategoryName;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memocategoryview_Execute", out  GXt_boolean1) ;
         AV53IsAuthorized_MemoCategoryName = GXt_boolean1;
         AssignAttri("", false, "AV53IsAuthorized_MemoCategoryName", AV53IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( "", AV53IsAuthorized_MemoCategoryName, context));
         GXt_boolean1 = AV54IsAuthorized_MemoTitle;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memoview_Execute", out  GXt_boolean1) ;
      ...
      protected void E19BA2( )
      {
         ...
         edtMemoCategoryName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoTitle_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoStartDateTime_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoEndDateTime_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoDuration_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtMemoRemoveDate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(6)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E15BA2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            {
               AV25TFMemoCategoryName = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV25TFMemoCategoryName", AV25TFMemoCategoryName);
               AV26TFMemoCategoryName_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV26TFMemoCategoryName_Sel", AV26TFMemoCategoryName_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "MemoTitle") == 0 )
            {
      ...
      private void E20BA2( )
      {
         ...
         if ( AV53IsAuthorized_MemoCategoryName )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategoryview.aspx"+UrlEncode(A568MemoCategoryId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memoview.aspx"+UrlEncode(A575MemoId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
      ...
      protected void E16BA2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "Trn_MemoWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV17ColumnsSelectorXML)) ? "" : AV19ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11BA2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_MemoWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E14BA2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0068",(string)"",(string)"Trn_Memo",(short)1,(string)"",(string)""});
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoCategoryName",  "",  "Category Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoTitle",  "",  "Title",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoStartDateTime",  "",  "Date Time",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoEndDateTime",  "",  "Date Time",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoDuration",  "",  "Duration",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "MemoRemoveDate",  "",  "Remove Date",  true,  "") ;
         GXt_char3 = AV18UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "Trn_MemoWWColumnsSelector", out  GXt_char3) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memo_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memo_Delete", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memo_Insert", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_MemoWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S182( )
      {
         ...
         AV16FilterFullText = "";
         AssignAttri("", false, "AV16FilterFullText", AV16FilterFullText);
         AV25TFMemoCategoryName = "";
         AssignAttri("", false, "AV25TFMemoCategoryName", AV25TFMemoCategoryName);
         AV26TFMemoCategoryName_Sel = "";
         AssignAttri("", false, "AV26TFMemoCategoryName_Sel", AV26TFMemoCategoryName_Sel);
         AV27TFMemoTitle = "";
         AssignAttri("", false, "AV27TFMemoTitle", AV27TFMemoTitle);
         AV28TFMemoTitle_Sel = "";
      ...
      protected void S212( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memo.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(A575MemoId.ToString());
            CallWebObject(formatLink("trn_memo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S222( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memo.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(A575MemoId.ToString());
            CallWebObject(formatLink("trn_memo.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S192( )
      {
         ...
         while ( AV74GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV25TFMemoCategoryName = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV25TFMemoCategoryName", AV25TFMemoCategoryName);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFMEMOCATEGORYNAME_SEL") == 0 )
            {
               AV26TFMemoCategoryName_Sel = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV26TFMemoCategoryName_Sel", AV26TFMemoCategoryName_Sel);
            }
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV26TFMemoCategoryName_Sel)),  AV26TFMemoCategoryName_Sel, out  GXt_char3) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV28TFMemoTitle_Sel)),  AV28TFMemoTitle_Sel, out  GXt_char5) ;
         Ddo_grid_Selectedvalue_set = GXt_char3+"|"+GXt_char5+"||||";
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV25TFMemoCategoryName)),  AV25TFMemoCategoryName, out  GXt_char5) ;
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV27TFMemoTitle)),  AV27TFMemoTitle, out  GXt_char3) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113444967", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memoww.js", "?202532113444969", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoDocument_Internalname,(string)A579MemoDocument,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoDocument_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)200,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoStartDateTime_Internalname,context.localUtil.TToC( A587MemoStartDateTime, 10, 8, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "),context.localUtil.Format( A587MemoStartDateTime, "99/99/99 99:99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoStartDateTime_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtMemoStartDateTime_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)17,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoEndDateTime_Internalname,context.localUtil.TToC( A588MemoEndDateTime, 10, 8, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "),context.localUtil.Format( A588MemoEndDateTime, "99/99/99 99:99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoEndDateTime_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtMemoEndDateTime_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)17,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl39( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A575MemoId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A568MemoCategoryId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A569MemoCategoryName));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A576MemoTitle));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A577MemoDescription));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A578MemoImage));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A579MemoDocument));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.TToC( A587MemoStartDateTime, 10, 8, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " ")));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtMemoStartDateTime_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.TToC( A588MemoEndDateTime, 10, 8, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " ")));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtMemoEndDateTime_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A589MemoDuration), 4, 0, ".", ""))));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtMemoDuration_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A590MemoRemoveDate, "99/99/99")));
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Filtertype = "Character|Character|Date|Date|Numeric|Date";
         Ddo_grid_Includefilter = "T";
         Ddo_grid_Includesortasc = "T";
         Ddo_grid_Columnssortvalues = "2|1|3|4|5|6";
         Ddo_grid_Columnids = "2:MemoCategoryName|3:MemoTitle|7:MemoStartDateTime|8:MemoEndDateTime|9:MemoDuration|10:MemoRemoveDate";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"edtMemoTitle_Visible","ctrl":"MEMOTITLE","prop":"Visible"},{"av":"edtMemoStartDateTime_Visible","ctrl":"MEMOSTARTDATETIME","prop":"Visible"},{"av":"edtMemoEndDateTime_Visible","ctrl":"MEMOENDDATETIME","prop":"Visible"},{"av":"edtMemoDuration_Visible","ctrl":"MEMODURATION","prop":"Visible"},{"av":"edtMemoRemoveDate_Visible","ctrl":"MEMOREMOVEDATE","prop":"Visible"},{"av":"AV50GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV51GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV52GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E15BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Filteredtextto_get","ctrl":"DDO_GRID","prop":"FilteredTextTo_get"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E20BA2","iparms":[{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"A568MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"A575MemoId","fld":"MEMOID","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV55ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"edtMemoCategoryName_Link","ctrl":"MEMOCATEGORYNAME","prop":"Link"},{"av":"edtMemoTitle_Link","ctrl":"MEMOTITLE","prop":"Link"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E16BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"edtMemoTitle_Visible","ctrl":"MEMOTITLE","prop":"Visible"},{"av":"edtMemoStartDateTime_Visible","ctrl":"MEMOSTARTDATETIME","prop":"Visible"},{"av":"edtMemoEndDateTime_Visible","ctrl":"MEMOENDDATETIME","prop":"Visible"},{"av":"edtMemoDuration_Visible","ctrl":"MEMODURATION","prop":"Visible"},{"av":"edtMemoRemoveDate_Visible","ctrl":"MEMOREMOVEDATE","prop":"Visible"},{"av":"AV50GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV51GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV52GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV31DDO_MemoStartDateTimeAuxDate","fld":"vDDO_MEMOSTARTDATETIMEAUXDATE"},{"av":"AV36DDO_MemoEndDateTimeAuxDate","fld":"vDDO_MEMOENDDATETIMEAUXDATE"},{"av":"AV32DDO_MemoStartDateTimeAuxDateTo","fld":"vDDO_MEMOSTARTDATETIMEAUXDATETO"},{"av":"AV37DDO_MemoEndDateTimeAuxDateTo","fld":"vDDO_MEMOENDDATETIMEAUXDATETO"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Filteredtextto_set","ctrl":"DDO_GRID","prop":"FilteredTextTo_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV36DDO_MemoEndDateTimeAuxDate","fld":"vDDO_MEMOENDDATETIMEAUXDATE"},{"av":"AV37DDO_MemoEndDateTimeAuxDateTo","fld":"vDDO_MEMOENDDATETIMEAUXDATETO"},{"av":"AV31DDO_MemoStartDateTimeAuxDate","fld":"vDDO_MEMOSTARTDATETIMEAUXDATE"},{"av":"AV32DDO_MemoStartDateTimeAuxDateTo","fld":"vDDO_MEMOSTARTDATETIMEAUXDATETO"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"edtMemoTitle_Visible","ctrl":"MEMOTITLE","prop":"Visible"},{"av":"edtMemoStartDateTime_Visible","ctrl":"MEMOSTARTDATETIME","prop":"Visible"},{"av":"edtMemoEndDateTime_Visible","ctrl":"MEMOENDDATETIME","prop":"Visible"},{"av":"edtMemoDuration_Visible","ctrl":"MEMODURATION","prop":"Visible"},{"av":"edtMemoRemoveDate_Visible","ctrl":"MEMOREMOVEDATE","prop":"Visible"},{"av":"AV50GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV51GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV52GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E21BA2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV55ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A575MemoId","fld":"MEMOID","hsh":true}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV55ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"edtMemoTitle_Visible","ctrl":"MEMOTITLE","prop":"Visible"},{"av":"edtMemoStartDateTime_Visible","ctrl":"MEMOSTARTDATETIME","prop":"Visible"},{"av":"edtMemoEndDateTime_Visible","ctrl":"MEMOENDDATETIME","prop":"Visible"},{"av":"edtMemoDuration_Visible","ctrl":"MEMODURATION","prop":"Visible"},{"av":"edtMemoRemoveDate_Visible","ctrl":"MEMOREMOVEDATE","prop":"Visible"},{"av":"AV50GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV51GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV52GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E17BA2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV26TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV27TFMemoTitle","fld":"vTFMEMOTITLE"},{"av":"AV28TFMemoTitle_Sel","fld":"vTFMEMOTITLE_SEL"},{"av":"AV29TFMemoStartDateTime","fld":"vTFMEMOSTARTDATETIME","pic":"99/99/99 99:99"},{"av":"AV30TFMemoStartDateTime_To","fld":"vTFMEMOSTARTDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV34TFMemoEndDateTime","fld":"vTFMEMOENDDATETIME","pic":"99/99/99 99:99"},{"av":"AV35TFMemoEndDateTime_To","fld":"vTFMEMOENDDATETIME_TO","pic":"99/99/99 99:99"},{"av":"AV39TFMemoDuration","fld":"vTFMEMODURATION","pic":"ZZZ9"},{"av":"AV40TFMemoDuration_To","fld":"vTFMEMODURATION_TO","pic":"ZZZ9"},{"av":"AV41TFMemoRemoveDate","fld":"vTFMEMOREMOVEDATE"},{"av":"AV42TFMemoRemoveDate_To","fld":"vTFMEMOREMOVEDATE_TO"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV53IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV54IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A575MemoId","fld":"MEMOID","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"edtMemoTitle_Visible","ctrl":"MEMOTITLE","prop":"Visible"},{"av":"edtMemoStartDateTime_Visible","ctrl":"MEMOSTARTDATETIME","prop":"Visible"},{"av":"edtMemoEndDateTime_Visible","ctrl":"MEMOENDDATETIME","prop":"Visible"},{"av":"edtMemoDuration_Visible","ctrl":"MEMODURATION","prop":"Visible"},{"av":"edtMemoRemoveDate_Visible","ctrl":"MEMOREMOVEDATE","prop":"Visible"},{"av":"AV50GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV51GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV52GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV56IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV57IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV58IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV59IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E14BA2","iparms":[]""");
      ...
      public override void initialize( )
      {
         ...
         A71ResidentGUID = "";
         lV61Trn_memowwds_1_filterfulltext = "";
         lV62Trn_memowwds_2_tfmemocategoryname = "";
         lV64Trn_memowwds_4_tfmemotitle = "";
         AV61Trn_memowwds_1_filterfulltext = "";
         AV63Trn_memowwds_3_tfmemocategoryname_sel = "";
         AV62Trn_memowwds_2_tfmemocategoryname = "";
         AV65Trn_memowwds_5_tfmemotitle_sel = "";
         AV64Trn_memowwds_4_tfmemotitle = "";
         AV66Trn_memowwds_6_tfmemostartdatetime = (DateTime)(DateTime.MinValue);
         AV67Trn_memowwds_7_tfmemostartdatetime_to = (DateTime)(DateTime.MinValue);
         AV68Trn_memowwds_8_tfmemoenddatetime = (DateTime)(DateTime.MinValue);
         AV69Trn_memowwds_9_tfmemoenddatetime_to = (DateTime)(DateTime.MinValue);
         AV72Trn_memowwds_12_tfmemoremovedate = DateTime.MinValue;
         AV73Trn_memowwds_13_tfmemoremovedate_to = DateTime.MinValue;
         H00BA2_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         H00BA2_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BA2_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         H00BA2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BA2_A71ResidentGUID = new string[] {""} ;
         H00BA2_A65ResidentLastName = new string[] {""} ;
         H00BA2_A64ResidentGivenName = new string[] {""} ;
         H00BA2_A72ResidentSalutation = new string[] {""} ;
         H00BA2_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BA2_A590MemoRemoveDate = new DateTime[] {DateTime.MinValue} ;
         H00BA2_A589MemoDuration = new short[1] ;
         H00BA2_n589MemoDuration = new bool[] {false} ;
         H00BA2_A588MemoEndDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BA2_n588MemoEndDateTime = new bool[] {false} ;
         H00BA2_A587MemoStartDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BA2_n587MemoStartDateTime = new bool[] {false} ;
         H00BA2_A579MemoDocument = new string[] {""} ;
         H00BA2_n579MemoDocument = new bool[] {false} ;
         H00BA2_A578MemoImage = new string[] {""} ;
         H00BA2_n578MemoImage = new bool[] {false} ;
         H00BA2_A577MemoDescription = new string[] {""} ;
         H00BA2_A576MemoTitle = new string[] {""} ;
         H00BA2_A569MemoCategoryName = new string[] {""} ;
         H00BA2_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00BA2_A575MemoId = new Guid[] {Guid.Empty} ;
         A555SG_LocationId = Guid.Empty;
         A29LocationId = Guid.Empty;
         A556SG_OrganisationId = Guid.Empty;
         A11OrganisationId = Guid.Empty;
         H00BA3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memoww__default(),
            new Object[][] {
                new Object[] {
               H00BA2_A555SG_LocationId, H00BA2_A29LocationId, H00BA2_A556SG_OrganisationId, H00BA2_A11OrganisationId, H00BA2_A71ResidentGUID, H00BA2_A65ResidentLastName, H00BA2_A64ResidentGivenName, H00BA2_A72ResidentSalutation, H00BA2_A62ResidentId, H00BA2_A590MemoRemoveDate,
               H00BA2_A589MemoDuration, H00BA2_n589MemoDuration, H00BA2_A588MemoEndDateTime, H00BA2_n588MemoEndDateTime, H00BA2_A587MemoStartDateTime, H00BA2_n587MemoStartDateTime, H00BA2_A579MemoDocument, H00BA2_n579MemoDocument, H00BA2_A578MemoImage, H00BA2_n578MemoImage,
               H00BA2_A577MemoDescription, H00BA2_A576MemoTitle, H00BA2_A569MemoCategoryName, H00BA2_A568MemoCategoryId, H00BA2_A575MemoId
               }
               , new Object[] {
               H00BA3_AGRID_nRecordCount
               }
            }
         );
      ...
      private short AV70Trn_memowwds_10_tfmemoduration ;
      private short AV71Trn_memowwds_11_tfmemoduration_to ;
      ...
      private DateTime AV66Trn_memowwds_6_tfmemostartdatetime ;
      private DateTime AV67Trn_memowwds_7_tfmemostartdatetime_to ;
      private DateTime AV68Trn_memowwds_8_tfmemoenddatetime ;
      private DateTime AV69Trn_memowwds_9_tfmemoenddatetime_to ;
      ...
      private DateTime AV72Trn_memowwds_12_tfmemoremovedate ;
      private DateTime AV73Trn_memowwds_13_tfmemoremovedate_to ;
      ...
      private bool AV53IsAuthorized_MemoCategoryName ;
      ...
      private string AV25TFMemoCategoryName ;
      private string AV26TFMemoCategoryName_Sel ;
      ...
      private string lV62Trn_memowwds_2_tfmemocategoryname ;
      private string lV64Trn_memowwds_4_tfmemotitle ;
      private string AV61Trn_memowwds_1_filterfulltext ;
      private string AV63Trn_memowwds_3_tfmemocategoryname_sel ;
      private string AV62Trn_memowwds_2_tfmemocategoryname ;
      private string AV65Trn_memowwds_5_tfmemotitle_sel ;
      private string AV64Trn_memowwds_4_tfmemotitle ;
      ...
      private Guid[] H00BA2_A555SG_LocationId ;
      private Guid[] H00BA2_A29LocationId ;
      private Guid[] H00BA2_A556SG_OrganisationId ;
      private Guid[] H00BA2_A11OrganisationId ;
      private string[] H00BA2_A71ResidentGUID ;
      private string[] H00BA2_A65ResidentLastName ;
      private string[] H00BA2_A64ResidentGivenName ;
      private string[] H00BA2_A72ResidentSalutation ;
      private Guid[] H00BA2_A62ResidentId ;
      private DateTime[] H00BA2_A590MemoRemoveDate ;
      private short[] H00BA2_A589MemoDuration ;
      private bool[] H00BA2_n589MemoDuration ;
      private DateTime[] H00BA2_A588MemoEndDateTime ;
      private bool[] H00BA2_n588MemoEndDateTime ;
      private DateTime[] H00BA2_A587MemoStartDateTime ;
      private bool[] H00BA2_n587MemoStartDateTime ;
      private string[] H00BA2_A579MemoDocument ;
      private bool[] H00BA2_n579MemoDocument ;
      private string[] H00BA2_A578MemoImage ;
      private bool[] H00BA2_n578MemoImage ;
      private string[] H00BA2_A577MemoDescription ;
      private string[] H00BA2_A576MemoTitle ;
      private string[] H00BA2_A569MemoCategoryName ;
      private Guid[] H00BA2_A568MemoCategoryId ;
      private Guid[] H00BA2_A575MemoId ;
      private long[] H00BA3_AGRID_nRecordCount ;
   ...
   {
      protected Object[] conditional_H00BA2( IGxContext context ,
                                             string AV61Trn_memowwds_1_filterfulltext ,
                                             string AV63Trn_memowwds_3_tfmemocategoryname_sel ,
                                             string AV62Trn_memowwds_2_tfmemocategoryname ,
                                             string AV65Trn_memowwds_5_tfmemotitle_sel ,
                                             string AV64Trn_memowwds_4_tfmemotitle ,
                                             DateTime AV66Trn_memowwds_6_tfmemostartdatetime ,
                                             DateTime AV67Trn_memowwds_7_tfmemostartdatetime_to ,
                                             DateTime AV68Trn_memowwds_8_tfmemoenddatetime ,
                                             DateTime AV69Trn_memowwds_9_tfmemoenddatetime_to ,
                                             short AV70Trn_memowwds_10_tfmemoduration ,
                                             short AV71Trn_memowwds_11_tfmemoduration_to ,
                                             DateTime AV72Trn_memowwds_12_tfmemoremovedate ,
                                             DateTime AV73Trn_memowwds_13_tfmemoremovedate_to ,
                                             string A569MemoCategoryName ,
                                             string A576MemoTitle ,
                                             short A589MemoDuration ,
                                             DateTime A587MemoStartDateTime ,
                                             DateTime A588MemoEndDateTime ,
                                             DateTime A590MemoRemoveDate ,
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.SG_LocationId, T2.LocationId, T1.SG_OrganisationId, T2.OrganisationId, T2.ResidentGUID, T2.ResidentLastName, T2.ResidentGivenName, T2.ResidentSalutation, T1.ResidentId, T1.MemoRemoveDate, T1.MemoDuration, T1.MemoEndDateTime, T1.MemoStartDateTime, T1.MemoDocument, T1.MemoImage, T1.MemoDescription, T1.MemoTitle, T3.MemoCategoryName, T1.MemoCategoryId, T1.MemoId";
         sFromString = " FROM ((Trn_Memo T1 INNER JOIN Trn_Resident T2 ON T2.ResidentId = T1.ResidentId AND T2.LocationId = T1.SG_LocationId AND T2.OrganisationId = T1.SG_OrganisationId) INNER JOIN Trn_MemoCategory T3 ON T3.MemoCategoryId = T1.MemoCategoryId)";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Trn_memowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T3.MemoCategoryName) like '%' || LOWER(:lV61Trn_memowwds_1_filterfulltext)) or ( LOWER(T1.MemoTitle) like '%' || LOWER(:lV61Trn_memowwds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.MemoDuration,'9999'), 2) like '%' || :lV61Trn_memowwds_1_filterfulltext))");
         }
         else
         {
            GXv_int6[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_memowwds_3_tfmemocategoryname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Trn_memowwds_2_tfmemocategoryname)) ) )
         {
            AddWhere(sWhereString, "(T3.MemoCategoryName like :lV62Trn_memowwds_2_tfmemocategoryname)");
         }
         else
         {
            GXv_int6[3] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_memowwds_3_tfmemocategoryname_sel)) && ! ( StringUtil.StrCmp(AV63Trn_memowwds_3_tfmemocategoryname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.MemoCategoryName = ( :AV63Trn_memowwds_3_tfmemocategoryname_sel))");
         }
         else
         {
            GXv_int6[4] = 1;
         }
         if ( StringUtil.StrCmp(AV63Trn_memowwds_3_tfmemocategoryname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T3.MemoCategoryName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_memowwds_5_tfmemotitle_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV64Trn_memowwds_4_tfmemotitle)) ) )
         {
            AddWhere(sWhereString, "(T1.MemoTitle like :lV64Trn_memowwds_4_tfmemotitle)");
         }
         else
         {
            GXv_int6[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_memowwds_5_tfmemotitle_sel)) && ! ( StringUtil.StrCmp(AV65Trn_memowwds_5_tfmemotitle_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.MemoTitle = ( :AV65Trn_memowwds_5_tfmemotitle_sel))");
         }
         else
         {
            GXv_int6[6] = 1;
         }
         if ( StringUtil.StrCmp(AV65Trn_memowwds_5_tfmemotitle_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.MemoTitle))=0))");
         }
         if ( ! (DateTime.MinValue==AV66Trn_memowwds_6_tfmemostartdatetime) )
         {
            AddWhere(sWhereString, "(T1.MemoStartDateTime >= :AV66Trn_memowwds_6_tfmemostartdatetime)");
         }
         else
         {
            GXv_int6[7] = 1;
         }
         if ( ! (DateTime.MinValue==AV67Trn_memowwds_7_tfmemostartdatetime_to) )
         {
            AddWhere(sWhereString, "(T1.MemoStartDateTime <= :AV67Trn_memowwds_7_tfmemostartdatetime_to)");
         }
         else
         {
            GXv_int6[8] = 1;
         }
         if ( ! (DateTime.MinValue==AV68Trn_memowwds_8_tfmemoenddatetime) )
         {
            AddWhere(sWhereString, "(T1.MemoEndDateTime >= :AV68Trn_memowwds_8_tfmemoenddatetime)");
         }
         else
         {
            GXv_int6[9] = 1;
         }
         if ( ! (DateTime.MinValue==AV69Trn_memowwds_9_tfmemoenddatetime_to) )
         {
            AddWhere(sWhereString, "(T1.MemoEndDateTime <= :AV69Trn_memowwds_9_tfmemoenddatetime_to)");
         }
         else
         {
            GXv_int6[10] = 1;
         }
         if ( ! (0==AV70Trn_memowwds_10_tfmemoduration) )
         {
            AddWhere(sWhereString, "(T1.MemoDuration >= :AV70Trn_memowwds_10_tfmemoduration)");
         }
         else
         {
            GXv_int6[11] = 1;
         }
         if ( ! (0==AV71Trn_memowwds_11_tfmemoduration_to) )
         {
            AddWhere(sWhereString, "(T1.MemoDuration <= :AV71Trn_memowwds_11_tfmemoduration_to)");
         }
         else
         {
            GXv_int6[12] = 1;
         }
         if ( ! (DateTime.MinValue==AV72Trn_memowwds_12_tfmemoremovedate) )
         {
            AddWhere(sWhereString, "(T1.MemoRemoveDate >= :AV72Trn_memowwds_12_tfmemoremovedate)");
         }
         else
         {
            GXv_int6[13] = 1;
         }
         if ( ! (DateTime.MinValue==AV73Trn_memowwds_13_tfmemoremovedate_to) )
         {
            AddWhere(sWhereString, "(T1.MemoRemoveDate <= :AV73Trn_memowwds_13_tfmemoremovedate_to)");
         }
         else
         {
            GXv_int6[14] = 1;
         ...
         {
            sOrderString += " ORDER BY T3.MemoCategoryName, T1.MemoId";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T3.MemoCategoryName DESC, T1.MemoId";
         }
      ...
      protected Object[] conditional_H00BA3( IGxContext context ,
                                             string AV61Trn_memowwds_1_filterfulltext ,
                                             string AV63Trn_memowwds_3_tfmemocategoryname_sel ,
                                             string AV62Trn_memowwds_2_tfmemocategoryname ,
                                             string AV65Trn_memowwds_5_tfmemotitle_sel ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((Trn_Memo T1 INNER JOIN Trn_Resident T3 ON T3.ResidentId = T1.ResidentId AND T3.LocationId = T1.SG_LocationId AND T3.OrganisationId = T1.SG_OrganisationId) INNER JOIN Trn_MemoCategory T2 ON T2.MemoCategoryId = T1.MemoCategoryId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Trn_memowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T2.MemoCategoryName) like '%' || LOWER(:lV61Trn_memowwds_1_filterfulltext)) or ( LOWER(T1.MemoTitle) like '%' || LOWER(:lV61Trn_memowwds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.MemoDuration,'9999'), 2) like '%' || :lV61Trn_memowwds_1_filterfulltext))");
         }
         else
         {
            GXv_int8[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_memowwds_3_tfmemocategoryname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Trn_memowwds_2_tfmemocategoryname)) ) )
         {
            AddWhere(sWhereString, "(T2.MemoCategoryName like :lV62Trn_memowwds_2_tfmemocategoryname)");
         }
         else
         {
            GXv_int8[3] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_memowwds_3_tfmemocategoryname_sel)) && ! ( StringUtil.StrCmp(AV63Trn_memowwds_3_tfmemocategoryname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.MemoCategoryName = ( :AV63Trn_memowwds_3_tfmemocategoryname_sel))");
         }
         else
         {
            GXv_int8[4] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00BA2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (DateTime)dynConstraints[11] , (DateTime)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (short)dynConstraints[15] , (DateTime)dynConstraints[16] , (DateTime)dynConstraints[17] , (DateTime)dynConstraints[18] , (short)dynConstraints[19] , (bool)dynConstraints[20] );
               case 1 :
                     return conditional_H00BA3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (DateTime)dynConstraints[11] , (DateTime)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (short)dynConstraints[15] , (DateTime)dynConstraints[16] , (DateTime)dynConstraints[17] , (DateTime)dynConstraints[18] , (short)dynConstraints[19] , (bool)dynConstraints[20] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV61Trn_memowwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV61Trn_memowwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV62Trn_memowwds_2_tfmemocategoryname",GXType.VarChar,100,0) ,
          new ParDef("AV63Trn_memowwds_3_tfmemocategoryname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV64Trn_memowwds_4_tfmemotitle",GXType.VarChar,100,0) ,
          new ParDef("AV65Trn_memowwds_5_tfmemotitle_sel",GXType.VarChar,100,0) ,
          new ParDef("AV66Trn_memowwds_6_tfmemostartdatetime",GXType.DateTime,8,5) ,
          new ParDef("AV67Trn_memowwds_7_tfmemostartdatetime_to",GXType.DateTime,8,5) ,
          new ParDef("AV68Trn_memowwds_8_tfmemoenddatetime",GXType.DateTime,8,5) ,
          new ParDef("AV69Trn_memowwds_9_tfmemoenddatetime_to",GXType.DateTime,8,5) ,
          new ParDef("AV70Trn_memowwds_10_tfmemoduration",GXType.Int16,4,0) ,
          new ParDef("AV71Trn_memowwds_11_tfmemoduration_to",GXType.Int16,4,0) ,
          new ParDef("AV72Trn_memowwds_12_tfmemoremovedate",GXType.Date,8,0) ,
          new ParDef("AV73Trn_memowwds_13_tfmemoremovedate_to",GXType.Date,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00BA2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BA2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00BA3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BA3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((DateTime[]) buf[14])[0] = rslt.getGXDateTime(13);
