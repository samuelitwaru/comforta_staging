   ...
   public class wc_copygeneraldynamicformtolocation : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vLOCATION") == 0 )
               {
                  ...
                  GXDLVvLOCATIONA52( AV12Organisation) ;
                  return  ;
               }
      ...
      protected void WBA50( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnucancel_Internalname, "", context.GetMessage( "Cancel", ""), bttBtnucancel_Jsonclick, 7, context.GetMessage( "Cancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11a51_client"+"'", TempTags, "", 2, "HLP_WC_CopyGeneralDynamicFormToLocation.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void GXDLVvORGANISATIONA52( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvORGANISATION_htmlA52( )
      {
         Guid gxdynajaxvalue;
         GXDLVvORGANISATION_dataA52( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvORGANISATION_dataA52( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H00A52_A11OrganisationId[0].ToString());
            gxdynajaxctrldescr.Add(H00A52_A13OrganisationName[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvLOCATIONA52( Guid AV12Organisation )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvLOCATION_dataA52( AV12Organisation) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvLOCATION_htmlA52( Guid AV12Organisation )
      {
         Guid gxdynajaxvalue;
         GXDLVvLOCATION_dataA52( AV12Organisation) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvLOCATION_dataA52( Guid AV12Organisation )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(Guid.Empty.ToString());
         ...
         {
            gxdynajaxctrlcodr.Add(H00A53_A29LocationId[0].ToString());
            gxdynajaxctrldescr.Add(H00A53_A31LocationName[0]);
      ...
      protected void RFA52( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A207WWPFormVersionNumber = H00A54_A207WWPFormVersionNumber[0];
               A206WWPFormId = H00A54_A206WWPFormId[0];
               A208WWPFormReferenceName = H00A54_A208WWPFormReferenceName[0];
               GXVvORGANISATION_htmlA52( ) ;
               GXVvLOCATION_htmlA52( AV12Organisation) ;
               /* Execute user event: Load */
               E14A52 ();
      ...
      protected void S112( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Organisation", ""), "", "", "", "", "", "", "", ""),  "error",  dynavOrganisation_Internalname,  "true",  ""));
            AV5CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV5CheckRequiredFieldsResult", AV5CheckRequiredFieldsResult);
         }
         if ( (Guid.Empty==AV9Location) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Location", ""), "", "", "", "", "", "", "", ""),  "error",  dynavLocation_Internalname,  "true",  ""));
            AV5CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV5CheckRequiredFieldsResult", AV5CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S122( )
      {
         ...
         {
            A206WWPFormId = H00A55_A206WWPFormId[0];
            ...
            if ( ! (Guid.Empty==AV9Location) )
            {
               ...
               else
               {
                  ...
                  while ( AV22GXV3 <= AV21GXV2.Count )
                  {
                     ...
                     GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  context.GetMessage( "WWP_DF_ErrorCloning", ""),  AV10Message.gxTpr_Description,  "error",  "",  "false",  ""));
         ...
         else
         {
            ...
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  context.GetMessage( "WWP_DF_ErrorCloning", ""),  AV13ResultMsg,  "error",  "",  "false",  ""));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202522220344125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_copygeneraldynamicformtolocation.js", "?202522220344125", false, true);
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         H00A52_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00A52_A13OrganisationName = new string[] {""} ;
         H00A53_A29LocationId = new Guid[] {Guid.Empty} ;
         H00A53_A31LocationName = new string[] {""} ;
         H00A53_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00A54_A207WWPFormVersionNumber = new short[1] ;
         H00A54_A206WWPFormId = new short[1] ;
         H00A54_A208WWPFormReferenceName = new string[] {""} ;
         ...
         AV11NewWWPForm = new GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form(context);
         H00A55_A207WWPFormVersionNumber = new short[1] ;
         H00A55_A206WWPFormId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wc_copygeneraldynamicformtolocation__default(),
            new Object[][] {
                new Object[] {
               H00A52_A11OrganisationId, H00A52_A13OrganisationName
               }
               , new Object[] {
               H00A53_A29LocationId, H00A53_A31LocationName, H00A53_A11OrganisationId
               }
               , new Object[] {
               H00A54_A207WWPFormVersionNumber, H00A54_A206WWPFormId, H00A54_A208WWPFormReferenceName
               }
               , new Object[] {
               H00A55_A207WWPFormVersionNumber, H00A55_A206WWPFormId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] H00A52_A11OrganisationId ;
      private string[] H00A52_A13OrganisationName ;
      private Guid[] H00A53_A29LocationId ;
      private string[] H00A53_A31LocationName ;
      private Guid[] H00A53_A11OrganisationId ;
      private short[] H00A54_A207WWPFormVersionNumber ;
      private short[] H00A54_A206WWPFormId ;
      private string[] H00A54_A208WWPFormReferenceName ;
      ...
      private short[] H00A55_A207WWPFormVersionNumber ;
      private short[] H00A55_A206WWPFormId ;
...
public class wc_copygeneraldynamicformtolocation__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       Object[] prmH00A54;
       prmH00A54 = new Object[] {
       };
       Object[] prmH00A55;
       prmH00A55 = new Object[] {
       };
       def= new CursorDef[] {
           new CursorDef("H00A52", "SELECT OrganisationId, OrganisationName FROM Trn_Organisation ORDER BY OrganisationName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A52,0, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00A53", "SELECT LocationId, LocationName, OrganisationId FROM Trn_Location WHERE OrganisationId = :AV12Organisation ORDER BY LocationName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A53,0, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00A54", "SELECT WWPFormVersionNumber, WWPFormId, WWPFormReferenceName FROM WWP_Form ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A54,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00A55", "SELECT WWPFormVersionNumber, WWPFormId FROM WWP_Form ORDER BY WWPFormId DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00A55,1, GxCacheFrequency.OFF ,false,true )
       };
    }
 }
