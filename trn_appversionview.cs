   ...
   public class trn_appversionview : GXDataArea
   {
      ...
      protected void RFAP2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A543AppVersionId = H00AP2_A543AppVersionId[0];
               /* Execute user event: Load */
               E16AP2 ();
      ...
      protected void E14AP2( )
      {
         ...
         {
            A543AppVersionId = H00AP3_A543AppVersionId[0];
            A544AppVersionName = H00AP3_A544AppVersionName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A544AppVersionName;
      ...
      protected void E15AP2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_AppVersion",  StringUtil.Trim( A543AppVersionId.ToString())) )
         {
      ...
      protected void E11AP2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_AppVersion",(short)2,StringUtil.Trim( A543AppVersionId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12AP2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_AppVersion",StringUtil.Trim( A543AppVersionId.ToString()),(string)AV14RecordDescription,formatLink("trn_appversionview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025361243173", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_appversionview.js", "?2025361243173", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A543AppVersionId","fld":"APPVERSIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10AppVersionId","fld":"vAPPVERSIONID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11AP2","iparms":[{"av":"A543AppVersionId","fld":"APPVERSIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12AP2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A543AppVersionId","fld":"APPVERSIONID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13AP2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10AppVersionId","fld":"vAPPVERSIONID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00AP2_A543AppVersionId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00AP3_A543AppVersionId = new Guid[] {Guid.Empty} ;
         H00AP3_A544AppVersionName = new string[] {""} ;
         A544AppVersionName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionview__default(),
            new Object[][] {
                new Object[] {
               H00AP2_A543AppVersionId
               }
               , new Object[] {
               H00AP3_A543AppVersionId, H00AP3_A544AppVersionName
               }
            }
         );
      ...
      private Guid[] H00AP2_A543AppVersionId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00AP3_A543AppVersionId ;
      private string[] H00AP3_A544AppVersionName ;
   ...
   public class trn_appversionview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00AP2", "SELECT AppVersionId FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AP2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00AP3", "SELECT AppVersionId, AppVersionName FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AP3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
