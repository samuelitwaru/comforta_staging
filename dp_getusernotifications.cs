   ...
   public class dp_getusernotifications : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            Gxm1wwp_sdtnotificationsdata.gxTpr_Notificationdefinitionid = A128WWPNotificationDefinitionId;
            Gxm1wwp_sdtnotificationsdata.gxTpr_Notificationisread = A187WWPNotificationIsRead;
            Gxm1wwp_sdtnotificationsdata.gxTpr_Notitifcationmetadata = A165WWPNotificationMetadata;
