...
namespace GeneXus.Programs {
   public class ufilledoutformsgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV32GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "UFilledOutFormsGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRKAV2 = false;
            A112WWPUserExtendedId = P00AV2_A112WWPUserExtendedId[0];
            A206WWPFormId = P00AV2_A206WWPFormId[0];
            A113WWPUserExtendedFullName = P00AV2_A113WWPUserExtendedFullName[0];
            A207WWPFormVersionNumber = P00AV2_A207WWPFormVersionNumber[0];
            A239WWPFormInstanceDate = P00AV2_A239WWPFormInstanceDate[0];
            A214WWPFormInstanceId = P00AV2_A214WWPFormInstanceId[0];
            A113WWPUserExtendedFullName = P00AV2_A113WWPUserExtendedFullName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( P00AV2_A206WWPFormId[0] == A206WWPFormId ) && ( StringUtil.StrCmp(P00AV2_A113WWPUserExtendedFullName[0], A113WWPUserExtendedFullName) == 0 ) )
            {
               BRKAV2 = false;
               A112WWPUserExtendedId = P00AV2_A112WWPUserExtendedId[0];
               A214WWPFormInstanceId = P00AV2_A214WWPFormInstanceId[0];
      ...
      public override void initialize( )
      {
         ...
         P00AV2_A112WWPUserExtendedId = new string[] {""} ;
         P00AV2_A206WWPFormId = new short[1] ;
         P00AV2_A113WWPUserExtendedFullName = new string[] {""} ;
         P00AV2_A207WWPFormVersionNumber = new short[1] ;
         P00AV2_A239WWPFormInstanceDate = new DateTime[] {DateTime.MinValue} ;
         P00AV2_A214WWPFormInstanceId = new int[1] ;
         A112WWPUserExtendedId = "";
         AV24Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ufilledoutformsgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00AV2_A112WWPUserExtendedId, P00AV2_A206WWPFormId, P00AV2_A113WWPUserExtendedFullName, P00AV2_A207WWPFormVersionNumber, P00AV2_A239WWPFormInstanceDate, P00AV2_A214WWPFormInstanceId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00AV2_A112WWPUserExtendedId ;
      private short[] P00AV2_A206WWPFormId ;
      private string[] P00AV2_A113WWPUserExtendedFullName ;
      private short[] P00AV2_A207WWPFormVersionNumber ;
      private DateTime[] P00AV2_A239WWPFormInstanceDate ;
      private int[] P00AV2_A214WWPFormInstanceId ;
   ...
   public class ufilledoutformsgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00AV2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] );
         }
