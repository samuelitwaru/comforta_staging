...
namespace GeneXus.Programs {
   public class dp_getdashboarditems : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         Gxm1homemodulessdt.gxTpr_Optiontitle = "Managers";
         Gxm1homemodulessdt.gxTpr_Optioniconthemeclass = "far fa-address-card";
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("trn_managerww.aspx") ;
         Gxm1homemodulessdt.gxTpr_Rolename = "Organisation Manager";
         Gxm1homemodulessdt.gxTpr_Optionbackgroundimage = context.convertURL( (string)(context.GetImagePath( "8b339ea3-0806-4fdc-b87f-6f4b66cf669e", "", context.GetTheme( ))));
         Gxm1homemodulessdt.gxTpr_Optiondescription = "Location Managers";
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("wp_organisationagbsuppliers.aspx") ;
         Gxm1homemodulessdt.gxTpr_Rolename = "Organisation Manager";
         Gxm1homemodulessdt.gxTpr_Optionbackgroundimage = context.convertURL( (string)(context.GetImagePath( "4688f42a-4096-4b76-bddb-a886e286486f", "", context.GetTheme( ))));
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("wp_organisationgeneralsuppliers.aspx") ;
         Gxm1homemodulessdt.gxTpr_Rolename = "Organisation Manager";
         ...
         Gxm1homemodulessdt.gxTpr_Optiondescription = "Suppliers (General)";
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         Gxm1homemodulessdt.gxTpr_Optiontitle = "Services";
         Gxm1homemodulessdt.gxTpr_Optioniconthemeclass = "fas fa-box-open";
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         ...
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         Gxm1homemodulessdt.gxTpr_Optiontitle = "Notifications";
         Gxm1homemodulessdt.gxTpr_Optioniconthemeclass = "fa fa-bell";
         Gxm1homemodulessdt.gxTpr_Rolename = "Receptionist";
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("wp_notificationdashboard.aspx") ;
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         Gxm1homemodulessdt.gxTpr_Optiontitle = "Audit";
         Gxm1homemodulessdt.gxTpr_Optioniconthemeclass = "fas fa-list-ul";
         Gxm1homemodulessdt.gxTpr_Rolename = "Organisation Manager";
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("trn_auditww.aspx") ;
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("wp_userprofile.aspx") ;
         cleanup();
      }
