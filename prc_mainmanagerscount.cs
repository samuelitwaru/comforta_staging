...
namespace GeneXus.Programs {
   public class prc_mainmanagerscount : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         cV9MainManagers = P00B32_AV9MainManagers[0];
         pr_default.close(0);
      ...
      private short[] P00B32_AV9MainManagers ;
   ...
   public class prc_mainmanagerscount__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00B32", "SELECT COUNT(*) FROM Trn_Manager WHERE (OrganisationId = :AV8OrganisationId) AND (ManagerIsMainManager = TRUE) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00B32,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
