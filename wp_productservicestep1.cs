...
namespace GeneXus.Programs {
   public class wp_productservicestep1 : GXWebComponent
   {
                           ...
                           ref Guid aP4_FromToolBox_ProductServiceId )
      {
         ...
         this.AV51IsPopup = aP3_IsPopup;
         this.AV52FromToolBox_ProductServiceId = aP4_FromToolBox_ProductServiceId;
         ExecuteImpl();
         aP3_IsPopup=this.AV51IsPopup;
         aP4_FromToolBox_ProductServiceId=this.AV52FromToolBox_ProductServiceId;
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV51IsPopup = StringUtil.StrToBool( GetPar( "IsPopup"));
                  AssignAttri(sPrefix, false, "AV51IsPopup", AV51IsPopup);
                  AV52FromToolBox_ProductServiceId = StringUtil.StrToGuid( GetPar( "FromToolBox_ProductServiceId"));
                  AssignAttri(sPrefix, false, "AV52FromToolBox_ProductServiceId", AV52FromToolBox_ProductServiceId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV37WebSessionKey,(string)AV20PreviousStep,(bool)AV14GoingBack,(bool)AV51IsPopup,(Guid)AV52FromToolBox_ProductServiceId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wp_productservicestep1.aspx"+UrlEncode(StringUtil.RTrim(AV37WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV20PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV14GoingBack)) + "," + UrlEncode(StringUtil.BoolToStr(AV51IsPopup)) + "," + UrlEncode(AV52FromToolBox_ProductServiceId.ToString());
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vORGANISATIONID", AV19OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vORGANISATIONID", GetSecureSignedToken( sPrefix, AV19OrganisationId, context));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB720( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavProductservicetilename_Internalname, context.GetMessage( "App Tile Name", ""), "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void wb_table1_42_722e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProductserviceclasserror_Internalname, "", "", "", lblProductserviceclasserror_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_ProductServiceStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavProductservicegroup, dynavProductservicegroup_Internalname, StringUtil.RTrim( AV22ProductServiceGroup), 1, dynavProductservicegroup_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavProductservicegroup.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,65);\"", "", true, 0, "HLP_WP_ProductServiceStep1.htm");
            ...
            wb_table2_79_722( true) ;
         }
         else
         {
            wb_table2_79_722( false) ;
         }
         return  ;
      }

      protected void wb_table2_79_722e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
            wb_table3_96_722( true) ;
         }
         else
         {
            wb_table3_96_722( false) ;
         }
         return  ;
      }

      protected void wb_table3_96_722e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavSupplieragbid_Internalname, AV28SupplierAgbId.ToString(), AV28SupplierAgbId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,118);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSupplieragbid_Jsonclick, 0, "Attribute", "", "", "", "", edtavSupplieragbid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_ProductServiceStep1.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSuppliergenid_Internalname, AV30SupplierGenId.ToString(), AV30SupplierGenId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,119);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSuppliergenid_Jsonclick, 0, "Attribute", "", "", "", "", edtavSuppliergenid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_ProductServiceStep1.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 120,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProductserviceid_Internalname, AV23ProductServiceId.ToString(), AV23ProductServiceId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,120);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProductserviceid_Jsonclick, 0, "Attribute", "", "", "", "", edtavProductserviceid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_ProductServiceStep1.htm");
            /* Multiple line edit */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavProductserviceimagevar_Internalname, AV25ProductServiceImageVar, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,121);\"", 0, edtavProductserviceimagevar_Visible, 1, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WP_ProductServiceStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STRUP720( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV51IsPopup = StringUtil.StrToBool( cgiGet( sPrefix+"wcpOAV51IsPopup"));
            wcpOAV52FromToolBox_ProductServiceId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV52FromToolBox_ProductServiceId"));
      ...
      protected void E13722( )
      {
         /* Start Routine */
         returnInSub = false;
         GXt_guid1 = AV19OrganisationId;
         new prc_getuserorganisationid(context ).execute( out  GXt_guid1) ;
         AV19OrganisationId = GXt_guid1;
         AssignAttri(sPrefix, false, "AV19OrganisationId", AV19OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vORGANISATIONID", GetSecureSignedToken( sPrefix, AV19OrganisationId, context));
         GXt_objcol_guid2 = AV43PreferredAgbSuppliers;
         new prc_getpreferredagbsuppliers(context ).execute( ref  GXt_objcol_guid2) ;
         AV43PreferredAgbSuppliers = GXt_objcol_guid2;
         GXt_objcol_guid2 = AV44PreferredGenSuppliers;
         new prc_getpreferredgensuppliers(context ).execute( ref  GXt_objcol_guid2) ;
         AV44PreferredGenSuppliers = GXt_objcol_guid2;
      ...
      protected void S172( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "App Tile Name", ""), "", "", "", "", "", "", "", ""),  "error",  edtavProductservicetilename_Internalname,  "true",  ""));
            AV5CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV5CheckRequiredFieldsResult", AV5CheckRequiredFieldsResult);
         }
      ...
      protected void S132( )
      {
         ...
         /* Using cursor H00723 */
         pr_default.execute(1, new Object[] {AV19OrganisationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A11OrganisationId = H00723_A11OrganisationId[0];
            n11OrganisationId = H00723_n11OrganisationId[0];
      ...
      protected void S152( )
      {
         ...
         else if ( ! AV47noFilterGen && ( StringUtil.StrCmp(AV22ProductServiceGroup, "General Supplier") == 0 ) )
         {
            ...
            /* Using cursor H00727 */
            pr_default.execute(5, new Object[] {AV19OrganisationId});
            while ( (pr_default.getStatus(5) != 101) )
            {
               A42SupplierGenId = H00727_A42SupplierGenId[0];
               A11OrganisationId = H00727_A11OrganisationId[0];
               n11OrganisationId = H00727_n11OrganisationId[0];
      ...
      protected void S192( )
      {
         ...
         /* Using cursor H00729 */
         pr_default.execute(7, new Object[] {AV16LocationId, AV19OrganisationId, AV26ProductServiceName});
         while ( (pr_default.getStatus(7) != 101) )
         {
            A11OrganisationId = H00729_A11OrganisationId[0];
            n11OrganisationId = H00729_n11OrganisationId[0];
            A29LocationId = H00729_A29LocationId[0];
            A59ProductServiceName = H00729_A59ProductServiceName[0];
      ...
      protected void wb_table3_96_722( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_96_722e( true) ;
         }
         else
         {
            wb_table3_96_722e( false) ;
         }
      }

      protected void wb_table2_79_722( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_79_722e( true) ;
         }
         else
         {
            wb_table2_79_722e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV14GoingBack", AV14GoingBack);
         AV51IsPopup = (bool)getParm(obj,3);
         AssignAttri(sPrefix, false, "AV51IsPopup", AV51IsPopup);
         AV52FromToolBox_ProductServiceId = (Guid)getParm(obj,4);
         AssignAttri(sPrefix, false, "AV52FromToolBox_ProductServiceId", AV52FromToolBox_ProductServiceId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV51IsPopup = (string)((string)getParm(obj,3));
         sCtrlAV52FromToolBox_ProductServiceId = (string)((string)getParm(obj,4));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV14GoingBack", AV14GoingBack);
            AV51IsPopup = (bool)getParm(obj,5);
            AssignAttri(sPrefix, false, "AV51IsPopup", AV51IsPopup);
            AV52FromToolBox_ProductServiceId = (Guid)getParm(obj,6);
            AssignAttri(sPrefix, false, "AV52FromToolBox_ProductServiceId", AV52FromToolBox_ProductServiceId.ToString());
         }
         wcpOAV37WebSessionKey = cgiGet( sPrefix+"wcpOAV37WebSessionKey");
         wcpOAV20PreviousStep = cgiGet( sPrefix+"wcpOAV20PreviousStep");
         ...
         wcpOAV51IsPopup = StringUtil.StrToBool( cgiGet( sPrefix+"wcpOAV51IsPopup"));
         wcpOAV52FromToolBox_ProductServiceId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV52FromToolBox_ProductServiceId"));
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV37WebSessionKey, wcpOAV37WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV20PreviousStep, wcpOAV20PreviousStep) != 0 ) || ( AV14GoingBack != wcpOAV14GoingBack ) || ( AV51IsPopup != wcpOAV51IsPopup ) || ( AV52FromToolBox_ProductServiceId != wcpOAV52FromToolBox_ProductServiceId ) ) )
         {
            setjustcreated();
         }
         ...
         wcpOAV51IsPopup = AV51IsPopup;
         wcpOAV52FromToolBox_ProductServiceId = AV52FromToolBox_ProductServiceId;
      }
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV51IsPopup = cgiGet( sPrefix+"AV51IsPopup_CTRL");
         if ( StringUtil.Len( sCtrlAV51IsPopup) > 0 )
         {
            AV51IsPopup = StringUtil.StrToBool( cgiGet( sCtrlAV51IsPopup));
            AssignAttri(sPrefix, false, "AV51IsPopup", AV51IsPopup);
         }
         else
         {
            AV51IsPopup = StringUtil.StrToBool( cgiGet( sPrefix+"AV51IsPopup_PARM"));
         }
         sCtrlAV52FromToolBox_ProductServiceId = cgiGet( sPrefix+"AV52FromToolBox_ProductServiceId_CTRL");
         if ( StringUtil.Len( sCtrlAV52FromToolBox_ProductServiceId) > 0 )
         {
            AV52FromToolBox_ProductServiceId = StringUtil.StrToGuid( cgiGet( sCtrlAV52FromToolBox_ProductServiceId));
            AssignAttri(sPrefix, false, "AV52FromToolBox_ProductServiceId", AV52FromToolBox_ProductServiceId.ToString());
         }
         else
         {
            AV52FromToolBox_ProductServiceId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV52FromToolBox_ProductServiceId_PARM"));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV51IsPopup_PARM", StringUtil.BoolToStr( AV51IsPopup));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV51IsPopup)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV51IsPopup_CTRL", StringUtil.RTrim( sCtrlAV51IsPopup));
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"AV52FromToolBox_ProductServiceId_PARM", AV52FromToolBox_ProductServiceId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV52FromToolBox_ProductServiceId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV52FromToolBox_ProductServiceId_CTRL", StringUtil.RTrim( sCtrlAV52FromToolBox_ProductServiceId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113412969", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_productservicestep1.js", "?202532113412973", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblProductserviceclasserror_Internalname = sPrefix+"PRODUCTSERVICECLASSERROR";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E17722","iparms":[{"av":"AV52FromToolBox_ProductServiceId","fld":"vFROMTOOLBOX_PRODUCTSERVICEID"},{"av":"AV51IsPopup","fld":"vISPOPUP"}]}""");
      ...
      public override void initialize( )
      {
         ...
         wcpOAV52FromToolBox_ProductServiceId = Guid.Empty;
         ...
         lblProductserviceclasserror_Jsonclick = "";
         ...
         H00723_n11OrganisationId = new bool[] {false} ;
         ...
         H00727_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00727_n11OrganisationId = new bool[] {false} ;
         ...
         H00729_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H00729_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00729_n11OrganisationId = new bool[] {false} ;
         H00729_A29LocationId = new Guid[] {Guid.Empty} ;
         H00729_A59ProductServiceName = new string[] {""} ;
         sStyleString = "";
         ...
         sCtrlAV14GoingBack = "";
         sCtrlAV51IsPopup = "";
         sCtrlAV52FromToolBox_ProductServiceId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_productservicestep1__default(),
            new Object[][] {
               ...
               , new Object[] {
               H00723_A11OrganisationId, H00723_n11OrganisationId, H00723_A42SupplierGenId, H00723_A44SupplierGenCompanyName
               }
               , new Object[] {
               ...
               , new Object[] {
               H00727_A42SupplierGenId, H00727_A11OrganisationId, H00727_n11OrganisationId, H00727_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00728_A42SupplierGenId, H00728_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00729_A58ProductServiceId, H00729_A11OrganisationId, H00729_A29LocationId, H00729_A59ProductServiceName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string lblProductserviceclasserror_Internalname ;
      private string lblProductserviceclasserror_Jsonclick ;
      ...
      private string sCtrlAV51IsPopup ;
      private string sCtrlAV52FromToolBox_ProductServiceId ;
      private bool AV14GoingBack ;
      private bool AV51IsPopup ;
      private bool wcpOAV14GoingBack ;
      private bool wcpOAV51IsPopup ;
      ...
      private Guid AV52FromToolBox_ProductServiceId ;
      private Guid wcpOAV52FromToolBox_ProductServiceId ;
      ...
      private bool[] H00722_n11OrganisationId ;
      ...
      private bool[] H00723_n11OrganisationId ;
      ...
      private Guid[] H00727_A11OrganisationId ;
      private bool[] H00727_n11OrganisationId ;
      ...
      private Guid[] H00729_A58ProductServiceId ;
      private Guid[] H00729_A11OrganisationId ;
      private bool[] H00729_n11OrganisationId ;
      private Guid[] H00729_A29LocationId ;
      private string[] H00729_A59ProductServiceName ;
   ...
   public class wp_productservicestep1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV19OrganisationId )
      {
         ...
         AddWhere(sWhereString, "(Not "+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV44PreferredGenSuppliers, "SupplierGenId IN (", ")")+")");
         AddWhere(sWhereString, "(OrganisationId = :AV19OrganisationId)");
         scmdbuf += sWhereString;
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 5 :
                     return conditional_H00727(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 6 :
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00729;
          prmH00729 = new Object[] {
          new ParDef("AV16LocationId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV19OrganisationId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV26ProductServiceName",GXType.VarChar,100,0)
          };
          Object[] prmH00724;
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00723", "SELECT OrganisationId, SupplierGenId, SupplierGenCompanyName FROM Trn_SupplierGen WHERE OrganisationId = :AV19OrganisationId ORDER BY SupplierGenCompanyName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00723,100, GxCacheFrequency.OFF ,false,false )
             ...
             ,new CursorDef("H00729", "SELECT ProductServiceId, OrganisationId, LocationId, ProductServiceName FROM Trn_ProductService WHERE (LocationId = :AV16LocationId and OrganisationId = :AV19OrganisationId) AND (ProductServiceName = ( :AV26ProductServiceName)) ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00729,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
