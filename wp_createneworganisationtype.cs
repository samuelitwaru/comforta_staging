   ...
   public class wp_createneworganisationtype : GXDataArea
   {
      ...
      protected void WB8A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavTrn_organisationtype_organisationtypename_Internalname, "Organisation Type", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412191574162", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createneworganisationtype.js", "?202412191574162", false, true);
