...
namespace GeneXus.Programs {
   public class prc_getmemocategory : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A568MemoCategoryId = P00D42_A568MemoCategoryId[0];
            A569MemoCategoryName = P00D42_A569MemoCategoryName[0];
            AV10SDT_MemoCategory = new SdtSDT_MemoCategory(context);
            AV10SDT_MemoCategory.gxTpr_Memocategoryid = A568MemoCategoryId;
            AV10SDT_MemoCategory.gxTpr_Memocategoryname = A569MemoCategoryName;
      ...
      {
         AV10SDT_MemoCategory = new SdtSDT_MemoCategory(context);
         P00D42_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00D42_A569MemoCategoryName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getmemocategory__default(),
            new Object[][] {
                new Object[] {
               P00D42_A568MemoCategoryId, P00D42_A569MemoCategoryName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00D42_A568MemoCategoryId ;
      private string[] P00D42_A569MemoCategoryName ;
   ...
   public class prc_getmemocategory__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00D42", "SELECT MemoCategoryId, MemoCategoryName FROM Trn_MemoCategory WHERE MemoCategoryId = :AV9MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D42,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
