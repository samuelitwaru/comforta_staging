...
namespace GeneXus.Programs {
   public class trn_appversionpagewc : GXWebComponent
   {
      ...
      protected void RenderHtmlCloseFormAS2( )
      {
      ...
      protected void WBAS0( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAppVersionId_Internalname, A543AppVersionId.ToString(), A543AppVersionId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppVersionId_Jsonclick, 0, "Attribute", "", "", "", "", edtAppVersionId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_AppVersionPageWC.htm");
            /* User Defined Control */
      ...
      protected void WSAS2( )
      {
         STARTAS2( ) ;
         EVTAS2( ) ;
      }

      protected void EVTAS2( )
      {
         sXEvt = cgiGet( "_EventName");
      ...
      protected void WEAS2( )
      {
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            if ( ! GxWebStd.gx_redirect( context) )
            {
               RenderHtmlCloseFormAS2( ) ;
            }
         }
      }

      protected void PAAS2( )
      {
         if ( nDonePA == 0 )
         {
            if ( StringUtil.Len( sPrefix) != 0 )
      ...
      protected void RFAS2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A543AppVersionId = H00AS2_A543AppVersionId[0];
               AssignAttri(sPrefix, false, "A543AppVersionId", A543AppVersionId.ToString());
               A545PageType = H00AS2_A545PageType[0];
               A523PageStructure = H00AS2_A523PageStructure[0];
               A522PageName = H00AS2_A522PageName[0];
               A521PageId = H00AS2_A521PageId[0];
               A523PageStructure = H00AS2_A523PageStructure[0];
               A522PageName = H00AS2_A522PageName[0];
               /* Execute user event: Grid.Load */
               E16AS2 ();
      ...
      protected void send_integrity_lvl_hashesAS2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV23Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV23Pgmname, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H00AS3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253611111878", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_appversionpagewc.js", "?20253611111878", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbPageType,(string)cmbPageType_Internalname,StringUtil.RTrim( A545PageType),(short)1,(string)cmbPageType_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",(string)"",(string)"",(bool)true,(short)0});
      ...
      protected void StartGridControl15( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Page Structure", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A521PageId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A522PageName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A523PageStructure));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A545PageType));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PageId|1:PageName|2:PageStructure|3:PageType";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16AS2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         A545PageType = "";
         GXDecQS = "";
         H00AS2_A543AppVersionId = new Guid[] {Guid.Empty} ;
         H00AS2_A545PageType = new string[] {""} ;
         H00AS2_A523PageStructure = new string[] {""} ;
         H00AS2_A522PageName = new string[] {""} ;
         H00AS2_A521PageId = new Guid[] {Guid.Empty} ;
         H00AS3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionpagewc__default(),
            new Object[][] {
                new Object[] {
               H00AS2_A543AppVersionId, H00AS2_A545PageType, H00AS2_A523PageStructure, H00AS2_A522PageName, H00AS2_A521PageId
               }
               , new Object[] {
               H00AS3_AGRID_nRecordCount
               }
            }
         );
         AV23Pgmname = "Trn_AppVersionPageWC";
      ...
      private Guid[] H00AS2_A543AppVersionId ;
      private string[] H00AS2_A545PageType ;
      private string[] H00AS2_A523PageStructure ;
      private string[] H00AS2_A522PageName ;
      private Guid[] H00AS2_A521PageId ;
      private long[] H00AS3_AGRID_nRecordCount ;
   ...
   {
      protected Object[] conditional_H00AS2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8AppVersionId ,
                                             Guid A543AppVersionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.AppVersionId, T1.PageType, T2.PageStructure, T2.PageName, T1.PageId";
         sFromString = " FROM (Trn_AppVersionPage T1 INNER JOIN Trn_ContentPage T2 ON T2.PageId = T1.PageId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.AppVersionId = :AV8AppVersionId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.AppVersionId, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.AppVersionId DESC, T1.PageId DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.AppVersionId, T2.PageName, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.AppVersionId DESC, T2.PageName DESC, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.AppVersionId, T2.PageStructure, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.AppVersionId DESC, T2.PageStructure DESC, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.AppVersionId, T1.PageType, T1.PageId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.AppVersionId DESC, T1.PageType DESC, T1.PageId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.AppVersionId, T1.PageId";
      ...
      protected Object[] conditional_H00AS3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8AppVersionId ,
                                             Guid A543AppVersionId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (Trn_AppVersionPage T1 INNER JOIN Trn_ContentPage T2 ON T2.PageId = T1.PageId)";
         AddWhere(sWhereString, "(T1.AppVersionId = :AV8AppVersionId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00AS2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 1 :
                     return conditional_H00AS3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00AS3;
          prmH00AS3 = new Object[] {
          new ParDef("AV8AppVersionId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00AS2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AS2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00AS3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AS3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
