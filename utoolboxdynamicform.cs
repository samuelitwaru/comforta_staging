...
namespace GeneXus.Programs {
   public class utoolboxdynamicform : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "utoolboxdynamicform.aspx"+UrlEncode(StringUtil.LTrimStr(AV48WWPFormId,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV42WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.RTrim(AV10DefaultFormType)) + "," + UrlEncode(StringUtil.LTrimStr(AV49WWPFormType,1,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("utoolboxdynamicform.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "utoolboxdynamicform.aspx"+UrlEncode(StringUtil.LTrimStr(AV48WWPFormId,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV42WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.RTrim(AV10DefaultFormType)) + "," + UrlEncode(StringUtil.LTrimStr(AV49WWPFormType,1,0));
         return formatLink("utoolboxdynamicform.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WBAD0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", context.GetMessage( "Confirm", ""), bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_UToolboxDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsettings_Internalname, "", context.GetMessage( "UASettings", ""), bttBtnsettings_Jsonclick, 7, context.GetMessage( "UASettings", ""), "", StyleString, ClassString, bttBtnsettings_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11ad1_client"+"'", TempTags, "", 2, "HLP_UToolboxDynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_42_AD2( true) ;
         }
         else
         {
            wb_table1_42_AD2( false) ;
         }
         return  ;
      }

      protected void wb_table1_42_AD2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void PAAD2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "utoolboxdynamicform.aspx")), "utoolboxdynamicform.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "utoolboxdynamicform.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E14AD2( )
      {
         ...
         if ( StringUtil.StrCmp(AV16HttpRequest.Method, "GET") == 0 )
         {
            ...
            {
               A206WWPFormId = H00AD2_A206WWPFormId[0];
               A207WWPFormVersionNumber = H00AD2_A207WWPFormVersionNumber[0];
      ...
      protected void E18AD2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void wb_table1_42_AD2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_42_AD2e( true) ;
         }
         else
         {
            wb_table1_42_AD2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202521310365242", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("utoolboxdynamicform.js", "?202521310365243", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOSETTINGS'","""{"handler":"E11AD1","iparms":[]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13AD2","iparms":[{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E15AD2","iparms":[{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("VDYNAMICSECTIONTOUPDATE.CLICK","""{"handler":"E17AD2","iparms":[{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV42WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true},{"av":"cmbavDynamicsectiontoupdate"},{"av":"AV11DynamicSectionToUpdate","fld":"vDYNAMICSECTIONTOUPDATE","pic":"ZZZ9"}]""");
         setEventMetadata("VDYNAMICSECTIONTOUPDATE.CLICK",""","oparms":[{"av":"AV43WWPForm","fld":"vWWPFORM"},{"ctrl":"WCWWP_DYNAMICFORMFS_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12AD2","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         H00AD2_A206WWPFormId = new short[1] ;
         H00AD2_A207WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.utoolboxdynamicform__default(),
            new Object[][] {
                new Object[] {
               H00AD2_A206WWPFormId, H00AD2_A207WWPFormVersionNumber
               }
            }
         );
      ...
      private short[] H00AD2_A206WWPFormId ;
      private short[] H00AD2_A207WWPFormVersionNumber ;
   ...
   public class utoolboxdynamicform__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00AD2", "SELECT WWPFormId, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = :AV48WWPFormId ORDER BY WWPFormId, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AD2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
