...
namespace GeneXus.Programs {
   public class trn_residentpackagegeneral : GXWebComponent
   {
      ...
      {
         this.A554ResidentPackageId = aP0_ResidentPackageId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A554ResidentPackageId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_residentpackagegeneral.aspx"+UrlEncode(A554ResidentPackageId.ToString());
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA554ResidentPackageId", wcpOA554ResidentPackageId.ToString());
      }
      ...
      protected void WBB00( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtResidentPackageName_Internalname, A557ResidentPackageName, StringUtil.RTrim( context.localUtil.Format( A557ResidentPackageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentPackageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtResidentPackageName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_ResidentPackageGeneral.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSG_OrganisationId_Internalname, A556SG_OrganisationId.ToString(), A556SG_OrganisationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSG_OrganisationId_Jsonclick, 0, "Attribute", "", "", "", "", edtSG_OrganisationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackageGeneral.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSG_LocationId_Internalname, A555SG_LocationId.ToString(), A555SG_LocationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSG_LocationId_Jsonclick, 0, "Attribute", "", "", "", "", edtSG_LocationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AssignAttri(sPrefix, false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
      }
      ...
      protected void RFB02( )
      {
         ...
         {
            /* Using cursor H00B02 */
            pr_default.execute(0, new Object[] {A554ResidentPackageId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A555SG_LocationId = H00B02_A555SG_LocationId[0];
               AssignAttri(sPrefix, false, "A555SG_LocationId", A555SG_LocationId.ToString());
               A556SG_OrganisationId = H00B02_A556SG_OrganisationId[0];
               AssignAttri(sPrefix, false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
               A559ResidentPackageDefault = H00B02_A559ResidentPackageDefault[0];
               AssignAttri(sPrefix, false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
               A557ResidentPackageName = H00B02_A557ResidentPackageName[0];
               AssignAttri(sPrefix, false, "A557ResidentPackageName", A557ResidentPackageName);
               /* Execute user event: Load */
               E12B02 ();
      ...
      protected void STRUPB00( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA554ResidentPackageId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA554ResidentPackageId"));
      ...
      protected void E12B02( )
      {
         ...
         new trn_residentpackageloaddvcombo(context ).execute(  "ResidentPackageModules",  "UPD",  A554ResidentPackageId, out  AV15ComboSelectedValue, out  AV12ResidentPackageModules_Description, out  GXt_objcol_SdtDVB_SDTComboData_Item1) ;
         AssignAttri(sPrefix, false, "AV12ResidentPackageModules_Description", AV12ResidentPackageModules_Description);
         ...
         while ( AV19GXV1 <= AV17ComboSelectedItems.Count )
         {
            ...
            {
               AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV13Combo_Data.Item(AV20GXV2));
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA554ResidentPackageId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A554ResidentPackageId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
         }
         wcpOA554ResidentPackageId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA554ResidentPackageId"));
         if ( ! GetJustCreated( ) && ( ( A554ResidentPackageId != wcpOA554ResidentPackageId ) ) )
         {
            setjustcreated();
         }
         wcpOA554ResidentPackageId = A554ResidentPackageId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA554ResidentPackageId = cgiGet( sPrefix+"A554ResidentPackageId_CTRL");
         if ( StringUtil.Len( sCtrlA554ResidentPackageId) > 0 )
         {
            A554ResidentPackageId = StringUtil.StrToGuid( cgiGet( sCtrlA554ResidentPackageId));
            AssignAttri(sPrefix, false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
         }
         else
         {
            A554ResidentPackageId = StringUtil.StrToGuid( cgiGet( sPrefix+"A554ResidentPackageId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A554ResidentPackageId_PARM", A554ResidentPackageId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA554ResidentPackageId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A554ResidentPackageId_CTRL", StringUtil.RTrim( sCtrlA554ResidentPackageId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253121515599", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_residentpackagegeneral.js", "?20253121515599", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A554ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
      ...
      {
         wcpOA554ResidentPackageId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV21Pgmname = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B02_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00B02_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         H00B02_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         H00B02_A559ResidentPackageDefault = new bool[] {false} ;
         H00B02_A557ResidentPackageName = new string[] {""} ;
         ...
         sCtrlA554ResidentPackageId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentpackagegeneral__default(),
            new Object[][] {
                new Object[] {
               H00B02_A554ResidentPackageId, H00B02_A555SG_LocationId, H00B02_A556SG_OrganisationId, H00B02_A559ResidentPackageDefault, H00B02_A557ResidentPackageName
               }
            }
         );
         AV21Pgmname = "Trn_ResidentPackageGeneral";
      ...
      private string sCtrlA554ResidentPackageId ;
      ...
      private Guid wcpOA554ResidentPackageId ;
      ...
      private Guid[] H00B02_A554ResidentPackageId ;
      private Guid[] H00B02_A555SG_LocationId ;
      private Guid[] H00B02_A556SG_OrganisationId ;
      private bool[] H00B02_A559ResidentPackageDefault ;
      private string[] H00B02_A557ResidentPackageName ;
   ...
   public class trn_residentpackagegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B02", "SELECT ResidentPackageId, SG_LocationId, SG_OrganisationId, ResidentPackageDefault, ResidentPackageName FROM Trn_ResidentPackage WHERE ResidentPackageId = :ResidentPackageId ORDER BY ResidentPackageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B02,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
