...
namespace GeneXus.Programs {
   public class prc_getuseridfromaccesstoken : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_gam.getStatus(0) != 101) )
         {
            ...
            A484sesapptokenexp = P009K2_A484sesapptokenexp[0];
            A468userguid = P009K2_A468userguid[0];
            A469sesdate = P009K2_A469sesdate[0];
            A461repid = P009K2_A461repid[0];
            if ( A484sesapptokenexp > DateTimeUtil.ServerNow( context, pr_default) )
            {
      ...
      public override void initialize( )
      {
         ...
         P009K2_A484sesapptokenexp = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_getuseridfromaccesstoken__gam(),
            new Object[][] {
                new Object[] {
               P009K2_A460sestoken, P009K2_A484sesapptokenexp, P009K2_A468userguid, P009K2_A469sesdate, P009K2_A461repid
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getuseridfromaccesstoken__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private DateTime[] P009K2_A484sesapptokenexp ;
   ...
   public class prc_getuseridfromaccesstoken__gam : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P009K2", "SELECT sestoken, sesapptokenexp, userguid, sesdate, repid FROM gam.session WHERE sestoken = ( :AV8access_token) ORDER BY sesdate DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009K2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class prc_getuseridfromaccesstoken__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
