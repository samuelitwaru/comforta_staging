...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_mdatagrid_remove_wc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121117355332", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mdatagrid_remove_wc.js", "?2024121117355333", false, true);
