   ...
   public class wwp_forminstanceww : GXDataArea
   {
      ...
      protected void E14202( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            {
               AV26TFWWPFormInstanceDate = context.localUtil.CToT( Ddo_grid_Filteredtext_get, 2);
               AssignAttri("", false, "AV26TFWWPFormInstanceDate", context.localUtil.TToC( AV26TFWWPFormInstanceDate, 8, 5, 0, 3, "/", ":", " "));
               AV27TFWWPFormInstanceDate_To = context.localUtil.CToT( Ddo_grid_Filteredtextto_get, 2);
               AssignAttri("", false, "AV27TFWWPFormInstanceDate_To", context.localUtil.TToC( AV27TFWWPFormInstanceDate_To, 8, 5, 0, 3, "/", ":", " "));
      ...
      protected void S182( )
      {
         ...
         while ( AV68GXV1 <= AV9GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV26TFWWPFormInstanceDate = context.localUtil.CToT( AV10GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri("", false, "AV26TFWWPFormInstanceDate", context.localUtil.TToC( AV26TFWWPFormInstanceDate, 8, 5, 0, 3, "/", ":", " "));
               AV27TFWWPFormInstanceDate_To = context.localUtil.CToT( AV10GridStateFilterValue.gxTpr_Valueto, 2);
               AssignAttri("", false, "AV27TFWWPFormInstanceDate_To", context.localUtil.TToC( AV27TFWWPFormInstanceDate_To, 8, 5, 0, 3, "/", ":", " "));
         ...
         Ddo_grid_Filteredtext_set = ((0==AV24TFWWPFormInstanceId) ? "" : StringUtil.Str( (decimal)(AV24TFWWPFormInstanceId), 6, 0))+"|"+((DateTime.MinValue==AV26TFWWPFormInstanceDate) ? "" : context.localUtil.DToC( AV28DDO_WWPFormInstanceDateAuxDate, 2, "/"))+"|"+((0==AV31TFWWPFormVersionNumber) ? "" : StringUtil.Str( (decimal)(AV31TFWWPFormVersionNumber), 4, 0))+"|"+GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
         Ddo_grid_Filteredtextto_set = ((0==AV25TFWWPFormInstanceId_To) ? "" : StringUtil.Str( (decimal)(AV25TFWWPFormInstanceId_To), 6, 0))+"|"+((DateTime.MinValue==AV27TFWWPFormInstanceDate_To) ? "" : context.localUtil.DToC( AV29DDO_WWPFormInstanceDateAuxDateTo, 2, "/"))+"|"+((0==AV32TFWWPFormVersionNumber_To) ? "" : StringUtil.Str( (decimal)(AV32TFWWPFormVersionNumber_To), 4, 0))+"|";
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "FilteredTextTo_set", Ddo_grid_Filteredtextto_set);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121713272839", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_forminstanceww.js", "?2024121713272841", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl35( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.TToC( A239WWPFormInstanceDate, 10, 8, 0, 3, "/", ":", " ")));
      ...
      public override void initialize( )
      {
         ...
         lV66Workwithplus_dynamicforms_wwp_forminstancewwds_9_tfwwpuserextendedfullname = "";
         AV59Workwithplus_dynamicforms_wwp_forminstancewwds_2_filterfulltext = "";
         AV62Workwithplus_dynamicforms_wwp_forminstancewwds_5_tfwwpforminstancedate = (DateTime)(DateTime.MinValue);
         AV63Workwithplus_dynamicforms_wwp_forminstancewwds_6_tfwwpforminstancedate_to = (DateTime)(DateTime.MinValue);
         AV67Workwithplus_dynamicforms_wwp_forminstancewwds_10_tfwwpuserextendedfullname_sel = "";
         AV66Workwithplus_dynamicforms_wwp_forminstancewwds_9_tfwwpuserextendedfullname = "";
   ...
   public class wwp_forminstanceww__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV62Workwithplus_dynamicforms_wwp_forminstancewwds_5_tfwwpformi",GXType.DateTime,8,5) ,
          new ParDef("AV63Workwithplus_dynamicforms_wwp_forminstancewwds_6_tfwwpformi",GXType.DateTime,8,5) ,
