...
namespace GeneXus.Programs {
   public class trn_residentpackagetrn_residentwc : GXWebComponent
   {
      ...
      protected void WBB10( )
      {
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtResidentPackageId_Internalname, A554ResidentPackageId.ToString(), A554ResidentPackageId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentPackageId_Jsonclick, 0, "Attribute", "", "", "", "", edtResidentPackageId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackageTrn_ResidentWC.htm");
            /* User Defined Control */
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A554ResidentPackageId = H00B12_A554ResidentPackageId[0];
            n554ResidentPackageId = H00B12_n554ResidentPackageId[0];
            AssignAttri(sPrefix, false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
            A376ResidentPhoneNumber = H00B12_A376ResidentPhoneNumber[0];
            A375ResidentPhoneCode = H00B12_A375ResidentPhoneCode[0];
            A99MedicalIndicationName = H00B12_A99MedicalIndicationName[0];
            A98MedicalIndicationId = H00B12_A98MedicalIndicationId[0];
            n98MedicalIndicationId = H00B12_n98MedicalIndicationId[0];
            A97ResidentTypeName = H00B12_A97ResidentTypeName[0];
            A96ResidentTypeId = H00B12_A96ResidentTypeId[0];
            n96ResidentTypeId = H00B12_n96ResidentTypeId[0];
            A71ResidentGUID = H00B12_A71ResidentGUID[0];
            A73ResidentBirthDate = H00B12_A73ResidentBirthDate[0];
            A444ResidentHomePhone = H00B12_A444ResidentHomePhone[0];
            A70ResidentPhone = H00B12_A70ResidentPhone[0];
            A358ResidentAddressLine2 = H00B12_A358ResidentAddressLine2[0];
            A357ResidentAddressLine1 = H00B12_A357ResidentAddressLine1[0];
            A356ResidentZipCode = H00B12_A356ResidentZipCode[0];
            A355ResidentCity = H00B12_A355ResidentCity[0];
            A354ResidentCountry = H00B12_A354ResidentCountry[0];
            A68ResidentGender = H00B12_A68ResidentGender[0];
            A67ResidentEmail = H00B12_A67ResidentEmail[0];
            A66ResidentInitials = H00B12_A66ResidentInitials[0];
            A65ResidentLastName = H00B12_A65ResidentLastName[0];
            A64ResidentGivenName = H00B12_A64ResidentGivenName[0];
            A63ResidentBsnNumber = H00B12_A63ResidentBsnNumber[0];
            A72ResidentSalutation = H00B12_A72ResidentSalutation[0];
            A11OrganisationId = H00B12_A11OrganisationId[0];
            A29LocationId = H00B12_A29LocationId[0];
            A62ResidentId = H00B12_A62ResidentId[0];
            A99MedicalIndicationName = H00B12_A99MedicalIndicationName[0];
            A97ResidentTypeName = H00B12_A97ResidentTypeName[0];
      ...
      protected void RFB12( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A554ResidentPackageId = H00B13_A554ResidentPackageId[0];
               n554ResidentPackageId = H00B13_n554ResidentPackageId[0];
               AssignAttri(sPrefix, false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
               A376ResidentPhoneNumber = H00B13_A376ResidentPhoneNumber[0];
               A375ResidentPhoneCode = H00B13_A375ResidentPhoneCode[0];
               A99MedicalIndicationName = H00B13_A99MedicalIndicationName[0];
               A98MedicalIndicationId = H00B13_A98MedicalIndicationId[0];
               n98MedicalIndicationId = H00B13_n98MedicalIndicationId[0];
               A97ResidentTypeName = H00B13_A97ResidentTypeName[0];
               A96ResidentTypeId = H00B13_A96ResidentTypeId[0];
               n96ResidentTypeId = H00B13_n96ResidentTypeId[0];
               A71ResidentGUID = H00B13_A71ResidentGUID[0];
               A73ResidentBirthDate = H00B13_A73ResidentBirthDate[0];
               A444ResidentHomePhone = H00B13_A444ResidentHomePhone[0];
               A70ResidentPhone = H00B13_A70ResidentPhone[0];
               A358ResidentAddressLine2 = H00B13_A358ResidentAddressLine2[0];
               A357ResidentAddressLine1 = H00B13_A357ResidentAddressLine1[0];
               A356ResidentZipCode = H00B13_A356ResidentZipCode[0];
               A355ResidentCity = H00B13_A355ResidentCity[0];
               A354ResidentCountry = H00B13_A354ResidentCountry[0];
               A68ResidentGender = H00B13_A68ResidentGender[0];
               A67ResidentEmail = H00B13_A67ResidentEmail[0];
               A66ResidentInitials = H00B13_A66ResidentInitials[0];
               A65ResidentLastName = H00B13_A65ResidentLastName[0];
               A64ResidentGivenName = H00B13_A64ResidentGivenName[0];
               A63ResidentBsnNumber = H00B13_A63ResidentBsnNumber[0];
               A72ResidentSalutation = H00B13_A72ResidentSalutation[0];
               A11OrganisationId = H00B13_A11OrganisationId[0];
               A29LocationId = H00B13_A29LocationId[0];
               A62ResidentId = H00B13_A62ResidentId[0];
               A99MedicalIndicationName = H00B13_A99MedicalIndicationName[0];
               A97ResidentTypeName = H00B13_A97ResidentTypeName[0];
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) || ( ( StringUtil.Like( StringUtil.Lower( A64ResidentGivenName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A65ResidentLastName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A67ResidentEmail) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "male", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A68ResidentGender, "Male") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "female", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A68ResidentGender, "Female") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "other", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A68ResidentGender, "Other") == 0 ) ) || ( StringUtil.Like( StringUtil.Lower( A70ResidentPhone) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) ) )
               {
      ...
      protected void E17B12( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV33Pgmname, out  GXt_char3) ;
      ...
      protected void E11B12( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_ResidentPackageTrn_ResidentWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV33Pgmname+"GridState",  AV19ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_ResidentPackageTrn_ResidentWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S182( )
      {
         ...
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV34GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253121553825", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_residentpackagetrn_residentwc.js", "?20253121553825", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtResidentZipCode_Internalname,(string)A356ResidentZipCode,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtResidentZipCode_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtResidentAddressLine2_Internalname,(string)A358ResidentAddressLine2,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtResidentAddressLine2_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl35( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A444ResidentHomePhone)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18B12","iparms":[{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV31IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV16FilterFullText = "";
         H00B12_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00B12_n554ResidentPackageId = new bool[] {false} ;
         H00B12_A376ResidentPhoneNumber = new string[] {""} ;
         H00B12_A375ResidentPhoneCode = new string[] {""} ;
         H00B12_A99MedicalIndicationName = new string[] {""} ;
         H00B12_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H00B12_n98MedicalIndicationId = new bool[] {false} ;
         H00B12_A97ResidentTypeName = new string[] {""} ;
         H00B12_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H00B12_n96ResidentTypeId = new bool[] {false} ;
         H00B12_A71ResidentGUID = new string[] {""} ;
         H00B12_A73ResidentBirthDate = new DateTime[] {DateTime.MinValue} ;
         H00B12_A444ResidentHomePhone = new string[] {""} ;
         H00B12_A70ResidentPhone = new string[] {""} ;
         H00B12_A358ResidentAddressLine2 = new string[] {""} ;
         H00B12_A357ResidentAddressLine1 = new string[] {""} ;
         H00B12_A356ResidentZipCode = new string[] {""} ;
         H00B12_A355ResidentCity = new string[] {""} ;
         H00B12_A354ResidentCountry = new string[] {""} ;
         H00B12_A68ResidentGender = new string[] {""} ;
         H00B12_A67ResidentEmail = new string[] {""} ;
         H00B12_A66ResidentInitials = new string[] {""} ;
         H00B12_A65ResidentLastName = new string[] {""} ;
         H00B12_A64ResidentGivenName = new string[] {""} ;
         H00B12_A63ResidentBsnNumber = new string[] {""} ;
         H00B12_A72ResidentSalutation = new string[] {""} ;
         H00B12_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B12_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B12_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00B13_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00B13_n554ResidentPackageId = new bool[] {false} ;
         H00B13_A376ResidentPhoneNumber = new string[] {""} ;
         H00B13_A375ResidentPhoneCode = new string[] {""} ;
         H00B13_A99MedicalIndicationName = new string[] {""} ;
         H00B13_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H00B13_n98MedicalIndicationId = new bool[] {false} ;
         H00B13_A97ResidentTypeName = new string[] {""} ;
         H00B13_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H00B13_n96ResidentTypeId = new bool[] {false} ;
         H00B13_A71ResidentGUID = new string[] {""} ;
         H00B13_A73ResidentBirthDate = new DateTime[] {DateTime.MinValue} ;
         H00B13_A444ResidentHomePhone = new string[] {""} ;
         H00B13_A70ResidentPhone = new string[] {""} ;
         H00B13_A358ResidentAddressLine2 = new string[] {""} ;
         H00B13_A357ResidentAddressLine1 = new string[] {""} ;
         H00B13_A356ResidentZipCode = new string[] {""} ;
         H00B13_A355ResidentCity = new string[] {""} ;
         H00B13_A354ResidentCountry = new string[] {""} ;
         H00B13_A68ResidentGender = new string[] {""} ;
         H00B13_A67ResidentEmail = new string[] {""} ;
         H00B13_A66ResidentInitials = new string[] {""} ;
         H00B13_A65ResidentLastName = new string[] {""} ;
         H00B13_A64ResidentGivenName = new string[] {""} ;
         H00B13_A63ResidentBsnNumber = new string[] {""} ;
         H00B13_A72ResidentSalutation = new string[] {""} ;
         H00B13_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B13_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B13_A62ResidentId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentpackagetrn_residentwc__default(),
            new Object[][] {
                new Object[] {
               H00B12_A554ResidentPackageId, H00B12_n554ResidentPackageId, H00B12_A376ResidentPhoneNumber, H00B12_A375ResidentPhoneCode, H00B12_A99MedicalIndicationName, H00B12_A98MedicalIndicationId, H00B12_n98MedicalIndicationId, H00B12_A97ResidentTypeName, H00B12_A96ResidentTypeId, H00B12_n96ResidentTypeId,
               H00B12_A71ResidentGUID, H00B12_A73ResidentBirthDate, H00B12_A444ResidentHomePhone, H00B12_A70ResidentPhone, H00B12_A358ResidentAddressLine2, H00B12_A357ResidentAddressLine1, H00B12_A356ResidentZipCode, H00B12_A355ResidentCity, H00B12_A354ResidentCountry, H00B12_A68ResidentGender,
               H00B12_A67ResidentEmail, H00B12_A66ResidentInitials, H00B12_A65ResidentLastName, H00B12_A64ResidentGivenName, H00B12_A63ResidentBsnNumber, H00B12_A72ResidentSalutation, H00B12_A11OrganisationId, H00B12_A29LocationId, H00B12_A62ResidentId
               }
               , new Object[] {
               H00B13_A554ResidentPackageId, H00B13_n554ResidentPackageId, H00B13_A376ResidentPhoneNumber, H00B13_A375ResidentPhoneCode, H00B13_A99MedicalIndicationName, H00B13_A98MedicalIndicationId, H00B13_n98MedicalIndicationId, H00B13_A97ResidentTypeName, H00B13_A96ResidentTypeId, H00B13_n96ResidentTypeId,
               H00B13_A71ResidentGUID, H00B13_A73ResidentBirthDate, H00B13_A444ResidentHomePhone, H00B13_A70ResidentPhone, H00B13_A358ResidentAddressLine2, H00B13_A357ResidentAddressLine1, H00B13_A356ResidentZipCode, H00B13_A355ResidentCity, H00B13_A354ResidentCountry, H00B13_A68ResidentGender,
               H00B13_A67ResidentEmail, H00B13_A66ResidentInitials, H00B13_A65ResidentLastName, H00B13_A64ResidentGivenName, H00B13_A63ResidentBsnNumber, H00B13_A72ResidentSalutation, H00B13_A11OrganisationId, H00B13_A29LocationId, H00B13_A62ResidentId
               }
            }
         );
         AV33Pgmname = "Trn_ResidentPackageTrn_ResidentWC";
      ...
      private Guid[] H00B12_A554ResidentPackageId ;
      private bool[] H00B12_n554ResidentPackageId ;
      private string[] H00B12_A376ResidentPhoneNumber ;
      private string[] H00B12_A375ResidentPhoneCode ;
      private string[] H00B12_A99MedicalIndicationName ;
      private Guid[] H00B12_A98MedicalIndicationId ;
      private bool[] H00B12_n98MedicalIndicationId ;
      private string[] H00B12_A97ResidentTypeName ;
      private Guid[] H00B12_A96ResidentTypeId ;
      private bool[] H00B12_n96ResidentTypeId ;
      private string[] H00B12_A71ResidentGUID ;
      private DateTime[] H00B12_A73ResidentBirthDate ;
      private string[] H00B12_A444ResidentHomePhone ;
      private string[] H00B12_A70ResidentPhone ;
      private string[] H00B12_A358ResidentAddressLine2 ;
      private string[] H00B12_A357ResidentAddressLine1 ;
      private string[] H00B12_A356ResidentZipCode ;
      private string[] H00B12_A355ResidentCity ;
      private string[] H00B12_A354ResidentCountry ;
      private string[] H00B12_A68ResidentGender ;
      private string[] H00B12_A67ResidentEmail ;
      private string[] H00B12_A66ResidentInitials ;
      private string[] H00B12_A65ResidentLastName ;
      private string[] H00B12_A64ResidentGivenName ;
      private string[] H00B12_A63ResidentBsnNumber ;
      private string[] H00B12_A72ResidentSalutation ;
      private Guid[] H00B12_A11OrganisationId ;
      private Guid[] H00B12_A29LocationId ;
      private Guid[] H00B12_A62ResidentId ;
      private Guid[] H00B13_A554ResidentPackageId ;
      private bool[] H00B13_n554ResidentPackageId ;
      private string[] H00B13_A376ResidentPhoneNumber ;
      private string[] H00B13_A375ResidentPhoneCode ;
      private string[] H00B13_A99MedicalIndicationName ;
      private Guid[] H00B13_A98MedicalIndicationId ;
      private bool[] H00B13_n98MedicalIndicationId ;
      private string[] H00B13_A97ResidentTypeName ;
      private Guid[] H00B13_A96ResidentTypeId ;
      private bool[] H00B13_n96ResidentTypeId ;
      private string[] H00B13_A71ResidentGUID ;
      private DateTime[] H00B13_A73ResidentBirthDate ;
      private string[] H00B13_A444ResidentHomePhone ;
      private string[] H00B13_A70ResidentPhone ;
      private string[] H00B13_A358ResidentAddressLine2 ;
      private string[] H00B13_A357ResidentAddressLine1 ;
      private string[] H00B13_A356ResidentZipCode ;
      private string[] H00B13_A355ResidentCity ;
      private string[] H00B13_A354ResidentCountry ;
      private string[] H00B13_A68ResidentGender ;
      private string[] H00B13_A67ResidentEmail ;
      private string[] H00B13_A66ResidentInitials ;
      private string[] H00B13_A65ResidentLastName ;
      private string[] H00B13_A64ResidentGivenName ;
      private string[] H00B13_A63ResidentBsnNumber ;
      private string[] H00B13_A72ResidentSalutation ;
      private Guid[] H00B13_A11OrganisationId ;
      private Guid[] H00B13_A29LocationId ;
      private Guid[] H00B13_A62ResidentId ;
   ...
   public class trn_residentpackagetrn_residentwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00B12(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] );
               case 1 :
                     return conditional_H00B13(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00B13", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B13,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
