...
namespace GeneXus.Programs {
   public class wc_productservice : GXDataArea
   {
      ...
      protected void WBAK0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_40_AK2( true) ;
         }
         else
         {
            wb_table1_40_AK2( false) ;
         }
         return  ;
      }

      protected void wb_table1_40_AK2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table2_72_AK2( true) ;
         }
         else
         {
            wb_table2_72_AK2( false) ;
         }
         return  ;
      }

      protected void wb_table2_72_AK2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table3_89_AK2( true) ;
         }
         else
         {
            wb_table3_89_AK2( false) ;
         }
         return  ;
      }

      protected void wb_table3_89_AK2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuseractionadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(180), 3, 0)+","+"null"+");", context.GetMessage( "Save", ""), bttBtnuseractionadd_Jsonclick, 7, context.GetMessage( "Save", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11ak1_client"+"'", TempTags, "", 2, "HLP_WC_ProductService.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void GXDSVvPRODUCTSERVICEGROUPAK2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDSVvPRODUCTSERVICEGROUP_dataAK2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvPRODUCTSERVICEGROUP_htmlAK2( )
      {
      ...
      protected void GXDSVvPRODUCTSERVICEGROUP_dataAK2( )
      {
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            GXVvPRODUCTSERVICEGROUP_htmlAK2( ) ;
            dynload_actions( ) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV43SupplierGenId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         GXt_boolean7 = false;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "<Check_Is_Authenticated>", out  GXt_boolean7) ;
         ...
         {
            A11OrganisationId = H00AK2_A11OrganisationId[0];
            n11OrganisationId = H00AK2_n11OrganisationId[0];
            A42SupplierGenId = H00AK2_A42SupplierGenId[0];
            A44SupplierGenCompanyName = H00AK2_A44SupplierGenCompanyName[0];
            AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A49SupplierAgbId = H00AK3_A49SupplierAgbId[0];
            A51SupplierAgbName = H00AK3_A51SupplierAgbName[0];
            AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S202( )
      {
         ...
         if ( ! AV42noFilterAgb && ( StringUtil.StrCmp(AV13ProductServiceGroup, " AGB Supplier") == 0 ) )
         {
            ...
            {
               A49SupplierAgbId = H00AK4_A49SupplierAgbId[0];
               A51SupplierAgbName = H00AK4_A51SupplierAgbName[0];
               AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV31Combo_DataItem.gxTpr_Id = StringUtil.Trim( A49SupplierAgbId.ToString());
               AV31Combo_DataItem.gxTpr_Title = A51SupplierAgbName;
               AV46SupplierAgbId_Data.Add(AV31Combo_DataItem, 0);
         ...
         else if ( ( AV42noFilterAgb ) && ( StringUtil.StrCmp(AV13ProductServiceGroup, " AGB Supplier") == 0 ) )
         {
            ...
            {
               A49SupplierAgbId = H00AK5_A49SupplierAgbId[0];
               A51SupplierAgbName = H00AK5_A51SupplierAgbName[0];
               AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV31Combo_DataItem.gxTpr_Id = StringUtil.Trim( A49SupplierAgbId.ToString());
               AV31Combo_DataItem.gxTpr_Title = A51SupplierAgbName;
               AV46SupplierAgbId_Data.Add(AV31Combo_DataItem, 0);
         ...
         else if ( ! AV40noFilterGen && ( StringUtil.StrCmp(AV13ProductServiceGroup, "General Supplier") == 0 ) )
         {
            ...
            /* Using cursor H00AK6 */
            pr_default.execute(4, new Object[] {AV47OrganisationId});
            while ( (pr_default.getStatus(4) != 101) )
            {
               A42SupplierGenId = H00AK6_A42SupplierGenId[0];
               A11OrganisationId = H00AK6_A11OrganisationId[0];
               n11OrganisationId = H00AK6_n11OrganisationId[0];
               A44SupplierGenCompanyName = H00AK6_A44SupplierGenCompanyName[0];
               AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV31Combo_DataItem.gxTpr_Id = StringUtil.Trim( A42SupplierGenId.ToString());
               AV31Combo_DataItem.gxTpr_Title = A44SupplierGenCompanyName;
               AV43SupplierGenId_Data.Add(AV31Combo_DataItem, 0);
         ...
         else if ( ( AV40noFilterGen ) && ( StringUtil.StrCmp(AV13ProductServiceGroup, "General Supplier") == 0 ) )
         {
            ...
            {
               A42SupplierGenId = H00AK7_A42SupplierGenId[0];
               A44SupplierGenCompanyName = H00AK7_A44SupplierGenCompanyName[0];
               AV31Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV31Combo_DataItem.gxTpr_Id = StringUtil.Trim( A42SupplierGenId.ToString());
               AV31Combo_DataItem.gxTpr_Title = A44SupplierGenCompanyName;
               AV43SupplierGenId_Data.Add(AV31Combo_DataItem, 0);
      ...
      protected void wb_table3_89_AK2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_89_AK2e( true) ;
         }
         else
         {
            wb_table3_89_AK2e( false) ;
         }
      }

      protected void wb_table2_72_AK2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_72_AK2e( true) ;
         }
         else
         {
            wb_table2_72_AK2e( false) ;
         }
      }

      protected void wb_table1_40_AK2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_40_AK2e( true) ;
         }
         else
         {
            wb_table1_40_AK2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202522112331722", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wc_productservice.js", "?202522112331723", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDSDT_CALLTOACTIONS.LOAD","""{"handler":"E19AK2","iparms":[]""");
         ...
         setEventMetadata("'DOFINISH'","""{"handler":"E13AK1","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONADD'","""{"handler":"E11AK1","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONCLEAR'","""{"handler":"E12AK1","iparms":[]}""");
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E20AK2","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV51GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("COMBO_LOCATIONDYNAMICFORMID.ONOPTIONCLICKED","""{"handler":"E16AK2","iparms":[{"av":"Combo_locationdynamicformid_Selectedvalue_get","ctrl":"COMBO_LOCATIONDYNAMICFORMID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("COMBO_SUPPLIERAGBID.ONOPTIONCLICKED","""{"handler":"E14AK2","iparms":[{"av":"Combo_supplieragbid_Selectedvalue_get","ctrl":"COMBO_SUPPLIERAGBID","prop":"SelectedValue_get"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV46SupplierAgbId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV43SupplierGenId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV30DDO_TitleSettingsIcons = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         AV34PhoneCode_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV29LocationDynamicFormId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         H00AK2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00AK2_n11OrganisationId = new bool[] {false} ;
         H00AK2_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00AK2_A44SupplierGenCompanyName = new string[] {""} ;
         A49SupplierAgbId = Guid.Empty;
         H00AK3_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H00AK3_A51SupplierAgbName = new string[] {""} ;
         A51SupplierAgbName = "";
         Combo_supplieragbid_Selectedvalue_set = "";
         ucCombo_supplieragbid = new GXUserControl();
         H00AK4_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H00AK4_A51SupplierAgbName = new string[] {""} ;
         H00AK5_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H00AK5_A51SupplierAgbName = new string[] {""} ;
         H00AK6_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00AK6_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00AK6_n11OrganisationId = new bool[] {false} ;
         H00AK6_A44SupplierGenCompanyName = new string[] {""} ;
         H00AK7_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00AK7_A44SupplierGenCompanyName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wc_productservice__default(),
            new Object[][] {
                new Object[] {
               H00AK2_A11OrganisationId, H00AK2_n11OrganisationId, H00AK2_A42SupplierGenId, H00AK2_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00AK3_A49SupplierAgbId, H00AK3_A51SupplierAgbName
               }
               , new Object[] {
               H00AK4_A49SupplierAgbId, H00AK4_A51SupplierAgbName
               }
               , new Object[] {
               H00AK5_A49SupplierAgbId, H00AK5_A51SupplierAgbName
               }
               , new Object[] {
               H00AK6_A42SupplierGenId, H00AK6_A11OrganisationId, H00AK6_n11OrganisationId, H00AK6_A44SupplierGenCompanyName
               }
               , new Object[] {
               H00AK7_A42SupplierGenId, H00AK7_A44SupplierGenCompanyName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV46SupplierAgbId_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV43SupplierGenId_Data ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV30DDO_TitleSettingsIcons ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV34PhoneCode_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV29LocationDynamicFormId_Data ;
      ...
      private Guid[] H00AK2_A11OrganisationId ;
      private bool[] H00AK2_n11OrganisationId ;
      private Guid[] H00AK2_A42SupplierGenId ;
      private string[] H00AK2_A44SupplierGenCompanyName ;
      private Guid[] H00AK3_A49SupplierAgbId ;
      private string[] H00AK3_A51SupplierAgbName ;
      private Guid[] H00AK4_A49SupplierAgbId ;
      private string[] H00AK4_A51SupplierAgbName ;
      private Guid[] H00AK5_A49SupplierAgbId ;
      private string[] H00AK5_A51SupplierAgbName ;
      private Guid[] H00AK6_A42SupplierGenId ;
      private Guid[] H00AK6_A11OrganisationId ;
      private bool[] H00AK6_n11OrganisationId ;
      private string[] H00AK6_A44SupplierGenCompanyName ;
      private Guid[] H00AK7_A42SupplierGenId ;
      private string[] H00AK7_A44SupplierGenCompanyName ;
   ...
   {
      protected Object[] conditional_H00AK3( IGxContext context ,
      ...
      protected Object[] conditional_H00AK6( IGxContext context ,
                                             ...
                                             Guid AV47OrganisationId )
      {
         ...
         AddWhere(sWhereString, "(Not "+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV38PreferredGenSuppliers, "SupplierGenId IN (", ")")+")");
         AddWhere(sWhereString, "(OrganisationId = :AV47OrganisationId)");
         scmdbuf += sWhereString;
      ...
      protected Object[] conditional_H00AK7( IGxContext context ,
                                             Guid A42SupplierGenId ,
                                             GxSimpleCollection<Guid> AV38PreferredGenSuppliers )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H00AK3(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
               case 3 :
                     return conditional_H00AK5(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
               case 4 :
                     return conditional_H00AK6(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 5 :
                     return conditional_H00AK7(context, (Guid)dynConstraints[0] , (GxSimpleCollection<Guid>)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00AK2", "SELECT OrganisationId, SupplierGenId, SupplierGenCompanyName FROM Trn_SupplierGen WHERE OrganisationId = :AV47OrganisationId ORDER BY SupplierGenCompanyName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00AK3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00AK4", "SELECT SupplierAgbId, SupplierAgbName FROM Trn_SupplierAGB ORDER BY SupplierAgbName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00AK5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00AK6", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00AK7", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK7,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
