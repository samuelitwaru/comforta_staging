...
namespace GeneXus.Programs {
   public class prc_deletecascadereceptionist : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A89ReceptionistId = P00CA2_A89ReceptionistId[0];
            A11OrganisationId = P00CA2_A11OrganisationId[0];
            A29LocationId = P00CA2_A29LocationId[0];
            A95ReceptionistGAMGUID = P00CA2_A95ReceptionistGAMGUID[0];
      ...
      public override void initialize( )
      {
         ...
         P00CA2_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         P00CA2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00CA2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00CA2_A95ReceptionistGAMGUID = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadereceptionist__default(),
            new Object[][] {
                new Object[] {
               P00CA2_A89ReceptionistId, P00CA2_A11OrganisationId, P00CA2_A29LocationId, P00CA2_A95ReceptionistGAMGUID
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00CA2_A89ReceptionistId ;
      private Guid[] P00CA2_A11OrganisationId ;
      private Guid[] P00CA2_A29LocationId ;
      private string[] P00CA2_A95ReceptionistGAMGUID ;
   }
   ...
   public class prc_deletecascadereceptionist__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00CA2(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CA2", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CA2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00CA3", "SAVEPOINT gxupdate;DELETE FROM Trn_Receptionist  WHERE ReceptionistId = :ReceptionistId AND OrganisationId = :OrganisationId AND LocationId = :LocationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00CA3)
          };
       }
    }
