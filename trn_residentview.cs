   ...
   public class trn_residentview : GXDataArea
   {
      ...
      protected void E14652( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A65ResidentLastName = H00653_A65ResidentLastName[0];
            AV19GXLvl9 = 1;
      ...
      protected void E11652( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"Trn_Resident",(short)2,StringUtil.Trim( A62ResidentId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV16RecordDescription});
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(Guid)AV10ResidentId,(Guid)AV11LocationId,(Guid)AV12OrganisationId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251222144242", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentview.js", "?20251222144242", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00653_A65ResidentLastName = new string[] {""} ;
         A65ResidentLastName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentview__default(),
            new Object[][] {
               ...
               , new Object[] {
               H00653_A11OrganisationId, H00653_A29LocationId, H00653_A62ResidentId, H00653_A65ResidentLastName
               }
            }
         );
      ...
      private string[] H00653_A65ResidentLastName ;
