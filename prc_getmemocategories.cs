...
namespace GeneXus.Programs {
   public class prc_getmemocategories : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A568MemoCategoryId = P00D52_A568MemoCategoryId[0];
            A569MemoCategoryName = P00D52_A569MemoCategoryName[0];
      ...
      public override void initialize( )
      {
         ...
         P00D52_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00D52_A569MemoCategoryName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_getmemocategories__default(),
            new Object[][] {
                new Object[] {
               P00D52_A568MemoCategoryId, P00D52_A569MemoCategoryName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00D52_A568MemoCategoryId ;
      private string[] P00D52_A569MemoCategoryName ;
   ...
   public class prc_getmemocategories__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00D52", "SELECT MemoCategoryId, MemoCategoryName FROM Trn_MemoCategory ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D52,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
