...
namespace GeneXus.Programs {
   public class prc_deletecascadecalltoaction : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A395LocationDynamicFormId = P00CD2_A395LocationDynamicFormId[0];
            n395LocationDynamicFormId = P00CD2_n395LocationDynamicFormId[0];
            A58ProductServiceId = P00CD2_A58ProductServiceId[0];
            A11OrganisationId = P00CD2_A11OrganisationId[0];
            A29LocationId = P00CD2_A29LocationId[0];
            A367CallToActionId = P00CD2_A367CallToActionId[0];
            /* Using cursor P00CD3 */
      ...
      public override void initialize( )
      {
         ...
         P00CD2_A395LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         P00CD2_n395LocationDynamicFormId = new bool[] {false} ;
         P00CD2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P00CD2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00CD2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00CD2_A367CallToActionId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadecalltoaction__default(),
            new Object[][] {
                new Object[] {
               P00CD2_A395LocationDynamicFormId, P00CD2_n395LocationDynamicFormId, P00CD2_A58ProductServiceId, P00CD2_A11OrganisationId, P00CD2_A29LocationId, P00CD2_A367CallToActionId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00CD2_A395LocationDynamicFormId ;
      private bool[] P00CD2_n395LocationDynamicFormId ;
      private Guid[] P00CD2_A58ProductServiceId ;
      private Guid[] P00CD2_A11OrganisationId ;
      private Guid[] P00CD2_A29LocationId ;
      private Guid[] P00CD2_A367CallToActionId ;
   }
   ...
   public class prc_deletecascadecalltoaction__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00CD2(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] , (Guid)dynConstraints[8] , (Guid)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CD2", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CD2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00CD3", "SAVEPOINT gxupdate;DELETE FROM Trn_CallToAction  WHERE CallToActionId = :CallToActionId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00CD3)
          };
       }
    }
