...
namespace GeneXus.Programs {
   public class wp_createlocationandlicense : GXDataArea
   {
      ...
      protected void E11BG2( )
      {
         ...
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Location", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113435572", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createlocationandlicense.js", "?202532113435572", false, true);
