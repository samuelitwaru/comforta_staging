   ...
   public class trn_memocategoryview : GXDataArea
   {
      ...
      protected void RFB52( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A568MemoCategoryId = H00B52_A568MemoCategoryId[0];
               /* Execute user event: Load */
               E16B52 ();
      ...
      protected void E14B52( )
      {
         ...
         {
            A568MemoCategoryId = H00B53_A568MemoCategoryId[0];
            A569MemoCategoryName = H00B53_A569MemoCategoryName[0];
            AV17GXLvl8 = 1;
            Form.Caption = A569MemoCategoryName;
      ...
      protected void E15B52( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_MemoCategory",  StringUtil.Trim( A568MemoCategoryId.ToString())) )
         {
      ...
      protected void E11B52( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_MemoCategory",(short)2,StringUtil.Trim( A568MemoCategoryId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12B52( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_MemoCategory",StringUtil.Trim( A568MemoCategoryId.ToString()),(string)AV14RecordDescription,formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202531920412311", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memocategoryview.js", "?202531920412311", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11B52","iparms":[{"av":"A568MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12B52","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A568MemoCategoryId","fld":"MEMOCATEGORYID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13B52","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10MemoCategoryId","fld":"vMEMOCATEGORYID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B52_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B53_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00B53_A569MemoCategoryName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memocategoryview__default(),
            new Object[][] {
                new Object[] {
               H00B52_A568MemoCategoryId
               }
               , new Object[] {
               H00B53_A568MemoCategoryId, H00B53_A569MemoCategoryName
               }
            }
         );
      ...
      private Guid[] H00B52_A568MemoCategoryId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00B53_A568MemoCategoryId ;
      private string[] H00B53_A569MemoCategoryName ;
   ...
   public class trn_memocategoryview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B52", "SELECT MemoCategoryId FROM Trn_MemoCategory WHERE MemoCategoryId = :AV10MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B52,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00B53", "SELECT MemoCategoryId, MemoCategoryName FROM Trn_MemoCategory WHERE MemoCategoryId = :AV10MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B53,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
