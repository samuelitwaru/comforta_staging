...
namespace GeneXus.Programs {
   public class wp_residentdiscussion : GXDataArea
   {
      ...
      protected void E11802( )
      {
         ...
         {
            AV11WebSession.Set("WebViewResidentId", AV9ResidentId);
            ...
            if ( AV16WWP_UserExtended.Success() )
            {
               ...
               if ( AV14WWP_FormInstance.Success() )
               {
                  ...
                  AV19Description = "A filled " + AV14WWP_FormInstance.gxTpr_Wwpformtitle;
               }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412614452686", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_residentdiscussion.js", "?202412614452687", false, true);
