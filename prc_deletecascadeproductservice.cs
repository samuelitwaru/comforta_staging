...
namespace GeneXus.Programs {
   public class prc_deletecascadeproductservice : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A42SupplierGenId = P00C62_A42SupplierGenId[0];
            n42SupplierGenId = P00C62_n42SupplierGenId[0];
            A29LocationId = P00C62_A29LocationId[0];
            A58ProductServiceId = P00C62_A58ProductServiceId[0];
            A11OrganisationId = P00C62_A11OrganisationId[0];
      ...
      public override void initialize( )
      {
         ...
         P00C62_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         P00C62_n42SupplierGenId = new bool[] {false} ;
         P00C62_A29LocationId = new Guid[] {Guid.Empty} ;
         P00C62_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P00C62_A11OrganisationId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadeproductservice__default(),
            new Object[][] {
                new Object[] {
               P00C62_A42SupplierGenId, P00C62_n42SupplierGenId, P00C62_A29LocationId, P00C62_A58ProductServiceId, P00C62_A11OrganisationId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C62_A42SupplierGenId ;
      private bool[] P00C62_n42SupplierGenId ;
      private Guid[] P00C62_A29LocationId ;
      private Guid[] P00C62_A58ProductServiceId ;
      private Guid[] P00C62_A11OrganisationId ;
   }
   ...
   public class prc_deletecascadeproductservice__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C62(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C62", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C62,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C63", "SAVEPOINT gxupdate;DELETE FROM Trn_ProductService  WHERE ProductServiceId = :ProductServiceId AND LocationId = :LocationId AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C63)
          };
       }
    }
