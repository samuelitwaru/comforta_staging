...
namespace GeneXus.Programs {
   public class prc_initlocationpages2 : GXProcedure
   {
      public prc_initlocationpages2( )
      {
      ...
      public prc_initlocationpages2( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV30GXLvl4 == 0 )
         {
            ...
            {
               context.CommitDataStores("prc_initlocationpages2",pr_default);
            }
            else
            {
               AV32GXV2 = 1;
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.prc_initlocationpages2__datastore1(),
            new Object[][] {
            }
         );
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_initlocationpages2__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_initlocationpages2__default(),
            new Object[][] {
                new Object[] {
   ...
   public class prc_initlocationpages2__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class prc_initlocationpages2__gam : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
...
public class prc_initlocationpages2__default : DataStoreHelperBase, IDataStoreHelper
{
   public ICursor[] getCursors( )
   {
      cursorDefinitions();
