   ...
   public class trn_memoview : GXDataArea
   {
      ...
      protected void RFB92( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A575MemoId = H00B92_A575MemoId[0];
               /* Execute user event: Load */
               E16B92 ();
      ...
      protected void E14B92( )
      {
         ...
         {
            A575MemoId = H00B93_A575MemoId[0];
            A576MemoTitle = H00B93_A576MemoTitle[0];
            AV17GXLvl8 = 1;
            Form.Caption = A576MemoTitle;
      ...
      protected void E15B92( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Memo",  StringUtil.Trim( A575MemoId.ToString())) )
         {
      ...
      protected void E11B92( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Memo",(short)2,StringUtil.Trim( A575MemoId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12B92( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Memo",StringUtil.Trim( A575MemoId.ToString()),(string)AV14RecordDescription,formatLink("trn_memoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113435498", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memoview.js", "?202532113435499", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A575MemoId","fld":"MEMOID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10MemoId","fld":"vMEMOID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11B92","iparms":[{"av":"A575MemoId","fld":"MEMOID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12B92","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A575MemoId","fld":"MEMOID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13B92","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10MemoId","fld":"vMEMOID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B92_A575MemoId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B93_A575MemoId = new Guid[] {Guid.Empty} ;
         H00B93_A576MemoTitle = new string[] {""} ;
         A576MemoTitle = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memoview__default(),
            new Object[][] {
               ...
               , new Object[] {
               H00B93_A575MemoId, H00B93_A576MemoTitle
               }
            }
         );
      ...
      private Guid[] H00B92_A575MemoId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00B93_A575MemoId ;
      private string[] H00B93_A576MemoTitle ;
   ...
   public class trn_memoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B92", "SELECT MemoId FROM Trn_Memo WHERE MemoId = :AV10MemoId ORDER BY MemoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B92,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00B93", "SELECT MemoId, MemoTitle FROM Trn_Memo WHERE MemoId = :AV10MemoId ORDER BY MemoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B93,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
