   ...
   public class uhome : GXDataArea
   {
      ...
      private void E12A22( )
      {
         ...
         while ( AV14GXV1 <= AV6HomeModulesSDT.Count )
         {
            ...
            {
               lblLayoutoptionandtitleoptionicon_Caption = StringUtil.Format( "<i class='CardsMenuIcon %1' style='font-size: 40px'></i>", ((SdtUHomeModulesSDT_UHomeModulesSDTItem)(AV6HomeModulesSDT.CurrentItem)).gxTpr_Optioniconthemeclass, "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121713331386", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("uhome.js", "?2024121713331388", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDHOMEMODULESSDTS.LOAD","""{"handler":"E12A22","iparms":[{"av":"AV6HomeModulesSDT","fld":"vHOMEMODULESSDT","hsh":true}]""");
