...
namespace GeneXus.Programs {
   public class prc_activateresidentaccount : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.prc_activateresidentaccount__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class prc_activateresidentaccount__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
