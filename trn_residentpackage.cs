...
namespace GeneXus.Programs {
   public class trn_residentpackage : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         {
            A554ResidentPackageId = StringUtil.StrToGuid( GetPar( "ResidentPackageId"));
            n554ResidentPackageId = false;
            AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
            ...
            A559ResidentPackageDefault = StringUtil.StrToBool( GetPar( "ResidentPackageDefault"));
            AssignAttri("", false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
            ...
            XC_18_1R111( A554ResidentPackageId, A555SG_LocationId, A559ResidentPackageDefault) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel8"+"_"+"SG_LOCATIONID") == 0 )
         {
            ...
            GX8ASASG_LOCATIONID1R111( AV32Insert_SG_LocationId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel10"+"_"+"SG_ORGANISATIONID") == 0 )
         {
            ...
            GX10ASASG_ORGANISATIONID1R111( AV33Insert_SG_OrganisationId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_20") == 0 )
         {
            ...
            gxLoad_20( A555SG_LocationId, A556SG_OrganisationId) ;
            return  ;
         }
      ...
      {
         A559ResidentPackageDefault = StringUtil.StrToBool( StringUtil.BoolToStr( A559ResidentPackageDefault));
         AssignAttri("", false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
      }
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtResidentPackageName_Internalname, A557ResidentPackageName, StringUtil.RTrim( context.localUtil.Format( A557ResidentPackageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentPackageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtResidentPackageName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtResidentPackageModules_Internalname, A558ResidentPackageModules, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,32);\"", 0, 1, edtResidentPackageModules_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtResidentPackageId_Internalname, A554ResidentPackageId.ToString(), A554ResidentPackageId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentPackageId_Jsonclick, 0, "Attribute", "", "", "", "", edtResidentPackageId_Visible, edtResidentPackageId_Enabled, 1, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackage.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 53,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSG_OrganisationId_Internalname, A556SG_OrganisationId.ToString(), A556SG_OrganisationId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSG_OrganisationId_Jsonclick, 0, "Attribute", "", "", "", "", edtSG_OrganisationId_Visible, edtSG_OrganisationId_Enabled, 1, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackage.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSG_LocationId_Internalname, A555SG_LocationId.ToString(), A555SG_LocationId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSG_LocationId_Jsonclick, 0, "Attribute", "", "", "", "", edtSG_LocationId_Visible, edtSG_LocationId_Enabled, 1, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               /* Read saved values. */
               Z554ResidentPackageId = StringUtil.StrToGuid( cgiGet( "Z554ResidentPackageId"));
               Z557ResidentPackageName = cgiGet( "Z557ResidentPackageName");
               Z559ResidentPackageDefault = StringUtil.StrToBool( cgiGet( "Z559ResidentPackageDefault"));
               ...
               A557ResidentPackageName = cgiGet( edtResidentPackageName_Internalname);
               AssignAttri("", false, "A557ResidentPackageName", A557ResidentPackageName);
               A558ResidentPackageModules = cgiGet( edtResidentPackageModules_Internalname);
               AssignAttri("", false, "A558ResidentPackageModules", A558ResidentPackageModules);
               A559ResidentPackageDefault = StringUtil.StrToBool( cgiGet( chkResidentPackageDefault_Internalname));
               AssignAttri("", false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
               ...
               else
               {
                  try
                  {
                     A554ResidentPackageId = StringUtil.StrToGuid( cgiGet( edtResidentPackageId_Internalname));
                     n554ResidentPackageId = false;
                     AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
                  }
                  catch ( Exception  )
               ...
               else
               {
                  try
                  {
                     A556SG_OrganisationId = StringUtil.StrToGuid( cgiGet( edtSG_OrganisationId_Internalname));
                     AssignAttri("", false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
                  }
                  catch ( Exception  )
                  {
               ...
               else
               {
                  try
                  {
                     A555SG_LocationId = StringUtil.StrToGuid( cgiGet( edtSG_LocationId_Internalname));
                     AssignAttri("", false, "A555SG_LocationId", A555SG_LocationId.ToString());
                  }
                  catch ( Exception  )
                  {
               ...
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A554ResidentPackageId != Z554ResidentPackageId ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
               {
            ...
            else
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
               {
                  ...
                  {
                     A554ResidentPackageId = AV7ResidentPackageId;
                     n554ResidentPackageId = false;
                     AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
                  }
                  else
                  {
                     if ( IsIns( )  && (Guid.Empty==A554ResidentPackageId) && ( Gx_BScreen == 0 ) )
                     {
      ...
      protected void ZM1R111( short GX_JID )
      {
         if ( ( GX_JID == 19 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z557ResidentPackageName = T001R3_A557ResidentPackageName[0];
               Z559ResidentPackageDefault = T001R3_A559ResidentPackageDefault[0];
               Z555SG_LocationId = T001R3_A555SG_LocationId[0];
               Z556SG_OrganisationId = T001R3_A556SG_OrganisationId[0];
            }
            else
            {
      ...
      protected void standaloneModal( )
      {
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (Guid.Empty==AV33Insert_SG_OrganisationId) )
         {
            A556SG_OrganisationId = AV33Insert_SG_OrganisationId;
            AssignAttri("", false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
         }
         else
         {
            GXt_guid3 = A556SG_OrganisationId;
            new prc_getuserorganisationid(context ).execute( out  GXt_guid3) ;
            A556SG_OrganisationId = GXt_guid3;
            AssignAttri("", false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
         }
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (Guid.Empty==AV32Insert_SG_LocationId) )
         {
            A555SG_LocationId = AV32Insert_SG_LocationId;
            AssignAttri("", false, "A555SG_LocationId", A555SG_LocationId.ToString());
         }
         else
         {
            GXt_guid3 = A555SG_LocationId;
            new prc_getuserlocationid(context ).execute( out  GXt_guid3) ;
            A555SG_LocationId = GXt_guid3;
            AssignAttri("", false, "A555SG_LocationId", A555SG_LocationId.ToString());
         }
         A558ResidentPackageModules = AV22ComboResidentPackageModules;
         AssignAttri("", false, "A558ResidentPackageModules", A558ResidentPackageModules);
      ...
      protected void Load1R111( )
      {
         ...
         {
            RcdFound111 = 1;
            A558ResidentPackageModules = T001R5_A558ResidentPackageModules[0];
            AssignAttri("", false, "A558ResidentPackageModules", A558ResidentPackageModules);
            A557ResidentPackageName = T001R5_A557ResidentPackageName[0];
            AssignAttri("", false, "A557ResidentPackageName", A557ResidentPackageName);
            A559ResidentPackageDefault = T001R5_A559ResidentPackageDefault[0];
            AssignAttri("", false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
            A555SG_LocationId = T001R5_A555SG_LocationId[0];
            AssignAttri("", false, "A555SG_LocationId", A555SG_LocationId.ToString());
            A556SG_OrganisationId = T001R5_A556SG_OrganisationId[0];
            AssignAttri("", false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
            ZM1R111( -19) ;
         }
         pr_default.close(3);
      ...
      protected void gxLoad_20( Guid A555SG_LocationId ,
                                Guid A556SG_OrganisationId )
      {
         /* Using cursor T001R6 */
         pr_default.execute(4, new Object[] {A555SG_LocationId, A556SG_OrganisationId});
      ...
      {
         /* Using cursor T001R7 */
         pr_default.execute(5, new Object[] {n554ResidentPackageId, A554ResidentPackageId});
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM1R111( 19) ;
            RcdFound111 = 1;
            A554ResidentPackageId = T001R3_A554ResidentPackageId[0];
            n554ResidentPackageId = T001R3_n554ResidentPackageId[0];
            AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
            A558ResidentPackageModules = T001R3_A558ResidentPackageModules[0];
            AssignAttri("", false, "A558ResidentPackageModules", A558ResidentPackageModules);
            A557ResidentPackageName = T001R3_A557ResidentPackageName[0];
            AssignAttri("", false, "A557ResidentPackageName", A557ResidentPackageName);
            A559ResidentPackageDefault = T001R3_A559ResidentPackageDefault[0];
            AssignAttri("", false, "A559ResidentPackageDefault", A559ResidentPackageDefault);
            A555SG_LocationId = T001R3_A555SG_LocationId[0];
            AssignAttri("", false, "A555SG_LocationId", A555SG_LocationId.ToString());
            A556SG_OrganisationId = T001R3_A556SG_OrganisationId[0];
            AssignAttri("", false, "A556SG_OrganisationId", A556SG_OrganisationId.ToString());
            Z554ResidentPackageId = A554ResidentPackageId;
            sMode111 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound111 = 0;
         /* Using cursor T001R8 */
         pr_default.execute(6, new Object[] {n554ResidentPackageId, A554ResidentPackageId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( GuidUtil.Compare(T001R8_A554ResidentPackageId[0], A554ResidentPackageId, 0) < 0 ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( GuidUtil.Compare(T001R8_A554ResidentPackageId[0], A554ResidentPackageId, 0) > 0 ) ) )
            {
               A554ResidentPackageId = T001R8_A554ResidentPackageId[0];
               n554ResidentPackageId = T001R8_n554ResidentPackageId[0];
               AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
               RcdFound111 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( GuidUtil.Compare(T001R9_A554ResidentPackageId[0], A554ResidentPackageId, 0) > 0 ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( GuidUtil.Compare(T001R9_A554ResidentPackageId[0], A554ResidentPackageId, 0) < 0 ) ) )
            {
               A554ResidentPackageId = T001R9_A554ResidentPackageId[0];
               n554ResidentPackageId = T001R9_n554ResidentPackageId[0];
               AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
               RcdFound111 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency1R111( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z557ResidentPackageName, T001R2_A557ResidentPackageName[0]) != 0 ) || ( Z559ResidentPackageDefault != T001R2_A559ResidentPackageDefault[0] ) || ( Z555SG_LocationId != T001R2_A555SG_LocationId[0] ) || ( Z556SG_OrganisationId != T001R2_A556SG_OrganisationId[0] ) )
            {
               if ( StringUtil.StrCmp(Z557ResidentPackageName, T001R2_A557ResidentPackageName[0]) != 0 )
               {
                  GXUtil.WriteLog("trn_residentpackage:[seudo value changed for attri]"+"ResidentPackageName");
                  GXUtil.WriteLogRaw("Old: ",Z557ResidentPackageName);
                  GXUtil.WriteLogRaw("Current: ",T001R2_A557ResidentPackageName[0]);
               }
               if ( Z559ResidentPackageDefault != T001R2_A559ResidentPackageDefault[0] )
               {
                  GXUtil.WriteLog("trn_residentpackage:[seudo value changed for attri]"+"ResidentPackageDefault");
                  GXUtil.WriteLogRaw("Old: ",Z559ResidentPackageDefault);
                  GXUtil.WriteLogRaw("Current: ",T001R2_A559ResidentPackageDefault[0]);
               }
               if ( Z555SG_LocationId != T001R2_A555SG_LocationId[0] )
               {
                  GXUtil.WriteLog("trn_residentpackage:[seudo value changed for attri]"+"SG_LocationId");
                  GXUtil.WriteLogRaw("Old: ",Z555SG_LocationId);
                  GXUtil.WriteLogRaw("Current: ",T001R2_A555SG_LocationId[0]);
               }
               if ( Z556SG_OrganisationId != T001R2_A556SG_OrganisationId[0] )
               {
                  ...
                  GXUtil.WriteLogRaw("Current: ",T001R2_A556SG_OrganisationId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {n554ResidentPackageId, A554ResidentPackageId, A558ResidentPackageModules, A557ResidentPackageName, A559ResidentPackageDefault, A555SG_LocationId, A556SG_OrganisationId});
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A558ResidentPackageModules, A557ResidentPackageName, A559ResidentPackageDefault, A555SG_LocationId, A556SG_OrganisationId, n554ResidentPackageId, A554ResidentPackageId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_ResidentPackage");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(10, new Object[] {n554ResidentPackageId, A554ResidentPackageId});
                  pr_default.close(10);
                  pr_default.SmartCacheProvider.SetUpdated("Trn_ResidentPackage");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls1R111( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(11, new Object[] {n554ResidentPackageId, A554ResidentPackageId});
      ...
      public void ScanStart1R111( )
      {
         ...
         {
            RcdFound111 = 1;
            A554ResidentPackageId = T001R14_A554ResidentPackageId[0];
            n554ResidentPackageId = T001R14_n554ResidentPackageId[0];
            AssignAttri("", false, "A554ResidentPackageId", A554ResidentPackageId.ToString());
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext1R111( )
      {
         /* Scan next routine */
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z554ResidentPackageId", Z554ResidentPackageId.ToString());
         GxWebStd.gx_hidden_field( context, "Z557ResidentPackageName", Z557ResidentPackageName);
         GxWebStd.gx_boolean_hidden_field( context, "Z559ResidentPackageDefault", Z559ResidentPackageDefault);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113424496", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentpackage.js", "?202532113424499", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void GX8ASASG_LOCATIONID1R111( Guid AV32Insert_SG_LocationId )
      {
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (Guid.Empty==AV32Insert_SG_LocationId) )
         {
            A555SG_LocationId = AV32Insert_SG_LocationId;
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A555SG_LocationId.ToString())+"\"") ;
         AddString( "]") ;
         if ( true )
         {
            AddString( ",") ;
      ...
      protected void GX10ASASG_ORGANISATIONID1R111( Guid AV33Insert_SG_OrganisationId )
      {
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (Guid.Empty==AV33Insert_SG_OrganisationId) )
         {
            A556SG_OrganisationId = AV33Insert_SG_OrganisationId;
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A556SG_OrganisationId.ToString())+"\"") ;
         AddString( "]") ;
         if ( true )
         {
            AddString( ",") ;
      ...
      protected void XC_18_1R111( Guid A554ResidentPackageId ,
                                  Guid A555SG_LocationId ,
                                  bool A559ResidentPackageDefault )
      {
         if ( A559ResidentPackageDefault )
         {
            new prc_defaultresidetpackage(context ).execute(  A554ResidentPackageId, ref  A555SG_LocationId) ;
      ...
      public void Valid_Sg_locationid( )
      {
         ...
         pr_default.execute(13, new Object[] {A555SG_LocationId, A556SG_OrganisationId});
      ...
      {
         setEventMetadata("ENTER","""{"handler":"UserMainFullajax","iparms":[{"postForm":true},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV7ResidentPackageId","fld":"vRESIDENTPACKAGEID","hsh":true},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV7ResidentPackageId","fld":"vRESIDENTPACKAGEID","hsh":true},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("AFTER TRN","""{"handler":"E121R2","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("AFTER TRN",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_RESIDENTPACKAGENAME","""{"handler":"Valid_Residentpackagename","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGENAME",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_RESIDENTPACKAGEMODULES","""{"handler":"Valid_Residentpackagemodules","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGEMODULES",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_RESIDENTPACKAGEDEFAULT","""{"handler":"Valid_Residentpackagedefault","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGEDEFAULT",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALIDV_COMBORESIDENTPACKAGEMODULES","""{"handler":"Validv_Comboresidentpackagemodules","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALIDV_COMBORESIDENTPACKAGEMODULES",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_RESIDENTPACKAGEID","""{"handler":"Valid_Residentpackageid","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGEID",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_SG_ORGANISATIONID","""{"handler":"Valid_Sg_organisationid","iparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_SG_ORGANISATIONID",""","oparms":[{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         setEventMetadata("VALID_SG_LOCATIONID","""{"handler":"Valid_Sg_locationid","iparms":[{"av":"A555SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A556SG_OrganisationId","fld":"SG_ORGANISATIONID"},{"av":"A554ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_SG_LOCATIONID",""","oparms":[{"av":"A555SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A559ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV18ResidentPackageModules_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         A558ResidentPackageModules = "";
         ...
         T001R5_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R5_n554ResidentPackageId = new bool[] {false} ;
         T001R5_A558ResidentPackageModules = new string[] {""} ;
         T001R5_A557ResidentPackageName = new string[] {""} ;
         T001R5_A559ResidentPackageDefault = new bool[] {false} ;
         T001R5_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         T001R5_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         T001R4_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         T001R6_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         T001R7_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R7_n554ResidentPackageId = new bool[] {false} ;
         T001R3_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R3_n554ResidentPackageId = new bool[] {false} ;
         T001R3_A558ResidentPackageModules = new string[] {""} ;
         T001R3_A557ResidentPackageName = new string[] {""} ;
         T001R3_A559ResidentPackageDefault = new bool[] {false} ;
         T001R3_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         T001R3_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         T001R8_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R8_n554ResidentPackageId = new bool[] {false} ;
         T001R9_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R9_n554ResidentPackageId = new bool[] {false} ;
         T001R2_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R2_n554ResidentPackageId = new bool[] {false} ;
         T001R2_A558ResidentPackageModules = new string[] {""} ;
         T001R2_A557ResidentPackageName = new string[] {""} ;
         T001R2_A559ResidentPackageDefault = new bool[] {false} ;
         T001R2_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         T001R2_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         T001R13_A62ResidentId = new Guid[] {Guid.Empty} ;
         T001R13_A29LocationId = new Guid[] {Guid.Empty} ;
         T001R13_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001R14_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         T001R14_n554ResidentPackageId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         GXt_guid3 = Guid.Empty;
         T001R15_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentpackage__default(),
            new Object[][] {
                new Object[] {
               T001R2_A554ResidentPackageId, T001R2_A558ResidentPackageModules, T001R2_A557ResidentPackageName, T001R2_A559ResidentPackageDefault, T001R2_A555SG_LocationId, T001R2_A556SG_OrganisationId
               }
               , new Object[] {
               T001R3_A554ResidentPackageId, T001R3_A558ResidentPackageModules, T001R3_A557ResidentPackageName, T001R3_A559ResidentPackageDefault, T001R3_A555SG_LocationId, T001R3_A556SG_OrganisationId
               }
               , new Object[] {
               T001R4_A555SG_LocationId
               }
               , new Object[] {
               T001R5_A554ResidentPackageId, T001R5_A558ResidentPackageModules, T001R5_A557ResidentPackageName, T001R5_A559ResidentPackageDefault, T001R5_A555SG_LocationId, T001R5_A556SG_OrganisationId
               }
               , new Object[] {
               T001R6_A555SG_LocationId
               }
               , new Object[] {
               T001R7_A554ResidentPackageId
               }
               , new Object[] {
               T001R8_A554ResidentPackageId
               }
               , new Object[] {
               T001R9_A554ResidentPackageId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T001R13_A62ResidentId, T001R13_A29LocationId, T001R13_A11OrganisationId
               }
               , new Object[] {
               T001R14_A554ResidentPackageId
               }
               , new Object[] {
               T001R15_A555SG_LocationId
               }
            }
         );
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV18ResidentPackageModules_Data ;
      ...
      private Guid[] T001R5_A554ResidentPackageId ;
      private bool[] T001R5_n554ResidentPackageId ;
      private string[] T001R5_A558ResidentPackageModules ;
      private string[] T001R5_A557ResidentPackageName ;
      private bool[] T001R5_A559ResidentPackageDefault ;
      private Guid[] T001R5_A555SG_LocationId ;
      private Guid[] T001R5_A556SG_OrganisationId ;
      private Guid[] T001R4_A555SG_LocationId ;
      private Guid[] T001R6_A555SG_LocationId ;
      private Guid[] T001R7_A554ResidentPackageId ;
      private bool[] T001R7_n554ResidentPackageId ;
      private Guid[] T001R3_A554ResidentPackageId ;
      private bool[] T001R3_n554ResidentPackageId ;
      private string[] T001R3_A558ResidentPackageModules ;
      private string[] T001R3_A557ResidentPackageName ;
      private bool[] T001R3_A559ResidentPackageDefault ;
      private Guid[] T001R3_A555SG_LocationId ;
      private Guid[] T001R3_A556SG_OrganisationId ;
      private Guid[] T001R8_A554ResidentPackageId ;
      private bool[] T001R8_n554ResidentPackageId ;
      private Guid[] T001R9_A554ResidentPackageId ;
      private bool[] T001R9_n554ResidentPackageId ;
      private Guid[] T001R2_A554ResidentPackageId ;
      private bool[] T001R2_n554ResidentPackageId ;
      private string[] T001R2_A558ResidentPackageModules ;
      private string[] T001R2_A557ResidentPackageName ;
      private bool[] T001R2_A559ResidentPackageDefault ;
      private Guid[] T001R2_A555SG_LocationId ;
      private Guid[] T001R2_A556SG_OrganisationId ;
      private Guid[] T001R13_A62ResidentId ;
      private Guid[] T001R13_A29LocationId ;
      private Guid[] T001R13_A11OrganisationId ;
      private Guid[] T001R14_A554ResidentPackageId ;
      private bool[] T001R14_n554ResidentPackageId ;
      private Guid[] T001R15_A555SG_LocationId ;
...
public class trn_residentpackage__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("T001R2", "SELECT ResidentPackageId, ResidentPackageModules, ResidentPackageName, ResidentPackageDefault, SG_LocationId, SG_OrganisationId FROM Trn_ResidentPackage WHERE ResidentPackageId = :ResidentPackageId  FOR UPDATE OF Trn_ResidentPackage NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT001R2,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R3", "SELECT ResidentPackageId, ResidentPackageModules, ResidentPackageName, ResidentPackageDefault, SG_LocationId, SG_OrganisationId FROM Trn_ResidentPackage WHERE ResidentPackageId = :ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R3,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R4", "SELECT LocationId AS SG_LocationId FROM Trn_Location WHERE LocationId = :SG_LocationId AND OrganisationId = :SG_OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R4,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R5", "SELECT TM1.ResidentPackageId, TM1.ResidentPackageModules, TM1.ResidentPackageName, TM1.ResidentPackageDefault, TM1.SG_LocationId AS SG_LocationId, TM1.SG_OrganisationId AS SG_OrganisationId FROM Trn_ResidentPackage TM1 WHERE TM1.ResidentPackageId = :ResidentPackageId ORDER BY TM1.ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R5,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R6", "SELECT LocationId AS SG_LocationId FROM Trn_Location WHERE LocationId = :SG_LocationId AND OrganisationId = :SG_OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R6,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R7", "SELECT ResidentPackageId FROM Trn_ResidentPackage WHERE ResidentPackageId = :ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R7,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R8", "SELECT ResidentPackageId FROM Trn_ResidentPackage WHERE ( ResidentPackageId > :ResidentPackageId) ORDER BY ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R8,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T001R9", "SELECT ResidentPackageId FROM Trn_ResidentPackage WHERE ( ResidentPackageId < :ResidentPackageId) ORDER BY ResidentPackageId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R9,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T001R10", "SAVEPOINT gxupdate;INSERT INTO Trn_ResidentPackage(ResidentPackageId, ResidentPackageModules, ResidentPackageName, ResidentPackageDefault, SG_LocationId, SG_OrganisationId) VALUES(:ResidentPackageId, :ResidentPackageModules, :ResidentPackageName, :ResidentPackageDefault, :SG_LocationId, :SG_OrganisationId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001R10)
          ,new CursorDef("T001R11", "SAVEPOINT gxupdate;UPDATE Trn_ResidentPackage SET ResidentPackageModules=:ResidentPackageModules, ResidentPackageName=:ResidentPackageName, ResidentPackageDefault=:ResidentPackageDefault, SG_LocationId=:SG_LocationId, SG_OrganisationId=:SG_OrganisationId  WHERE ResidentPackageId = :ResidentPackageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001R11)
          ,new CursorDef("T001R12", "SAVEPOINT gxupdate;DELETE FROM Trn_ResidentPackage  WHERE ResidentPackageId = :ResidentPackageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001R12)
          ,new CursorDef("T001R13", "SELECT ResidentId, LocationId, OrganisationId FROM Trn_Resident WHERE ResidentPackageId = :ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R13,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T001R14", "SELECT ResidentPackageId FROM Trn_ResidentPackage ORDER BY ResidentPackageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R14,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001R15", "SELECT LocationId AS SG_LocationId FROM Trn_Location WHERE LocationId = :SG_LocationId AND OrganisationId = :SG_OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001R15,1, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
