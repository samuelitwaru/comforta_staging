...
namespace GeneXus.Programs {
   public class wp_createlocationandreceptioniststep2 : GXWebComponent
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_83", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_83), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void wb_table1_34_6U2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPhonelabel_Internalname, "Phone", "", "", lblPhonelabel_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_WP_CreateLocationAndReceptionistStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavReceptionistphonenumber_Internalname, "Receptionist Phone Number", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
         ...
         if ( wbEnd == 83 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavReceptionistphonecode_Internalname, AV35ReceptionistPhoneCode, StringUtil.RTrim( context.localUtil.Format( AV35ReceptionistPhoneCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,108);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavReceptionistphonecode_Jsonclick, 0, "Attribute", "", "", "", "", edtavReceptionistphonecode_Visible, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateLocationAndReceptionistStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 109,'" + sPrefix + "',false,'" + sGXsfl_83_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavReceptionistphone_Internalname, StringUtil.RTrim( AV17ReceptionistPhone), StringUtil.RTrim( context.localUtil.Format( AV17ReceptionistPhone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,109);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavReceptionistphone_Jsonclick, 0, "Attribute", "", "", "", "", edtavReceptionistphone_Visible, 1, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WP_CreateLocationAndReceptionistStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 110,'" + sPrefix + "',false,'" + sGXsfl_83_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavReceptionistid_Internalname, AV13ReceptionistId.ToString(), AV13ReceptionistId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,110);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavReceptionistid_Jsonclick, 0, "Attribute", "", "", "", "", edtavReceptionistid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_CreateLocationAndReceptionistStep2.htm");
            /* User Defined Control */
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 27), "GRIDSDT_RECEPTIONISTSS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6U0( ) ;
                              ...
                              AV62GXV1 = (int)(nGXsfl_83_idx+GRIDSDT_RECEPTIONISTSS_nFirstRecordOnPage);
                              if ( ( AV19SDT_Receptionists.Count >= AV62GXV1 ) && ( AV62GXV1 > 0 ) )
                              {
                                 AV19SDT_Receptionists.CurrentItem = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1));
      ...
      protected void STRUP6U0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_83 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_83"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            while ( nGXsfl_83_fel_idx < nRC_GXsfl_83 )
            {
               ...
               AV62GXV1 = (int)(nGXsfl_83_fel_idx+GRIDSDT_RECEPTIONISTSS_nFirstRecordOnPage);
               if ( ( AV19SDT_Receptionists.Count >= AV62GXV1 ) && ( AV62GXV1 > 0 ) )
               {
                  AV19SDT_Receptionists.CurrentItem = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1));
                  cmbavGridactiongroup1.Name = cmbavGridactiongroup1_Internalname;
      ...
      private void E186U2( )
      {
         ...
         returnInSub = false;
         AV62GXV1 = 1;
         while ( AV62GXV1 <= AV19SDT_Receptionists.Count )
         {
            AV19SDT_Receptionists.CurrentItem = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1));
      ...
      {
         AV62GXV1 = (int)(nGXsfl_83_idx+GRIDSDT_RECEPTIONISTSS_nFirstRecordOnPage);
         if ( ( AV62GXV1 > 0 ) && ( AV19SDT_Receptionists.Count >= AV62GXV1 ) )
         {
            AV19SDT_Receptionists.CurrentItem = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1));
         }
         /* Enter Routine */
      ...
      protected void E146U2( )
      {
         ...
         if ( AV18CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            ...
            AV76GXV15 = 1;
            while ( AV76GXV15 <= AV19SDT_Receptionists.Count )
            {
               AV21SDT_Receptionist = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV76GXV15));
            ...
            {
               GX_msglist.addItem("This Receptionist email has already been added.");
      ...
      protected void S152( )
      {
         ...
         {
            AV78GXV16 = 1;
            while ( AV78GXV16 <= AV19SDT_Receptionists.Count )
            {
               AV21SDT_Receptionist = ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV78GXV16));
               ...
               {
                  AV80GXV18 = 1;
                  AV79GXV17 = AV43Trn_Manager.GetMessages();
                  while ( AV80GXV18 <= AV79GXV17.Count )
                  {
                     AV28Error = ((GeneXus.Utils.SdtMessages_Message)AV79GXV17.Item(AV80GXV18));
                     AV23ErrorMessages.Add(AV28Error, 0);
                     AV80GXV18 = (int)(AV80GXV18+1);
                  }
               }
               else
               {
                  ...
                  {
                     GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  "Invitation sent successfully",  "success",  "",  "true",  ""));
                  }
                  AV81GXV19 = 1;
                  while ( AV81GXV19 <= AV48GAMErrorCollection.Count )
                  {
                     AV49GAMErrorItem = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV48GAMErrorCollection.Item(AV81GXV19));
                     ...
                     AV23ErrorMessages.Add(AV28Error, 0);
                     AV81GXV19 = (int)(AV81GXV19+1);
                  }
               }
               AV78GXV16 = (int)(AV78GXV16+1);
            }
      ...
      protected void S162( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38ReceptionistPhoneNumber)) && ! GxRegex.IsMatch(AV38ReceptionistPhoneNumber,"\\b\\d{9}\\b") )
         {
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV83GXV21 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem3 = AV82GXV20;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem3) ;
         AV82GXV20 = GXt_objcol_SdtSDT_Country_SDT_CountryItem3;
         while ( AV83GXV21 <= AV82GXV20.Count )
         {
            AV37ReceptionistPhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV82GXV20.Item(AV83GXV21));
      ...
      protected void E166U2( )
      {
         ...
         returnInSub = false;
         if ( ! GxRegex.IsMatch(AV38ReceptionistPhoneNumber,"\\b\\d{9}\\b") && ! String.IsNullOrEmpty(StringUtil.RTrim( AV38ReceptionistPhoneNumber)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Phone contains 9 digits",  "error",  edtavReceptionistphonenumber_Internalname,  "true",  ""));
            AV18CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV18CheckRequiredFieldsResult", AV18CheckRequiredFieldsResult);
         }
         /*  Sending Event outputs  */
      ...
      protected void S202( )
      {
         ...
         returnInSub = false;
         AV84GXV22 = 1;
         while ( AV84GXV22 <= AV23ErrorMessages.Count )
         {
            AV28Error = ((GeneXus.Utils.SdtMessages_Message)AV23ErrorMessages.Item(AV84GXV22));
            GX_msglist.addItem("Error: "+AV28Error.gxTpr_Description);
            AV84GXV22 = (int)(AV84GXV22+1);
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202412191553936", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createlocationandreceptioniststep2.js", "?202412191553940", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void sendrow_832( )
      {
         ...
         if ( ( subGridsdt_receptionistss_Rows * 1 == 0 ) || ( nGXsfl_83_idx <= subGridsdt_receptionistss_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1)).gxTpr_Receptionistimage)) ? ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1)).gxTpr_Receptionistimage_gxi : context.PathToRelativeUrl( ((SdtSDT_Receptionists_SDT_ReceptionistsItem)AV19SDT_Receptionists.Item(AV62GXV1)).gxTpr_Receptionistimage));
            ...
            if ( ( cmbavGridactiongroup1.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV62GXV1 > 0 ) && ( AV19SDT_Receptionists.Count >= AV62GXV1 ) && (0==AV60GridActionGroup1) )
                  {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E196U2","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV60GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9"},{"av":"AV19SDT_Receptionists","fld":"vSDT_RECEPTIONISTS","grid":83},{"av":"nGXsfl_83_idx","ctrl":"GRID","prop":"GridCurrRow","grid":83},{"av":"GRIDSDT_RECEPTIONISTSS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_83","ctrl":"GRIDSDT_RECEPTIONISTSS","prop":"GridRC","grid":83},{"av":"AV11WizardData","fld":"vWIZARDDATA"},{"av":"GRIDSDT_RECEPTIONISTSS_nEOF"},{"av":"subGridsdt_receptionistss_Rows","ctrl":"GRIDSDT_RECEPTIONISTSS","prop":"Rows"},{"av":"sPrefix"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true},{"av":"AV43Trn_Manager","fld":"vTRN_MANAGER","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV50Image = "";
         AV79GXV17 = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         AV28Error = new GeneXus.Utils.SdtMessages_Message(context);
         GXt_char2 = "";
         AV49GAMErrorItem = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
         AV82GXV20 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
      ...
      private int AV78GXV16 ;
      private int AV80GXV18 ;
      private int AV81GXV19 ;
      private int AV83GXV21 ;
      private int AV84GXV22 ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV79GXV17 ;
      private GeneXus.Utils.SdtMessages_Message AV28Error ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV49GAMErrorItem ;
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV82GXV20 ;
