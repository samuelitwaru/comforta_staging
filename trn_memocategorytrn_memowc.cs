   ...
   public class trn_memocategorytrn_memowc : GXWebComponent
   {
      ...
      protected void WBBC0( )
      {
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMemoCategoryId_Internalname, A568MemoCategoryId.ToString(), A568MemoCategoryId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMemoCategoryId_Jsonclick, 0, "Attribute", "", "", "", "", edtMemoCategoryId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_MemoCategoryTrn_MemoWC.htm");
            /* User Defined Control */
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A555SG_LocationId = H00BC2_A555SG_LocationId[0];
            A556SG_OrganisationId = H00BC2_A556SG_OrganisationId[0];
            A29LocationId = H00BC2_A29LocationId[0];
            A11OrganisationId = H00BC2_A11OrganisationId[0];
            A568MemoCategoryId = H00BC2_A568MemoCategoryId[0];
            AssignAttri(sPrefix, false, "A568MemoCategoryId", A568MemoCategoryId.ToString());
            A71ResidentGUID = H00BC2_A71ResidentGUID[0];
            A65ResidentLastName = H00BC2_A65ResidentLastName[0];
            A64ResidentGivenName = H00BC2_A64ResidentGivenName[0];
            A72ResidentSalutation = H00BC2_A72ResidentSalutation[0];
            A62ResidentId = H00BC2_A62ResidentId[0];
            A590MemoRemoveDate = H00BC2_A590MemoRemoveDate[0];
            A589MemoDuration = H00BC2_A589MemoDuration[0];
            n589MemoDuration = H00BC2_n589MemoDuration[0];
            A588MemoEndDateTime = H00BC2_A588MemoEndDateTime[0];
            n588MemoEndDateTime = H00BC2_n588MemoEndDateTime[0];
            A587MemoStartDateTime = H00BC2_A587MemoStartDateTime[0];
            n587MemoStartDateTime = H00BC2_n587MemoStartDateTime[0];
            A579MemoDocument = H00BC2_A579MemoDocument[0];
            n579MemoDocument = H00BC2_n579MemoDocument[0];
            A578MemoImage = H00BC2_A578MemoImage[0];
            n578MemoImage = H00BC2_n578MemoImage[0];
            A577MemoDescription = H00BC2_A577MemoDescription[0];
            A576MemoTitle = H00BC2_A576MemoTitle[0];
            A575MemoId = H00BC2_A575MemoId[0];
            A71ResidentGUID = H00BC2_A71ResidentGUID[0];
            A65ResidentLastName = H00BC2_A65ResidentLastName[0];
            A64ResidentGivenName = H00BC2_A64ResidentGivenName[0];
            A72ResidentSalutation = H00BC2_A72ResidentSalutation[0];
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) || ( ( StringUtil.Like( StringUtil.Lower( A576MemoTitle) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A577MemoDescription) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) ||
            ( StringUtil.Like( StringUtil.Lower( A578MemoImage) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A579MemoDocument) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) ||
            ( StringUtil.Like( StringUtil.Str( (decimal)(A589MemoDuration), 4, 0) , StringUtil.PadR( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "mr", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A72ResidentSalutation, "Mr") == 0 ) ) ||
      ...
      protected void RFBC2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A555SG_LocationId = H00BC3_A555SG_LocationId[0];
               A556SG_OrganisationId = H00BC3_A556SG_OrganisationId[0];
               A29LocationId = H00BC3_A29LocationId[0];
               A11OrganisationId = H00BC3_A11OrganisationId[0];
               A568MemoCategoryId = H00BC3_A568MemoCategoryId[0];
               AssignAttri(sPrefix, false, "A568MemoCategoryId", A568MemoCategoryId.ToString());
               A71ResidentGUID = H00BC3_A71ResidentGUID[0];
               A65ResidentLastName = H00BC3_A65ResidentLastName[0];
               A64ResidentGivenName = H00BC3_A64ResidentGivenName[0];
               A72ResidentSalutation = H00BC3_A72ResidentSalutation[0];
               A62ResidentId = H00BC3_A62ResidentId[0];
               A590MemoRemoveDate = H00BC3_A590MemoRemoveDate[0];
               A589MemoDuration = H00BC3_A589MemoDuration[0];
               n589MemoDuration = H00BC3_n589MemoDuration[0];
               A588MemoEndDateTime = H00BC3_A588MemoEndDateTime[0];
               n588MemoEndDateTime = H00BC3_n588MemoEndDateTime[0];
               A587MemoStartDateTime = H00BC3_A587MemoStartDateTime[0];
               n587MemoStartDateTime = H00BC3_n587MemoStartDateTime[0];
               A579MemoDocument = H00BC3_A579MemoDocument[0];
               n579MemoDocument = H00BC3_n579MemoDocument[0];
               A578MemoImage = H00BC3_A578MemoImage[0];
               n578MemoImage = H00BC3_n578MemoImage[0];
               A577MemoDescription = H00BC3_A577MemoDescription[0];
               A576MemoTitle = H00BC3_A576MemoTitle[0];
               A575MemoId = H00BC3_A575MemoId[0];
               A71ResidentGUID = H00BC3_A71ResidentGUID[0];
               A65ResidentLastName = H00BC3_A65ResidentLastName[0];
               A64ResidentGivenName = H00BC3_A64ResidentGivenName[0];
               A72ResidentSalutation = H00BC3_A72ResidentSalutation[0];
      ...
      protected void E11BC2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_MemoCategoryTrn_MemoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_MemoCategoryTrn_MemoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532113431342", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_memocategorytrn_memowc.js", "?202532113431343", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18BC2","iparms":[{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A575MemoId","fld":"MEMOID","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV27IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E15BC2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8MemoCategoryId","fld":"vMEMOCATEGORYID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV27IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV34IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A575MemoId","fld":"MEMOID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV16FilterFullText = "";
         H00BC2_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         H00BC2_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         H00BC2_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BC2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BC2_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00BC2_A71ResidentGUID = new string[] {""} ;
         H00BC2_A65ResidentLastName = new string[] {""} ;
         H00BC2_A64ResidentGivenName = new string[] {""} ;
         H00BC2_A72ResidentSalutation = new string[] {""} ;
         H00BC2_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BC2_A590MemoRemoveDate = new DateTime[] {DateTime.MinValue} ;
         H00BC2_A589MemoDuration = new short[1] ;
         H00BC2_n589MemoDuration = new bool[] {false} ;
         H00BC2_A588MemoEndDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BC2_n588MemoEndDateTime = new bool[] {false} ;
         H00BC2_A587MemoStartDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BC2_n587MemoStartDateTime = new bool[] {false} ;
         H00BC2_A579MemoDocument = new string[] {""} ;
         H00BC2_n579MemoDocument = new bool[] {false} ;
         H00BC2_A578MemoImage = new string[] {""} ;
         H00BC2_n578MemoImage = new bool[] {false} ;
         H00BC2_A577MemoDescription = new string[] {""} ;
         H00BC2_A576MemoTitle = new string[] {""} ;
         H00BC2_A575MemoId = new Guid[] {Guid.Empty} ;
         A555SG_LocationId = Guid.Empty;
         A556SG_OrganisationId = Guid.Empty;
         H00BC3_A555SG_LocationId = new Guid[] {Guid.Empty} ;
         H00BC3_A556SG_OrganisationId = new Guid[] {Guid.Empty} ;
         H00BC3_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BC3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BC3_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00BC3_A71ResidentGUID = new string[] {""} ;
         H00BC3_A65ResidentLastName = new string[] {""} ;
         H00BC3_A64ResidentGivenName = new string[] {""} ;
         H00BC3_A72ResidentSalutation = new string[] {""} ;
         H00BC3_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BC3_A590MemoRemoveDate = new DateTime[] {DateTime.MinValue} ;
         H00BC3_A589MemoDuration = new short[1] ;
         H00BC3_n589MemoDuration = new bool[] {false} ;
         H00BC3_A588MemoEndDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BC3_n588MemoEndDateTime = new bool[] {false} ;
         H00BC3_A587MemoStartDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BC3_n587MemoStartDateTime = new bool[] {false} ;
         H00BC3_A579MemoDocument = new string[] {""} ;
         H00BC3_n579MemoDocument = new bool[] {false} ;
         H00BC3_A578MemoImage = new string[] {""} ;
         H00BC3_n578MemoImage = new bool[] {false} ;
         H00BC3_A577MemoDescription = new string[] {""} ;
         H00BC3_A576MemoTitle = new string[] {""} ;
         H00BC3_A575MemoId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memocategorytrn_memowc__default(),
            new Object[][] {
                new Object[] {
               H00BC2_A555SG_LocationId, H00BC2_A556SG_OrganisationId, H00BC2_A29LocationId, H00BC2_A11OrganisationId, H00BC2_A568MemoCategoryId, H00BC2_A71ResidentGUID, H00BC2_A65ResidentLastName, H00BC2_A64ResidentGivenName, H00BC2_A72ResidentSalutation, H00BC2_A62ResidentId,
               H00BC2_A590MemoRemoveDate, H00BC2_A589MemoDuration, H00BC2_n589MemoDuration, H00BC2_A588MemoEndDateTime, H00BC2_n588MemoEndDateTime, H00BC2_A587MemoStartDateTime, H00BC2_n587MemoStartDateTime, H00BC2_A579MemoDocument, H00BC2_n579MemoDocument, H00BC2_A578MemoImage,
               H00BC2_n578MemoImage, H00BC2_A577MemoDescription, H00BC2_A576MemoTitle, H00BC2_A575MemoId
               }
               , new Object[] {
               H00BC3_A555SG_LocationId, H00BC3_A556SG_OrganisationId, H00BC3_A29LocationId, H00BC3_A11OrganisationId, H00BC3_A568MemoCategoryId, H00BC3_A71ResidentGUID, H00BC3_A65ResidentLastName, H00BC3_A64ResidentGivenName, H00BC3_A72ResidentSalutation, H00BC3_A62ResidentId,
               H00BC3_A590MemoRemoveDate, H00BC3_A589MemoDuration, H00BC3_n589MemoDuration, H00BC3_A588MemoEndDateTime, H00BC3_n588MemoEndDateTime, H00BC3_A587MemoStartDateTime, H00BC3_n587MemoStartDateTime, H00BC3_A579MemoDocument, H00BC3_n579MemoDocument, H00BC3_A578MemoImage,
               H00BC3_n578MemoImage, H00BC3_A577MemoDescription, H00BC3_A576MemoTitle, H00BC3_A575MemoId
               }
            }
         );
         AV36Pgmname = "Trn_MemoCategoryTrn_MemoWC";
      ...
      private Guid[] H00BC2_A555SG_LocationId ;
      private Guid[] H00BC2_A556SG_OrganisationId ;
      private Guid[] H00BC2_A29LocationId ;
      private Guid[] H00BC2_A11OrganisationId ;
      private Guid[] H00BC2_A568MemoCategoryId ;
      private string[] H00BC2_A71ResidentGUID ;
      private string[] H00BC2_A65ResidentLastName ;
      private string[] H00BC2_A64ResidentGivenName ;
      private string[] H00BC2_A72ResidentSalutation ;
      private Guid[] H00BC2_A62ResidentId ;
      private DateTime[] H00BC2_A590MemoRemoveDate ;
      private short[] H00BC2_A589MemoDuration ;
      private bool[] H00BC2_n589MemoDuration ;
      private DateTime[] H00BC2_A588MemoEndDateTime ;
      private bool[] H00BC2_n588MemoEndDateTime ;
      private DateTime[] H00BC2_A587MemoStartDateTime ;
      private bool[] H00BC2_n587MemoStartDateTime ;
      private string[] H00BC2_A579MemoDocument ;
      private bool[] H00BC2_n579MemoDocument ;
      private string[] H00BC2_A578MemoImage ;
      private bool[] H00BC2_n578MemoImage ;
      private string[] H00BC2_A577MemoDescription ;
      private string[] H00BC2_A576MemoTitle ;
      private Guid[] H00BC2_A575MemoId ;
      private Guid[] H00BC3_A555SG_LocationId ;
      private Guid[] H00BC3_A556SG_OrganisationId ;
      private Guid[] H00BC3_A29LocationId ;
      private Guid[] H00BC3_A11OrganisationId ;
      private Guid[] H00BC3_A568MemoCategoryId ;
      private string[] H00BC3_A71ResidentGUID ;
      private string[] H00BC3_A65ResidentLastName ;
      private string[] H00BC3_A64ResidentGivenName ;
      private string[] H00BC3_A72ResidentSalutation ;
      private Guid[] H00BC3_A62ResidentId ;
      private DateTime[] H00BC3_A590MemoRemoveDate ;
      private short[] H00BC3_A589MemoDuration ;
      private bool[] H00BC3_n589MemoDuration ;
      private DateTime[] H00BC3_A588MemoEndDateTime ;
      private bool[] H00BC3_n588MemoEndDateTime ;
      private DateTime[] H00BC3_A587MemoStartDateTime ;
      private bool[] H00BC3_n587MemoStartDateTime ;
      private string[] H00BC3_A579MemoDocument ;
      private bool[] H00BC3_n579MemoDocument ;
      private string[] H00BC3_A578MemoImage ;
      private bool[] H00BC3_n578MemoImage ;
      private string[] H00BC3_A577MemoDescription ;
      private string[] H00BC3_A576MemoTitle ;
      private Guid[] H00BC3_A575MemoId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00BC3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BC3,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
