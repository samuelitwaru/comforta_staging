...
namespace GeneXus.Programs {
   public class prc_subscriberesidenttodiscussion : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A128WWPNotificationDefinitionId = P00A32_A128WWPNotificationDefinitionId[0];
            A125WWPEntityId = P00A32_A125WWPEntityId[0];
            A164WWPNotificationDefinitionName = P00A32_A164WWPNotificationDefinitionName[0];
            AV17GXLvl2 = 1;
            AV19GXLvl5 = 0;
            /* Optimized UPDATE. */
            /* Using cursor P00A33 */
      ...
      {
         P00A32_A128WWPNotificationDefinitionId = new long[1] ;
         P00A32_A125WWPEntityId = new long[1] ;
         P00A32_A164WWPNotificationDefinitionName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_subscriberesidenttodiscussion__default(),
            new Object[][] {
                new Object[] {
               P00A32_A128WWPNotificationDefinitionId, P00A32_A125WWPEntityId, P00A32_A164WWPNotificationDefinitionName
               }
               , new Object[] {
               }
            }
      ...
      private long[] P00A32_A128WWPNotificationDefinitionId ;
      private long[] P00A32_A125WWPEntityId ;
      private string[] P00A32_A164WWPNotificationDefinitionName ;
