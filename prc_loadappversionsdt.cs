   ...
   public class prc_loadappversionsdt__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CM2", "SELECT PageId, PageName, PageType, PageStructure, AppVersionId FROM Trn_AppVersionPage ORDER BY AppVersionId, PageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CM2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
