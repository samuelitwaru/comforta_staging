...
namespace GeneXus.Programs {
   public class trn_residentww : GXDataArea
   {
      ...
      protected void RF662( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV75Trn_residentwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV75Trn_residentwwds_1_filterfulltext), "%", "");
            lV75Trn_residentwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV75Trn_residentwwds_1_filterfulltext), "%", "");
            lV75Trn_residentwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV75Trn_residentwwds_1_filterfulltext), "%", "");
            lV75Trn_residentwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV75Trn_residentwwds_1_filterfulltext), "%", "");
            lV75Trn_residentwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV75Trn_residentwwds_1_filterfulltext), "%", "");
            ...
            /* Using cursor H00662 */
            pr_default.execute(0, new Object[] {lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV77Trn_residentwwds_3_tfresidentgivenname, AV78Trn_residentwwds_4_tfresidentgivenname_sel, lV79Trn_residentwwds_5_tfresidentlastname, AV80Trn_residentwwds_6_tfresidentlastname_sel, lV82Trn_residentwwds_8_tfresidentemail, AV83Trn_residentwwds_9_tfresidentemail_sel, lV84Trn_residentwwds_10_tfresidentphone, AV85Trn_residentwwds_11_tfresidentphone_sel, lV86Trn_residentwwds_12_tfresidenttypename, AV87Trn_residentwwds_13_tfresidenttypename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV86Trn_residentwwds_12_tfresidenttypename = StringUtil.Concat( StringUtil.RTrim( AV86Trn_residentwwds_12_tfresidenttypename), "%", "");
         /* Using cursor H00663 */
         pr_default.execute(1, new Object[] {lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV75Trn_residentwwds_1_filterfulltext, lV77Trn_residentwwds_3_tfresidentgivenname, AV78Trn_residentwwds_4_tfresidentgivenname_sel, lV79Trn_residentwwds_5_tfresidentlastname, AV80Trn_residentwwds_6_tfresidentlastname_sel, lV82Trn_residentwwds_8_tfresidentemail, AV83Trn_residentwwds_9_tfresidentemail_sel, lV84Trn_residentwwds_10_tfresidentphone, AV85Trn_residentwwds_11_tfresidentphone_sel, lV86Trn_residentwwds_12_tfresidenttypename, AV87Trn_residentwwds_13_tfresidenttypename_sel});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024121019514921", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentww.js", "?2024121019514923", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class trn_residentww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sFromString = " FROM ((Trn_Resident T1 LEFT JOIN Trn_MedicalIndication T2 ON T2.MedicalIndicationId = T1.MedicalIndicationId) INNER JOIN Trn_ResidentType T3 ON T3.ResidentTypeId = T1.ResidentTypeId)";
         sOrderString = "";
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_residentwwds_13_tfresidenttypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_residentwwds_12_tfresidenttypename)) ) )
         {
            AddWhere(sWhereString, "(T2.ResidentTypeName like :lV86Trn_residentwwds_12_tfresidenttypename)");
         }
         else
         {
            GXv_int13[20] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_residentwwds_13_tfresidenttypename_sel)) && ! ( StringUtil.StrCmp(AV87Trn_residentwwds_13_tfresidenttypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.ResidentTypeName = ( :AV87Trn_residentwwds_13_tfresidenttypename_sel))");
         }
         else
         {
            GXv_int13[21] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV75Trn_residentwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV75Trn_residentwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV75Trn_residentwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV75Trn_residentwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV75Trn_residentwwds_1_filterfulltext",GXType.VarChar,100,0) ,
