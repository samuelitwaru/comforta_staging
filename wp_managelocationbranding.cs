...
namespace GeneXus.Programs {
   public class wp_managelocationbranding : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV31LocationId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void WBBH0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, context.GetMessage( "Location Branding", ""), 1, 0, "px", 0, "px", "Group", "", "HLP_WP_ManageLocationBranding.htm");
            /* Div Control */
      ...
      protected void E12BH2( )
      {
         ...
         if ( AV32Trn_Location.Update() )
         {
            ...
            AV30websession.Set(context.GetMessage( "NotificationMessage", ""), context.GetMessage( "Location brand updated successfully", ""));
      ...
      protected void S132( )
      {
         ...
         while ( AV39GXV1 <= AV10ErrorMessages.Count )
         {
            ...
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error",  AV15Message.gxTpr_Description,  "error",  "",  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025321134400", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_managelocationbranding.js", "?2025321134400", false, true);
         context.AddJavascriptSource("UserControls/UC_ThemeSelectorRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/UC_CtaThemeSelectorRender.js", "", false, true);
