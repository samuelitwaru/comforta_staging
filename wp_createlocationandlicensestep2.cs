...
namespace GeneXus.Programs {
   public class wp_createlocationandlicensestep2 : GXWebComponent
   {
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV24GXV1 = 1;
         while ( AV24GXV1 <= AV8ErrorMessages.Count )
         {
            AV7Error = ((GeneXus.Utils.SdtMessages_Message)AV8ErrorMessages.Item(AV24GXV1));
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV7Error.gxTpr_Description,  "error",  "",  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253211340334", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createlocationandlicensestep2.js", "?20253211340334", false, true);
         context.AddJavascriptSource("UserControls/UC_ThemeSelectorRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/UC_CtaThemeSelectorRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E13BK2","iparms":[{"av":"AV16OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV12LocationHasMyCare","fld":"vLOCATIONHASMYCARE"},{"av":"AV13LocationHasMyLiving","fld":"vLOCATIONHASMYLIVING"},{"av":"AV14LocationHasMyServices","fld":"vLOCATIONHASMYSERVICES"},{"av":"AV15LocationHasOwnBrand","fld":"vLOCATIONHASOWNBRAND"}]""");
         setEventMetadata("'WIZARDPREVIOUS'",""","oparms":[{"av":"AV16OrganisationId","fld":"vORGANISATIONID"},{"av":"AV21WizardData","fld":"vWIZARDDATA"}]}""");
         setEventMetadata("'DOWIZARDFINISH'","""{"handler":"E14BK2","iparms":[{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true},{"av":"AV20WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV12LocationHasMyCare","fld":"vLOCATIONHASMYCARE"},{"av":"AV13LocationHasMyLiving","fld":"vLOCATIONHASMYLIVING"},{"av":"AV14LocationHasMyServices","fld":"vLOCATIONHASMYSERVICES"},{"av":"AV15LocationHasOwnBrand","fld":"vLOCATIONHASOWNBRAND"},{"av":"AV21WizardData","fld":"vWIZARDDATA"},{"av":"AV11ImageFile2","fld":"vIMAGEFILE2"},{"av":"AV16OrganisationId","fld":"vORGANISATIONID"},{"av":"AV22SelectedBrandTheme","fld":"vSELECTEDBRANDTHEME"},{"av":"AV23SelectedCtaTheme","fld":"vSELECTEDCTATHEME"},{"av":"AV8ErrorMessages","fld":"vERRORMESSAGES"}]""");
