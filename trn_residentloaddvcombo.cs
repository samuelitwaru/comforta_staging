...
namespace GeneXus.Programs {
   public class trn_residentloaddvcombo : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            while ( (pr_default.getStatus(4) != 101) )
            {
               ...
               n98MedicalIndicationId = P007A6_n98MedicalIndicationId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  while ( (pr_default.getStatus(5) != 101) )
                  {
                     ...
                     n98MedicalIndicationId = P007A7_n98MedicalIndicationId[0];
               ...
               else
               {
                  ...
                  while ( (pr_default.getStatus(6) != 101) )
                  {
                     ...
                     n98MedicalIndicationId = P007A8_n98MedicalIndicationId[0];
      ...
      protected void S141( )
      {
         ...
         returnInSub = false;
         AV54GXV5 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem1 = AV53GXV4;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem1) ;
         AV53GXV4 = GXt_objcol_SdtSDT_Country_SDT_CountryItem1;
         while ( AV54GXV5 <= AV53GXV4.Count )
         {
            AV41ResidentHomePhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV53GXV4.Item(AV54GXV5));
            AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            while ( (pr_default.getStatus(7) != 101) )
            {
               ...
               A445ResidentHomePhoneCode = P007A9_A445ResidentHomePhoneCode[0];
            ...
            {
               AV56GXV6 = 1;
               while ( AV56GXV6 <= AV15Combo_Data.Count )
               {
                  AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV15Combo_Data.Item(AV56GXV6));
                  if ( StringUtil.StrCmp(AV16Combo_DataItem.gxTpr_Id, AV24SelectedValue) == 0 )
                  {
                     AV38ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
                     AV38ComboTitles.FromJSonString(AV16Combo_DataItem.gxTpr_Title, null);
      ...
      protected void S151( )
      {
         ...
         returnInSub = false;
         AV58GXV8 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem1 = AV57GXV7;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem1) ;
         AV57GXV7 = GXt_objcol_SdtSDT_Country_SDT_CountryItem1;
         while ( AV58GXV8 <= AV57GXV7.Count )
         {
            AV40ResidentPhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV57GXV7.Item(AV58GXV8));
            AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            while ( (pr_default.getStatus(8) != 101) )
            {
               ...
               A375ResidentPhoneCode = P007A10_A375ResidentPhoneCode[0];
            ...
            {
               AV60GXV9 = 1;
               while ( AV60GXV9 <= AV15Combo_Data.Count )
               {
                  AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV15Combo_Data.Item(AV60GXV9));
                  if ( StringUtil.StrCmp(AV16Combo_DataItem.gxTpr_Id, AV24SelectedValue) == 0 )
                  {
                     AV38ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
                     AV38ComboTitles.FromJSonString(AV16Combo_DataItem.gxTpr_Title, null);
      ...
      public override void initialize( )
      {
         ...
         P007A6_n98MedicalIndicationId = new bool[] {false} ;
         ...
         P007A7_n98MedicalIndicationId = new bool[] {false} ;
         ...
         P007A8_n98MedicalIndicationId = new bool[] {false} ;
         P007A8_A99MedicalIndicationName = new string[] {""} ;
         AV53GXV4 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
         ...
         P007A9_A445ResidentHomePhoneCode = new string[] {""} ;
         A445ResidentHomePhoneCode = "";
         AV57GXV7 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
         ...
         P007A10_A375ResidentPhoneCode = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentloaddvcombo__default(),
            new Object[][] {
               ...
               , new Object[] {
               P007A4_A11OrganisationId, P007A4_A29LocationId, P007A4_A62ResidentId, P007A4_A96ResidentTypeId, P007A4_A97ResidentTypeName
               }
               , new Object[] {
               ...
               , new Object[] {
               P007A7_A11OrganisationId, P007A7_A29LocationId, P007A7_A62ResidentId, P007A7_A98MedicalIndicationId, P007A7_n98MedicalIndicationId, P007A7_A99MedicalIndicationName
               }
               , new Object[] {
               P007A8_A98MedicalIndicationId, P007A8_A99MedicalIndicationName
               }
               , new Object[] {
               P007A9_A11OrganisationId, P007A9_A29LocationId, P007A9_A62ResidentId, P007A9_A445ResidentHomePhoneCode
               }
               , new Object[] {
               P007A10_A11OrganisationId, P007A10_A29LocationId, P007A10_A62ResidentId, P007A10_A375ResidentPhoneCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P007A6_n98MedicalIndicationId ;
      ...
      private bool[] P007A7_n98MedicalIndicationId ;
      private string[] P007A7_A99MedicalIndicationName ;
      private Guid[] P007A8_A98MedicalIndicationId ;
      private bool[] P007A8_n98MedicalIndicationId ;
      private string[] P007A8_A99MedicalIndicationName ;
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV53GXV4 ;
      ...
      private string[] P007A9_A445ResidentHomePhoneCode ;
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV57GXV7 ;
      ...
      private string[] P007A10_A375ResidentPhoneCode ;
