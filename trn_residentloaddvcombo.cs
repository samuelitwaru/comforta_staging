...
namespace GeneXus.Programs {
   public class trn_residentloaddvcombo : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "GET_DSC") == 0 )
            {
               ...
               AV43GXV1 = 1;
               while ( AV43GXV1 <= AV33ValuesCollection.Count )
               {
                  AV34ValueItem = ((string)AV33ValuesCollection.Item(AV43GXV1));
      ...
      protected void S121( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "GET_DSC") == 0 )
            {
               ...
               AV32DscsCollection = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
               AV46GXV2 = 1;
               while ( AV46GXV2 <= AV33ValuesCollection.Count )
               {
                  AV34ValueItem = ((string)AV33ValuesCollection.Item(AV46GXV2));
      ...
      protected void S131( )
      {
         ...
         returnInSub = false;
         AV50GXV4 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem1 = AV49GXV3;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem1) ;
         AV49GXV3 = GXt_objcol_SdtSDT_Country_SDT_CountryItem1;
         while ( AV50GXV4 <= AV49GXV3.Count )
         {
            AV39ResidentCountry_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV49GXV3.Item(AV50GXV4));
            AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            {
               AV52GXV5 = 1;
               while ( AV52GXV5 <= AV15Combo_Data.Count )
               {
                  AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV15Combo_Data.Item(AV52GXV5));
      ...
      protected void S141( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A97ResidentTypeName = P007A7_A97ResidentTypeName[0];
               A96ResidentTypeId = P007A7_A96ResidentTypeId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  while ( (pr_default.getStatus(6) != 101) )
                  {
                     ...
                     A96ResidentTypeId = P007A8_A96ResidentTypeId[0];
                     A97ResidentTypeName = P007A8_A97ResidentTypeName[0];
                     A97ResidentTypeName = P007A8_A97ResidentTypeName[0];
               ...
               else
               {
                  ...
                  /* Using cursor P007A9 */
                  pr_default.execute(7, new Object[] {AV30ResidentTypeId});
      ...
      protected void S151( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            while ( (pr_default.getStatus(8) != 101) )
            {
               ...
               n98MedicalIndicationId = P007A10_n98MedicalIndicationId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  pr_default.execute(9, new Object[] {AV20ResidentId, AV21LocationId, AV22OrganisationId});
                  while ( (pr_default.getStatus(9) != 101) )
                  {
                     A11OrganisationId = P007A11_A11OrganisationId[0];
                     A29LocationId = P007A11_A29LocationId[0];
                     A62ResidentId = P007A11_A62ResidentId[0];
                     A98MedicalIndicationId = P007A11_A98MedicalIndicationId[0];
                     n98MedicalIndicationId = P007A11_n98MedicalIndicationId[0];
                     A99MedicalIndicationName = P007A11_A99MedicalIndicationName[0];
                     A99MedicalIndicationName = P007A11_A99MedicalIndicationName[0];
               ...
               else
               {
                  ...
                  pr_default.execute(10, new Object[] {AV31MedicalIndicationId});
      ...
      protected void S161( )
      {
         ...
         returnInSub = false;
         AV60GXV7 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem1 = AV59GXV6;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem1) ;
         AV59GXV6 = GXt_objcol_SdtSDT_Country_SDT_CountryItem1;
         while ( AV60GXV7 <= AV59GXV6.Count )
         {
            AV41ResidentHomePhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV59GXV6.Item(AV60GXV7));
            AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            while ( (pr_default.getStatus(11) != 101) )
            {
               ...
               A445ResidentHomePhoneCode = P007A13_A445ResidentHomePhoneCode[0];
            ...
            {
               AV62GXV8 = 1;
               while ( AV62GXV8 <= AV15Combo_Data.Count )
               {
                  AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV15Combo_Data.Item(AV62GXV8));
                  if ( StringUtil.StrCmp(AV16Combo_DataItem.gxTpr_Id, AV24SelectedValue) == 0 )
                  {
                     AV38ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
                     AV38ComboTitles.FromJSonString(AV16Combo_DataItem.gxTpr_Title, null);
      ...
      protected void S171( )
      {
         ...
         returnInSub = false;
         AV64GXV10 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem1 = AV63GXV9;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem1) ;
         AV63GXV9 = GXt_objcol_SdtSDT_Country_SDT_CountryItem1;
         while ( AV64GXV10 <= AV63GXV9.Count )
         {
            AV40ResidentPhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV63GXV9.Item(AV64GXV10));
            AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
         {
            ...
            pr_default.execute(12, new Object[] {AV20ResidentId, AV21LocationId, AV22OrganisationId});
            while ( (pr_default.getStatus(12) != 101) )
            {
               A11OrganisationId = P007A14_A11OrganisationId[0];
               A29LocationId = P007A14_A29LocationId[0];
               A62ResidentId = P007A14_A62ResidentId[0];
               A375ResidentPhoneCode = P007A14_A375ResidentPhoneCode[0];
            ...
            {
               AV66GXV11 = 1;
               while ( AV66GXV11 <= AV15Combo_Data.Count )
               {
                  AV16Combo_DataItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item)AV15Combo_Data.Item(AV66GXV11));
                  if ( StringUtil.StrCmp(AV16Combo_DataItem.gxTpr_Id, AV24SelectedValue) == 0 )
                  {
                     AV38ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
                     AV38ComboTitles.FromJSonString(AV16Combo_DataItem.gxTpr_Title, null);
      ...
      public override void initialize( )
      {
         ...
         AV49GXV3 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
         ...
         A354ResidentCountry = "";
         A97ResidentTypeName = "";
         P007A7_A97ResidentTypeName = new string[] {""} ;
         P007A7_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         ...
         P007A8_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         P007A8_A97ResidentTypeName = new string[] {""} ;
         ...
         P007A10_n98MedicalIndicationId = new bool[] {false} ;
         A98MedicalIndicationId = Guid.Empty;
         P007A11_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007A11_A29LocationId = new Guid[] {Guid.Empty} ;
         P007A11_A62ResidentId = new Guid[] {Guid.Empty} ;
         P007A11_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         P007A11_n98MedicalIndicationId = new bool[] {false} ;
         P007A11_A99MedicalIndicationName = new string[] {""} ;
         ...
         AV59GXV6 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
         ...
         P007A13_A445ResidentHomePhoneCode = new string[] {""} ;
         A445ResidentHomePhoneCode = "";
         AV63GXV9 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
         ...
         P007A14_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007A14_A29LocationId = new Guid[] {Guid.Empty} ;
         P007A14_A62ResidentId = new Guid[] {Guid.Empty} ;
         P007A14_A375ResidentPhoneCode = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentloaddvcombo__default(),
            new Object[][] {
               ...
               , new Object[] {
               P007A7_A97ResidentTypeName, P007A7_A96ResidentTypeId
               }
               , new Object[] {
               P007A8_A11OrganisationId, P007A8_A29LocationId, P007A8_A62ResidentId, P007A8_A96ResidentTypeId, P007A8_A97ResidentTypeName
               }
               , new Object[] {
               P007A9_A96ResidentTypeId, P007A9_A97ResidentTypeName
               }
               , new Object[] {
               P007A10_A99MedicalIndicationName, P007A10_A98MedicalIndicationId
               }
               , new Object[] {
               P007A11_A11OrganisationId, P007A11_A29LocationId, P007A11_A62ResidentId, P007A11_A98MedicalIndicationId, P007A11_n98MedicalIndicationId, P007A11_A99MedicalIndicationName
               }
               , new Object[] {
               P007A12_A98MedicalIndicationId, P007A12_A99MedicalIndicationName
               }
               , new Object[] {
               P007A13_A11OrganisationId, P007A13_A29LocationId, P007A13_A62ResidentId, P007A13_A445ResidentHomePhoneCode
               }
               , new Object[] {
               P007A14_A11OrganisationId, P007A14_A29LocationId, P007A14_A62ResidentId, P007A14_A375ResidentPhoneCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV44GXLvl41 ;
      private short AV47GXLvl81 ;
      ...
      private int AV64GXV10 ;
      private int AV66GXV11 ;
      ...
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV49GXV3 ;
      ...
      private string[] P007A7_A97ResidentTypeName ;
      private Guid[] P007A7_A96ResidentTypeId ;
      private Guid[] P007A8_A11OrganisationId ;
      private Guid[] P007A8_A29LocationId ;
      private Guid[] P007A8_A62ResidentId ;
      private Guid[] P007A8_A96ResidentTypeId ;
      private string[] P007A8_A97ResidentTypeName ;
      ...
      private bool[] P007A10_n98MedicalIndicationId ;
      private Guid[] P007A11_A11OrganisationId ;
      private Guid[] P007A11_A29LocationId ;
      private Guid[] P007A11_A62ResidentId ;
      private Guid[] P007A11_A98MedicalIndicationId ;
      private bool[] P007A11_n98MedicalIndicationId ;
      private string[] P007A11_A99MedicalIndicationName ;
      ...
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV59GXV6 ;
      ...
      private string[] P007A13_A445ResidentHomePhoneCode ;
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV63GXV9 ;
      ...
      private Guid[] P007A14_A11OrganisationId ;
      private Guid[] P007A14_A29LocationId ;
      private Guid[] P007A14_A62ResidentId ;
      private string[] P007A14_A375ResidentPhoneCode ;
   ...
   public class trn_residentloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P007A7( IGxContext context ,
                                             string AV14SearchTxt ,
      ...
      protected Object[] conditional_P007A10( IGxContext context ,
                                              string AV14SearchTxt ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 5 :
                     return conditional_P007A7(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 8 :
                     return conditional_P007A10(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P007A7", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A7,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P007A8", "SELECT T1.OrganisationId, T1.LocationId, T1.ResidentId, T1.ResidentTypeId, T2.ResidentTypeName FROM (Trn_Resident T1 INNER JOIN Trn_ResidentType T2 ON T2.ResidentTypeId = T1.ResidentTypeId) WHERE T1.ResidentId = :AV20ResidentId and T1.LocationId = :AV21LocationId and T1.OrganisationId = :AV22OrganisationId ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A8,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007A9", "SELECT ResidentTypeId, ResidentTypeName FROM Trn_ResidentType WHERE ResidentTypeId = :AV30ResidentTypeId ORDER BY ResidentTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A9,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007A10", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A10,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P007A11", "SELECT T1.OrganisationId, T1.LocationId, T1.ResidentId, T1.MedicalIndicationId, T2.MedicalIndicationName FROM (Trn_Resident T1 LEFT JOIN Trn_MedicalIndication T2 ON T2.MedicalIndicationId = T1.MedicalIndicationId) WHERE T1.ResidentId = :AV20ResidentId and T1.LocationId = :AV21LocationId and T1.OrganisationId = :AV22OrganisationId ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A11,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007A12", "SELECT MedicalIndicationId, MedicalIndicationName FROM Trn_MedicalIndication WHERE MedicalIndicationId = :AV31MedicalIndicationId ORDER BY MedicalIndicationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A12,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007A13", "SELECT OrganisationId, LocationId, ResidentId, ResidentHomePhoneCode FROM Trn_Resident WHERE ResidentId = :AV20ResidentId and LocationId = :AV21LocationId and OrganisationId = :AV22OrganisationId ORDER BY ResidentId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A13,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007A14", "SELECT OrganisationId, LocationId, ResidentId, ResidentPhoneCode FROM Trn_Resident WHERE ResidentId = :AV20ResidentId and LocationId = :AV21LocationId and OrganisationId = :AV22OrganisationId ORDER BY ResidentId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007A14,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
