...
namespace GeneXus.Programs {
   public class prc_deletecascademanager : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A11OrganisationId = P00C32_A11OrganisationId[0];
            A21ManagerId = P00C32_A21ManagerId[0];
            A28ManagerGAMGUID = P00C32_A28ManagerGAMGUID[0];
      ...
      public override void initialize( )
      {
         ...
         P00C32_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00C32_A21ManagerId = new Guid[] {Guid.Empty} ;
         P00C32_A28ManagerGAMGUID = new string[] {""} ;
         A28ManagerGAMGUID = "";
         AV8GAMErrorResponse = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascademanager__default(),
            new Object[][] {
                new Object[] {
               P00C32_A11OrganisationId, P00C32_A21ManagerId, P00C32_A28ManagerGAMGUID
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C32_A11OrganisationId ;
      private Guid[] P00C32_A21ManagerId ;
      private string[] P00C32_A28ManagerGAMGUID ;
   }

   public class prc_deletecascademanager__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00C32( IGxContext context ,
                                             Guid AV9ManagerId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C32(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C32", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C32,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C33", "SAVEPOINT gxupdate;DELETE FROM Trn_Manager  WHERE ManagerId = :ManagerId AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C33)
          };
       }
    }
