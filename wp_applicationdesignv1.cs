...
namespace GeneXus.Programs {
   public class wp_applicationdesignv1 : GXDataArea
   {
      ...
      {
         return context.GetMessage( "WP_Application Design V1", "") ;
      }
      ...
      protected void STARTB42( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WP_Application Design V1", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E12B42( )
      {
         ...
         {
            A11OrganisationId = H00B42_A11OrganisationId[0];
            A40000OrganisationLogo_GXI = H00B42_A40000OrganisationLogo_GXI[0];
         ...
         {
            A29LocationId = H00B43_A29LocationId[0];
            A247Trn_ThemeId = H00B43_A247Trn_ThemeId[0];
            n247Trn_ThemeId = H00B43_n247Trn_ThemeId[0];
         ...
         {
            A278Trn_TemplateId = H00B44_A278Trn_TemplateId[0];
            AV10BC_Trn_Template = new SdtTrn_Template(context);
            AV10BC_Trn_Template.Load(A278Trn_TemplateId);
         ...
         {
            A11OrganisationId = H00B45_A11OrganisationId[0];
            A29LocationId = H00B45_A29LocationId[0];
            A40001ProductServiceImage_GXI = H00B45_A40001ProductServiceImage_GXI[0];
            A58ProductServiceId = H00B45_A58ProductServiceId[0];
            A59ProductServiceName = H00B45_A59ProductServiceName[0];
            A301ProductServiceTileName = H00B45_A301ProductServiceTileName[0];
            A61ProductServiceImage = H00B45_A61ProductServiceImage[0];
         ...
         {
            A207WWPFormVersionNumber = H00B46_A207WWPFormVersionNumber[0];
            A11OrganisationId = H00B46_A11OrganisationId[0];
            A29LocationId = H00B46_A29LocationId[0];
            A206WWPFormId = H00B46_A206WWPFormId[0];
            A208WWPFormReferenceName = H00B46_A208WWPFormReferenceName[0];
            A208WWPFormReferenceName = H00B46_A208WWPFormReferenceName[0];
         ...
         {
            A29LocationId = H00B47_A29LocationId[0];
            A409MediaId = H00B47_A409MediaId[0];
            A410MediaName = H00B47_A410MediaName[0];
            AV6BC_Trn_Media = new SdtTrn_Media(context);
            AV6BC_Trn_Media.Load(A409MediaId);
            AV46MediaPath = context.GetMessage( "media/", "") + A410MediaName;
            AV45File = new GxFile(context.GetPhysicalPath());
            AV45File.Source = context.GetMessage( "media/", "")+A410MediaName;
            if ( AV45File.Exists() )
            {
         ...
         new prc_getorganisationtheme(context ).execute(  AV25OrganisationId, out  GXt_objcol_SdtTrn_Theme4) ;
         AV13BC_Trn_ThemeCollection = GXt_objcol_SdtTrn_Theme4;
         /* Using cursor H00B48 */
         pr_default.execute(6);
         while ( (pr_default.getStatus(6) != 101) )
         {
            A310Trn_PageId = H00B48_A310Trn_PageId[0];
            A318Trn_PageName = H00B48_A318Trn_PageName[0];
            A437PageChildren = H00B48_A437PageChildren[0];
            n437PageChildren = H00B48_n437PageChildren[0];
            AV35SDT_PageStructure = new SdtSDT_PageStructure(context);
            AV35SDT_PageStructure.gxTpr_Id = A310Trn_PageId;
            AV35SDT_PageStructure.gxTpr_Name = A318Trn_PageName;
            AV35SDT_PageStructure.gxTpr_Children.FromJSonString(A437PageChildren, null);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253181353799", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesignv1.js", "?2025318135380", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBoxRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "WP_Application Design V1", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("APPTOOLBOX1.ADDSERVICEBUTTONEVENT","""{"handler":"E11B42","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00B42_A40000OrganisationLogo_GXI = new string[] {""} ;
         A11OrganisationId = Guid.Empty;
         A40000OrganisationLogo_GXI = "";
         H00B43_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B43_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B43_A247Trn_ThemeId = new Guid[] {Guid.Empty} ;
         H00B43_n247Trn_ThemeId = new bool[] {false} ;
         A29LocationId = Guid.Empty;
         A247Trn_ThemeId = Guid.Empty;
         H00B44_A278Trn_TemplateId = new Guid[] {Guid.Empty} ;
         A278Trn_TemplateId = Guid.Empty;
         AV10BC_Trn_Template = new SdtTrn_Template(context);
         AV52Udparg1 = Guid.Empty;
         AV53Udparg2 = Guid.Empty;
         H00B45_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B45_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B45_A40001ProductServiceImage_GXI = new string[] {""} ;
         H00B45_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H00B45_A59ProductServiceName = new string[] {""} ;
         H00B45_A301ProductServiceTileName = new string[] {""} ;
         H00B45_A61ProductServiceImage = new string[] {""} ;
         ...
         AV36SDT_ProductService = new SdtSDT_ProductService(context);
         H00B46_A395LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         H00B46_A207WWPFormVersionNumber = new short[1] ;
         H00B46_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00B46_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B46_A206WWPFormId = new short[1] ;
         H00B46_A208WWPFormReferenceName = new string[] {""} ;
         A208WWPFormReferenceName = "";
         AV28SDT_DynamicForms = new SdtSDT_DynamicForms(context);
         GXt_char1 = "";
         GXt_char3 = "";
         H00B47_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B47_A409MediaId = new Guid[] {Guid.Empty} ;
         H00B47_A410MediaName = new string[] {""} ;
         ...
         H00B48_A29LocationId = new Guid[] {Guid.Empty} ;
         H00B48_A310Trn_PageId = new Guid[] {Guid.Empty} ;
         H00B48_A318Trn_PageName = new string[] {""} ;
         H00B48_A437PageChildren = new string[] {""} ;
         H00B48_n437PageChildren = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_applicationdesignv1__default(),
            new Object[][] {
                new Object[] {
               H00B42_A11OrganisationId, H00B42_A40000OrganisationLogo_GXI
               }
               , new Object[] {
               H00B43_A11OrganisationId, H00B43_A29LocationId, H00B43_A247Trn_ThemeId, H00B43_n247Trn_ThemeId
               }
               , new Object[] {
               H00B44_A278Trn_TemplateId
               }
               , new Object[] {
               H00B45_A11OrganisationId, H00B45_A29LocationId, H00B45_A40001ProductServiceImage_GXI, H00B45_A58ProductServiceId, H00B45_A59ProductServiceName, H00B45_A301ProductServiceTileName, H00B45_A61ProductServiceImage
               }
               , new Object[] {
               H00B46_A395LocationDynamicFormId, H00B46_A207WWPFormVersionNumber, H00B46_A11OrganisationId, H00B46_A29LocationId, H00B46_A206WWPFormId, H00B46_A208WWPFormReferenceName
               }
               , new Object[] {
               H00B47_A29LocationId, H00B47_A409MediaId, H00B47_A410MediaName
               }
               , new Object[] {
               H00B48_A29LocationId, H00B48_A310Trn_PageId, H00B48_A318Trn_PageName, H00B48_A437PageChildren, H00B48_n437PageChildren
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] H00B42_A40000OrganisationLogo_GXI ;
      private Guid[] H00B43_A11OrganisationId ;
      private Guid[] H00B43_A29LocationId ;
      private Guid[] H00B43_A247Trn_ThemeId ;
      private bool[] H00B43_n247Trn_ThemeId ;
      private Guid[] H00B44_A278Trn_TemplateId ;
      private SdtTrn_Template AV10BC_Trn_Template ;
      private Guid[] H00B45_A11OrganisationId ;
      private Guid[] H00B45_A29LocationId ;
      private string[] H00B45_A40001ProductServiceImage_GXI ;
      private Guid[] H00B45_A58ProductServiceId ;
      private string[] H00B45_A59ProductServiceName ;
      private string[] H00B45_A301ProductServiceTileName ;
      private string[] H00B45_A61ProductServiceImage ;
      private SdtSDT_ProductService AV36SDT_ProductService ;
      private Guid[] H00B46_A395LocationDynamicFormId ;
      private short[] H00B46_A207WWPFormVersionNumber ;
      private Guid[] H00B46_A11OrganisationId ;
      private Guid[] H00B46_A29LocationId ;
      private short[] H00B46_A206WWPFormId ;
      private string[] H00B46_A208WWPFormReferenceName ;
      private SdtSDT_DynamicForms AV28SDT_DynamicForms ;
      private Guid[] H00B47_A29LocationId ;
      private Guid[] H00B47_A409MediaId ;
      private string[] H00B47_A410MediaName ;
      private SdtTrn_Media AV6BC_Trn_Media ;
      private GXBCCollection<SdtTrn_Theme> GXt_objcol_SdtTrn_Theme4 ;
      private Guid[] H00B48_A29LocationId ;
      private Guid[] H00B48_A310Trn_PageId ;
      private string[] H00B48_A318Trn_PageName ;
      private string[] H00B48_A437PageChildren ;
      private bool[] H00B48_n437PageChildren ;
...
public class wp_applicationdesignv1__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       Object[] prmH00B47;
       prmH00B47 = new Object[] {
       new ParDef("AV52Udparg1",GXType.UniqueIdentifier,36,0)
       };
       Object[] prmH00B48;
       prmH00B48 = new Object[] {
       };
       def= new CursorDef[] {
           new CursorDef("H00B42", "SELECT OrganisationId, OrganisationLogo_GXI FROM Trn_Organisation WHERE OrganisationId = :AV25OrganisationId ORDER BY OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B42,1, GxCacheFrequency.OFF ,false,true )
          ,new CursorDef("H00B43", "SELECT OrganisationId, LocationId, Trn_ThemeId FROM Trn_Location WHERE LocationId = :AV22LocationId ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B43,100, GxCacheFrequency.OFF ,false,false )
          ,new CursorDef("H00B44", "SELECT Trn_TemplateId FROM Trn_Template ORDER BY Trn_TemplateId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B44,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00B45", "SELECT OrganisationId, LocationId, ProductServiceImage_GXI, ProductServiceId, ProductServiceName, ProductServiceTileName, ProductServiceImage FROM Trn_ProductService WHERE LocationId = :AV52Udparg1 and OrganisationId = :AV53Udparg2 ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B45,100, GxCacheFrequency.OFF ,false,false )
          ,new CursorDef("H00B46", "SELECT T1.LocationDynamicFormId, T1.WWPFormVersionNumber, T1.OrganisationId, T1.LocationId, T1.WWPFormId, T2.WWPFormReferenceName FROM (Trn_LocationDynamicForm T1 INNER JOIN WWP_Form T2 ON T2.WWPFormId = T1.WWPFormId AND T2.WWPFormVersionNumber = T1.WWPFormVersionNumber) WHERE T1.LocationId = :AV52Udparg1 and T1.OrganisationId = :AV53Udparg2 ORDER BY T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B46,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00B47", "SELECT LocationId, MediaId, MediaName FROM Trn_Media WHERE LocationId = :AV52Udparg1 ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B47,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("H00B48", "SELECT LocationId, Trn_PageId, Trn_PageName, PageChildren FROM Trn_Page ORDER BY Trn_PageId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B48,100, GxCacheFrequency.OFF ,false,false )
       };
    }
 }
