...
namespace GeneXus.Programs {
   public class trn_bulletinboardview : GXDataArea
   {
      public trn_bulletinboardview( )
      {
      ...
      public trn_bulletinboardview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_BulletinBoardId ,
                           string aP1_TabCode )
      {
         this.AV10BulletinBoardId = aP0_BulletinBoardId;
      ...
      {
         get {
            return "trn_bulletinboardview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_bulletinboardview.aspx"+UrlEncode(AV10BulletinBoardId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_bulletinboardview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBULLETINBOARDID", AV10BulletinBoardId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vBULLETINBOARDID", GetSecureSignedToken( "", AV10BulletinBoardId, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_bulletinboardview.aspx"+UrlEncode(AV10BulletinBoardId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_bulletinboardview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_BulletinBoardView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Bulletin Board View", "") ;
      }
      ...
      protected void WBB70( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_BulletinBoardView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_memo_title_Internalname, context.GetMessage( "Memos", ""), "", "", lblTrn_memo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_BulletinBoardView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void STARTB72( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Bulletin Board View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PAB72( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_bulletinboardview.aspx")), "trn_bulletinboardview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_bulletinboardview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10BulletinBoardId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10BulletinBoardId", AV10BulletinBoardId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vBULLETINBOARDID", GetSecureSignedToken( "", AV10BulletinBoardId, context));
      ...
      protected void RFB72( )
      {
         ...
         {
            /* Using cursor H00B72 */
            pr_default.execute(0, new Object[] {AV10BulletinBoardId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A574BulletinBoardId = H00B72_A574BulletinBoardId[0];
               /* Execute user event: Load */
               E16B72 ();
      ...
      protected void E14B72( )
      {
         ...
         AV17GXLvl8 = 0;
         /* Using cursor H00B73 */
         pr_default.execute(1, new Object[] {AV10BulletinBoardId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A574BulletinBoardId = H00B73_A574BulletinBoardId[0];
            A585BulletinBoardBgColorCode = H00B73_A585BulletinBoardBgColorCode[0];
            AV17GXLvl8 = 1;
            Form.Caption = A585BulletinBoardBgColorCode;
      ...
      protected void E15B72( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_BulletinBoard",  StringUtil.Trim( A574BulletinBoardId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_BulletinBoard",  2) )
         {
      ...
      protected void E11B72( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_BulletinBoard",(short)2,StringUtil.Trim( A574BulletinBoardId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12B72( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_BulletinBoard",StringUtil.Trim( A574BulletinBoardId.ToString()),(string)AV14RecordDescription,formatLink("trn_bulletinboardview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Trn_BulletinBoardGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_bulletinboardgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Trn_BulletinBoardGeneral";
               WebComp_Generalwc_Component = "Trn_BulletinBoardGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0027",(string)"",(Guid)AV10BulletinBoardId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "Trn_Memo") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_memowc_Component), StringUtil.Lower( "Trn_BulletinBoardTrn_MemoWC")) != 0 )
            {
               WebComp_Trn_memowc = getWebComponent(GetType(), "GeneXus.Programs", "trn_bulletinboardtrn_memowc", new Object[] {context} );
               WebComp_Trn_memowc.ComponentInit();
               WebComp_Trn_memowc.Name = "Trn_BulletinBoardTrn_MemoWC";
               WebComp_Trn_memowc_Component = "Trn_BulletinBoardTrn_MemoWC";
            }
            if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
            {
               WebComp_Trn_memowc.setjustcreated();
               WebComp_Trn_memowc.componentprepare(new Object[] {(string)"W0035",(string)"",(Guid)AV10BulletinBoardId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BulletinBoardId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10BulletinBoardId", AV10BulletinBoardId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vBULLETINBOARDID", GetSecureSignedToken( "", AV10BulletinBoardId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202531920411532", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_bulletinboardview.js", "?202531920411533", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Bulletin Board View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A574BulletinBoardId","fld":"BULLETINBOARDID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10BulletinBoardId","fld":"vBULLETINBOARDID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11B72","iparms":[{"av":"A574BulletinBoardId","fld":"BULLETINBOARDID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12B72","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A574BulletinBoardId","fld":"BULLETINBOARDID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13B72","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10BulletinBoardId","fld":"vBULLETINBOARDID","hsh":true}]""");
      ...
      {
         wcpOAV10BulletinBoardId = Guid.Empty;
         wcpOAV8TabCode = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B72_A574BulletinBoardId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B73_A574BulletinBoardId = new Guid[] {Guid.Empty} ;
         H00B73_A585BulletinBoardBgColorCode = new string[] {""} ;
         A585BulletinBoardBgColorCode = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_bulletinboardview__default(),
            new Object[][] {
                new Object[] {
               H00B72_A574BulletinBoardId
               }
               , new Object[] {
               H00B73_A574BulletinBoardId, H00B73_A585BulletinBoardBgColorCode
               }
            }
         );
      ...
      private Guid AV10BulletinBoardId ;
      private Guid wcpOAV10BulletinBoardId ;
      ...
      private Guid[] H00B72_A574BulletinBoardId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00B73_A574BulletinBoardId ;
      private string[] H00B73_A585BulletinBoardBgColorCode ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_bulletinboardview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10BulletinBoardId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00B73;
          ...
          def= new CursorDef[] {
              new CursorDef("H00B72", "SELECT BulletinBoardId FROM Trn_BulletinBoard WHERE BulletinBoardId = :AV10BulletinBoardId ORDER BY BulletinBoardId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B72,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00B73", "SELECT BulletinBoardId, BulletinBoardBgColorCode FROM Trn_BulletinBoard WHERE BulletinBoardId = :AV10BulletinBoardId ORDER BY BulletinBoardId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B73,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
