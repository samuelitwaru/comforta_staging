...
namespace GeneXus.Programs {
   public class trn_memocategorywwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV26GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "Trn_MemoCategoryWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRKCR2 = false;
            A569MemoCategoryName = P00CR2_A569MemoCategoryName[0];
            A568MemoCategoryId = P00CR2_A568MemoCategoryId[0];
            AV23count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00CR2_A569MemoCategoryName[0], A569MemoCategoryName) == 0 ) )
            {
               BRKCR2 = false;
               A568MemoCategoryId = P00CR2_A568MemoCategoryId[0];
            ...
            if ( (0==AV14SkipItems) )
            {
               AV18Option = (String.IsNullOrEmpty(StringUtil.RTrim( A569MemoCategoryName)) ? "<#Empty#>" : A569MemoCategoryName);
      ...
      public override void initialize( )
      {
         ...
         A569MemoCategoryName = "";
         P00CR2_A569MemoCategoryName = new string[] {""} ;
         P00CR2_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memocategorywwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00CR2_A569MemoCategoryName, P00CR2_A568MemoCategoryId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00CR2_A569MemoCategoryName ;
      private Guid[] P00CR2_A568MemoCategoryId ;
   ...
   public class trn_memocategorywwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00CR2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
