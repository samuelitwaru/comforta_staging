...
namespace GeneXus.Programs {
   public class prc_deletecascadelocationdynamicform : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A206WWPFormId = P00C72_A206WWPFormId[0];
            A395LocationDynamicFormId = P00C72_A395LocationDynamicFormId[0];
            A11OrganisationId = P00C72_A11OrganisationId[0];
            A29LocationId = P00C72_A29LocationId[0];
            A207WWPFormVersionNumber = P00C72_A207WWPFormVersionNumber[0];
            new prc_deletelocationform(context ).execute(  A206WWPFormId,  A207WWPFormVersionNumber,  A395LocationDynamicFormId,  A11OrganisationId,  A29LocationId, out  AV12Messages) ;
            if ( AV12Messages.Count == 0 )
            {
               /* Using cursor P00C73 */
               pr_default.execute(1, new Object[] {A395LocationDynamicFormId, A11OrganisationId, A29LocationId});
               pr_default.close(1);
      ...
      public override void initialize( )
      {
         ...
         P00C72_A206WWPFormId = new short[1] ;
         P00C72_A395LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         P00C72_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00C72_A29LocationId = new Guid[] {Guid.Empty} ;
         P00C72_A207WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadelocationdynamicform__default(),
            new Object[][] {
                new Object[] {
               P00C72_A206WWPFormId, P00C72_A395LocationDynamicFormId, P00C72_A11OrganisationId, P00C72_A29LocationId, P00C72_A207WWPFormVersionNumber
               }
               , new Object[] {
               }
            }
      ...
      private short[] P00C72_A206WWPFormId ;
      private Guid[] P00C72_A395LocationDynamicFormId ;
      private Guid[] P00C72_A11OrganisationId ;
      private Guid[] P00C72_A29LocationId ;
      private short[] P00C72_A207WWPFormVersionNumber ;
   ...
   public class prc_deletecascadelocationdynamicform__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C72(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (short)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (short)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C72", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C72,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C73", "SAVEPOINT gxupdate;DELETE FROM Trn_LocationDynamicForm  WHERE LocationDynamicFormId = :LocationDynamicFormId AND OrganisationId = :OrganisationId AND LocationId = :LocationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C73)
          };
       }
    }
