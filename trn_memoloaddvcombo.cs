...
namespace GeneXus.Programs {
   public class trn_memoloaddvcombo : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A569MemoCategoryName = P00CU2_A569MemoCategoryName[0];
               A568MemoCategoryId = P00CU2_A568MemoCategoryId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV16Combo_DataItem.gxTpr_Id = StringUtil.Trim( A568MemoCategoryId.ToString());
               AV16Combo_DataItem.gxTpr_Title = A569MemoCategoryName;
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  {
                     A575MemoId = P00CU3_A575MemoId[0];
                     A568MemoCategoryId = P00CU3_A568MemoCategoryId[0];
                     A569MemoCategoryName = P00CU3_A569MemoCategoryName[0];
                     A569MemoCategoryName = P00CU3_A569MemoCategoryName[0];
                     AV22SelectedValue = ((Guid.Empty==A568MemoCategoryId) ? "" : StringUtil.Trim( A568MemoCategoryId.ToString()));
                     AV23SelectedText = A569MemoCategoryName;
               ...
               else
               {
                  ...
                  {
                     A568MemoCategoryId = P00CU4_A568MemoCategoryId[0];
                     A569MemoCategoryName = P00CU4_A569MemoCategoryName[0];
                     AV23SelectedText = A569MemoCategoryName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         lV14SearchTxt = "";
         A569MemoCategoryName = "";
         P00CU2_A569MemoCategoryName = new string[] {""} ;
         P00CU2_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         A568MemoCategoryId = Guid.Empty;
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV15Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         P00CU3_A575MemoId = new Guid[] {Guid.Empty} ;
         P00CU3_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00CU3_A569MemoCategoryName = new string[] {""} ;
         A575MemoId = Guid.Empty;
         AV29MemoCategoryId = Guid.Empty;
         P00CU4_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         P00CU4_A569MemoCategoryName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memoloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00CU2_A569MemoCategoryName, P00CU2_A568MemoCategoryId
               }
               , new Object[] {
               P00CU3_A575MemoId, P00CU3_A568MemoCategoryId, P00CU3_A569MemoCategoryName
               }
               , new Object[] {
               P00CU4_A568MemoCategoryId, P00CU4_A569MemoCategoryName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00CU2_A569MemoCategoryName ;
      private Guid[] P00CU2_A568MemoCategoryId ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV16Combo_DataItem ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV15Combo_Data ;
      private Guid[] P00CU3_A575MemoId ;
      private Guid[] P00CU3_A568MemoCategoryId ;
      private string[] P00CU3_A569MemoCategoryName ;
      private Guid[] P00CU4_A568MemoCategoryId ;
      private string[] P00CU4_A569MemoCategoryName ;
   ...
   public class trn_memoloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00CU2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CU2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CU2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00CU3", "SELECT T1.MemoId, T1.MemoCategoryId, T2.MemoCategoryName FROM (Trn_Memo T1 INNER JOIN Trn_MemoCategory T2 ON T2.MemoCategoryId = T1.MemoCategoryId) WHERE T1.MemoId = :AV20MemoId ORDER BY T1.MemoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CU3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00CU4", "SELECT MemoCategoryId, MemoCategoryName FROM Trn_MemoCategory WHERE MemoCategoryId = :AV29MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CU4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
