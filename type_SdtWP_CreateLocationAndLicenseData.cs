	...
	public class SdtWP_CreateLocationAndLicenseData : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardAuxiliarData_WizardAuxiliarDataItem> gxTpr_Auxiliardata_GXBaseCollection
		{
			get {
				if ( gxTv_SdtWP_CreateLocationAndLicenseData_Auxiliardata == null )
				{
					gxTv_SdtWP_CreateLocationAndLicenseData_Auxiliardata = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardAuxiliarData_WizardAuxiliarDataItem>( context, "WizardAuxiliarData", "");
				}
		...
		protected GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardAuxiliarData_WizardAuxiliarDataItem> gxTv_SdtWP_CreateLocationAndLicenseData_Auxiliardata = null;  
