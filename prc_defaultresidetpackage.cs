   ...
   public class prc_defaultresidetpackage__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BN2", "UPDATE Trn_ResidentPackage SET ResidentPackageDefault=FALSE  WHERE (SG_LocationId = :AV9LocationId) AND (Not ResidentPackageId = :AV8ResidentPackageId)", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00BN2)
          };
       }
    }
