...
namespace GeneXus.Programs {
   public class trn_organisationww : GXDataArea
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              A520OrganisationLogo = cgiGet( edtOrganisationLogo_Internalname);
                              AssignProp("", false, edtOrganisationLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo)) ? A40000OrganisationLogo_GXI : context.convertURL( context.PathToRelativeUrl( A520OrganisationLogo))), !bGXsfl_39_Refreshing);
                              AssignProp("", false, edtOrganisationLogo_Internalname, "SrcSet", context.GetImageSrcSet( A520OrganisationLogo), true);
      ...
      {
         /* GeneXus formulas. */
         AV81Pgmname = "Trn_OrganisationWW";
      ...
      protected void RF3U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV82Trn_organisationwwds_1_filterfulltext ,
                                                 AV84Trn_organisationwwds_3_tforganisationname_sel ,
                                                 AV83Trn_organisationwwds_2_tforganisationname ,
                                                 AV86Trn_organisationwwds_5_tforganisationtypename_sel ,
                                                 AV85Trn_organisationwwds_4_tforganisationtypename ,
                                                 AV88Trn_organisationwwds_7_tforganisationemail_sel ,
                                                 AV87Trn_organisationwwds_6_tforganisationemail ,
                                                 AV90Trn_organisationwwds_9_tforganisationphone_sel ,
                                                 AV89Trn_organisationwwds_8_tforganisationphone ,
                                                 A13OrganisationName ,
            ...
            lV82Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV82Trn_organisationwwds_1_filterfulltext), "%", "");
            lV82Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV82Trn_organisationwwds_1_filterfulltext), "%", "");
            lV82Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV82Trn_organisationwwds_1_filterfulltext), "%", "");
            lV82Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV82Trn_organisationwwds_1_filterfulltext), "%", "");
            lV83Trn_organisationwwds_2_tforganisationname = StringUtil.Concat( StringUtil.RTrim( AV83Trn_organisationwwds_2_tforganisationname), "%", "");
            lV85Trn_organisationwwds_4_tforganisationtypename = StringUtil.Concat( StringUtil.RTrim( AV85Trn_organisationwwds_4_tforganisationtypename), "%", "");
            lV87Trn_organisationwwds_6_tforganisationemail = StringUtil.Concat( StringUtil.RTrim( AV87Trn_organisationwwds_6_tforganisationemail), "%", "");
            lV89Trn_organisationwwds_8_tforganisationphone = StringUtil.PadR( StringUtil.RTrim( AV89Trn_organisationwwds_8_tforganisationphone), 20, "%");
            /* Using cursor H003U2 */
            pr_default.execute(0, new Object[] {lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV83Trn_organisationwwds_2_tforganisationname, AV84Trn_organisationwwds_3_tforganisationname_sel, lV85Trn_organisationwwds_4_tforganisationtypename, AV86Trn_organisationwwds_5_tforganisationtypename_sel, lV87Trn_organisationwwds_6_tforganisationemail, AV88Trn_organisationwwds_7_tforganisationemail_sel, lV89Trn_organisationwwds_8_tforganisationphone, AV90Trn_organisationwwds_9_tforganisationphone_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A40000OrganisationLogo_GXI = H003U2_A40000OrganisationLogo_GXI[0];
               AssignProp("", false, edtOrganisationLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo)) ? A40000OrganisationLogo_GXI : context.convertURL( context.PathToRelativeUrl( A520OrganisationLogo))), !bGXsfl_39_Refreshing);
               AssignProp("", false, edtOrganisationLogo_Internalname, "SrcSet", context.GetImageSrcSet( A520OrganisationLogo), true);
               ...
               A520OrganisationLogo = H003U2_A520OrganisationLogo[0];
               AssignProp("", false, edtOrganisationLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo)) ? A40000OrganisationLogo_GXI : context.convertURL( context.PathToRelativeUrl( A520OrganisationLogo))), !bGXsfl_39_Refreshing);
               AssignProp("", false, edtOrganisationLogo_Internalname, "SrcSet", context.GetImageSrcSet( A520OrganisationLogo), true);
               A20OrganisationTypeName = H003U2_A20OrganisationTypeName[0];
               /* Execute user event: Grid.Load */
      ...
      {
         AV82Trn_organisationwwds_1_filterfulltext = AV15FilterFullText;
         AV83Trn_organisationwwds_2_tforganisationname = AV22TFOrganisationName;
         AV84Trn_organisationwwds_3_tforganisationname_sel = AV23TFOrganisationName_Sel;
         AV85Trn_organisationwwds_4_tforganisationtypename = AV34TFOrganisationTypeName;
         AV86Trn_organisationwwds_5_tforganisationtypename_sel = AV35TFOrganisationTypeName_Sel;
         AV87Trn_organisationwwds_6_tforganisationemail = AV28TFOrganisationEmail;
         AV88Trn_organisationwwds_7_tforganisationemail_sel = AV29TFOrganisationEmail_Sel;
         AV89Trn_organisationwwds_8_tforganisationphone = AV30TFOrganisationPhone;
         AV90Trn_organisationwwds_9_tforganisationphone_sel = AV31TFOrganisationPhone_Sel;
         ...
         lV89Trn_organisationwwds_8_tforganisationphone = StringUtil.PadR( StringUtil.RTrim( AV89Trn_organisationwwds_8_tforganisationphone), 20, "%");
         /* Using cursor H003U3 */
         pr_default.execute(1, new Object[] {lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV82Trn_organisationwwds_1_filterfulltext, lV83Trn_organisationwwds_2_tforganisationname, AV84Trn_organisationwwds_3_tforganisationname_sel, lV85Trn_organisationwwds_4_tforganisationtypename, AV86Trn_organisationwwds_5_tforganisationtypename_sel, lV87Trn_organisationwwds_6_tforganisationemail, AV88Trn_organisationwwds_7_tforganisationemail_sel, lV89Trn_organisationwwds_8_tforganisationphone, AV90Trn_organisationwwds_9_tforganisationphone_sel});
      ...
      protected void E183U2( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Success",  AV79successmsg,  "success",  "",  "true",  ""));
      ...
      protected void E193U2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV81Pgmname, out  GXt_char3) ;
      ...
      protected void E113U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV81Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV81Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void E143U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0069",(string)"",(string)"Trn_Organisation",(short)1,(string)"",(string)""});
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "Trn_OrganisationWWColumnsSelector", out  GXt_char3) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV81Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV81Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV81Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV91GXV1));
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV81Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025225165860", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationww.js", "?2025225165862", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            A520OrganisationLogo_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo))&&String.IsNullOrEmpty(StringUtil.RTrim( A40000OrganisationLogo_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( A520OrganisationLogo)) ? A40000OrganisationLogo_GXI : context.PathToRelativeUrl( A520OrganisationLogo));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtOrganisationLogo_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)0,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A520OrganisationLogo_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
      ...
      protected void StartGridControl39( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A520OrganisationLogo));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E133U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E153U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E203U2","iparms":[{"av":"A331OrganisationAddressCountry","fld":"ORGANISATIONADDRESSCOUNTRY"},{"av":"A289OrganisationAddressCity","fld":"ORGANISATIONADDRESSCITY"},{"av":"A288OrganisationAddressZipCode","fld":"ORGANISATIONADDRESSZIPCODE"},{"av":"A342OrganisationAddressLine1","fld":"ORGANISATIONADDRESSLINE1"},{"av":"A343OrganisationAddressLine2","fld":"ORGANISATIONADDRESSLINE2"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"}]""");
         ...
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E163U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E113U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E213U2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV72ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV77ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV81Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV6WWPContext","fld":"vWWPCONTEXT"},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"A13OrganisationName","fld":"ORGANISATIONNAME","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         lV82Trn_organisationwwds_1_filterfulltext = "";
         lV83Trn_organisationwwds_2_tforganisationname = "";
         lV85Trn_organisationwwds_4_tforganisationtypename = "";
         lV87Trn_organisationwwds_6_tforganisationemail = "";
         lV89Trn_organisationwwds_8_tforganisationphone = "";
         AV82Trn_organisationwwds_1_filterfulltext = "";
         AV84Trn_organisationwwds_3_tforganisationname_sel = "";
         AV83Trn_organisationwwds_2_tforganisationname = "";
         AV86Trn_organisationwwds_5_tforganisationtypename_sel = "";
         ...
         H003U2_A40000OrganisationLogo_GXI = new string[] {""} ;
         ...
         H003U2_A520OrganisationLogo = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationww__default(),
            new Object[][] {
                new Object[] {
               H003U2_A390OrganisationPhoneNumber, H003U2_A389OrganisationPhoneCode, H003U2_A19OrganisationTypeId, H003U2_A343OrganisationAddressLine2, H003U2_A342OrganisationAddressLine1, H003U2_A331OrganisationAddressCountry, H003U2_A288OrganisationAddressZipCode, H003U2_A289OrganisationAddressCity, H003U2_A40000OrganisationLogo_GXI, H003U2_A18OrganisationVATNumber,
               H003U2_A17OrganisationPhone, H003U2_A16OrganisationEmail, H003U2_A12OrganisationKvkNumber, H003U2_A20OrganisationTypeName, H003U2_A13OrganisationName, H003U2_A11OrganisationId, H003U2_A520OrganisationLogo
               }
               , new Object[] {
      ...
      private string lV89Trn_organisationwwds_8_tforganisationphone ;
      private string AV90Trn_organisationwwds_9_tforganisationphone_sel ;
      private string AV89Trn_organisationwwds_8_tforganisationphone ;
      ...
      private bool A520OrganisationLogo_IsBlob ;
      ...
      private string lV82Trn_organisationwwds_1_filterfulltext ;
      private string lV83Trn_organisationwwds_2_tforganisationname ;
      private string lV85Trn_organisationwwds_4_tforganisationtypename ;
      private string lV87Trn_organisationwwds_6_tforganisationemail ;
      private string AV82Trn_organisationwwds_1_filterfulltext ;
      private string AV84Trn_organisationwwds_3_tforganisationname_sel ;
      private string AV83Trn_organisationwwds_2_tforganisationname ;
      private string AV86Trn_organisationwwds_5_tforganisationtypename_sel ;
      private string AV85Trn_organisationwwds_4_tforganisationtypename ;
      private string AV88Trn_organisationwwds_7_tforganisationemail_sel ;
      private string AV87Trn_organisationwwds_6_tforganisationemail ;
      private string AV79successmsg ;
      private string A520OrganisationLogo ;
      ...
      private string[] H003U2_A40000OrganisationLogo_GXI ;
      ...
      private string[] H003U2_A520OrganisationLogo ;
   ...
   public class trn_organisationww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003U2( IGxContext context ,
                                             string AV82Trn_organisationwwds_1_filterfulltext ,
                                             string AV84Trn_organisationwwds_3_tforganisationname_sel ,
                                             string AV83Trn_organisationwwds_2_tforganisationname ,
                                             string AV86Trn_organisationwwds_5_tforganisationtypename_sel ,
                                             string AV85Trn_organisationwwds_4_tforganisationtypename ,
                                             string AV88Trn_organisationwwds_7_tforganisationemail_sel ,
                                             string AV87Trn_organisationwwds_6_tforganisationemail ,
                                             string AV90Trn_organisationwwds_9_tforganisationphone_sel ,
                                             string AV89Trn_organisationwwds_8_tforganisationphone ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV82Trn_organisationwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T1.OrganisationName) like '%' || LOWER(:lV82Trn_organisationwwds_1_filterfulltext)) or ( LOWER(T2.OrganisationTypeName) like '%' || LOWER(:lV82Trn_organisationwwds_1_filterfulltext)) or ( LOWER(T1.OrganisationEmail) like '%' || LOWER(:lV82Trn_organisationwwds_1_filterfulltext)) or ( LOWER(T1.OrganisationPhone) like '%' || LOWER(:lV82Trn_organisationwwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int8[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV84Trn_organisationwwds_3_tforganisationname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV83Trn_organisationwwds_2_tforganisationname)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationName like :lV83Trn_organisationwwds_2_tforganisationname)");
         }
         else
         {
            GXv_int8[4] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV84Trn_organisationwwds_3_tforganisationname_sel)) && ! ( StringUtil.StrCmp(AV84Trn_organisationwwds_3_tforganisationname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationName = ( :AV84Trn_organisationwwds_3_tforganisationname_sel))");
         }
         else
         {
            GXv_int8[5] = 1;
         }
         if ( StringUtil.StrCmp(AV84Trn_organisationwwds_3_tforganisationname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.OrganisationName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_organisationwwds_5_tforganisationtypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV85Trn_organisationwwds_4_tforganisationtypename)) ) )
         {
            AddWhere(sWhereString, "(T2.OrganisationTypeName like :lV85Trn_organisationwwds_4_tforganisationtypename)");
         }
         else
         {
            GXv_int8[6] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_organisationwwds_5_tforganisationtypename_sel)) && ! ( StringUtil.StrCmp(AV86Trn_organisationwwds_5_tforganisationtypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.OrganisationTypeName = ( :AV86Trn_organisationwwds_5_tforganisationtypename_sel))");
         }
         else
         {
            GXv_int8[7] = 1;
         }
         if ( StringUtil.StrCmp(AV86Trn_organisationwwds_5_tforganisationtypename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T2.OrganisationTypeName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV88Trn_organisationwwds_7_tforganisationemail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_organisationwwds_6_tforganisationemail)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationEmail like :lV87Trn_organisationwwds_6_tforganisationemail)");
         }
         else
         {
            GXv_int8[8] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV88Trn_organisationwwds_7_tforganisationemail_sel)) && ! ( StringUtil.StrCmp(AV88Trn_organisationwwds_7_tforganisationemail_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationEmail = ( :AV88Trn_organisationwwds_7_tforganisationemail_sel))");
         }
         else
         {
            GXv_int8[9] = 1;
         }
         if ( StringUtil.StrCmp(AV88Trn_organisationwwds_7_tforganisationemail_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.OrganisationEmail))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_organisationwwds_9_tforganisationphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV89Trn_organisationwwds_8_tforganisationphone)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationPhone like :lV89Trn_organisationwwds_8_tforganisationphone)");
         }
         else
         {
            GXv_int8[10] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_organisationwwds_9_tforganisationphone_sel)) && ! ( StringUtil.StrCmp(AV90Trn_organisationwwds_9_tforganisationphone_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationPhone = ( :AV90Trn_organisationwwds_9_tforganisationphone_sel))");
         }
         else
         {
            GXv_int8[11] = 1;
         }
         if ( StringUtil.StrCmp(AV90Trn_organisationwwds_9_tforganisationphone_sel, "<#Empty#>") == 0 )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV82Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV82Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV82Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV82Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV83Trn_organisationwwds_2_tforganisationname",GXType.VarChar,100,0) ,
          new ParDef("AV84Trn_organisationwwds_3_tforganisationname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV85Trn_organisationwwds_4_tforganisationtypename",GXType.VarChar,100,0) ,
          new ParDef("AV86Trn_organisationwwds_5_tforganisationtypename_sel",GXType.VarChar,100,0) ,
          new ParDef("lV87Trn_organisationwwds_6_tforganisationemail",GXType.VarChar,100,0) ,
          new ParDef("AV88Trn_organisationwwds_7_tforganisationemail_sel",GXType.VarChar,100,0) ,
          new ParDef("lV89Trn_organisationwwds_8_tforganisationphone",GXType.Char,20,0) ,
          new ParDef("AV90Trn_organisationwwds_9_tforganisationphone_sel",GXType.Char,20,0) ,
