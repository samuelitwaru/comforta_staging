...
namespace GeneXus.Programs {
   public class trn_bulletinboardtrn_memowc : GXWebComponent
   {
      public trn_bulletinboardtrn_memowc( )
      {
      ...
      public trn_bulletinboardtrn_memowc( IGxContext context )
      {
      ...
      {
         this.AV8BulletinBoardId = aP0_BulletinBoardId;
         ExecuteImpl();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "BulletinBoardId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8BulletinBoardId = StringUtil.StrToGuid( GetPar( "BulletinBoardId"));
                  AssignAttri(sPrefix, false, "AV8BulletinBoardId", AV8BulletinBoardId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8BulletinBoardId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27IsAuthorized_MemoCategoryName = StringUtil.StrToBool( GetPar( "IsAuthorized_MemoCategoryName"));
         AV36IsAuthorized_MemoTitle = StringUtil.StrToBool( GetPar( "IsAuthorized_MemoTitle"));
         AV28IsAuthorized_ResidentLastName = StringUtil.StrToBool( GetPar( "IsAuthorized_ResidentLastName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8BulletinBoardId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV27IsAuthorized_MemoCategoryName, AV36IsAuthorized_MemoTitle, AV28IsAuthorized_ResidentLastName, AV35IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV37Pgmname = "Trn_BulletinBoardTrn_MemoWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_Bulletin Board Trn_Memo WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_bulletinboardtrn_memowc.aspx"+UrlEncode(AV8BulletinBoardId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_bulletinboardtrn_memowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_MEMOCATEGORYNAME", AV27IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MemoCategoryName, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_MEMOTITLE", AV36IsAuthorized_MemoTitle);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MEMOTITLE", GetSecureSignedToken( sPrefix, AV36IsAuthorized_MemoTitle, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_RESIDENTLASTNAME", AV28IsAuthorized_ResidentLastName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_RESIDENTLASTNAME", GetSecureSignedToken( sPrefix, AV28IsAuthorized_ResidentLastName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8BulletinBoardId", wcpOAV8BulletinBoardId.ToString());
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV35IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vBULLETINBOARDID", AV8BulletinBoardId.ToString());
      ...
      protected void RenderHtmlCloseFormBE2( )
      {
      ...
      {
         return "Trn_BulletinBoardTrn_MemoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Bulletin Board Trn_Memo WC", "") ;
      }
      ...
      protected void WBBE0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_bulletinboardtrn_memowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBulletinBoardId_Internalname, A574BulletinBoardId.ToString(), A574BulletinBoardId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBulletinBoardId_Jsonclick, 0, "Attribute", "", "", "", "", edtBulletinBoardId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_BulletinBoardTrn_MemoWC.htm");
            /* User Defined Control */
      ...
      protected void STARTBE2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_Bulletin Board Trn_Memo WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_bulletinboardtrn_memowc.aspx")), "trn_bulletinboardtrn_memowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_bulletinboardtrn_memowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV27IsAuthorized_MemoCategoryName ,
                                       bool AV36IsAuthorized_MemoTitle ,
                                       bool AV28IsAuthorized_ResidentLastName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MEMOID", GetSecureSignedToken( sPrefix, A575MemoId, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"MEMOID", A575MemoId.ToString());
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         /* Using cursor H00BE2 */
         pr_default.execute(0, new Object[] {AV8BulletinBoardId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A11OrganisationId = H00BE2_A11OrganisationId[0];
            A29LocationId = H00BE2_A29LocationId[0];
            A574BulletinBoardId = H00BE2_A574BulletinBoardId[0];
            AssignAttri(sPrefix, false, "A574BulletinBoardId", A574BulletinBoardId.ToString());
            A71ResidentGUID = H00BE2_A71ResidentGUID[0];
            A65ResidentLastName = H00BE2_A65ResidentLastName[0];
            A64ResidentGivenName = H00BE2_A64ResidentGivenName[0];
            A72ResidentSalutation = H00BE2_A72ResidentSalutation[0];
            A62ResidentId = H00BE2_A62ResidentId[0];
            A590MemoRemoveDate = H00BE2_A590MemoRemoveDate[0];
            A589MemoDuration = H00BE2_A589MemoDuration[0];
            n589MemoDuration = H00BE2_n589MemoDuration[0];
            A588MemoEndDateTime = H00BE2_A588MemoEndDateTime[0];
            n588MemoEndDateTime = H00BE2_n588MemoEndDateTime[0];
            A587MemoStartDateTime = H00BE2_A587MemoStartDateTime[0];
            n587MemoStartDateTime = H00BE2_n587MemoStartDateTime[0];
            A579MemoDocument = H00BE2_A579MemoDocument[0];
            n579MemoDocument = H00BE2_n579MemoDocument[0];
            A578MemoImage = H00BE2_A578MemoImage[0];
            n578MemoImage = H00BE2_n578MemoImage[0];
            A577MemoDescription = H00BE2_A577MemoDescription[0];
            A576MemoTitle = H00BE2_A576MemoTitle[0];
            A569MemoCategoryName = H00BE2_A569MemoCategoryName[0];
            A568MemoCategoryId = H00BE2_A568MemoCategoryId[0];
            A575MemoId = H00BE2_A575MemoId[0];
            A11OrganisationId = H00BE2_A11OrganisationId[0];
            A29LocationId = H00BE2_A29LocationId[0];
            A71ResidentGUID = H00BE2_A71ResidentGUID[0];
            A65ResidentLastName = H00BE2_A65ResidentLastName[0];
            ...
            A72ResidentSalutation = H00BE2_A72ResidentSalutation[0];
            A569MemoCategoryName = H00BE2_A569MemoCategoryName[0];
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) || ( ( StringUtil.Like( StringUtil.Lower( A569MemoCategoryName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A576MemoTitle) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) ||
            ( StringUtil.Like( StringUtil.Lower( A577MemoDescription) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A578MemoImage) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) ||
            ( StringUtil.Like( StringUtil.Lower( A579MemoDocument) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A589MemoDuration), 4, 0) , StringUtil.PadR( "%" + AV16FilterFullText , 254 , "%"),  ' ' ) ) ||
            ( StringUtil.Like( context.GetMessage( "mr", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A72ResidentSalutation, "Mr") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "mrs", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A72ResidentSalutation, "Mrs") == 0 ) ) ||
            ( StringUtil.Like( context.GetMessage( "dr", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A72ResidentSalutation, "Dr") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "miss", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A72ResidentSalutation, "Miss") == 0 ) ) ||
            ( StringUtil.Like( StringUtil.Lower( A64ResidentGivenName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A65ResidentLastName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A71ResidentGUID) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) )
            )
            {
      ...
      protected void RFBE2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00BE3 */
            pr_default.execute(1, new Object[] {AV8BulletinBoardId});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            GRID_nEOF = 0;
            ...
            {
               A11OrganisationId = H00BE3_A11OrganisationId[0];
               A29LocationId = H00BE3_A29LocationId[0];
               A574BulletinBoardId = H00BE3_A574BulletinBoardId[0];
               AssignAttri(sPrefix, false, "A574BulletinBoardId", A574BulletinBoardId.ToString());
               A71ResidentGUID = H00BE3_A71ResidentGUID[0];
               A65ResidentLastName = H00BE3_A65ResidentLastName[0];
               A64ResidentGivenName = H00BE3_A64ResidentGivenName[0];
               A72ResidentSalutation = H00BE3_A72ResidentSalutation[0];
               A62ResidentId = H00BE3_A62ResidentId[0];
               A590MemoRemoveDate = H00BE3_A590MemoRemoveDate[0];
               A589MemoDuration = H00BE3_A589MemoDuration[0];
               n589MemoDuration = H00BE3_n589MemoDuration[0];
               A588MemoEndDateTime = H00BE3_A588MemoEndDateTime[0];
               n588MemoEndDateTime = H00BE3_n588MemoEndDateTime[0];
               A587MemoStartDateTime = H00BE3_A587MemoStartDateTime[0];
               n587MemoStartDateTime = H00BE3_n587MemoStartDateTime[0];
               A579MemoDocument = H00BE3_A579MemoDocument[0];
               n579MemoDocument = H00BE3_n579MemoDocument[0];
               A578MemoImage = H00BE3_A578MemoImage[0];
               n578MemoImage = H00BE3_n578MemoImage[0];
               A577MemoDescription = H00BE3_A577MemoDescription[0];
               A576MemoTitle = H00BE3_A576MemoTitle[0];
               A569MemoCategoryName = H00BE3_A569MemoCategoryName[0];
               A568MemoCategoryId = H00BE3_A568MemoCategoryId[0];
               A575MemoId = H00BE3_A575MemoId[0];
               A11OrganisationId = H00BE3_A11OrganisationId[0];
               A29LocationId = H00BE3_A29LocationId[0];
               A71ResidentGUID = H00BE3_A71ResidentGUID[0];
               A65ResidentLastName = H00BE3_A65ResidentLastName[0];
      ...
      protected void send_integrity_lvl_hashesBE2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV35IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MEMOID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, A575MemoId, context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtBulletinBoardId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtBulletinBoardId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUPBE0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8BulletinBoardId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8BulletinBoardId"));
      ...
      protected void E16BE2( )
      {
         ...
         GXt_boolean1 = AV27IsAuthorized_MemoCategoryName;
         ...
         AV27IsAuthorized_MemoCategoryName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV27IsAuthorized_MemoCategoryName", AV27IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MemoCategoryName, context));
         GXt_boolean1 = AV36IsAuthorized_MemoTitle;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memoview_Execute", out  GXt_boolean1) ;
         AV36IsAuthorized_MemoTitle = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV36IsAuthorized_MemoTitle", AV36IsAuthorized_MemoTitle);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MEMOTITLE", GetSecureSignedToken( sPrefix, AV36IsAuthorized_MemoTitle, context));
         GXt_boolean1 = AV28IsAuthorized_ResidentLastName;
         ...
         AV28IsAuthorized_ResidentLastName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV28IsAuthorized_ResidentLastName", AV28IsAuthorized_ResidentLastName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_RESIDENTLASTNAME", GetSecureSignedToken( sPrefix, AV28IsAuthorized_ResidentLastName, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtBulletinBoardId_Visible = 0;
         AssignProp(sPrefix, false, edtBulletinBoardId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtBulletinBoardId_Visible), 5, 0), true);
      ...
      private void E18BE2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            if ( AV27IsAuthorized_MemoCategoryName )
            {
               GXKey = Crypto.GetSiteKey( );
      ...
      protected void E11BE2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_BulletinBoardTrn_MemoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_BulletinBoardTrn_MemoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_BulletinBoardTrn_MemoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_BulletinBoardTrn_MemoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "BulletinBoardId";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8BulletinBoardId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8BulletinBoardId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8BulletinBoardId", AV8BulletinBoardId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8BulletinBoardId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_bulletinboardtrn_memowc", GetJustCreated( ));
         ...
         {
            AV8BulletinBoardId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8BulletinBoardId", AV8BulletinBoardId.ToString());
         }
         wcpOAV8BulletinBoardId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8BulletinBoardId"));
         if ( ! GetJustCreated( ) && ( ( AV8BulletinBoardId != wcpOAV8BulletinBoardId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8BulletinBoardId = AV8BulletinBoardId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8BulletinBoardId = cgiGet( sPrefix+"AV8BulletinBoardId_CTRL");
         if ( StringUtil.Len( sCtrlAV8BulletinBoardId) > 0 )
         {
            AV8BulletinBoardId = StringUtil.StrToGuid( cgiGet( sCtrlAV8BulletinBoardId));
            AssignAttri(sPrefix, false, "AV8BulletinBoardId", AV8BulletinBoardId.ToString());
         }
         else
         {
            AV8BulletinBoardId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8BulletinBoardId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8BulletinBoardId_PARM", AV8BulletinBoardId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8BulletinBoardId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8BulletinBoardId_CTRL", StringUtil.RTrim( sCtrlAV8BulletinBoardId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253192041958", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_bulletinboardtrn_memowc.js", "?20253192041959", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtMemoCategoryId_Internalname = sPrefix+"MEMOCATEGORYID_"+sGXsfl_35_idx;
         edtMemoCategoryName_Internalname = sPrefix+"MEMOCATEGORYNAME_"+sGXsfl_35_idx;
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtMemoCategoryId_Internalname = sPrefix+"MEMOCATEGORYID_"+sGXsfl_35_fel_idx;
         edtMemoCategoryName_Internalname = sPrefix+"MEMOCATEGORYNAME_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoDocument_Internalname,(string)A579MemoDocument,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoDocument_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)200,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoDuration_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A589MemoDuration), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A589MemoDuration), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoDuration_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Memo Category Id", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Memo Category Name", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtBulletinBoardId_Internalname = sPrefix+"BULLETINBOARDID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:MemoId|1:MemoCategoryId|2:MemoCategoryName|3:MemoTitle|4:MemoDescription|5:MemoImage|6:MemoDocument|7:MemoStartDateTime|8:MemoEndDateTime|9:MemoDuration|10:MemoRemoveDate|11:ResidentId|12:ResidentSalutation|13:ResidentGivenName|14:ResidentLastName|15:ResidentGUID";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"sPrefix"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12BE2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13BE2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E14BE2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18BE2","iparms":[{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A575MemoId","fld":"MEMOID","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"A568MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV29Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV31Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV33Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtMemoCategoryName_Link","ctrl":"MEMOCATEGORYNAME","prop":"Link"},{"av":"edtMemoTitle_Link","ctrl":"MEMOTITLE","prop":"Link"},{"av":"edtResidentLastName_Link","ctrl":"RESIDENTLASTNAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11BE2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E15BE2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8BulletinBoardId","fld":"vBULLETINBOARDID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV36IsAuthorized_MemoTitle","fld":"vISAUTHORIZED_MEMOTITLE","hsh":true},{"av":"AV28IsAuthorized_ResidentLastName","fld":"vISAUTHORIZED_RESIDENTLASTNAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A575MemoId","fld":"MEMOID","hsh":true}]""");
         ...
         setEventMetadata("VALID_MEMOCATEGORYNAME","""{"handler":"Valid_Memocategoryname","iparms":[]}""");
      ...
      {
         wcpOAV8BulletinBoardId = Guid.Empty;
         ...
         GXDecQS = "";
         lV16FilterFullText = "";
         H00BE2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BE2_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BE2_A574BulletinBoardId = new Guid[] {Guid.Empty} ;
         H00BE2_A71ResidentGUID = new string[] {""} ;
         H00BE2_A65ResidentLastName = new string[] {""} ;
         H00BE2_A64ResidentGivenName = new string[] {""} ;
         H00BE2_A72ResidentSalutation = new string[] {""} ;
         H00BE2_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BE2_A590MemoRemoveDate = new DateTime[] {DateTime.MinValue} ;
         H00BE2_A589MemoDuration = new short[1] ;
         H00BE2_n589MemoDuration = new bool[] {false} ;
         H00BE2_A588MemoEndDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BE2_n588MemoEndDateTime = new bool[] {false} ;
         H00BE2_A587MemoStartDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BE2_n587MemoStartDateTime = new bool[] {false} ;
         H00BE2_A579MemoDocument = new string[] {""} ;
         H00BE2_n579MemoDocument = new bool[] {false} ;
         H00BE2_A578MemoImage = new string[] {""} ;
         H00BE2_n578MemoImage = new bool[] {false} ;
         H00BE2_A577MemoDescription = new string[] {""} ;
         H00BE2_A576MemoTitle = new string[] {""} ;
         H00BE2_A569MemoCategoryName = new string[] {""} ;
         H00BE2_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00BE2_A575MemoId = new Guid[] {Guid.Empty} ;
         H00BE3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00BE3_A29LocationId = new Guid[] {Guid.Empty} ;
         H00BE3_A574BulletinBoardId = new Guid[] {Guid.Empty} ;
         H00BE3_A71ResidentGUID = new string[] {""} ;
         H00BE3_A65ResidentLastName = new string[] {""} ;
         H00BE3_A64ResidentGivenName = new string[] {""} ;
         H00BE3_A72ResidentSalutation = new string[] {""} ;
         H00BE3_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00BE3_A590MemoRemoveDate = new DateTime[] {DateTime.MinValue} ;
         H00BE3_A589MemoDuration = new short[1] ;
         H00BE3_n589MemoDuration = new bool[] {false} ;
         H00BE3_A588MemoEndDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BE3_n588MemoEndDateTime = new bool[] {false} ;
         H00BE3_A587MemoStartDateTime = new DateTime[] {DateTime.MinValue} ;
         H00BE3_n587MemoStartDateTime = new bool[] {false} ;
         H00BE3_A579MemoDocument = new string[] {""} ;
         H00BE3_n579MemoDocument = new bool[] {false} ;
         H00BE3_A578MemoImage = new string[] {""} ;
         H00BE3_n578MemoImage = new bool[] {false} ;
         H00BE3_A577MemoDescription = new string[] {""} ;
         H00BE3_A576MemoTitle = new string[] {""} ;
         H00BE3_A569MemoCategoryName = new string[] {""} ;
         H00BE3_A568MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00BE3_A575MemoId = new Guid[] {Guid.Empty} ;
         ...
         sCtrlAV8BulletinBoardId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_bulletinboardtrn_memowc__default(),
            new Object[][] {
                new Object[] {
               H00BE2_A11OrganisationId, H00BE2_A29LocationId, H00BE2_A574BulletinBoardId, H00BE2_A71ResidentGUID, H00BE2_A65ResidentLastName, H00BE2_A64ResidentGivenName, H00BE2_A72ResidentSalutation, H00BE2_A62ResidentId, H00BE2_A590MemoRemoveDate, H00BE2_A589MemoDuration,
               H00BE2_n589MemoDuration, H00BE2_A588MemoEndDateTime, H00BE2_n588MemoEndDateTime, H00BE2_A587MemoStartDateTime, H00BE2_n587MemoStartDateTime, H00BE2_A579MemoDocument, H00BE2_n579MemoDocument, H00BE2_A578MemoImage, H00BE2_n578MemoImage, H00BE2_A577MemoDescription,
               H00BE2_A576MemoTitle, H00BE2_A569MemoCategoryName, H00BE2_A568MemoCategoryId, H00BE2_A575MemoId
               }
               , new Object[] {
               H00BE3_A11OrganisationId, H00BE3_A29LocationId, H00BE3_A574BulletinBoardId, H00BE3_A71ResidentGUID, H00BE3_A65ResidentLastName, H00BE3_A64ResidentGivenName, H00BE3_A72ResidentSalutation, H00BE3_A62ResidentId, H00BE3_A590MemoRemoveDate, H00BE3_A589MemoDuration,
               H00BE3_n589MemoDuration, H00BE3_A588MemoEndDateTime, H00BE3_n588MemoEndDateTime, H00BE3_A587MemoStartDateTime, H00BE3_n587MemoStartDateTime, H00BE3_A579MemoDocument, H00BE3_n579MemoDocument, H00BE3_A578MemoImage, H00BE3_n578MemoImage, H00BE3_A577MemoDescription,
               H00BE3_A576MemoTitle, H00BE3_A569MemoCategoryName, H00BE3_A568MemoCategoryId, H00BE3_A575MemoId
               }
            }
         );
         AV37Pgmname = "Trn_BulletinBoardTrn_MemoWC";
      ...
      private string sCtrlAV8BulletinBoardId ;
      ...
      private bool AV27IsAuthorized_MemoCategoryName ;
      private bool AV36IsAuthorized_MemoTitle ;
      private bool AV28IsAuthorized_ResidentLastName ;
      ...
      private Guid AV8BulletinBoardId ;
      private Guid wcpOAV8BulletinBoardId ;
      ...
      private Guid[] H00BE2_A11OrganisationId ;
      private Guid[] H00BE2_A29LocationId ;
      private Guid[] H00BE2_A574BulletinBoardId ;
      private string[] H00BE2_A71ResidentGUID ;
      private string[] H00BE2_A65ResidentLastName ;
      private string[] H00BE2_A64ResidentGivenName ;
      private string[] H00BE2_A72ResidentSalutation ;
      private Guid[] H00BE2_A62ResidentId ;
      private DateTime[] H00BE2_A590MemoRemoveDate ;
      private short[] H00BE2_A589MemoDuration ;
      private bool[] H00BE2_n589MemoDuration ;
      private DateTime[] H00BE2_A588MemoEndDateTime ;
      private bool[] H00BE2_n588MemoEndDateTime ;
      private DateTime[] H00BE2_A587MemoStartDateTime ;
      private bool[] H00BE2_n587MemoStartDateTime ;
      private string[] H00BE2_A579MemoDocument ;
      private bool[] H00BE2_n579MemoDocument ;
      private string[] H00BE2_A578MemoImage ;
      private bool[] H00BE2_n578MemoImage ;
      private string[] H00BE2_A577MemoDescription ;
      private string[] H00BE2_A576MemoTitle ;
      private string[] H00BE2_A569MemoCategoryName ;
      private Guid[] H00BE2_A568MemoCategoryId ;
      private Guid[] H00BE2_A575MemoId ;
      private Guid[] H00BE3_A11OrganisationId ;
      private Guid[] H00BE3_A29LocationId ;
      private Guid[] H00BE3_A574BulletinBoardId ;
      private string[] H00BE3_A71ResidentGUID ;
      private string[] H00BE3_A65ResidentLastName ;
      private string[] H00BE3_A64ResidentGivenName ;
      private string[] H00BE3_A72ResidentSalutation ;
      private Guid[] H00BE3_A62ResidentId ;
      private DateTime[] H00BE3_A590MemoRemoveDate ;
      private short[] H00BE3_A589MemoDuration ;
      private bool[] H00BE3_n589MemoDuration ;
      private DateTime[] H00BE3_A588MemoEndDateTime ;
      private bool[] H00BE3_n588MemoEndDateTime ;
      private DateTime[] H00BE3_A587MemoStartDateTime ;
      private bool[] H00BE3_n587MemoStartDateTime ;
      private string[] H00BE3_A579MemoDocument ;
      private bool[] H00BE3_n579MemoDocument ;
      private string[] H00BE3_A578MemoImage ;
      private bool[] H00BE3_n578MemoImage ;
      private string[] H00BE3_A577MemoDescription ;
      private string[] H00BE3_A576MemoTitle ;
      private string[] H00BE3_A569MemoCategoryName ;
      private Guid[] H00BE3_A568MemoCategoryId ;
      private Guid[] H00BE3_A575MemoId ;
   ...
   public class trn_bulletinboardtrn_memowc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00BE2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid A574BulletinBoardId ,
                                             Guid AV8BulletinBoardId ,
                                             string AV16FilterFullText ,
                                             string A569MemoCategoryName ,
                                             string A576MemoTitle ,
                                             string A577MemoDescription ,
                                             string A578MemoImage ,
                                             string A579MemoDocument ,
                                             ...
                                             string A71ResidentGUID )
      {
         ...
         scmdbuf = "SELECT T2.OrganisationId, T2.LocationId, T1.BulletinBoardId, T3.ResidentGUID, T3.ResidentLastName, T3.ResidentGivenName, T3.ResidentSalutation, T1.ResidentId, T1.MemoRemoveDate, T1.MemoDuration, T1.MemoEndDateTime, T1.MemoStartDateTime, T1.MemoDocument, T1.MemoImage, T1.MemoDescription, T1.MemoTitle, T4.MemoCategoryName, T1.MemoCategoryId, T1.MemoId FROM (((Trn_Memo T1 INNER JOIN Trn_BulletinBoard T2 ON T2.BulletinBoardId = T1.BulletinBoardId) LEFT JOIN Trn_Resident T3 ON T3.ResidentId = T1.ResidentId AND T3.LocationId = T2.LocationId AND T3.OrganisationId = T2.OrganisationId) INNER JOIN Trn_MemoCategory T4 ON T4.MemoCategoryId = T1.MemoCategoryId)";
         AddWhere(sWhereString, "(T1.BulletinBoardId = :AV8BulletinBoardId)");
         scmdbuf += sWhereString;
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoTitle, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoTitle DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoCategoryId, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoCategoryId DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T4.MemoCategoryName, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T4.MemoCategoryName DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoDescription, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoDescription DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoImage, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoImage DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoDocument, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoDocument DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoStartDateTime, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoStartDateTime DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoEndDateTime, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoEndDateTime DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoDuration, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoDuration DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.MemoRemoveDate, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.MemoRemoveDate DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T1.ResidentId, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T1.ResidentId DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T3.ResidentSalutation, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T3.ResidentSalutation DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T3.ResidentGivenName, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T3.ResidentGivenName DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T3.ResidentLastName, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T3.ResidentLastName DESC, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId, T3.ResidentGUID, T1.MemoId";
         }
         else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.BulletinBoardId DESC, T3.ResidentGUID DESC, T1.MemoId";
         }
      ...
      protected Object[] conditional_H00BE3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid A574BulletinBoardId ,
                                             Guid AV8BulletinBoardId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00BE2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] );
               case 1 :
                     return conditional_H00BE3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8BulletinBoardId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BE3;
          ...
          def= new CursorDef[] {
              new CursorDef("H00BE2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BE2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00BE3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BE3,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((DateTime[]) buf[11])[0] = rslt.getGXDateTime(11);
