...
namespace GeneXus.Programs {
   public class trn_organisationtrn_managerwc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8OrganisationId, AV20ManageFiltersExecutionStep, AV41Pgmname, AV29IsAuthorized_Display, AV31IsAuthorized_Update, AV33IsAuthorized_Delete, AV27IsAuthorized_ManagerGivenName, AV34IsAuthorized_Insert, A11OrganisationId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV41Pgmname = "Trn_OrganisationTrn_ManagerWC";
      ...
      protected void WB9T0( )
      {
         ...
         if ( wbEnd == 35 )
         {
            ...
            wb_table1_59_9T2( true) ;
         }
         else
         {
            wb_table1_59_9T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_59_9T2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              A458ManagerImage = cgiGet( edtManagerImage_Internalname);
                              AssignProp(sPrefix, false, edtManagerImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.convertURL( context.PathToRelativeUrl( A458ManagerImage))), !bGXsfl_35_Refreshing);
                              AssignProp(sPrefix, false, edtManagerImage_Internalname, "SrcSet", context.GetImageSrcSet( A458ManagerImage), true);
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A11OrganisationId = H009T2_A11OrganisationId[0];
            AssignAttri(sPrefix, false, "A11OrganisationId", A11OrganisationId.ToString());
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORGANISATIONID", GetSecureSignedToken( sPrefix, A11OrganisationId, context));
            A40000ManagerImage_GXI = H009T2_A40000ManagerImage_GXI[0];
            AssignProp(sPrefix, false, edtManagerImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.convertURL( context.PathToRelativeUrl( A458ManagerImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtManagerImage_Internalname, "SrcSet", context.GetImageSrcSet( A458ManagerImage), true);
            A394ManagerIsActive = H009T2_A394ManagerIsActive[0];
            A360ManagerIsMainManager = H009T2_A360ManagerIsMainManager[0];
            A28ManagerGAMGUID = H009T2_A28ManagerGAMGUID[0];
            A27ManagerGender = H009T2_A27ManagerGender[0];
            A386ManagerPhoneNumber = H009T2_A386ManagerPhoneNumber[0];
            A385ManagerPhoneCode = H009T2_A385ManagerPhoneCode[0];
            A26ManagerPhone = H009T2_A26ManagerPhone[0];
            A25ManagerEmail = H009T2_A25ManagerEmail[0];
            A24ManagerInitials = H009T2_A24ManagerInitials[0];
            A23ManagerLastName = H009T2_A23ManagerLastName[0];
            A22ManagerGivenName = H009T2_A22ManagerGivenName[0];
            A21ManagerId = H009T2_A21ManagerId[0];
            A458ManagerImage = H009T2_A458ManagerImage[0];
            AssignProp(sPrefix, false, edtManagerImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.convertURL( context.PathToRelativeUrl( A458ManagerImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtManagerImage_Internalname, "SrcSet", context.GetImageSrcSet( A458ManagerImage), true);
      ...
      protected void RF9T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11OrganisationId = H009T3_A11OrganisationId[0];
               AssignAttri(sPrefix, false, "A11OrganisationId", A11OrganisationId.ToString());
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORGANISATIONID", GetSecureSignedToken( sPrefix, A11OrganisationId, context));
               A40000ManagerImage_GXI = H009T3_A40000ManagerImage_GXI[0];
               AssignProp(sPrefix, false, edtManagerImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.convertURL( context.PathToRelativeUrl( A458ManagerImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtManagerImage_Internalname, "SrcSet", context.GetImageSrcSet( A458ManagerImage), true);
               A394ManagerIsActive = H009T3_A394ManagerIsActive[0];
               A360ManagerIsMainManager = H009T3_A360ManagerIsMainManager[0];
               A28ManagerGAMGUID = H009T3_A28ManagerGAMGUID[0];
               A27ManagerGender = H009T3_A27ManagerGender[0];
               A386ManagerPhoneNumber = H009T3_A386ManagerPhoneNumber[0];
               A385ManagerPhoneCode = H009T3_A385ManagerPhoneCode[0];
               A26ManagerPhone = H009T3_A26ManagerPhone[0];
               A25ManagerEmail = H009T3_A25ManagerEmail[0];
               A24ManagerInitials = H009T3_A24ManagerInitials[0];
               A23ManagerLastName = H009T3_A23ManagerLastName[0];
               A22ManagerGivenName = H009T3_A22ManagerGivenName[0];
               A21ManagerId = H009T3_A21ManagerId[0];
               A458ManagerImage = H009T3_A458ManagerImage[0];
               AssignProp(sPrefix, false, edtManagerImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.convertURL( context.PathToRelativeUrl( A458ManagerImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtManagerImage_Internalname, "SrcSet", context.GetImageSrcSet( A458ManagerImage), true);
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) || ( ( StringUtil.Like( StringUtil.Lower( A22ManagerGivenName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A23ManagerLastName) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A25ManagerEmail) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A26ManagerPhone) , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "male", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Male") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "female", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Female") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "other", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV16FilterFullText) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Other") == 0 ) ) ) )
               {
      ...
      protected void E119T2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationTrn_ManagerWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV41Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV19ManageFiltersXml) ;
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV17Session.Get(AV41Pgmname+"GridState"), "") == 0 )
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV41Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV12GridState.FromXml(AV17Session.Get(AV41Pgmname+"GridState"), null, "", "");
         }
         AV14OrderedBy = AV12GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV14OrderedBy", StringUtil.LTrimStr( (decimal)(AV14OrderedBy), 4, 0));
         AV15OrderedDsc = AV12GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         AV42GXV1 = 1;
         while ( AV42GXV1 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV42GXV1));
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV12GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void wb_table1_59_9T2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_59_9T2e( true) ;
         }
         else
         {
            wb_table1_59_9T2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202512220565860", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_organisationtrn_managerwc.js", "?202512220565861", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            A458ManagerImage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage))&&String.IsNullOrEmpty(StringUtil.RTrim( A40000ManagerImage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( A458ManagerImage)) ? A40000ManagerImage_GXI : context.PathToRelativeUrl( A458ManagerImage));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtManagerImage_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)0,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A458ManagerImage_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl35( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A458ManagerImage));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E189T2","iparms":[{"av":"A28ManagerGAMGUID","fld":"MANAGERGAMGUID"},{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_ManagerGivenName","fld":"vISAUTHORIZED_MANAGERGIVENNAME","hsh":true},{"av":"A21ManagerId","fld":"MANAGERID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"A394ManagerIsActive","fld":"MANAGERISACTIVE"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"edtManagerGivenName_Link","ctrl":"MANAGERGIVENNAME","prop":"Link"},{"av":"edtavManagerisactive_Columnclass","ctrl":"vMANAGERISACTIVE","prop":"Columnclass"},{"av":"AV35ManagerIsActive","fld":"vMANAGERISACTIVE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E119T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_ManagerGivenName","fld":"vISAUTHORIZED_MANAGERGIVENNAME","hsh":true},{"av":"AV34IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E199T2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"A21ManagerId","fld":"MANAGERID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_ManagerGivenName","fld":"vISAUTHORIZED_MANAGERGIVENNAME","hsh":true},{"av":"AV34IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV35ManagerIsActive = "";
         GXDecQS = "";
         H009T2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009T2_A40000ManagerImage_GXI = new string[] {""} ;
         H009T2_A394ManagerIsActive = new bool[] {false} ;
         H009T2_A360ManagerIsMainManager = new bool[] {false} ;
         H009T2_A28ManagerGAMGUID = new string[] {""} ;
         H009T2_A27ManagerGender = new string[] {""} ;
         H009T2_A386ManagerPhoneNumber = new string[] {""} ;
         H009T2_A385ManagerPhoneCode = new string[] {""} ;
         H009T2_A26ManagerPhone = new string[] {""} ;
         H009T2_A25ManagerEmail = new string[] {""} ;
         H009T2_A24ManagerInitials = new string[] {""} ;
         H009T2_A23ManagerLastName = new string[] {""} ;
         H009T2_A22ManagerGivenName = new string[] {""} ;
         H009T2_A21ManagerId = new Guid[] {Guid.Empty} ;
         H009T2_A458ManagerImage = new string[] {""} ;
         H009T3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009T3_A40000ManagerImage_GXI = new string[] {""} ;
         H009T3_A394ManagerIsActive = new bool[] {false} ;
         H009T3_A360ManagerIsMainManager = new bool[] {false} ;
         H009T3_A28ManagerGAMGUID = new string[] {""} ;
         H009T3_A27ManagerGender = new string[] {""} ;
         H009T3_A386ManagerPhoneNumber = new string[] {""} ;
         H009T3_A385ManagerPhoneCode = new string[] {""} ;
         H009T3_A26ManagerPhone = new string[] {""} ;
         H009T3_A25ManagerEmail = new string[] {""} ;
         H009T3_A24ManagerInitials = new string[] {""} ;
         H009T3_A23ManagerLastName = new string[] {""} ;
         H009T3_A22ManagerGivenName = new string[] {""} ;
         H009T3_A21ManagerId = new Guid[] {Guid.Empty} ;
         H009T3_A458ManagerImage = new string[] {""} ;
         hsh = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationtrn_managerwc__default(),
            new Object[][] {
                new Object[] {
               H009T2_A11OrganisationId, H009T2_A40000ManagerImage_GXI, H009T2_A394ManagerIsActive, H009T2_A360ManagerIsMainManager, H009T2_A28ManagerGAMGUID, H009T2_A27ManagerGender, H009T2_A386ManagerPhoneNumber, H009T2_A385ManagerPhoneCode, H009T2_A26ManagerPhone, H009T2_A25ManagerEmail,
               H009T2_A24ManagerInitials, H009T2_A23ManagerLastName, H009T2_A22ManagerGivenName, H009T2_A21ManagerId, H009T2_A458ManagerImage
               }
               , new Object[] {
               H009T3_A11OrganisationId, H009T3_A40000ManagerImage_GXI, H009T3_A394ManagerIsActive, H009T3_A360ManagerIsMainManager, H009T3_A28ManagerGAMGUID, H009T3_A27ManagerGender, H009T3_A386ManagerPhoneNumber, H009T3_A385ManagerPhoneCode, H009T3_A26ManagerPhone, H009T3_A25ManagerEmail,
               H009T3_A24ManagerInitials, H009T3_A23ManagerLastName, H009T3_A22ManagerGivenName, H009T3_A21ManagerId, H009T3_A458ManagerImage
               }
            }
         );
         AV41Pgmname = "Trn_OrganisationTrn_ManagerWC";
      ...
      private bool A458ManagerImage_IsBlob ;
      ...
      private Guid[] H009T2_A11OrganisationId ;
      private string[] H009T2_A40000ManagerImage_GXI ;
      private bool[] H009T2_A394ManagerIsActive ;
      private bool[] H009T2_A360ManagerIsMainManager ;
      private string[] H009T2_A28ManagerGAMGUID ;
      private string[] H009T2_A27ManagerGender ;
      private string[] H009T2_A386ManagerPhoneNumber ;
      private string[] H009T2_A385ManagerPhoneCode ;
      private string[] H009T2_A26ManagerPhone ;
      private string[] H009T2_A25ManagerEmail ;
      private string[] H009T2_A24ManagerInitials ;
      private string[] H009T2_A23ManagerLastName ;
      private string[] H009T2_A22ManagerGivenName ;
      private Guid[] H009T2_A21ManagerId ;
      private string[] H009T2_A458ManagerImage ;
      private Guid[] H009T3_A11OrganisationId ;
      private string[] H009T3_A40000ManagerImage_GXI ;
      private bool[] H009T3_A394ManagerIsActive ;
      private bool[] H009T3_A360ManagerIsMainManager ;
      private string[] H009T3_A28ManagerGAMGUID ;
      private string[] H009T3_A27ManagerGender ;
      private string[] H009T3_A386ManagerPhoneNumber ;
      private string[] H009T3_A385ManagerPhoneCode ;
      private string[] H009T3_A26ManagerPhone ;
      private string[] H009T3_A25ManagerEmail ;
      private string[] H009T3_A24ManagerInitials ;
      private string[] H009T3_A23ManagerLastName ;
      private string[] H009T3_A22ManagerGivenName ;
      private Guid[] H009T3_A21ManagerId ;
      private string[] H009T3_A458ManagerImage ;
   ...
   {
      protected Object[] conditional_H009T2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid A11OrganisationId ,
                                             Guid AV8OrganisationId ,
      ...
      protected Object[] conditional_H009T3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid A11OrganisationId ,
                                             Guid AV8OrganisationId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H009T2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] );
               case 1 :
                     return conditional_H009T3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH009T2;
          prmH009T2 = new Object[] {
          new ParDef("AV8OrganisationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH009T3;
          prmH009T3 = new Object[] {
          new ParDef("AV8OrganisationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H009T2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009T2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H009T3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009T3,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
