...
namespace GeneXus.Programs {
   public class wp_organisationdynamicformgetfilterdata : GXProcedure
   {
      ...
      protected void S121( )
      {
         ...
         {
            BRKBA2 = false;
            A240WWPFormType = P00BA2_A240WWPFormType[0];
            A11OrganisationId = P00BA2_A11OrganisationId[0];
            A209WWPFormTitle = P00BA2_A209WWPFormTitle[0];
            A207WWPFormVersionNumber = P00BA2_A207WWPFormVersionNumber[0];
            A231WWPFormDate = P00BA2_A231WWPFormDate[0];
            A208WWPFormReferenceName = P00BA2_A208WWPFormReferenceName[0];
            A206WWPFormId = P00BA2_A206WWPFormId[0];
            A542OrganisationDynamicFormId = P00BA2_A542OrganisationDynamicFormId[0];
            A240WWPFormType = P00BA2_A240WWPFormType[0];
            A209WWPFormTitle = P00BA2_A209WWPFormTitle[0];
            A231WWPFormDate = P00BA2_A231WWPFormDate[0];
            A208WWPFormReferenceName = P00BA2_A208WWPFormReferenceName[0];
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV50Wp_organisationdynamicformds_2_filterfulltext)) || ( ( StringUtil.Like( StringUtil.Lower( A209WWPFormTitle) , StringUtil.PadR( "%" + StringUtil.Lower( AV50Wp_organisationdynamicformds_2_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A208WWPFormReferenceName) , StringUtil.PadR( "%" + StringUtil.Lower( AV50Wp_organisationdynamicformds_2_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A207WWPFormVersionNumber), 4, 0) , StringUtil.PadR( "%" + AV50Wp_organisationdynamicformds_2_filterfulltext , 254 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A219WWPFormLatestVersionNumber), 4, 0) , StringUtil.PadR( "%" + AV50Wp_organisationdynamicformds_2_filterfulltext , 254 , "%"),  ' ' ) ) ) )
            {
               if ( (0==AV59Wp_organisationdynamicformds_11_tfwwpformlatestversionnumber) || ( ( A219WWPFormLatestVersionNumber >= AV59Wp_organisationdynamicformds_11_tfwwpformlatestversionnumber ) ) )
               {
                  if ( (0==AV60Wp_organisationdynamicformds_12_tfwwpformlatestversionnumber_to) || ( ( A219WWPFormLatestVersionNumber <= AV60Wp_organisationdynamicformds_12_tfwwpformlatestversionnumber_to ) ) )
                  {
                     ...
                     AV31count = 0;
                     while ( (pr_default.getStatus(0) != 101) && ( P00BA2_A240WWPFormType[0] == A240WWPFormType ) && ( StringUtil.StrCmp(P00BA2_A209WWPFormTitle[0], A209WWPFormTitle) == 0 ) )
                     {
                        BRKBA2 = false;
                        A11OrganisationId = P00BA2_A11OrganisationId[0];
                        A207WWPFormVersionNumber = P00BA2_A207WWPFormVersionNumber[0];
      ...
      protected void S131( )
      {
         ...
         {
            BRKBA4 = false;
            A240WWPFormType = P00BA3_A240WWPFormType[0];
            A11OrganisationId = P00BA3_A11OrganisationId[0];
            A207WWPFormVersionNumber = P00BA3_A207WWPFormVersionNumber[0];
            A231WWPFormDate = P00BA3_A231WWPFormDate[0];
            A208WWPFormReferenceName = P00BA3_A208WWPFormReferenceName[0];
            A209WWPFormTitle = P00BA3_A209WWPFormTitle[0];
            A206WWPFormId = P00BA3_A206WWPFormId[0];
            A542OrganisationDynamicFormId = P00BA3_A542OrganisationDynamicFormId[0];
            A240WWPFormType = P00BA3_A240WWPFormType[0];
            A231WWPFormDate = P00BA3_A231WWPFormDate[0];
            A208WWPFormReferenceName = P00BA3_A208WWPFormReferenceName[0];
            A209WWPFormTitle = P00BA3_A209WWPFormTitle[0];
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV50Wp_organisationdynamicformds_2_filterfulltext)) || ( ( StringUtil.Like( StringUtil.Lower( A209WWPFormTitle) , StringUtil.PadR( "%" + StringUtil.Lower( AV50Wp_organisationdynamicformds_2_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Lower( A208WWPFormReferenceName) , StringUtil.PadR( "%" + StringUtil.Lower( AV50Wp_organisationdynamicformds_2_filterfulltext) , 255 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A207WWPFormVersionNumber), 4, 0) , StringUtil.PadR( "%" + AV50Wp_organisationdynamicformds_2_filterfulltext , 254 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A219WWPFormLatestVersionNumber), 4, 0) , StringUtil.PadR( "%" + AV50Wp_organisationdynamicformds_2_filterfulltext , 254 , "%"),  ' ' ) ) ) )
            {
               if ( (0==AV59Wp_organisationdynamicformds_11_tfwwpformlatestversionnumber) || ( ( A219WWPFormLatestVersionNumber >= AV59Wp_organisationdynamicformds_11_tfwwpformlatestversionnumber ) ) )
               {
                  if ( (0==AV60Wp_organisationdynamicformds_12_tfwwpformlatestversionnumber_to) || ( ( A219WWPFormLatestVersionNumber <= AV60Wp_organisationdynamicformds_12_tfwwpformlatestversionnumber_to ) ) )
                  {
                     W240WWPFormType = A240WWPFormType;
                     AV31count = 0;
                     while ( (pr_default.getStatus(1) != 101) && ( P00BA3_A240WWPFormType[0] == A240WWPFormType ) && ( P00BA3_A206WWPFormId[0] == A206WWPFormId ) && ( P00BA3_A207WWPFormVersionNumber[0] == A207WWPFormVersionNumber ) )
                     {
                        BRKBA4 = false;
                        A11OrganisationId = P00BA3_A11OrganisationId[0];
                        A542OrganisationDynamicFormId = P00BA3_A542OrganisationDynamicFormId[0];
      ...
      public override void initialize( )
      {
         ...
         P00BA2_A240WWPFormType = new short[1] ;
         P00BA2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00BA2_A209WWPFormTitle = new string[] {""} ;
         P00BA2_A207WWPFormVersionNumber = new short[1] ;
         P00BA2_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         P00BA2_A208WWPFormReferenceName = new string[] {""} ;
         P00BA2_A206WWPFormId = new short[1] ;
         P00BA2_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         A542OrganisationDynamicFormId = Guid.Empty;
         AV26Option = "";
         P00BA3_A240WWPFormType = new short[1] ;
         P00BA3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00BA3_A207WWPFormVersionNumber = new short[1] ;
         P00BA3_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         P00BA3_A208WWPFormReferenceName = new string[] {""} ;
         P00BA3_A209WWPFormTitle = new string[] {""} ;
         P00BA3_A206WWPFormId = new short[1] ;
         P00BA3_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_organisationdynamicformgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00BA2_A240WWPFormType, P00BA2_A11OrganisationId, P00BA2_A209WWPFormTitle, P00BA2_A207WWPFormVersionNumber, P00BA2_A231WWPFormDate, P00BA2_A208WWPFormReferenceName, P00BA2_A206WWPFormId, P00BA2_A542OrganisationDynamicFormId
               }
               , new Object[] {
               P00BA3_A240WWPFormType, P00BA3_A11OrganisationId, P00BA3_A207WWPFormVersionNumber, P00BA3_A231WWPFormDate, P00BA3_A208WWPFormReferenceName, P00BA3_A209WWPFormTitle, P00BA3_A206WWPFormId, P00BA3_A542OrganisationDynamicFormId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00BA2_A240WWPFormType ;
      private Guid[] P00BA2_A11OrganisationId ;
      private string[] P00BA2_A209WWPFormTitle ;
      private short[] P00BA2_A207WWPFormVersionNumber ;
      private DateTime[] P00BA2_A231WWPFormDate ;
      private string[] P00BA2_A208WWPFormReferenceName ;
      private short[] P00BA2_A206WWPFormId ;
      private Guid[] P00BA2_A542OrganisationDynamicFormId ;
      private short[] P00BA3_A240WWPFormType ;
      private Guid[] P00BA3_A11OrganisationId ;
      private short[] P00BA3_A207WWPFormVersionNumber ;
      private DateTime[] P00BA3_A231WWPFormDate ;
      private string[] P00BA3_A208WWPFormReferenceName ;
      private string[] P00BA3_A209WWPFormTitle ;
      private short[] P00BA3_A206WWPFormId ;
      private Guid[] P00BA3_A542OrganisationDynamicFormId ;
   ...
   public class wp_organisationdynamicformgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P00BA3( IGxContext context ,
                                             string AV52Wp_organisationdynamicformds_4_tfwwpformtitle_sel ,
                                             string AV51Wp_organisationdynamicformds_3_tfwwpformtitle ,
                                             string AV54Wp_organisationdynamicformds_6_tfwwpformreferencename_sel ,
                                             string AV53Wp_organisationdynamicformds_5_tfwwpformreferencename ,
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00BA3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BA3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
