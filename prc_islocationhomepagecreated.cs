   ...
   public class prc_islocationhomepagecreated : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A318Trn_PageName = P00B82_A318Trn_PageName[0];
            A310Trn_PageId = P00B82_A310Trn_PageId[0];
      ...
      public override void initialize( )
      {
         ...
         P00B82_A318Trn_PageName = new string[] {""} ;
         P00B82_A310Trn_PageId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_islocationhomepagecreated__default(),
            new Object[][] {
                new Object[] {
               P00B82_A29LocationId, P00B82_A318Trn_PageName, P00B82_A310Trn_PageId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00B82_A318Trn_PageName ;
      private Guid[] P00B82_A310Trn_PageId ;
   ...
   public class prc_islocationhomepagecreated__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00B82", "SELECT LocationId, Trn_PageName, Trn_PageId FROM Trn_Page WHERE LocationId = :AV8LocationId ORDER BY Trn_PageId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00B82,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
