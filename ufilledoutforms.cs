...
namespace GeneXus.Programs {
   public class ufilledoutforms : GXDataArea
   {
      ...
      protected void WSAA2( )
      {
         STARTAA2( ) ;
         EVTAA2( ) ;
      }

      protected void EVTAA2( )
      {
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
      ...
      protected void RFAA2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A112WWPUserExtendedId = H00AA2_A112WWPUserExtendedId[0];
               A113WWPUserExtendedFullName = H00AA2_A113WWPUserExtendedFullName[0];
               A208WWPFormReferenceName = H00AA2_A208WWPFormReferenceName[0];
               A209WWPFormTitle = H00AA2_A209WWPFormTitle[0];
               A207WWPFormVersionNumber = H00AA2_A207WWPFormVersionNumber[0];
               A239WWPFormInstanceDate = H00AA2_A239WWPFormInstanceDate[0];
               A214WWPFormInstanceId = H00AA2_A214WWPFormInstanceId[0];
               A206WWPFormId = H00AA2_A206WWPFormId[0];
               A113WWPUserExtendedFullName = H00AA2_A113WWPUserExtendedFullName[0];
               A208WWPFormReferenceName = H00AA2_A208WWPFormReferenceName[0];
               A209WWPFormTitle = H00AA2_A209WWPFormTitle[0];
      ...
      protected void send_integrity_lvl_hashesAA2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV57Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV57Pgmname, "")), context));
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H00AA3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E17AA2( )
      {
         ...
         edtWWPFormInstanceDate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavWwpformversionnumberwithtags_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtWWPUserExtendedFullName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E15AA2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "UFilledOutFormsColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV16ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11AA2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "UFilledOutFormsFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "UFilledOutFormsColumnsSelector", out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "UFilledOutFormsFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202512221115166", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ufilledoutforms.js", "?202512221115169", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18AA2","iparms":[{"av":"A207WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9"},{"av":"A219WWPFormLatestVersionNumber","fld":"WWPFORMLATESTVERSIONNUMBER","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E19AA2","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV55GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9"},{"av":"A208WWPFormReferenceName","fld":"WWPFORMREFERENCENAME"},{"av":"A214WWPFormInstanceId","fld":"WWPFORMINSTANCEID","pic":"ZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV65Ufilledoutformsds_8_tfwwpuserextendedfullname_sel = "";
         AV64Ufilledoutformsds_7_tfwwpuserextendedfullname = "";
         H00AA2_A112WWPUserExtendedId = new string[] {""} ;
         H00AA2_A113WWPUserExtendedFullName = new string[] {""} ;
         H00AA2_A208WWPFormReferenceName = new string[] {""} ;
         H00AA2_A209WWPFormTitle = new string[] {""} ;
         H00AA2_A207WWPFormVersionNumber = new short[1] ;
         H00AA2_A239WWPFormInstanceDate = new DateTime[] {DateTime.MinValue} ;
         H00AA2_A214WWPFormInstanceId = new int[1] ;
         H00AA2_A206WWPFormId = new short[1] ;
         A112WWPUserExtendedId = "";
         H00AA3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ufilledoutforms__default(),
            new Object[][] {
                new Object[] {
               H00AA2_A112WWPUserExtendedId, H00AA2_A113WWPUserExtendedFullName, H00AA2_A208WWPFormReferenceName, H00AA2_A209WWPFormTitle, H00AA2_A207WWPFormVersionNumber, H00AA2_A239WWPFormInstanceDate, H00AA2_A214WWPFormInstanceId, H00AA2_A206WWPFormId
               }
               , new Object[] {
               H00AA3_AGRID_nRecordCount
               }
            }
         );
         AV57Pgmname = "UFilledOutForms";
      ...
      private string[] H00AA2_A112WWPUserExtendedId ;
      private string[] H00AA2_A113WWPUserExtendedFullName ;
      private string[] H00AA2_A208WWPFormReferenceName ;
      private string[] H00AA2_A209WWPFormTitle ;
      private short[] H00AA2_A207WWPFormVersionNumber ;
      private DateTime[] H00AA2_A239WWPFormInstanceDate ;
      private int[] H00AA2_A214WWPFormInstanceId ;
      private short[] H00AA2_A206WWPFormId ;
      private long[] H00AA3_AGRID_nRecordCount ;
   ...
   {
      protected Object[] conditional_H00AA2( IGxContext context ,
      ...
      protected Object[] conditional_H00AA3( IGxContext context ,
                                             string AV59Ufilledoutformsds_2_filterfulltext ,
                                             DateTime AV60Ufilledoutformsds_3_tfwwpforminstancedate ,
                                             DateTime AV61Ufilledoutformsds_4_tfwwpforminstancedate_to ,
                                             short AV62Ufilledoutformsds_5_tfwwpformversionnumber ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00AA2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H00AA3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00AA2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AA2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00AA3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AA3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
