   ...
   public class urecoverpasswordstep2 : GXDataArea
   {
      ...
      protected void WBA80( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_35_A82( true) ;
         }
         else
         {
            wb_table1_35_A82( false) ;
         }
         return  ;
      }

      protected void wb_table1_35_A82e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void S112( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_Password", ""), "", "", "", "", "", "", "", ""),  "error",  edtavUserpassword_Internalname,  "true",  ""));
            AV19CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV19CheckRequiredFieldsResult", AV19CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV8UserPasswordComfirmation)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Comfirm Password", ""), "", "", "", "", "", "", "", ""),  "error",  edtavUserpasswordcomfirmation_Internalname,  "true",  ""));
            AV19CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV19CheckRequiredFieldsResult", AV19CheckRequiredFieldsResult);
         }
      ...
      protected void wb_table1_35_A82( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_35_A82e( true) ;
         }
         else
         {
            wb_table1_35_A82e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202512221113238", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("urecoverpasswordstep2.js", "?202512221113242", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GOTOLOGIN.CLICK","""{"handler":"E13A82","iparms":[]}""");
