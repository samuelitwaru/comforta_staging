   ...
   public class udfc_fs_wc : GXWebComponent
   {
      ...
      protected void WBA70( )
      {
         ...
         if ( wbEnd == 9 )
         {
            ...
            wb_table1_19_A72( true) ;
         }
         else
         {
            wb_table1_19_A72( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_A72e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_37_A72( true) ;
         }
         else
         {
            wb_table2_37_A72( false) ;
         }
         return  ;
      }

      protected void wb_table2_37_A72e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_42_A72( true) ;
         }
         else
         {
            wb_table3_42_A72( false) ;
         }
         return  ;
      }

      protected void wb_table3_42_A72e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_47_A72( true) ;
         }
         else
         {
            wb_table4_47_A72( false) ;
         }
         return  ;
      }

      protected void wb_table4_47_A72e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void wb_table4_47_A72( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_47_A72e( true) ;
         }
         else
         {
            wb_table4_47_A72e( false) ;
         }
      }

      protected void wb_table3_42_A72( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_42_A72e( true) ;
         }
         else
         {
            wb_table3_42_A72e( false) ;
         }
      }

      protected void wb_table2_37_A72( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_37_A72e( true) ;
         }
         else
         {
            wb_table2_37_A72e( false) ;
         }
      }

      protected void wb_table1_19_A72( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_A72e( true) ;
         }
         else
         {
            wb_table1_19_A72e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253121532373", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("udfc_fs_wc.js", "?20253121532374", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSGRID.LOAD","""{"handler":"E21A72","iparms":[{"av":"AV23WWPForm","fld":"vWWPFORM"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("FSGRID.LOAD",""","oparms":[{"ctrl":"WCCHILDREN"}]}""");
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E16A72","iparms":[{"av":"FSGRID_nFirstRecordOnPage"},{"av":"FSGRID_nEOF"},{"av":"AV10IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true},{"av":"AV11IsLastElement","fld":"vISLASTELEMENT","hsh":true},{"av":"AV5AllowDeletion","fld":"vALLOWDELETION","hsh":true},{"av":"AV23WWPForm","fld":"vWWPFORM"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true},{"av":"AV12IsStep","fld":"vISSTEP","hsh":true},{"av":"sPrefix"}]""");
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E17A72","iparms":[{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E18A72","iparms":[{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11A72","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV23WWPForm","fld":"vWWPFORM"}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13A72","iparms":[{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.ONLOADCOMPONENT","""{"handler":"E15A72","iparms":[{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
