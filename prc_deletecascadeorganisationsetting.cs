...
namespace GeneXus.Programs {
   public class prc_deletecascadeorganisationsetting : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A100OrganisationSettingid = P00C42_A100OrganisationSettingid[0];
            A11OrganisationId = P00C42_A11OrganisationId[0];
            /* Using cursor P00C43 */
      ...
      public override void initialize( )
      {
         ...
         P00C42_A100OrganisationSettingid = new Guid[] {Guid.Empty} ;
         P00C42_A11OrganisationId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadeorganisationsetting__default(),
            new Object[][] {
                new Object[] {
               P00C42_A100OrganisationSettingid, P00C42_A11OrganisationId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C42_A100OrganisationSettingid ;
      private Guid[] P00C42_A11OrganisationId ;
   }

   public class prc_deletecascadeorganisationsetting__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00C42( IGxContext context ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C42(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C42", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C42,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C43", "SAVEPOINT gxupdate;DELETE FROM Trn_OrganisationSetting  WHERE OrganisationSettingid = :OrganisationSettingid AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C43)
          };
       }
    }
