...
namespace GeneXus.Programs {
   public class applicationdesign : GXDataArea
   {
      ...
      public applicationdesign( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            ...
            GXEncryptionTmp = "applicationdesign.aspx"+UrlEncode(AV16Trn_PageId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("applicationdesign.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "applicationdesign.aspx"+UrlEncode(AV16Trn_PageId.ToString());
         return formatLink("applicationdesign.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void PA472( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "applicationdesign.aspx")), "applicationdesign.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "applicationdesign.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E11472( )
      {
         ...
         pr_default.close(0);
         AV47Udparg1 = new prc_getuserlocationid(context).executeUdp( );
         AV48Udparg2 = new prc_getuserorganisationid(context).executeUdp( );
         /* Using cursor H00473 */
         pr_default.execute(1, new Object[] {AV47Udparg1, AV48Udparg2});
         ...
         pr_default.close(1);
         /* Using cursor H00474 */
         pr_default.execute(2, new Object[] {AV41LocationId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251714453715", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("applicationdesign.js", "?20251714453716", false, true);
            context.AddJavascriptSource("UserControls/UC_AppToolBoxRender.js", "", false, true);
         }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.applicationdesign__default(),
            new Object[][] {
                new Object[] {
               ...
               , new Object[] {
               H00474_A29LocationId, H00474_A409MediaId
               }
               , new Object[] {
   ...
   public class applicationdesign__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV48Udparg2",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00474;
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00473", "SELECT OrganisationId, LocationId, ProductServiceImage_GXI, ProductServiceId, ProductServiceName, ProductServiceImage FROM Trn_ProductService WHERE LocationId = :AV47Udparg1 and OrganisationId = :AV48Udparg2 ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00473,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00474", "SELECT LocationId, MediaId FROM Trn_Media WHERE LocationId = :AV41LocationId ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00474,100, GxCacheFrequency.OFF ,true,false )
