   ...
   public class trn_organisationdynamicform : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel3"+"_"+"WWPFORMLATESTVERSIONNUMBER") == 0 )
         {
            ...
            GX3ASAWWPFORMLATESTVERSIONNUMBER1O104( A206WWPFormId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtOrganisationDynamicFormId_Internalname, A542OrganisationDynamicFormId.ToString(), A542OrganisationDynamicFormId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrganisationDynamicFormId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtOrganisationDynamicFormId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_OrganisationDynamicForm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z542OrganisationDynamicFormId = StringUtil.StrToGuid( cgiGet( "Z542OrganisationDynamicFormId"));
            ...
            if ( StringUtil.StrCmp(cgiGet( edtOrganisationDynamicFormId_Internalname), "") == 0 )
            {
               ...
               AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
            }
            else
            {
               try
               {
                  A542OrganisationDynamicFormId = StringUtil.StrToGuid( cgiGet( edtOrganisationDynamicFormId_Internalname));
                  AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
               }
               catch ( Exception  )
               {
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A542OrganisationDynamicFormId = StringUtil.StrToGuid( GetPar( "OrganisationDynamicFormId"));
               AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
               A11OrganisationId = StringUtil.StrToGuid( GetPar( "OrganisationId"));
               AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
               getEqualNoModal( ) ;
               if ( IsIns( )  && (Guid.Empty==A542OrganisationDynamicFormId) && ( Gx_BScreen == 0 ) )
               {
      ...
      protected void ZM1O104( short GX_JID )
      {
         if ( ( GX_JID == 5 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z206WWPFormId = T001O3_A206WWPFormId[0];
               Z207WWPFormVersionNumber = T001O3_A207WWPFormVersionNumber[0];
            }
            else
            {
      ...
      protected void Load1O104( )
      {
         ...
         {
            RcdFound104 = 1;
            A208WWPFormReferenceName = T001O6_A208WWPFormReferenceName[0];
            AssignAttri("", false, "A208WWPFormReferenceName", A208WWPFormReferenceName);
            A209WWPFormTitle = T001O6_A209WWPFormTitle[0];
            AssignAttri("", false, "A209WWPFormTitle", A209WWPFormTitle);
            A231WWPFormDate = T001O6_A231WWPFormDate[0];
            AssignAttri("", false, "A231WWPFormDate", context.localUtil.TToC( A231WWPFormDate, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "));
            A232WWPFormIsWizard = T001O6_A232WWPFormIsWizard[0];
            AssignAttri("", false, "A232WWPFormIsWizard", A232WWPFormIsWizard);
            A216WWPFormResume = T001O6_A216WWPFormResume[0];
            AssignAttri("", false, "A216WWPFormResume", StringUtil.Str( (decimal)(A216WWPFormResume), 1, 0));
            A235WWPFormResumeMessage = T001O6_A235WWPFormResumeMessage[0];
            AssignAttri("", false, "A235WWPFormResumeMessage", A235WWPFormResumeMessage);
            A233WWPFormValidations = T001O6_A233WWPFormValidations[0];
            AssignAttri("", false, "A233WWPFormValidations", A233WWPFormValidations);
            A234WWPFormInstantiated = T001O6_A234WWPFormInstantiated[0];
            AssignAttri("", false, "A234WWPFormInstantiated", A234WWPFormInstantiated);
            A240WWPFormType = T001O6_A240WWPFormType[0];
            AssignAttri("", false, "A240WWPFormType", StringUtil.Str( (decimal)(A240WWPFormType), 1, 0));
            A241WWPFormSectionRefElements = T001O6_A241WWPFormSectionRefElements[0];
            AssignAttri("", false, "A241WWPFormSectionRefElements", A241WWPFormSectionRefElements);
            A242WWPFormIsForDynamicValidations = T001O6_A242WWPFormIsForDynamicValidations[0];
            AssignAttri("", false, "A242WWPFormIsForDynamicValidations", A242WWPFormIsForDynamicValidations);
            A206WWPFormId = T001O6_A206WWPFormId[0];
            AssignAttri("", false, "A206WWPFormId", StringUtil.LTrimStr( (decimal)(A206WWPFormId), 4, 0));
            A207WWPFormVersionNumber = T001O6_A207WWPFormVersionNumber[0];
            AssignAttri("", false, "A207WWPFormVersionNumber", StringUtil.LTrimStr( (decimal)(A207WWPFormVersionNumber), 4, 0));
            ZM1O104( -5) ;
         }
         pr_default.close(4);
      ...
      protected void CheckExtendedTable1O104( )
      {
         ...
         A208WWPFormReferenceName = T001O5_A208WWPFormReferenceName[0];
         AssignAttri("", false, "A208WWPFormReferenceName", A208WWPFormReferenceName);
         A209WWPFormTitle = T001O5_A209WWPFormTitle[0];
         AssignAttri("", false, "A209WWPFormTitle", A209WWPFormTitle);
         A231WWPFormDate = T001O5_A231WWPFormDate[0];
         AssignAttri("", false, "A231WWPFormDate", context.localUtil.TToC( A231WWPFormDate, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "));
         A232WWPFormIsWizard = T001O5_A232WWPFormIsWizard[0];
         AssignAttri("", false, "A232WWPFormIsWizard", A232WWPFormIsWizard);
         A216WWPFormResume = T001O5_A216WWPFormResume[0];
         AssignAttri("", false, "A216WWPFormResume", StringUtil.Str( (decimal)(A216WWPFormResume), 1, 0));
         A235WWPFormResumeMessage = T001O5_A235WWPFormResumeMessage[0];
         AssignAttri("", false, "A235WWPFormResumeMessage", A235WWPFormResumeMessage);
         A233WWPFormValidations = T001O5_A233WWPFormValidations[0];
         AssignAttri("", false, "A233WWPFormValidations", A233WWPFormValidations);
         A234WWPFormInstantiated = T001O5_A234WWPFormInstantiated[0];
         AssignAttri("", false, "A234WWPFormInstantiated", A234WWPFormInstantiated);
         A240WWPFormType = T001O5_A240WWPFormType[0];
         AssignAttri("", false, "A240WWPFormType", StringUtil.Str( (decimal)(A240WWPFormType), 1, 0));
         A241WWPFormSectionRefElements = T001O5_A241WWPFormSectionRefElements[0];
         AssignAttri("", false, "A241WWPFormSectionRefElements", A241WWPFormSectionRefElements);
         A242WWPFormIsForDynamicValidations = T001O5_A242WWPFormIsForDynamicValidations[0];
         AssignAttri("", false, "A242WWPFormIsForDynamicValidations", A242WWPFormIsForDynamicValidations);
         pr_default.close(3);
         GXt_int1 = A219WWPFormLatestVersionNumber;
         new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_getlatestversionofform(context ).execute(  A206WWPFormId, out  GXt_int1) ;
                               ...
                               short A207WWPFormVersionNumber )
      {
         ...
         A208WWPFormReferenceName = T001O8_A208WWPFormReferenceName[0];
         AssignAttri("", false, "A208WWPFormReferenceName", A208WWPFormReferenceName);
         A209WWPFormTitle = T001O8_A209WWPFormTitle[0];
         AssignAttri("", false, "A209WWPFormTitle", A209WWPFormTitle);
         A231WWPFormDate = T001O8_A231WWPFormDate[0];
         AssignAttri("", false, "A231WWPFormDate", context.localUtil.TToC( A231WWPFormDate, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "));
         A232WWPFormIsWizard = T001O8_A232WWPFormIsWizard[0];
         AssignAttri("", false, "A232WWPFormIsWizard", A232WWPFormIsWizard);
         A216WWPFormResume = T001O8_A216WWPFormResume[0];
         AssignAttri("", false, "A216WWPFormResume", StringUtil.Str( (decimal)(A216WWPFormResume), 1, 0));
         A235WWPFormResumeMessage = T001O8_A235WWPFormResumeMessage[0];
         AssignAttri("", false, "A235WWPFormResumeMessage", A235WWPFormResumeMessage);
         A233WWPFormValidations = T001O8_A233WWPFormValidations[0];
         AssignAttri("", false, "A233WWPFormValidations", A233WWPFormValidations);
         A234WWPFormInstantiated = T001O8_A234WWPFormInstantiated[0];
         AssignAttri("", false, "A234WWPFormInstantiated", A234WWPFormInstantiated);
         A240WWPFormType = T001O8_A240WWPFormType[0];
         AssignAttri("", false, "A240WWPFormType", StringUtil.Str( (decimal)(A240WWPFormType), 1, 0));
         A241WWPFormSectionRefElements = T001O8_A241WWPFormSectionRefElements[0];
         AssignAttri("", false, "A241WWPFormSectionRefElements", A241WWPFormSectionRefElements);
         A242WWPFormIsForDynamicValidations = T001O8_A242WWPFormIsForDynamicValidations[0];
         AssignAttri("", false, "A242WWPFormIsForDynamicValidations", A242WWPFormIsForDynamicValidations);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      {
         /* Using cursor T001O9 */
         pr_default.execute(7, new Object[] {A542OrganisationDynamicFormId, A11OrganisationId});
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM1O104( 5) ;
            RcdFound104 = 1;
            A542OrganisationDynamicFormId = T001O3_A542OrganisationDynamicFormId[0];
            AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
            A11OrganisationId = T001O3_A11OrganisationId[0];
            AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
            A206WWPFormId = T001O3_A206WWPFormId[0];
            AssignAttri("", false, "A206WWPFormId", StringUtil.LTrimStr( (decimal)(A206WWPFormId), 4, 0));
            A207WWPFormVersionNumber = T001O3_A207WWPFormVersionNumber[0];
            AssignAttri("", false, "A207WWPFormVersionNumber", StringUtil.LTrimStr( (decimal)(A207WWPFormVersionNumber), 4, 0));
            Z542OrganisationDynamicFormId = A542OrganisationDynamicFormId;
            Z11OrganisationId = A11OrganisationId;
            sMode104 = Gx_mode;
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(8) != 101) && ( ( GuidUtil.Compare(T001O10_A542OrganisationDynamicFormId[0], A542OrganisationDynamicFormId, 0) < 0 ) || ( T001O10_A542OrganisationDynamicFormId[0] == A542OrganisationDynamicFormId ) && ( GuidUtil.Compare(T001O10_A11OrganisationId[0], A11OrganisationId, 0) < 0 ) ) )
            {
               pr_default.readNext(8);
            }
            if ( (pr_default.getStatus(8) != 101) && ( ( GuidUtil.Compare(T001O10_A542OrganisationDynamicFormId[0], A542OrganisationDynamicFormId, 0) > 0 ) || ( T001O10_A542OrganisationDynamicFormId[0] == A542OrganisationDynamicFormId ) && ( GuidUtil.Compare(T001O10_A11OrganisationId[0], A11OrganisationId, 0) > 0 ) ) )
            {
               A542OrganisationDynamicFormId = T001O10_A542OrganisationDynamicFormId[0];
               AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
               A11OrganisationId = T001O10_A11OrganisationId[0];
               AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
               RcdFound104 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         pr_default.execute(9, new Object[] {A542OrganisationDynamicFormId, A11OrganisationId});
         if ( (pr_default.getStatus(9) != 101) )
         {
            while ( (pr_default.getStatus(9) != 101) && ( ( GuidUtil.Compare(T001O11_A542OrganisationDynamicFormId[0], A542OrganisationDynamicFormId, 0) > 0 ) || ( T001O11_A542OrganisationDynamicFormId[0] == A542OrganisationDynamicFormId ) && ( GuidUtil.Compare(T001O11_A11OrganisationId[0], A11OrganisationId, 0) > 0 ) ) )
            {
               pr_default.readNext(9);
            }
            if ( (pr_default.getStatus(9) != 101) && ( ( GuidUtil.Compare(T001O11_A542OrganisationDynamicFormId[0], A542OrganisationDynamicFormId, 0) < 0 ) || ( T001O11_A542OrganisationDynamicFormId[0] == A542OrganisationDynamicFormId ) && ( GuidUtil.Compare(T001O11_A11OrganisationId[0], A11OrganisationId, 0) < 0 ) ) )
            {
               A542OrganisationDynamicFormId = T001O11_A542OrganisationDynamicFormId[0];
               AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
               A11OrganisationId = T001O11_A11OrganisationId[0];
               AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
               RcdFound104 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency1O104( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( Z206WWPFormId != T001O2_A206WWPFormId[0] ) || ( Z207WWPFormVersionNumber != T001O2_A207WWPFormVersionNumber[0] ) )
            {
               if ( Z206WWPFormId != T001O2_A206WWPFormId[0] )
               {
                  GXUtil.WriteLog("trn_organisationdynamicform:[seudo value changed for attri]"+"WWPFormId");
                  GXUtil.WriteLogRaw("Old: ",Z206WWPFormId);
                  GXUtil.WriteLogRaw("Current: ",T001O2_A206WWPFormId[0]);
               }
               if ( Z207WWPFormVersionNumber != T001O2_A207WWPFormVersionNumber[0] )
               {
                  ...
                  GXUtil.WriteLogRaw("Current: ",T001O2_A207WWPFormVersionNumber[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A542OrganisationDynamicFormId, A11OrganisationId, A206WWPFormId, A207WWPFormVersionNumber});
                     pr_default.close(10);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(11, new Object[] {A206WWPFormId, A207WWPFormVersionNumber, A542OrganisationDynamicFormId, A11OrganisationId});
                     pr_default.close(11);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_OrganisationDynamicForm");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(12, new Object[] {A542OrganisationDynamicFormId, A11OrganisationId});
                  pr_default.close(12);
                  pr_default.SmartCacheProvider.SetUpdated("Trn_OrganisationDynamicForm");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls1O104( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A208WWPFormReferenceName = T001O15_A208WWPFormReferenceName[0];
            AssignAttri("", false, "A208WWPFormReferenceName", A208WWPFormReferenceName);
            A209WWPFormTitle = T001O15_A209WWPFormTitle[0];
            AssignAttri("", false, "A209WWPFormTitle", A209WWPFormTitle);
            A231WWPFormDate = T001O15_A231WWPFormDate[0];
            AssignAttri("", false, "A231WWPFormDate", context.localUtil.TToC( A231WWPFormDate, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " "));
            A232WWPFormIsWizard = T001O15_A232WWPFormIsWizard[0];
            AssignAttri("", false, "A232WWPFormIsWizard", A232WWPFormIsWizard);
            A216WWPFormResume = T001O15_A216WWPFormResume[0];
            AssignAttri("", false, "A216WWPFormResume", StringUtil.Str( (decimal)(A216WWPFormResume), 1, 0));
            A235WWPFormResumeMessage = T001O15_A235WWPFormResumeMessage[0];
            AssignAttri("", false, "A235WWPFormResumeMessage", A235WWPFormResumeMessage);
            A233WWPFormValidations = T001O15_A233WWPFormValidations[0];
            AssignAttri("", false, "A233WWPFormValidations", A233WWPFormValidations);
            A234WWPFormInstantiated = T001O15_A234WWPFormInstantiated[0];
            AssignAttri("", false, "A234WWPFormInstantiated", A234WWPFormInstantiated);
            A240WWPFormType = T001O15_A240WWPFormType[0];
            AssignAttri("", false, "A240WWPFormType", StringUtil.Str( (decimal)(A240WWPFormType), 1, 0));
            A241WWPFormSectionRefElements = T001O15_A241WWPFormSectionRefElements[0];
            AssignAttri("", false, "A241WWPFormSectionRefElements", A241WWPFormSectionRefElements);
            A242WWPFormIsForDynamicValidations = T001O15_A242WWPFormIsForDynamicValidations[0];
            AssignAttri("", false, "A242WWPFormIsForDynamicValidations", A242WWPFormIsForDynamicValidations);
            pr_default.close(13);
         }
      }
      ...
      public void ScanStart1O104( )
      {
         ...
         {
            RcdFound104 = 1;
            A542OrganisationDynamicFormId = T001O16_A542OrganisationDynamicFormId[0];
            AssignAttri("", false, "A542OrganisationDynamicFormId", A542OrganisationDynamicFormId.ToString());
            A11OrganisationId = T001O16_A11OrganisationId[0];
            AssignAttri("", false, "A11OrganisationId", A11OrganisationId.ToString());
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext1O104( )
      {
         /* Scan next routine */
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z542OrganisationDynamicFormId", Z542OrganisationDynamicFormId.ToString());
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20253588846", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationdynamicform.js", "?20253588846", false, true);
      ...
      protected void GX3ASAWWPFORMLATESTVERSIONNUMBER1O104( short A206WWPFormId )
      {
         GXt_int1 = A219WWPFormLatestVersionNumber;
         new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_getlatestversionofform(context ).execute(  A206WWPFormId, out  GXt_int1) ;
         A219WWPFormLatestVersionNumber = GXt_int1;
      ...
      public override void initialize( )
      {
         ...
         T001O6_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O6_A208WWPFormReferenceName = new string[] {""} ;
         T001O6_A209WWPFormTitle = new string[] {""} ;
         T001O6_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         T001O6_A232WWPFormIsWizard = new bool[] {false} ;
         T001O6_A216WWPFormResume = new short[1] ;
         T001O6_A235WWPFormResumeMessage = new string[] {""} ;
         T001O6_A233WWPFormValidations = new string[] {""} ;
         T001O6_A234WWPFormInstantiated = new bool[] {false} ;
         T001O6_A240WWPFormType = new short[1] ;
         T001O6_A241WWPFormSectionRefElements = new string[] {""} ;
         T001O6_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         T001O6_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O6_A206WWPFormId = new short[1] ;
         T001O6_A207WWPFormVersionNumber = new short[1] ;
         T001O4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O5_A208WWPFormReferenceName = new string[] {""} ;
         T001O5_A209WWPFormTitle = new string[] {""} ;
         T001O5_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         T001O5_A232WWPFormIsWizard = new bool[] {false} ;
         T001O5_A216WWPFormResume = new short[1] ;
         T001O5_A235WWPFormResumeMessage = new string[] {""} ;
         T001O5_A233WWPFormValidations = new string[] {""} ;
         T001O5_A234WWPFormInstantiated = new bool[] {false} ;
         T001O5_A240WWPFormType = new short[1] ;
         T001O5_A241WWPFormSectionRefElements = new string[] {""} ;
         T001O5_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         T001O7_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O8_A208WWPFormReferenceName = new string[] {""} ;
         T001O8_A209WWPFormTitle = new string[] {""} ;
         T001O8_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         T001O8_A232WWPFormIsWizard = new bool[] {false} ;
         T001O8_A216WWPFormResume = new short[1] ;
         T001O8_A235WWPFormResumeMessage = new string[] {""} ;
         T001O8_A233WWPFormValidations = new string[] {""} ;
         T001O8_A234WWPFormInstantiated = new bool[] {false} ;
         T001O8_A240WWPFormType = new short[1] ;
         T001O8_A241WWPFormSectionRefElements = new string[] {""} ;
         T001O8_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         T001O9_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O9_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O3_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O3_A206WWPFormId = new short[1] ;
         T001O3_A207WWPFormVersionNumber = new short[1] ;
         sMode104 = "";
         T001O10_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O10_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O11_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O11_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O2_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         T001O2_A206WWPFormId = new short[1] ;
         T001O2_A207WWPFormVersionNumber = new short[1] ;
         T001O15_A208WWPFormReferenceName = new string[] {""} ;
         T001O15_A209WWPFormTitle = new string[] {""} ;
         T001O15_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         T001O15_A232WWPFormIsWizard = new bool[] {false} ;
         T001O15_A216WWPFormResume = new short[1] ;
         T001O15_A235WWPFormResumeMessage = new string[] {""} ;
         T001O15_A233WWPFormValidations = new string[] {""} ;
         T001O15_A234WWPFormInstantiated = new bool[] {false} ;
         T001O15_A240WWPFormType = new short[1] ;
         T001O15_A241WWPFormSectionRefElements = new string[] {""} ;
         T001O15_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         T001O16_A542OrganisationDynamicFormId = new Guid[] {Guid.Empty} ;
         T001O16_A11OrganisationId = new Guid[] {Guid.Empty} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         T001O17_A11OrganisationId = new Guid[] {Guid.Empty} ;
         ZZ542OrganisationDynamicFormId = Guid.Empty;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationdynamicform__default(),
            new Object[][] {
                new Object[] {
               T001O2_A542OrganisationDynamicFormId, T001O2_A11OrganisationId, T001O2_A206WWPFormId, T001O2_A207WWPFormVersionNumber
               }
               , new Object[] {
               T001O3_A542OrganisationDynamicFormId, T001O3_A11OrganisationId, T001O3_A206WWPFormId, T001O3_A207WWPFormVersionNumber
               }
               , new Object[] {
               T001O4_A11OrganisationId
               }
               , new Object[] {
               T001O5_A208WWPFormReferenceName, T001O5_A209WWPFormTitle, T001O5_A231WWPFormDate, T001O5_A232WWPFormIsWizard, T001O5_A216WWPFormResume, T001O5_A235WWPFormResumeMessage, T001O5_A233WWPFormValidations, T001O5_A234WWPFormInstantiated, T001O5_A240WWPFormType, T001O5_A241WWPFormSectionRefElements,
               T001O5_A242WWPFormIsForDynamicValidations
               }
               , new Object[] {
               T001O6_A542OrganisationDynamicFormId, T001O6_A208WWPFormReferenceName, T001O6_A209WWPFormTitle, T001O6_A231WWPFormDate, T001O6_A232WWPFormIsWizard, T001O6_A216WWPFormResume, T001O6_A235WWPFormResumeMessage, T001O6_A233WWPFormValidations, T001O6_A234WWPFormInstantiated, T001O6_A240WWPFormType,
               T001O6_A241WWPFormSectionRefElements, T001O6_A242WWPFormIsForDynamicValidations, T001O6_A11OrganisationId, T001O6_A206WWPFormId, T001O6_A207WWPFormVersionNumber
               }
               , new Object[] {
               T001O7_A11OrganisationId
               }
               , new Object[] {
               T001O8_A208WWPFormReferenceName, T001O8_A209WWPFormTitle, T001O8_A231WWPFormDate, T001O8_A232WWPFormIsWizard, T001O8_A216WWPFormResume, T001O8_A235WWPFormResumeMessage, T001O8_A233WWPFormValidations, T001O8_A234WWPFormInstantiated, T001O8_A240WWPFormType, T001O8_A241WWPFormSectionRefElements,
               T001O8_A242WWPFormIsForDynamicValidations
               }
               , new Object[] {
               T001O9_A542OrganisationDynamicFormId, T001O9_A11OrganisationId
               }
               , new Object[] {
               T001O10_A542OrganisationDynamicFormId, T001O10_A11OrganisationId
               }
               , new Object[] {
               T001O11_A542OrganisationDynamicFormId, T001O11_A11OrganisationId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T001O15_A208WWPFormReferenceName, T001O15_A209WWPFormTitle, T001O15_A231WWPFormDate, T001O15_A232WWPFormIsWizard, T001O15_A216WWPFormResume, T001O15_A235WWPFormResumeMessage, T001O15_A233WWPFormValidations, T001O15_A234WWPFormInstantiated, T001O15_A240WWPFormType, T001O15_A241WWPFormSectionRefElements,
               T001O15_A242WWPFormIsForDynamicValidations
               }
               , new Object[] {
               T001O16_A542OrganisationDynamicFormId, T001O16_A11OrganisationId
               }
               , new Object[] {
               T001O17_A11OrganisationId
               }
            }
         );
      ...
      private Guid ZZ542OrganisationDynamicFormId ;
      ...
      private Guid[] T001O6_A542OrganisationDynamicFormId ;
      private string[] T001O6_A208WWPFormReferenceName ;
      private string[] T001O6_A209WWPFormTitle ;
      private DateTime[] T001O6_A231WWPFormDate ;
      private bool[] T001O6_A232WWPFormIsWizard ;
      private short[] T001O6_A216WWPFormResume ;
      private string[] T001O6_A235WWPFormResumeMessage ;
      private string[] T001O6_A233WWPFormValidations ;
      private bool[] T001O6_A234WWPFormInstantiated ;
      private short[] T001O6_A240WWPFormType ;
      private string[] T001O6_A241WWPFormSectionRefElements ;
      private bool[] T001O6_A242WWPFormIsForDynamicValidations ;
      private Guid[] T001O6_A11OrganisationId ;
      private short[] T001O6_A206WWPFormId ;
      private short[] T001O6_A207WWPFormVersionNumber ;
      private Guid[] T001O4_A11OrganisationId ;
      private string[] T001O5_A208WWPFormReferenceName ;
      private string[] T001O5_A209WWPFormTitle ;
      private DateTime[] T001O5_A231WWPFormDate ;
      private bool[] T001O5_A232WWPFormIsWizard ;
      private short[] T001O5_A216WWPFormResume ;
      private string[] T001O5_A235WWPFormResumeMessage ;
      private string[] T001O5_A233WWPFormValidations ;
      private bool[] T001O5_A234WWPFormInstantiated ;
      private short[] T001O5_A240WWPFormType ;
      private string[] T001O5_A241WWPFormSectionRefElements ;
      private bool[] T001O5_A242WWPFormIsForDynamicValidations ;
      private Guid[] T001O7_A11OrganisationId ;
      private string[] T001O8_A208WWPFormReferenceName ;
      private string[] T001O8_A209WWPFormTitle ;
      private DateTime[] T001O8_A231WWPFormDate ;
      private bool[] T001O8_A232WWPFormIsWizard ;
      private short[] T001O8_A216WWPFormResume ;
      private string[] T001O8_A235WWPFormResumeMessage ;
      private string[] T001O8_A233WWPFormValidations ;
      private bool[] T001O8_A234WWPFormInstantiated ;
      private short[] T001O8_A240WWPFormType ;
      private string[] T001O8_A241WWPFormSectionRefElements ;
      private bool[] T001O8_A242WWPFormIsForDynamicValidations ;
      private Guid[] T001O9_A542OrganisationDynamicFormId ;
      private Guid[] T001O9_A11OrganisationId ;
      private Guid[] T001O3_A542OrganisationDynamicFormId ;
      private Guid[] T001O3_A11OrganisationId ;
      private short[] T001O3_A206WWPFormId ;
      private short[] T001O3_A207WWPFormVersionNumber ;
      private Guid[] T001O10_A542OrganisationDynamicFormId ;
      private Guid[] T001O10_A11OrganisationId ;
      private Guid[] T001O11_A542OrganisationDynamicFormId ;
      private Guid[] T001O11_A11OrganisationId ;
      private Guid[] T001O2_A542OrganisationDynamicFormId ;
      private Guid[] T001O2_A11OrganisationId ;
      private short[] T001O2_A206WWPFormId ;
      private short[] T001O2_A207WWPFormVersionNumber ;
      private string[] T001O15_A208WWPFormReferenceName ;
      private string[] T001O15_A209WWPFormTitle ;
      private DateTime[] T001O15_A231WWPFormDate ;
      private bool[] T001O15_A232WWPFormIsWizard ;
      private short[] T001O15_A216WWPFormResume ;
      private string[] T001O15_A235WWPFormResumeMessage ;
      private string[] T001O15_A233WWPFormValidations ;
      private bool[] T001O15_A234WWPFormInstantiated ;
      private short[] T001O15_A240WWPFormType ;
      private string[] T001O15_A241WWPFormSectionRefElements ;
      private bool[] T001O15_A242WWPFormIsForDynamicValidations ;
      private Guid[] T001O16_A542OrganisationDynamicFormId ;
      private Guid[] T001O16_A11OrganisationId ;
      private Guid[] T001O17_A11OrganisationId ;
...
public class trn_organisationdynamicform__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("T001O2", "SELECT OrganisationDynamicFormId, OrganisationId, WWPFormId, WWPFormVersionNumber FROM Trn_OrganisationDynamicForm WHERE OrganisationDynamicFormId = :OrganisationDynamicFormId AND OrganisationId = :OrganisationId  FOR UPDATE OF Trn_OrganisationDynamicForm NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT001O2,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O3", "SELECT OrganisationDynamicFormId, OrganisationId, WWPFormId, WWPFormVersionNumber FROM Trn_OrganisationDynamicForm WHERE OrganisationDynamicFormId = :OrganisationDynamicFormId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O3,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O4", "SELECT OrganisationId FROM Trn_Organisation WHERE OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O4,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O5", "SELECT WWPFormReferenceName, WWPFormTitle, WWPFormDate, WWPFormIsWizard, WWPFormResume, WWPFormResumeMessage, WWPFormValidations, WWPFormInstantiated, WWPFormType, WWPFormSectionRefElements, WWPFormIsForDynamicValidations FROM WWP_Form WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O5,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O6", "SELECT TM1.OrganisationDynamicFormId, T2.WWPFormReferenceName, T2.WWPFormTitle, T2.WWPFormDate, T2.WWPFormIsWizard, T2.WWPFormResume, T2.WWPFormResumeMessage, T2.WWPFormValidations, T2.WWPFormInstantiated, T2.WWPFormType, T2.WWPFormSectionRefElements, T2.WWPFormIsForDynamicValidations, TM1.OrganisationId, TM1.WWPFormId, TM1.WWPFormVersionNumber FROM (Trn_OrganisationDynamicForm TM1 INNER JOIN WWP_Form T2 ON T2.WWPFormId = TM1.WWPFormId AND T2.WWPFormVersionNumber = TM1.WWPFormVersionNumber) WHERE TM1.OrganisationDynamicFormId = :OrganisationDynamicFormId and TM1.OrganisationId = :OrganisationId ORDER BY TM1.OrganisationDynamicFormId, TM1.OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O6,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O7", "SELECT OrganisationId FROM Trn_Organisation WHERE OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O7,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O8", "SELECT WWPFormReferenceName, WWPFormTitle, WWPFormDate, WWPFormIsWizard, WWPFormResume, WWPFormResumeMessage, WWPFormValidations, WWPFormInstantiated, WWPFormType, WWPFormSectionRefElements, WWPFormIsForDynamicValidations FROM WWP_Form WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O8,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O9", "SELECT OrganisationDynamicFormId, OrganisationId FROM Trn_OrganisationDynamicForm WHERE OrganisationDynamicFormId = :OrganisationDynamicFormId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O9,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O10", "SELECT OrganisationDynamicFormId, OrganisationId FROM Trn_OrganisationDynamicForm WHERE ( OrganisationDynamicFormId > :OrganisationDynamicFormId or OrganisationDynamicFormId = :OrganisationDynamicFormId and OrganisationId > :OrganisationId) ORDER BY OrganisationDynamicFormId, OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O10,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T001O11", "SELECT OrganisationDynamicFormId, OrganisationId FROM Trn_OrganisationDynamicForm WHERE ( OrganisationDynamicFormId < :OrganisationDynamicFormId or OrganisationDynamicFormId = :OrganisationDynamicFormId and OrganisationId < :OrganisationId) ORDER BY OrganisationDynamicFormId DESC, OrganisationId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O11,1, GxCacheFrequency.OFF ,true,true )
          ...
          ,new CursorDef("T001O13", "SAVEPOINT gxupdate;UPDATE Trn_OrganisationDynamicForm SET WWPFormId=:WWPFormId, WWPFormVersionNumber=:WWPFormVersionNumber  WHERE OrganisationDynamicFormId = :OrganisationDynamicFormId AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001O13)
          ,new CursorDef("T001O14", "SAVEPOINT gxupdate;DELETE FROM Trn_OrganisationDynamicForm  WHERE OrganisationDynamicFormId = :OrganisationDynamicFormId AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001O14)
          ,new CursorDef("T001O15", "SELECT WWPFormReferenceName, WWPFormTitle, WWPFormDate, WWPFormIsWizard, WWPFormResume, WWPFormResumeMessage, WWPFormValidations, WWPFormInstantiated, WWPFormType, WWPFormSectionRefElements, WWPFormIsForDynamicValidations FROM WWP_Form WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O15,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O16", "SELECT OrganisationDynamicFormId, OrganisationId FROM Trn_OrganisationDynamicForm ORDER BY OrganisationDynamicFormId, OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O16,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T001O17", "SELECT OrganisationId FROM Trn_Organisation WHERE OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001O17,1, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
