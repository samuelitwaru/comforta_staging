...
namespace GeneXus.Programs {
   public class trn_themectacolorwc : GXWebComponent
   {
      ...
      protected void WBB30( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTrn_ThemeId_Internalname, A247Trn_ThemeId.ToString(), A247Trn_ThemeId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_ThemeId_Jsonclick, 0, "Attribute", "", "", "", "", edtTrn_ThemeId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ThemeCtaColorWC.htm");
            /* User Defined Control */
      ...
      protected void RFB32( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A247Trn_ThemeId = H00B32_A247Trn_ThemeId[0];
               AssignAttri(sPrefix, false, "A247Trn_ThemeId", A247Trn_ThemeId.ToString());
               A565CtaColorCode = H00B32_A565CtaColorCode[0];
               A564CtaColorName = H00B32_A564CtaColorName[0];
               A563CtaColorId = H00B32_A563CtaColorId[0];
               /* Execute user event: Grid.Load */
               E16B32 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H00B33_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202531521545779", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_themectacolorwc.js", "?202531521545779", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A563CtaColorId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A564CtaColorName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A565CtaColorCode));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16B32","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         A565CtaColorCode = "";
         GXDecQS = "";
         H00B32_A247Trn_ThemeId = new Guid[] {Guid.Empty} ;
         H00B32_A565CtaColorCode = new string[] {""} ;
         H00B32_A564CtaColorName = new string[] {""} ;
         H00B32_A563CtaColorId = new Guid[] {Guid.Empty} ;
         H00B33_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_themectacolorwc__default(),
            new Object[][] {
                new Object[] {
               H00B32_A247Trn_ThemeId, H00B32_A565CtaColorCode, H00B32_A564CtaColorName, H00B32_A563CtaColorId
               }
               , new Object[] {
               H00B33_AGRID_nRecordCount
               }
            }
         );
         AV23Pgmname = "Trn_ThemeCtaColorWC";
      ...
      private Guid[] H00B32_A247Trn_ThemeId ;
      private string[] H00B32_A565CtaColorCode ;
      private string[] H00B32_A564CtaColorName ;
      private Guid[] H00B32_A563CtaColorId ;
      private long[] H00B33_AGRID_nRecordCount ;
   ...
   public class trn_themectacolorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00B32(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 1 :
                     return conditional_H00B33(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00B33", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B33,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
