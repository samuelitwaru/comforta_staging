...
namespace GeneXus.Programs {
   public class prc_creatememo : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A71ResidentGUID = P00DA2_A71ResidentGUID[0];
            A62ResidentId = P00DA2_A62ResidentId[0];
            A29LocationId = P00DA2_A29LocationId[0];
            A11OrganisationId = P00DA2_A11OrganisationId[0];
      ...
      public override void initialize( )
      {
         ...
         P00DA2_A71ResidentGUID = new string[] {""} ;
         P00DA2_A62ResidentId = new Guid[] {Guid.Empty} ;
         P00DA2_A29LocationId = new Guid[] {Guid.Empty} ;
         P00DA2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         A71ResidentGUID = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_creatememo__default(),
            new Object[][] {
                new Object[] {
               P00DA2_A71ResidentGUID, P00DA2_A62ResidentId, P00DA2_A29LocationId, P00DA2_A11OrganisationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00DA2_A71ResidentGUID ;
      private Guid[] P00DA2_A62ResidentId ;
      private Guid[] P00DA2_A29LocationId ;
      private Guid[] P00DA2_A11OrganisationId ;
...
public class prc_creatememo__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("P00DA2", "SELECT ResidentGUID, ResidentId, LocationId, OrganisationId FROM Trn_Resident WHERE ResidentGUID = ( :AV19ResidentGUID) ORDER BY ResidentId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DA2,100, GxCacheFrequency.OFF ,false,false )
       };
    }
 }
