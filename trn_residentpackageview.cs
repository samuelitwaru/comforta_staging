   ...
   public class trn_residentpackageview : GXDataArea
   {
      ...
      protected void RFAY2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A554ResidentPackageId = H00AY2_A554ResidentPackageId[0];
               /* Execute user event: Load */
               E16AY2 ();
      ...
      protected void E14AY2( )
      {
         ...
         {
            A554ResidentPackageId = H00AY3_A554ResidentPackageId[0];
            A557ResidentPackageName = H00AY3_A557ResidentPackageName[0];
            AV19GXLvl8 = 1;
            Form.Caption = A557ResidentPackageName;
      ...
      protected void E15AY2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_ResidentPackage",  StringUtil.Trim( A554ResidentPackageId.ToString())) )
         {
      ...
      protected void E11AY2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_ResidentPackage",(short)2,StringUtil.Trim( A554ResidentPackageId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12AY2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_ResidentPackage",StringUtil.Trim( A554ResidentPackageId.ToString()),(string)AV14RecordDescription,formatLink("trn_residentpackageview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202531215103231", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentpackageview.js", "?202531215103231", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11AY2","iparms":[{"av":"A554ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12AY2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A554ResidentPackageId","fld":"RESIDENTPACKAGEID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13AY2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10ResidentPackageId","fld":"vRESIDENTPACKAGEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00AY2_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00AY3_A554ResidentPackageId = new Guid[] {Guid.Empty} ;
         H00AY3_A557ResidentPackageName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentpackageview__default(),
            new Object[][] {
                new Object[] {
               H00AY2_A554ResidentPackageId
               }
               , new Object[] {
               H00AY3_A554ResidentPackageId, H00AY3_A557ResidentPackageName
               }
            }
         );
      ...
      private Guid[] H00AY2_A554ResidentPackageId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00AY3_A554ResidentPackageId ;
      private string[] H00AY3_A557ResidentPackageName ;
   ...
   public class trn_residentpackageview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00AY2", "SELECT ResidentPackageId FROM Trn_ResidentPackage WHERE ResidentPackageId = :AV10ResidentPackageId ORDER BY ResidentPackageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AY2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00AY3", "SELECT ResidentPackageId, ResidentPackageName FROM Trn_ResidentPackage WHERE ResidentPackageId = :AV10ResidentPackageId ORDER BY ResidentPackageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AY3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
