...
namespace GeneXus.Programs {
   public class prc_deletecascadeaudit : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A11OrganisationId = P00C22_A11OrganisationId[0];
            n11OrganisationId = P00C22_n11OrganisationId[0];
            A415AuditId = P00C22_A415AuditId[0];
            /* Using cursor P00C23 */
      ...
      public override void initialize( )
      {
         ...
         P00C22_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00C22_n11OrganisationId = new bool[] {false} ;
         P00C22_A415AuditId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadeaudit__default(),
            new Object[][] {
                new Object[] {
               P00C22_A11OrganisationId, P00C22_n11OrganisationId, P00C22_A415AuditId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C22_A11OrganisationId ;
      private bool[] P00C22_n11OrganisationId ;
      private Guid[] P00C22_A415AuditId ;
   }
   ...
   public class prc_deletecascadeaudit__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C22(context, (Guid)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C22", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C22,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C23", "SAVEPOINT gxupdate;DELETE FROM Trn_Audit  WHERE AuditId = :AuditId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00C23)
          };
       }
    }
